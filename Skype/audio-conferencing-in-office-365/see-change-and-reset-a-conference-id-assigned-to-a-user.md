...
4. Nella **reimpostare ID conferenza?** finestra, fare clic su **Sì**. Una conferenza che ID verrà automaticamente creato e un messaggio di posta elettronica inviati all'utente con il nuovo ID conferenza.
    
    È possibile reimpostare l'ID conferenza per un utente tramite Windows PowerShell. A tale scopo, eseguire:
