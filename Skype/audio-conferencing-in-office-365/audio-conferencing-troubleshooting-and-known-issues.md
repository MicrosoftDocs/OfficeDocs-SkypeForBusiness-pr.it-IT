...
|Gli ID conferenza statici non sono supportati per le riunioni Microsoft Teams.  <br/> |Se l'amministratore ha priorità sull'impostazione predefinita dall'ID conferenza dinamiche all'ID conferenza statico, questa impostazione non ha effetto per le riunioni Teams Microsoft. Vedere [ID dinamico tramite servizi di conferenza Audio all'interno dell'organizzazione](using-audio-conferencing-dynamic-ids-in-your-organization.md).  <br/> |Non ci sono soluzioni alternative.  <br/> |25/9/2017  <br/> |
...
|Se, durante il provisioning iniziale, a un utente viene assegnata una licenza E5, è possibile che l'e-mail di benvenuto ai servizi di audioconferenza non sia stata recapitata in caso di mancata attivazione della cassetta postale.  <br/> |In questo caso, è possibile rinviare sempre le informazioni di accesso esterno alle audioconferenze dell'utente utilizzando il Skype **conferenze Audio** per interfaccia di amministrazione di Business o utilizzo di PowerShell. Vedere [abilitare o disabilitare l'invio messaggi di posta elettronica quando modificano le impostazioni di conferenza Audio](enable-or-disable-sending-emails-when-their-settings-change.md).  <br/> **Nota:** Per inviare nuovamente il PIN di conferenza audio all'utente, deve reimpostare il PIN. Si possono essere eseguita anche utilizzando **audioconferenze** in Skype per interfaccia di amministrazione di Business o utilizzo di PowerShell.          |Non ci sono soluzioni alternative.  <br/> |30/8/2017  <br/> |
