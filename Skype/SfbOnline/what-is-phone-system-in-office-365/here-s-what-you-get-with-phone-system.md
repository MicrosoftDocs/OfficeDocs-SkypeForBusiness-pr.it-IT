...
|[Cosa sono gli operatori automatici in Sistema telefonico](what-are-phone-system-auto-attendants.md) <br/> |Sistema telefonico gli operatori automatici possono essere utilizzati per creare un sistema di menu per l'organizzazione che consente ai chiamanti interni ed esterni spostarsi in un sistema di menu per individuare ed effettuare o trasferire le chiamate per gli utenti della società o reparti all'interno dell'organizzazione.  <br/> |
