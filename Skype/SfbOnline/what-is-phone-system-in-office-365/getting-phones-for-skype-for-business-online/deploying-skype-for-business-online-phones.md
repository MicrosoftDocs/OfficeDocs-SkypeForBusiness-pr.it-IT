...
- Per i telefoni Polycom, consulta [Polycom Deployment Guide]((http://www.polycom.com/voice-conferencing-solutions/desktop-ip-phones.html).
    
- Per i telefoni Yealink, consulta [Soluzione con telefoni IP HD Yealink per Skype for Business](http://www.yealink.com/products_top_2.html).
...
### <a name="step-2---make-sure-youre-purchasing-or-migrating-a-skype-for-business-supported-ip-phone-and-firmware"></a>Fase 2 - Assicurati di acquistare o migrare un telefono IP e firmware supportati da Skype for Business
...
Controlla la versione del firmware per i telefoni. Per:
...
- **Telefoni AudioCodes**, vai a **Menu** > **Stato dispositivo** > **Versione firmware** dalla schermata di avvio.
    ...
    > [!NOTE]
    > Per l'accesso remoto ai dettagli del telefono, consulta le guide per l'amministratore del produttore. Vedi i link riportati sopra per i manuali d'uso e i manuali del telefono. 
...
- **Uso di un accesso Web**: si tratta di un nuovo modo di autenticarsi per gli utenti online utilizzando un browser web standard. Gli utenti riceveranno una serie di istruzioni da seguire quando utilizzano un browser per l'accesso.
  ...
  - Gli utenti con telefoni **Yealink T48G/T46G** vedranno quanto segue:
    ...
    Il codice che viene generato scadrà tra 15 minuti. Alla scadenza, l'utente dovrà fare clic su **Riprova** o su **OK** per generare un nuovo codice, a seconda del telefono.
...
BToE è un meccanismo di accoppiamento telefoni per i telefoni IP partner che accoppia il telefono dell'utente con l'app Skype for Business per Windows. BToE consente agli utenti di:
...
3. La configurazione del server per BToE è impostata su **abilitato** e **la modalità automatica** per impostazione predefinita. Per modificare le impostazioni, consulta [Set-CsIPPhonePolicy](https://technet.microsoft.com/en-us/library/mt629497.aspx).
