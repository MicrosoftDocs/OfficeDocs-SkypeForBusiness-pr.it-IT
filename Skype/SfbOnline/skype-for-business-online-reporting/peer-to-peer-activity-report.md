...
2. Nella pagina **Utilizzo** selezionare  >  **Skype for Business'attività peer-to-peer** **nell'elenco Selezionare un report a** sinistra. In caso contrario, **fare clic Skype for Business** widget Attività peer-to-peer e quindi fare clic su Skype for Business attività **peer-to-peer** nell'elenco Skype for Business **attività.**
...
*    Nel grafico **attività Utenti,** l'asse Y è il numero totale di utenti che hanno tenuto sessioni di messaggistica istantanea, audio, video, condivisione di applicazioni e trasferimento di file. 
