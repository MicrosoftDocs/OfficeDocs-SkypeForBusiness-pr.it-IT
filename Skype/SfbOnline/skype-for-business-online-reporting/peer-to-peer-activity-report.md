...
***
![Numero 3](../images/sfbcallout3.png)<br/>Usare i dati del grafico interattivo **Attività** per comprendere le tendenze di utilizzo e vedere il numero totale di sessioni, per tipo di sessione, nella propria organizzazione. Verrà visualizzato il numero totale e i tipi di sessioni di **messaggistica istantanea**, **audio**, **video**, **condivisione applicazioni**e **trasferimenti file** in tutta l'organizzazione. 
***
![Numero 4](../images/sfbcallout4.png)<br/>Usare i dati del grafico interattivo **Utenti** per comprendere le tendenze di utilizzo e vedere il numero totale di utenti unici che hanno partecipato ad attività peer-to-peer tenute nella propria organizzazione. Verrà visualizzato il numero totale di utenti insieme ai tipi di **messaggistica istantanea**, **audio**, **video**, **condivisione applicazioni**e **trasferimenti di file** nelle sessioni peer-to-peer.
***
...
*    Nel grafico attività **utenti** l'asse Y è il numero totale di utenti che hanno tenuto le sessioni di messaggistica istantanea, audio, video, condivisione applicazioni e trasferimento file. 
...
***
![Numero 7](../images/sfbcallout7.png)<br/>È possibile filtrare la serie visualizzata nel grafico facendo clic su un elemento nella legenda. Nel grafico **attività** , ad esempio, fare clic o toccare **messaggistica istantanea**, **audio**, **video**, **condivisione applicazioni**e **trasferimenti file** per visualizzare solo le informazioni relative a ognuna di esse. La modifica di questa selezione non modifica le informazioni nella tabella della griglia. 
***
