...
È possibile ottenere una panoramica delle conferenze di Skype for business organizzate esaminando i grafici **attività**, **utenti**e **minuti** .
...
*    Nel grafico attività **minuti** l'asse Y rappresenta il numero totale di minuti di audio/video, di accesso esterno in Microsoft minuti e di Microsoft minute per le conferenze che gli utenti hanno organizzato nell'organizzazione.  
...
* **Chiamata in entrata/uscita-3a parte** Mostra il numero totale di conferenze audio in accesso esterno organizzate che usano un provider di servizi di audioconferenza di terze parti. 
* **Accesso esterno/uscita Microsoft** Mostra il numero totale di conferenze audio in accesso esterno organizzate. 
