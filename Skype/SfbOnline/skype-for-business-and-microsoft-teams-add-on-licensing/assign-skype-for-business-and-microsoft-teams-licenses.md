...
Questo articolo offre suggerimenti sull'assegnazione di licenze agli utenti per funzionalità come Audioconferenza, Sistema telefonico e Piani per chiamate. Vengono inoltre forniti gli script per assegnare le licenze in blocco.

> [!IMPORTANT]
> Vedere [Skype for Business licenze](skype-for-business-and-microsoft-teams-add-on-licensing.md) per i componenti aggiuntivi per informazioni sulle licenze che è necessario acquistare e su **come acquistarle**, a seconda del piano Microsoft 365 o Office 365, in modo che gli utenti possano ottenere Audioconferenza, numeri verdi e la possibilità di chiamare numeri di telefono al di fuori dell'azienda.
...
Cosa devi sapere prima di assegnare licenze per Audioconferenza, Sistema telefonico e piani per chiamate
...
- **Latenza dopo l'assegnazione delle licenze**: a causa della latenza tra Microsoft 365 o Office 365 e Skype for Business online, l'assegnazione di un piano per chiamate all'utente dopo l'assegnazione di una licenza può richiedere fino a 24 ore. Se dopo 24 ore all'utente non viene assegnato un piano per chiamate, [contatta il supporto tecnico per i prodotti aziendali - Amministrazione Guida](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b).
...
- **Passaggi successivi**: dopo avere assegnato le licenze per il Piano per chiamate agli utenti, dovrai recuperare i numeri di telefono per l'organizzazione e assegnarli agli utenti. Per istruzioni dettagliate, vedi [Configurare i piani per chiamate](/microsoftteams/set-up-calling-plans).
...
La procedura è uguale all'assegnazione di una licenza Microsoft 365 o Office 365. Vedere [Assegnare o rimuovere licenze per Microsoft 365 per le aziende](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc).
...
1. Installa **Assistente per l'accesso a Microsoft Online Services per professionisti IT - RTW**. Cosa fare se il modulo non è installato? Per scaricarlo, vedere [Microsoft Online Services Sign-In Assistant for IT Professionals RTW](https://go.microsoft.com/fwlink/?LinkId=625123) .

2. Installa il **Modulo di Windows Azure Active Directory.** Cosa fare se il modulo non è installato? Per istruzioni sul download e la sintassi del cmdlet, vedere [Gestire Azure AD usando Windows PowerShell](/previous-versions/azure/jj151815(v=azure.100)).
...
|Piano per chiamate nazionali (3000 min piani USA/1200 min UE)  <br/> |MCOPSTN1  <br/> |
|Piano per chiamate nazionali (piano per chiamate da 120 minuti)  <br/> |MCOPSTN5  <br/> |
|Piano per chiamate nazionali (piano per chiamate da 240 minuti)  <br/> |MCOPSTN6  <br/> |
...
- Passaggi successivi: dopo aver assegnato **Audioconferenza** licenze, devi assegnare un provider di servizi di audioconferenza. Vedi [Assegnare Microsoft come provider di servizi di audioconferenza].
...
1. Scaricare e installare [Microsoft Online Services Sign-In Assistant for IT Professionals RTW](https://go.microsoft.com/fwlink/?LinkId=625123).
...
2. Scarica e installa il **Modulo di Windows Azure Active Directory.** Consulta[Gestire Azure AD tramite Windows PowerShell](/previous-versions/azure/jj151815(v=azure.100)) per ottenere istruzioni per il download e la sintassi del cmdlet.
   ...
   Il nome delle licenze o i nomi dei prodotti nello script sono elencati in corsivo. Vedere [Audioconferenza nomi di prodotto o SKU usati per gli script](assign-skype-for-business-and-microsoft-teams-licenses.md#sku) per tutti i nomi di prodotto.
...
- **Enterprise clienti E5**: Anche se agli utenti sono assegnate licenze Enterprise E5, è comunque consigliabile assegnare loro licenze di **Crediti comunicazioni**.
    
- **Passaggi successivi**: dopo avere assegnato le licenze, dovrai recuperare i numeri di telefono per l'organizzazione e assegnarli agli utenti. Per istruzioni dettagliate, vedi [Configurare i piani per chiamate](/microsoftteams/set-up-calling-plans).
