...
- Comporre i numeri di telefono internazionale oltre a quelli descritti in una sottoscrizione **nazionali e internazionali chiamata pianificare** .
...
Se vuoi sapere quali sono i costi delle chiamate dei Piani per chiamate, consulta i piani di [Tariffe per le chiamate](https://products.office.com/en-us/skype-for-business/pstn-calling-plans#Rates) dei Crediti comunicazioni.
...
> [!NOTE]
> È necessario impostare Crediti comunicazioni e quindi assegnare una licenza di Crediti comunicazioni a ciascun utente nell' **interfaccia di amministrazione Office 365** > **Utenti** > **Utenti attivi**. 
  
È consigliabile valutare attentamente l'utilizzo dell'organizzazione del servizio di rete PSTN per comprendere il programma di installazione ottimale per crediti Communications. È possibile visualizzare ulteriori informazioni sui servizi PSTN leggendo [che cosa sono i piani di chiamata in Office 365?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md) e [audioconferenze domande frequenti](../audio-conferencing-in-office-365/Audio-Conferencing-common-questions.md).
...
> [!NOTE]
> È possibile vedere i piani e i prezzi [accedendo all'interfaccia di amministrazione di Office 365](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) e andando su **Fatturazione** > **Sottoscrizioni** > **Aggiungi sottoscrizioni**. 
...
È possibile consultare le informazioni sui prezzi anche [accedendo all'interfaccia di amministrazione di Office 365](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) e andando su **Fatturazione** > **Sottoscrizioni** > **Aggiungi sottoscrizioni**.
