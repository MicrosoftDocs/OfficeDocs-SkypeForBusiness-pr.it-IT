...
- **Consentire la registrazione di riunioni in broadcast** In questo modo tutte le riunioni devono essere registrate dal relatore o dall'organizzatore.
    
- **URL del supporto tecnico per i partecipanti** Immettere un collegamento per i partecipanti alla trasmissione della riunione da usare se hanno bisogno di aiuto per connettersi o partecipare a una riunione in broadcast.
