---
title: Limitazioni di comporre il numero verde
ms.author: tonysmit
author: tonysmit
manager: serdars
...
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="9dec7-105">Limitazioni di comporre il numero verde</span><span class="sxs-lookup"><span data-stu-id="9dec7-105">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="9dec7-106">Ciò consentirà di scoprire come per comporre i numeri gratuito a pagamento in ogni paese o regione.</span><span class="sxs-lookup"><span data-stu-id="9dec7-106">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="9dec7-107">Dopo aver selezionato il paese/area geografica, verranno visualizzate in una pagina che contiene dove numero a tariffa gratuito è disponibile inclusi limiti, restrizioni e dettagli specifici.</span><span class="sxs-lookup"><span data-stu-id="9dec7-107">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="9dec7-108">Il formato di composizione e i formati verranno visualizzato i codice di accesso necessarie all'interno di ogni paese/area geografica comporre il numero verde.</span><span class="sxs-lookup"><span data-stu-id="9dec7-108">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="9dec7-109">Se si è pronti, selezionare un paese o regione:</span><span class="sxs-lookup"><span data-stu-id="9dec7-109">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="9dec7-110">Selezionare il paese o regione per visualizzare i codici di composizione, limitazioni e le restrizioni.</span><span class="sxs-lookup"><span data-stu-id="9dec7-110">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
> - [Cinese (Nord)](../toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-chinanorth-10-800-714-xxxx-range.md)
> - [Cinese (sud)](../toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-chinasouth-10-800-140-xxxx-range.md)
...
> - [Malesia](../toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-malaysia.md)
...
> - [Thailandia](../toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-thailand.md)
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="9dec7-172">Ecco alcuni aspetti importanti da ricordare sui numeri gratuito a pagamento:</span><span class="sxs-lookup"><span data-stu-id="9dec7-172">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="9dec7-173">**I numeri liberi a pagamento funzionano solo all'interno di ogni paese/area geografica.**</span><span class="sxs-lookup"><span data-stu-id="9dec7-173">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="9dec7-174">Ad esempio, gli utenti saranno in grado di chiamare un numero verde australiano di fuori Australia.</span><span class="sxs-lookup"><span data-stu-id="9dec7-174">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="9dec7-175">**Acquisizione o porting universale International telefonico numeri (UIFN) non è supportato.**</span><span class="sxs-lookup"><span data-stu-id="9dec7-175">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="9dec7-176">**In molti paesi, l'Agenzia regolatore/telecommunication nel paese/area geografica richiede ogni numero verde mantenere almeno 100 minuti di utilizzo al mese per mantenere il numero.**</span><span class="sxs-lookup"><span data-stu-id="9dec7-176">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
    
    > [!NOTE]
    > Nel caso in cui viene visualizzato un numero verde e l'utilizzo del numero non soddisfa i requisiti minimi, Microsoft può farsi l'Agenzia regolatore/telecommunication per recuperare il numero degli utenti. 
  
- <span data-ttu-id="9dec7-178">**Cablate, fissa e accesso alla rete mobile a numeri verdi potrebbero non essere completamente o parzialmente con restrizioni.**</span><span class="sxs-lookup"><span data-stu-id="9dec7-178">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="9dec7-179">Il formato di composizione descrive i codici di accesso richiesti in ciascun paese per chiamare un numero verde.</span><span class="sxs-lookup"><span data-stu-id="9dec7-179">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="9dec7-180">**Piano di numerazione Nord America numero verde:** Al minuto tariffe per i numeri gratuiti a pagamento Nord America numerazione pianificare dipende dalle paese di origine.</span><span class="sxs-lookup"><span data-stu-id="9dec7-180">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="9dec7-181">La frequenza al minuto gratuito a pagamento per le chiamate provenienti dal mapping degli Stati Uniti alla frequenza definita come "Nord America".</span><span class="sxs-lookup"><span data-stu-id="9dec7-181">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="9dec7-182">Tuttavia, le chiamate provenienti da altri paesi Nord America, ad esempio Canada, Portorico e così via hanno tariffe gratuito a pagamento specifico.</span><span class="sxs-lookup"><span data-stu-id="9dec7-182">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9dec7-184">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="9dec7-184">Related topics</span></span>
[<span data-ttu-id="9dec7-185">Ottenere numeri di servizio per Skype for Business e Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="9dec7-185">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)
