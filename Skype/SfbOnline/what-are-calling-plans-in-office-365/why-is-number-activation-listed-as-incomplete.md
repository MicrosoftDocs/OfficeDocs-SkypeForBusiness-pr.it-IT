...
---
# <a name="why-is-number-activation-listed-as-incomplete"></a>Perché l'attivazione del numero è elencata come incompleta?

La convalida degli indirizzi è una parte importante della configurazione dei piani di chiamata. Se per qualche motivo un numero di telefono non è attivato ed è elencato come **incompleto** a causa della convalida degli indirizzi, è necessario creare e inviare una richiesta di servizio. Il modo in procedere dipende dalle dimensioni dell'organizzazione.
