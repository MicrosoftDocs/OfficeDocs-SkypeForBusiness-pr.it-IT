...
La convalida dell'indirizzo è una parte importante della configurazione dei Piani per chiamate. Se per qualche motivo un numero di telefono  non è attivato ed è elencato come aggiornato a causa della convalida dell'indirizzo, sarà necessario creare e inviare una richiesta di servizio. Il modo in procedere dipende dalle dimensioni dell'organizzazione.
