...
|:-----|:-----|
|Devi ottenere numeri per gli utenti che non sono elencati nell'interfaccia di amministrazione di Skype for Business.  <br/> | Scarica questo modulo <br/> [Richiesta di nuovo numero di telefono per la Francia (numeri geografici) (v.3.0)(fr-fr)](../../downloads/new-number-request-forms/new-phone-number-request-for-france-(geographic-numbers)-(v.3.0)-(fr-fr).pdf). <br/>  Compilalo e [inviacelo](mailto:ptneu@microsoft.com).  <br/> |
