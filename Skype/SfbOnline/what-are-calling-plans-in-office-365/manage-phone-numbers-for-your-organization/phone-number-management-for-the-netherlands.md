...
Usa questa tabella per trovare informazioni su come ottenere e gestire i numeri di telefono nei Paesi Bassi per Skype for Business online e Microsoft Teams. 
...
|Ottenere nuovi numeri di telefono del servizio che non sono incluse le Skype per interfaccia di amministrazione di Business. <br/> |Scaricare il modulo [nuova richiesta numerico di telefono per i Paesi Bassi (numeri service) (v. 1.2) (nl-nl)](../../downloads/new-number-request-forms/New-phone-number-request-for-the-netherlands-(service-numbers)-(v.1.2)-(nl-nl).pdf).<br/> Compilalo e [inviacelo](mailto:ptneu@microsoft.com).
