...
### [Chiamata in uscita da una riunione per consentire ad altri di parteciparvi](../audio-conferencing-in-office-365/dialing-out-from-a-meeting-so-other-people-can-join-it.md)
...
### [Aggiungere fondi e gestire Credito per la comunicazione](../skype-for-business-and-microsoft-teams-add-on-licensing/add-funds-and-manage-communications-credits.md)
...
### [Piani telefonici per Office 365](../skype-for-business-and-microsoft-teams-add-on-licensing/calling-plans-for-office-365.md)
...
## [Call Analytics e Dashboard Qualità della chiamata](../using-call-quality-in-your-organization/difference-between-call-analytics-and-call-quality-dashboard.md)
