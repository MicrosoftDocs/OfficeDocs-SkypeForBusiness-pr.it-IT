...
## <a name="want-to-learn-more-about-these-services"></a><span data-ttu-id="e991f-195">Vuoi saperne di più su questi servizi?</span><span class="sxs-lookup"><span data-stu-id="e991f-195">Want to learn more about these services?</span></span>

### <a name="audio-conferencing"></a><span data-ttu-id="e991f-196">Audioconferenza</span><span class="sxs-lookup"><span data-stu-id="e991f-196">Audio Conferencing</span></span>

<span data-ttu-id="e991f-197">A volte le persone all’interno dell'organizzazione devono utilizzare un telefono per accedere a una riunione.</span><span class="sxs-lookup"><span data-stu-id="e991f-197">Sometimes people in your organization will need to use a phone to call in to a meeting.</span></span> <span data-ttu-id="e991f-198">Skype for Business e Microsoft Teams offrono la funzione di Audioconferenza proprio per queste evenienze!</span><span class="sxs-lookup"><span data-stu-id="e991f-198">Skype for Business and Microsoft Teams include the Audio Conferencing feature for just this situation!</span></span> <span data-ttu-id="e991f-199">È possibile accedere alle riunioni utilizzando un telefono anziché le app Skype for Business e Microsoft Teams su un dispositivo mobile o un PC.</span><span class="sxs-lookup"><span data-stu-id="e991f-199">People can call in to meetings using a phone instead of using the Skype for Business and Microsoft Teams apps on a mobile device or PC.</span></span> <span data-ttu-id="e991f-200">Dopo aver deciso di adottare i servizi di Audioconferenza per la propria azienda, occorrerà acquistare una licenza di servizi di **Audioconferenza** per ciascuna persona che pianificherà od ospiterà una riunione audio.</span><span class="sxs-lookup"><span data-stu-id="e991f-200">After you have decided you want Audio Conferencing for your organization, you need to buy 1 **Audio Conferencing** license for each person in your organization who is going to schedule/host an audio meeting.</span></span>
  
<span data-ttu-id="e991f-201">Con Audioconferenza ci sono numeri telefonici a tariffa e verdi che possono essere utilizzati dai tuoi utenti per connettersi alle riunioni.</span><span class="sxs-lookup"><span data-stu-id="e991f-201">With Audio Conferencing, there are toll and toll free phone numbers that can be used by your users to dial-in to meetings.</span></span> <span data-ttu-id="e991f-202">I numeri a tariffa dei seguenti paesi o aree geografiche vengono assegnati automaticamente come numeri condivisi dei servizi di audioconferenza alle organizzazioni in cui è abilitata l’Audioconferenza.</span><span class="sxs-lookup"><span data-stu-id="e991f-202">Toll numbers from the following countries or regions are automatically assigned as shared audio conferencing numbers to organizations when they're enabled for Audio Conferencing.</span></span> <span data-ttu-id="e991f-203">I numeri verdi e a tariffa dedicati possono essere assegnati all'organizzazione da altre città.</span><span class="sxs-lookup"><span data-stu-id="e991f-203">Dedicated toll and toll-free numbers can be assigned to your organization from additional cities.</span></span>
...
<span data-ttu-id="e991f-208">Per saperne di più sull’Audioconferenza, consulta [Domande ricorrenti sull'Audioconferenza](../audio-conferencing-in-office-365/audio-conferencing-common-questions.md)</span><span class="sxs-lookup"><span data-stu-id="e991f-208">To see more about Audio Conferencing, see [Audio Conferencing common questions](../audio-conferencing-in-office-365/audio-conferencing-common-questions.md)</span></span>

[<span data-ttu-id="e991f-209">Prezzi per le Audioconferenze</span><span class="sxs-lookup"><span data-stu-id="e991f-209">Pricing for Audio Conferencing</span></span>](https://products.office.com/en-us/skype-for-business/audio-conferencing#Requirements) 
  
#### <a name="using-the-call-me-feature-or-when-adding-other-people-to-a-meeting-so-they-can-join-it"></a><span data-ttu-id="e991f-210">Utilizzo della funzionalità Chiama o quando aggiungere altre persone alla riunione in modo che vi possano accedere</span><span class="sxs-lookup"><span data-stu-id="e991f-210">Using the Call Me feature or when adding other people to a meeting so they can join it</span></span>
<span data-ttu-id="e991f-211">In Audioconferenza è presente una funzionalità denominata "*Chiama*" che può essere utilizzata per consentire ad altri di accedere a una riunione dall’esterno.</span><span class="sxs-lookup"><span data-stu-id="e991f-211">In Audio Conferencing there is a feature named "*Call Me*" and it can be used to let other people join a dial-in meeting.</span></span> <span data-ttu-id="e991f-212">Utilizza l'elenco a discesa qui sopra per cercare il paese/l’area geografica e vedere se questa funzione è disponibile.</span><span class="sxs-lookup"><span data-stu-id="e991f-212">Use the drop down list above to search for the country/region and see if this feature is available.</span></span>
...
### <a name="phone-system"></a><span data-ttu-id="e991f-220">Sistema telefonico</span><span class="sxs-lookup"><span data-stu-id="e991f-220">Phone System</span></span>
<span data-ttu-id="e991f-221">Con Sistema telefonico puoi creare operatori automatici e code di chiamata (con un numero verde o a tariffa) per rispondere alle chiamate in arrivo alla tua organizzazione e, quando aggiungi un Piano per chiamate per gli utenti, questi ultimi possono utilizzare Skype for Business per assolvere alle attività di base di controllo delle chiamate, come effettuare e ricevere chiamate, trasferire chiamate, attivare o disattivare l’audio delle chiamate.</span><span class="sxs-lookup"><span data-stu-id="e991f-221">With Phone System, you can create auto attendants and call queues (with a toll or toll-free number) to answer incoming calls for your organization, and when you add a Calling Plan for users they can use Skype for Business to take care of basic call-control tasks, such as placing and receiving calls, transferring calls, and muting and unmuting calls.</span></span> <span data-ttu-id="e991f-222">Gli utenti di **Sistema telefonico** possono fare clic su un nome nella loro rubrica e Skype for Business effettuerà una chiamata a tale persona.</span><span class="sxs-lookup"><span data-stu-id="e991f-222">**Phone System** users can click a name in their address book and Skype for Business will place a call to that person.</span></span> <span data-ttu-id="e991f-223">Per effettuare e ricevere chiamate, gli utenti di **Sistema telefonico** possono utilizzare i loro dispositivi mobili, una cuffia auricolare con laptop o PC o uno dei numerosi telefoni IP che funzionano con Skype for Business.</span><span class="sxs-lookup"><span data-stu-id="e991f-223">To place and receive calls, **Phone System** users can use their mobile devices, a headset with a laptop or PC, or one of many IP phones that work with Skype for Business.</span></span>

<span data-ttu-id="e991f-224">Oltre a ottenere numeri di telefono per singoli utenti di Office 365, è anche possibile cercare e acquisire numeri di telefono a tariffa o gratuiti (numeri verdi) per servizi come Audioconferenza (per il bridging delle conferenze), operatori automatici e code di chiamata.</span><span class="sxs-lookup"><span data-stu-id="e991f-224">In addition to getting phone numbers for individual users from Office 365, it's also possible to search and acquire toll or toll-free phone numbers for services such as Audio Conferencing (for conference bridges), auto attendants and call queues.</span></span> <span data-ttu-id="e991f-225">Questi vengono chiamati numeri di servizio.</span><span class="sxs-lookup"><span data-stu-id="e991f-225">These are called service numbers.</span></span> <span data-ttu-id="e991f-226">Visualizzare [i numeri di telefono di ottenere assistenza](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md) per ottenere i numeri di telefono.</span><span class="sxs-lookup"><span data-stu-id="e991f-226">See [Getting service phone numbers](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md) to get phone numbers.</span></span> <span data-ttu-id="e991f-227">Ai tuoi utenti, tuttavia, una volta assegnato loro un Piano per le chiamate, puoi assegnare un numero di telefono utente per permettere loro di effettuare e ricevere chiamate.</span><span class="sxs-lookup"><span data-stu-id="e991f-227">But for your users, after you assign a Calling Plan to them, you can assign a user phone number so they can make and receive phone calls.</span></span> <span data-ttu-id="e991f-228">Per trovare i numeri di telefono, accedere alla [Guida i numeri di telefono per gli utenti](../what-are-calling-plans-in-office-365/getting-phone-numbers-for-your-users.md).</span><span class="sxs-lookup"><span data-stu-id="e991f-228">To find those phone numbers, go to [Getting phone numbers for your users](../what-are-calling-plans-in-office-365/getting-phone-numbers-for-your-users.md).</span></span> <span data-ttu-id="e991f-229">Puoi anche consultare [Assegnare, modificare o rimuovere il numero di telefono di un utente](../what-are-calling-plans-in-office-365/assign-change-or-remove-a-phone-number-for-a-user.md).</span><span class="sxs-lookup"><span data-stu-id="e991f-229">You can also see [Assign, change, or remove a phone number for a user](../what-are-calling-plans-in-office-365/assign-change-or-remove-a-phone-number-for-a-user.md).</span></span> 

[<span data-ttu-id="e991f-230">Tariffe del Sistema telefonico</span><span class="sxs-lookup"><span data-stu-id="e991f-230">Pricing for Phone System</span></span>](https://products.office.com/en-us/skype-for-business/phone-system#Requirements)
...
<span data-ttu-id="e991f-232">Utilizza l'elenco a discesa in alto per cercare un paese o un’area geografica e sapere quali servizi sono disponibili.</span><span class="sxs-lookup"><span data-stu-id="e991f-232">Use the drop-down list at the top of the page to search for a country or region and what services are available.</span></span>

### <a name="calling-plans"></a><span data-ttu-id="e991f-233">Piani per chiamate</span><span class="sxs-lookup"><span data-stu-id="e991f-233">Calling Plans</span></span>
<span data-ttu-id="e991f-234">Unitamente al Sistema telefonico, un Piano per chiamate consente agli utenti di effettuare e ricevere telefonate.</span><span class="sxs-lookup"><span data-stu-id="e991f-234">Along with Phone System, a Calling Plans let users make and receive phone calls.</span></span> <span data-ttu-id="e991f-235">Devi anzitutto ottenere un numero di telefono dell'utente (abbonato) (non un numero di servizio) da assegnare all'utente, e quindi assegnargli un Piano per chiamate.</span><span class="sxs-lookup"><span data-stu-id="e991f-235">You first need to get a user (subscriber) phone number (not a service number) to assign to the user, and then assign a Calling Plan.</span></span> <span data-ttu-id="e991f-236">Ci sono due tipi di Piani per chiamate disponibili: **Nazionali** e **Nazionali e internazionali**.</span><span class="sxs-lookup"><span data-stu-id="e991f-236">There are two types of Calling Plans available: **Domestic** and **Domestic and International**.</span></span> <span data-ttu-id="e991f-237">Per maggiore dettagli, consulta [Che cosa sono i Piani per chiamate?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md)</span><span class="sxs-lookup"><span data-stu-id="e991f-237">See [What are Calling Plans?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md) for more details.</span></span>

<span data-ttu-id="e991f-238">Per informazioni sulle licenze puoi anche consultare [Licenze per Sistema telefonico e Piani per chiamate](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md).</span><span class="sxs-lookup"><span data-stu-id="e991f-238">You can also see [Phone System and Calling Plans licensing](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md) for licensing information.</span></span>
...
### <a name="toll-and-toll-free-phone-numbers-for-services"></a><span data-ttu-id="e991f-240">Numeri verdi a pagamento e gratuiti per i servizi</span><span class="sxs-lookup"><span data-stu-id="e991f-240">Toll and toll-free phone numbers for services</span></span>

<span data-ttu-id="e991f-241">Oltre a ottenere numeri di telefono per singoli utenti di Office 365, è anche possibile cercare e acquisire numeri di telefono a tariffa o gratuiti (numeri verdi) per servizi come Audioconferenza (per il bridging delle conferenze), operatori automatici e code di chiamata.</span><span class="sxs-lookup"><span data-stu-id="e991f-241">In addition to getting phone numbers for individual users from Office 365, it's also possible to search and acquire toll or toll-free phone numbers for services such as Audio Conferencing (for conference bridges), auto attendants, and call queues.</span></span> <span data-ttu-id="e991f-242">Questi vengono chiamati numeri di servizio.</span><span class="sxs-lookup"><span data-stu-id="e991f-242">These are called service numbers.</span></span>
  
<span data-ttu-id="e991f-243">Di seguito è riportato un elenco delle capitali e delle principali città da cui è possibile ottenere i numeri di servizio a tariffa da utilizzare con Audioconferenza e Piani per chiamate.</span><span class="sxs-lookup"><span data-stu-id="e991f-243">The following is a list of capitals and major cities from where you can get toll service numbers to use with Audio Conferencing and Calling Plans.</span></span> <span data-ttu-id="e991f-244">Puoi ottenere i numeri di servizio a tariffa di queste località richiedendoli all’**interfaccia di amministrazione di Skype for Business**.</span><span class="sxs-lookup"><span data-stu-id="e991f-244">You can get toll service numbers from these locations using the **Skype for Business admin center**.</span></span>
  
<span data-ttu-id="e991f-245">Se si desidera ottenere un numero a tariffa o numero verde del servizio, è possibile visualizzare [i numeri di telefono del servizio di Guida](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).</span><span class="sxs-lookup"><span data-stu-id="e991f-245">If you want to get a toll or toll-free service number, you can see [Getting service phone numbers](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).</span></span> <span data-ttu-id="e991f-246">Se disponi già di un numero di servizio a tariffa o verde che desideri trasferire da un altro provider, consulta [Gestire i numeri di telefono per la propria organizzazione](../what-are-calling-plans-in-office-365/manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md).</span><span class="sxs-lookup"><span data-stu-id="e991f-246">If you already have a toll or toll-free service number that you want to transfer from a different provider, see [Manage phone numbers for your organization](../what-are-calling-plans-in-office-365/manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md).</span></span>

<span data-ttu-id="e991f-247">Utilizza l'elenco a discesa in alto per cercare un paese o un’area geografica e sapere quali servizi sono disponibili.</span><span class="sxs-lookup"><span data-stu-id="e991f-247">Use the drop down list at the top of the page to search for a country or region and what services are available.</span></span>

### <a name="communications-credits"></a><span data-ttu-id="e991f-248">Crediti comunicazioni</span><span class="sxs-lookup"><span data-stu-id="e991f-248">Communications Credits</span></span>

<span data-ttu-id="e991f-249">Consigliamo di configurare i Crediti comunicazioni per i tuoi utenti di Audioconferenza e Piani per chiamate che hanno bisogno di effettuare chiamate in uscita verso **qualsiasi destinazione**.</span><span class="sxs-lookup"><span data-stu-id="e991f-249">We recommend that you set up Communications Credits for your Audio Conferencing and Calling Plans users that need the ability to dial out to **any destination**.</span></span> <span data-ttu-id="e991f-250">Sono inclusi numerosi paesi/aree geografiche, ma alcune destinazioni potrebbero non essere incluse nel tuo Piano per chiamate o nei tuoi abbonamenti Audioconferenza.</span><span class="sxs-lookup"><span data-stu-id="e991f-250">Many countries/regions are included, but some destinations might not be included in your Calling Plan or Audio Conferencing subscriptions.</span></span>
  
<span data-ttu-id="e991f-251">Se non vengono impostati i Crediti comunicazioni o assegnata una licenza Crediti comunicazioni agli utenti e vengono esauriti i minuti per la propria organizzazione (a seconda del Piano per chiamate e Audioconferenza per lo specifico paese/area geografica), quegli utenti non potranno effettuare chiamate o chiamate in uscita dalle riunioni.</span><span class="sxs-lookup"><span data-stu-id="e991f-251">If you don't set up Communications Credits and assign a license to users and you run out minutes for your organization (depending on your Calling Plan or Audio Conferencing plan or your country/region), they won't be able to make calls or dial out from meetings.</span></span> <span data-ttu-id="e991f-252">Per altre informazioni, compresi gli importi consigliati, consulta [Cosa sono i Crediti comunicazioni?](../skype-for-business-and-microsoft-teams-add-on-licensing/what-are-communications-credits.md)</span><span class="sxs-lookup"><span data-stu-id="e991f-252">You can find out more information including recommended funding amounts by reading [What are Communications Credits?](../skype-for-business-and-microsoft-teams-add-on-licensing/what-are-communications-credits.md)</span></span>

[!INCLUDE [LinkedIn Learning Info](../../common/office/linkedin-learning-info.md)]

## <a name="related-topics"></a><span data-ttu-id="e991f-253">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="e991f-253">Related topics</span></span>
[<span data-ttu-id="e991f-254">Ottenere numeri di servizio per Skype for Business e Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="e991f-254">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)
