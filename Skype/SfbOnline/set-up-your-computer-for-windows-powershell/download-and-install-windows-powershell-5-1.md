...
Per installare Windows Management Framework 5.1, completare la procedura descritta in [Installare e configurare WMF 5.1](https://docs.microsoft.com/it-IT/powershell/wmf/5.1/install-configure).
