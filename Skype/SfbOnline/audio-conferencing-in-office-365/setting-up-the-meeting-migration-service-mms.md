...
Si consiglia inoltre di controllare lo stato della migrazione per un utente specifico, ed è possibile utilizzare il parametro  `Identity` per questo. Ad esempio, il seguente comando restituirà lo stato dell'utente ashaw@contoso.com:
