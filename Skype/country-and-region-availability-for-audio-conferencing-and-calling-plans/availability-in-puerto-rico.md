...
Di seguito sono disponibili per il Portorico i servizi di Skype per le aziende e Teams di Microsoft Office 365.
...
|I numeri di telefono vengono assegnati automaticamente per le conferenze Audio?  <br/> |No  <br/> |
...
|Minuti disponibili per la chiamata dei piani  <br/> |3000 minuti di chiamate nazionali o 600 minuti di chiamate internazionali (a seconda del limite che viene raggiunto per primo per mese di calendario). Le chiamate nazionali negli Stati Uniti includono le chiamate a tutti i 50 Stati e a Portorico. Gli utenti a cui è assegnata la posizione di utilizzo della licenza degli Stati Uniti e/o a Portorico condividono lo stesso pool di minuti.  <br/> |
...
|**Funzionalità**|**Ulteriori informazioni**|
|:-----|:-----|
|Le lettere maiuscole o città principali è possibile ottenere numeri a pagamento per.  <br/> |San Juan  <br/> |
