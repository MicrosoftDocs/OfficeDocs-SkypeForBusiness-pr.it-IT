...
Di seguito sono disponibili per la Spagna i servizi di Skype per le aziende e Teams di Microsoft Office 365.
  
## <a name="audio-conferencing"></a>Audioconferenza

|**Funzionalità**|**Ulteriori informazioni**|
|:-----|:-----|
|È disponibile per l'acquisto conferenze Audio?  <br/> |Sì  <br/> |
|I numeri di telefono vengono assegnati automaticamente per le conferenze Audio?  <br/> |Sì, per Madrid. Se si desidera che i numeri di telefono dedicati, vedere [Getting numeri di telefono del servizio per Skype per le aziende e team di Microsoft](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
|Funzionalità di chiamata in uscita chiama Me funzionalità  <br/> |Disponibile  <br/> |
...
|**Funzionalità**|**Ulteriori informazioni**|
|:-----|:-----|
|Piani di chiamata sono disponibili per l'acquisto?  <br/> |Sì  <br/> |
|Minuti disponibili per la chiamata dei piani  <br/> |1200 minuti di chiamate nazionali o 600 minuti di chiamate internazionali (a seconda del limite che viene raggiunto per primo per mese di calendario).  <br/> |
|Può effettuare chiamate in uscita?  <br/> | Per 196 paesi, tra cui [tali](users-can-make-outbound-calls-to-these-countries-and-regions.md).  <br/> |
   
## <a name="toll-and-toll-free-numbers-for-services"></a>Numero a pagamento e numeri verdi per i servizi

|**Funzionalità**|**Ulteriori informazioni**|
|:-----|:-----|
|Le lettere maiuscole o città principali è possibile ottenere numeri a pagamento per.  <br/> | Barcellona <br/>  Madrid <br/> |
...
|**Funzionalità**|**Ulteriori informazioni**|
|:-----|:-----|
|Riconoscimenti Communications sono disponibili?  <br/> |Sì  <br/> |
