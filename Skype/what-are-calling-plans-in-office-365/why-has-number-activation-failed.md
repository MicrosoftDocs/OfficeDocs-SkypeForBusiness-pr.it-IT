...
Convalida dell'indirizzo è un aspetto importante della configurazione tariffe di chiamate in Office 365. Se per qualche motivo un numero di telefono non è attivato per la convalida dell'indirizzo, è necessario creare una richiesta di servizio. Come l'operazione dipende dalle dimensioni dell'organizzazione.
