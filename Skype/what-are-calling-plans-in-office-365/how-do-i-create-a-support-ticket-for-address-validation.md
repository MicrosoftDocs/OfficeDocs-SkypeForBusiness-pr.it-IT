...
# Come faccio a creare un ticket di supporto per la convalida dell'indirizzo?
...
2. Nell'interfaccia di amministrazione di Office 365, nel riquadro di spostamento sinistro fare clic su **supporto** > **nuova richiesta di assistenza**
    
3. Fare clic su **Aggiungi** in **richieste di assistenza**
    
4. Nella pagina **Crea una richiesta di assistenza**, fare clic su **collaborazione Online**.
    
5. Nella pagina **Identificare il problema** selezionare e immettere quanto segue:
    
  - **Caratteristica** selezionare **Chiamate nazionali pianificare** e/o **Pianificare internazionale**.
    
  - In **Sintomo** immettere **Chiamate di emergenza**.
    
  - **Il riepilogo** immettere **la convalida dell'indirizzo**.
...
6. Fare clic su pagina **successiva**, fare clic su **Sì, continua** per continuare.
    
7. Nella pagina **Aggiungi dettagli**, selezionare e immettere le operazioni seguenti:
