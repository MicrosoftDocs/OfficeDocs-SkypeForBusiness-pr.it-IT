...
Prima di distribuire Skype for Business per gli utenti, assicurarsi che è stata effettuata passaggi da 1 a 3 nell'articolo [configurare Skype Business online](set-up-skype-for-business-online.md). In questo modo, Skype per le aziende verrà configurato con il proprio dominio, tutti gli utenti disporranno le licenze e verranno configurati messaggistica Istantanea e [presenza Configure in Skype Business online](configure-presence-in-skype-for-business-online.md) per la propria organizzazione.
  
> [!NOTE]
> Gli utenti potranno installare Skype per applicazioni di Business, è necessario essere amministratori locali nel proprio PC o nel dispositivo. O è necessario far parte di un gruppo locale che può installare App sul PC o dispositivi. Se non sono consentiti agli utenti di installare software nei dispositivi, sarà necessario installare Skype per applicazioni aziendali di essi. 
  
## <a name="for-most-small-and-medium-sized-businesses"></a>Per la maggior parte delle piccole e medie imprese

 **Istruzioni di installazione:** Se si dispone di un'azienda di piccola o medie dimensioni, è consigliabile chiedere semplicemente agli utenti di installare Skype per app Business sul PC. Puntino a queste istruzioni: [Installare Skype per le aziende](https://support.office.com/en-us/article/8a0d4da8-9d58-44f9-9759-5c8f340cb3fb?ui=en-US&rs=en-US&ad=US). Se si utilizza Mac, puntino configurare [Lync per Mac 2011 per Office 365](https://support.office.com/en-us/article/ae3ebd0e-a1a7-48cf-9350-36b144dc5f88?ui=en-US&rs=en-US&ad=US). Skype per Business app viene installata separatamente da tutte le altre applicazioni di Office.
...
In alternativa è possibile scaricare Skype per Business Basic app per gli utenti. È possibile scaricare [Microsoft Skype per Business Basic (a 32 o 64 Bit)](https://www.microsoft.com/en-us/download/details.aspx?id=49440).
