...
- [Prezzi per sistema telefonico](https://products.office.com/en-us/skype-for-business/cloud-pbx#requirements)
...
> [!NOTE]
> Se si usa Skype for Business Online piano 2 o un piano Enterprise, invece di acquistare il componente aggiuntivo per le **Conferenze Audio**, è possibile scegliere di utilizzare un provider di conferenze audio di terze parti. Il provider verrà anche ospitare il bridge di conferenza audio. 
  
### Office 365 Enterprise (E1, E3 ed E4)

Se è già stato acquistato piano E4, [Office 365 Enterprise E1](https://products.office.com/en-us/business/office-365-enterprise-e1-business-software)o [E3](https://products.office.com/en-us/business/office-365-enterprise-e3-business-software), ecco le licenze di componente aggiuntivo che è necessario acquistare per ottenere ulteriori Skype for Business e caratteristiche Teams Microsoft.
  
|||
|:-----|:-----|
|**Per aggiungere questa funzionalità** <br/> |**Ecco cosa occorre acquistare** <br/> |
|**Conferenze audio** <br/> Acquistare licenze di ** Conferenze Audio** 1 per ogni persona che agirà da pianificare o un meeting dial-in. I partecipanti non è necessario licenze. <br/> |Componente aggiuntivo per le Conferenze audioQuando si acquista la licenza, Microsoft sarà il provider di conferenze audio. |
|**Numeri verdi per l'accesso dial-in per le riunioni e la possibilità di effettuare chiamate in uscita da una riunione per aggiungere una persona chiamando qualsiasi numero di telefono nel mondo** <br/> |Cosa sono i Crediti comunicazioni?|
|**Sistema telefonico** <br/> | Componente aggiuntivo di **Sistema telefonico di Office 365** <br/>  Piani di chiamata: acquistare una[Piani di chiamata per Office 365](calling-plans-for-office-365.md) da Office 365. <br/>  Oppure, usare il[Come si usa l'esistente chiamata plan di messaggistica unificata con Skype for Business ?](3ed752b1-5983-43f9-bcfd-760619ab40a7.md#bkmk_existing).  <br/> |
|**Segreteria telefonica sistema telefonico** <br/> |Per i piani E1 e E4, acquistare Exchange Online (Piano 2). Oppure, passare a una suite Office fornita con Exchange Online (Piano 2), come Office 365 E3. |
|**Tariffe delle chiamate** <br/> | Componente aggiuntivo di **Sistema telefonico** <br/> [Piani di chiamata per Office 365](calling-plans-for-office-365.md) : è possibile solo acquistare questo dopo l'acquisto il componente aggiuntivo **Sistema telefonico**.  <br/> |
   
> [!NOTE]
> Per i piani Enterprise che includono Skype for Business Online piano 2, invece di acquistare il componente aggiuntivo per le **Conferenze Audio**, è possibile scegliere di utilizzare un provider di conferenze audio di terze parti. Il provider verrà anche ospitare il bridge di conferenza. 
  
### Office 365 Enterprise E5 (senza audioconferenza)

Se è già stato acquistato il piano di Office 365 Enterprise E5 (senza conferenze Audio), ecco i Skype for Business e le licenze di componente aggiuntivo di Microsoft Teams che è necessario acquistare per ottenere altre caratteristiche.
  
|||
|:-----|:-----|
|**Per aggiungere questa funzionalità** <br/> |**Ecco cosa occorre acquistare** <br/> |
|**Conferenze audio** <br/> | Per ottenere questo componente aggiuntivo, procedere come segue. <br/>  Se si dispone già acquistato un piano E5 ma la caratteristica di conferenze Audio non è disponibile nel proprio paese o area geografica, sarà necessario utilizzare un provider di conferenze audio di terze parti. Trovare un provider di conferenze audio di terze parti in[Microsoft PinPoint](https://go.microsoft.com/fwlink/?LinkId=797530).  <br/>  Controllare questo articolo per verificare se conferenze Audio è disponibile nel proprio paese o area geografica:[Le conferenze PSTN con relativi numeri di telefono sono disponibili nel mio Paese o nella mia area geografica?](https://support.office.com/article/1096d81e-7e14-488c-95d8-b8322e39c059) <br/>  Se è disponibile, usare il[Passare a un piano di Office 365 per le aziende diverso](https://support.office.com/article/73318661-8f33-478b-bcc7-fb8d69dbb22a) per passare al piano Office 365 Enterprise E5 che la comprende. In questo modo, saranno disponibili anche altre funzionalità. <br/> |
|**Sistema telefonico è incluso!** <br/> | Piani di chiamata: acquistare una[Piani di chiamata per Office 365](calling-plans-for-office-365.md) da Office 365. <br/>  Oppure, usare il[Come si usa l'esistente chiamata plan di messaggistica unificata con Skype for Business ?](3ed752b1-5983-43f9-bcfd-760619ab40a7.md#bkmk_existing).  <br/> |
|**Segreteria telefonica sistema telefonico è inclusa!** <br/> |Non è necessario innanzitutto.  <br/> |
   
### Office 365 Enterprise E5

Il piano di [Office 365 Enterprise E5](https://products.office.com/en-us/business/office-365-enterprise-e5-business-software) comprende la maggior parte dei Skype for Business e caratteristiche Teams Microsoft. Sono sufficienti pochi altre opzioni.
  
|||
|:-----|:-----|
|**Per aggiungere questa funzionalità** <br/> |**Ecco cosa occorre acquistare** <br/> |
|**Conferenze audio sono inclusa!** <br/> |Quando si acquista la licenza, Microsoft sarà il provider di conferenze audio.  <br/> |
|**Numeri verdi per l'accesso dial-in per le riunioni e la possibilità di effettuare chiamate in uscita da una riunione per aggiungere una persona chiamando qualsiasi numero di telefono nel mondo.** <br/> |Come configurare le comunicazioni crediti|
|**Sistema telefonico e la segreteria è incluso!** <br/> |Piano di chiamata: acquistare una Piani di chiamata per Office 365 da Office 365. Oppure, usare il Come si usa l'esistente chiamata plan di messaggistica unificata con Skype for Business ?. |
   
## Come conoscere i prezzi e acquistare le licenze per componenti aggiuntivi
<a name="bkmk_how"> </a>
...
Il piano E3 fa parte di pacchetto per azione. Per acquistare i componenti aggiuntivi **Sistema telefonico** e **Conferenze Audio**:
...
Per un'ampia documentazione sulla pianificazione della distribuzione, tra cui sistema telefonico connettività PSTN locale, vedere [pianificare il sistema telefonico in Office 365 (PBX Cloud) soluzione](https://technet.microsoft.com/en-us/library/mt612869.aspx).
