...
Gli argomenti seguenti sono inclusi in questa sezione e devono essere esaminati prima di distribuire il dashboard qualità delle chiamate.
  
- [Pianificare il dashboard qualità delle chiamate per Skype for Business Server](plan.md)
- [Distribuire il dashboard qualità delle chiamate per Skype for Business Server](deploy-0.md)
- [Usare il dashboard qualità delle chiamate per Skype for Business Server](use.md)
- [Sviluppare il dashboard qualità delle chiamate per Skype for Business Server](develop.md)
