...
Queste informazioni sono state scritte in base alla versione 9319.0 del Monitoring Pack per Skype for Business Server 2015 communications software.
  
## <a name="configuration-overview"></a>Panoramica della configurazione

 Per configurare l'Skype for Business Server 2015 per l'utilizzo con System Center Operations Manager, è necessario eseguire tre operazioni:
...
I Management Pack possono essere utilizzati con System Center Operations Manager 2007 R2 (64 bit) (supportato solo a scopo di migrazione) o System Center Operations Manager 2012 SP1 &amp; R2 (64 bit) o System Center Operations Manager 2016 (64 bit). Nella tabella seguente sono illustrate le configurazioni supportate per i Management Pack per Skype for Business Server 2015: 
  
|Configurazione|Supportato?|
|:-----|:-----|
|Sistema operativo Windows Server 2008 R2  <br/> Windows Server 2012 Sistema operativo R2  <br/> |Sì. Sia nei Skype for Business Server server 2015 che nei nodi Synthetic Transaction Watcher.  <br/> |
|Server in cluster  <br/> |Non supportate.  <br/> |
|Monitoraggio senza agenti  <br/> |Non supportate.  <br/> |
|Ambiente virtuale  <br/> |Sì.  <br/> |
|Ruoli del server aggiunti a un dominio  <br/> |Tutti i ruoli Skype for Business Server 2015 devono essere aggiunti a un dominio.  <br/> |
|Ruoli del server autonomi  <br/> |Skype for Business Server server perimetrali 2015 non devono essere aggiunti a un dominio.  <br/> |
...
- System Center Agente Operations Manager 
    
-  Microsoft .NET Framework 4.5
    
- Skype for Business Server di installazione di base (OcsCore.msi) e UCMA (Unified Communications Managed API) (le versioni devono corrispondere alla Skype for Business Server WatcherNode.msi versione)
...
Le funzionalità seguenti sono una novità Skype for Business Server Management Pack 2015.
...
- **Individuazione automatica per l'accesso client** Le applicazioni client che a Skype for Business Server 2015 spesso individuano automaticamente il server a cui accedere. Le transazioni sintetiche ora supportano la verifica che l'individuazione automatica sia configurata correttamente.
...
Il Skype for Business Server 2015 Management Pack sfrutta un'ampia gamma di funzionalità che consentono di rilevare e diagnosticare i problemi. Queste funzionalità offrono visibilità in tempo reale sull'integrità di un Skype for Business Server 2015.
...
|8   <br/> |Messaggio istantaneo peer-to-peer MCX (mobile)  <br/> |Disponibile nella versione di settembre 2011 di Lync Server 2010 Skype for Business 2015  <br/> |
...
|15   <br/> |Application Sharing Conferencing  <br/> |Novità di Skype for Business Server 2015  <br/> |
...
|:-----|:-----|
|Skype for Business Server Distribuzione  <br/> |Rappresenta la distribuzione di Skype for Business Server 2015 nell'organizzazione.  <br/> |
...
I collegamenti seguenti si connettono alle informazioni sulle attività comuni associate ai Monitoring Pack System Center 2012:
...
Per domande su Operations Manager e sui Monitoring Pack, vedere il forum della community System Center [Operations Manager](https://go.microsoft.com/fwlink/p/?LinkID=179635).
