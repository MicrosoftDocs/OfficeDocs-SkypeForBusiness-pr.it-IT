...
2. <span data-ttu-id="2faa8-138">Digitare quanto segue al prompt della riga di comando:</span><span class="sxs-lookup"><span data-stu-id="2faa8-138">Type the following at the command-line prompt:</span></span>
