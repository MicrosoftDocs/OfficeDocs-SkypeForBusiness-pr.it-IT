...
Utilizzare i cmdlet **New-CsClsConfiguration** e **Set-CsClsConfiguration** per creare una nuova configurazione o aggiornare una configurazione esistente. Quando si esegue **Get-CsClsConfiguration**, vengono visualizzate informazioni simili alla schermata seguente, in cui la distribuzione dispone attualmente della configurazione globale predefinita, ma non sono definite configurazioni di sito:
