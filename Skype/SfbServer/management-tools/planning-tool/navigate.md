...
È possibile spostarsi all'interno dello Strumento di pianificazione di Skype for Business Server 2015 utilizzando una combinazione di una barra degli strumenti, pulsanti e collegamenti specifici della pagina e riquadri specifici del contesto. I riquadri specifici del contesto forniscono informazioni di progettazione per la pianificazione e la capacità rilevanti per le opzioni di selezione in una pagina specifica.
...
Nella pagina iniziale, il progettista sceglie **Introduzione,** **Progetta siti** o **Visualizza.** Per informazioni dettagliate, vedere Creare la progettazione della topologia [iniziale per Skype for Business Server 2015.](create-the-initial-design.md)
