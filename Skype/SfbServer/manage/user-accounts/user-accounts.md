...
Queste procedure devono essere eseguite durante una finestra di manutenzione, quando l'Skype for Business è più basso. L'eventuale esecuzione di questa operazione in base a una pianificazione giornaliera o settimanale dipende dalle esigenze dell'organizzazione.
...
1. Apri una finestra del browser e immetti l'URL di amministratore per aprire il Skype for Business Server pannello di controllo.
...
3. Passare a **UtentiEnable** >  **Users** e fare clic su **Aggiungi**.
...
3. Passare a **UtentiNuovo** >  >  **utente lync server** e fare clic su **Aggiungi.**
...
5. Nella tabella fare doppio clic sull'account utente che si desidera disabilitare o riattivare.
    1. Nel riquadro visualizzato, per disabilitare temporaneamente l'account utente per Skype for Business Server, selezionare **Disabilita utente**. Nel riquadro visualizzato fai clic su **Salva**.
    2. Per abilitare di nuovo l'account utente per Skype for Business Server, nel pannello seleziona **Ri-abilita utente**. Nel riquadro successivo visualizzato fai clic su **Salva**.
...
6. Nel riquadro visualizzato fai clic sull'icona a forma di matita accanto a **Criteri assegnati**.
...
> [!NOTE]
> La rimozione di un utente comporterà la perdita delle impostazioni configurate per l'account utente. Se invece si desidera disabilitare temporaneamente un account utente, vedere [Disabilitare o riattivare un account utente](#disable-or-re-enable-a-user-account-for-skype-for-business-server) abilitato in precedenza per Skype for Business Server.
...
6. Nel riquadro visualizzato fai clic su **Rimuovi utente**. Nel riquadro successivo visualizzato fare clic su **OK**.
...
### <a name="remove-user-accounts-with-windows-powershell-cmdlets"></a>Rimuovere account utente con Windows PowerShell cmdlet
