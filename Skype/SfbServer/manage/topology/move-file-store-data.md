...
7. Selezionare un server o un pool che utilizza l'archivio file ed eseguire le operazioni seguenti:
   ...
   c. In **Definisci nuovo archivio file,** in FQDN file **server,** digitare il nome di dominio completo (FQDN) del file server. In **Condivisione file** digitare il nome della nuova condivisione file e quindi fare clic su **OK.**
...
8. Per ogni server o pool che utilizza l'archivio file, eseguire le operazioni seguenti:
   ...
   b. In **Modifica proprietà,** in **Associazioni,** nell'archivio **file,** selezionare la nuova condivisione file e quindi fare clic su **OK.**
