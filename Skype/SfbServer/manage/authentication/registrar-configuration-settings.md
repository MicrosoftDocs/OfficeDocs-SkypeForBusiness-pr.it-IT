...
## <a name="removing-registrar-configuration-settings-by-using-windows-powershell-cmdlets"></a>Rimozione dei criteri di Impostazioni registrazione tramite Windows PowerShell cmdlet
