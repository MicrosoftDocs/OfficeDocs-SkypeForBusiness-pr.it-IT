...
2. Selezionare **StartAll** >  **Programs** >  **Skype for Business**.
...
5. Seleziona **Richiesta avanzata**.
    
6. Selezionare **Crea e invia una richiesta a questa CA**, quindi fare clic su **Avanti**.
    
7. A questo punto verrà visualizzata una pagina denominata Smart Card Enrollment Station. Approvare la richiesta di installazione ActiveX controllo e quindi completare il modulo Richiesta avanzata di certificato come segue:
...
8. Inserisci ora la smart card vuota nel lettore di schede collegato alla stazione di registrazione e fai clic su **Registra**.
...
11. Inserisci ora la smart card vuota nel lettore di schede collegato alla stazione di registrazione e fai clic su **Registra**.
