...
- Configurare il server con cui Skype for Business Server comunicherà come "applicazione partner". Ad esempio, se Skype for Business Server comunicare con Exchange, sarà necessario configurare Exchange essere un'applicazione partner.
