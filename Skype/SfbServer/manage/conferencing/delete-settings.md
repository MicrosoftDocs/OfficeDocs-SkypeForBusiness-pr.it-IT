...
È possibile eliminare una configurazione di sito o utente, ma non è possibile eliminare la configurazione globale. Se si tenta di eliminare la configurazione globale, vengono ripristinati automaticamente i valori predefiniti.
