...
4. Nell'elenco delle configurazioni di riunione fare clic sulla configurazione del sito o del pool che si desidera eliminare, fare clic su **Modifica e quindi** su **Elimina**.
...
Per ulteriori informazioni, incluso un elenco completo dei parametri, [vedere Remove-CsMeetingConfiguration](/powershell/module/skype/remove-csmeetingconfiguration?view=skype-ps).
