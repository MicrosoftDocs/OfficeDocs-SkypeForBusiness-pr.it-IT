...
In un'organizzazione con un numero tipico di conferenze per utente, è consigliabile creare una directory conferenze ogni 999 utenti del pool. Utilizzando queste linee guida, gli ID conferenza possono in genere essere mantenuti piccoli. Tuttavia, quando il numero di directory conferenze (tra i pool) supera 9, la lunghezza dell'ID conferenza aumenta per supportare conferenze aggiuntive.
