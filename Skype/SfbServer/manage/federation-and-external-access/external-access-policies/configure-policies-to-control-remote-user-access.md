...
Se si tratta di un criterio utente è inoltre necessario applicare il criterio agli utenti ai quali si desidera consentire di effettuare l'accesso in remoto. Per ulteriori informazioni, vedere [assegnare un criterio di accesso utente esterno](assign-an-external-user-access-policy.md).
