...
Configurare le impostazioni come descritto nell'argomento [Assegnare criteri di conferenza per supportare gli utenti anonimi](access-edge/assign-conferencing-policies-to-support-anonymous-users.md) [e Creare criteri conferenza](../conferencing/create-policies.md).
...
Configurare le impostazioni come descritto nell'argomento [Abilitare o disabilitare](access-edge/enable-or-disable-sending-an-archiving-disclaimer-to-federated-partners.md) l'invio di una dichiarazione di non responsabilità di archiviazione ai partner federati.
...
Configurare le impostazioni come descritto negli argomenti Configurare i criteri per controllare l'accesso degli utenti [federati](external-access-policies/configure-policies-to-control-federated-user-access.md)[, Abilitare](access-edge/enable-or-disable-federation-and-public-im-connectivity.md) o disabilitare la federazione e la connettività di messaggistica istantanea pubblica e Creare o modificare provider [federati SIP ospitati](sip-providers/manage-sip-federated-providers-for-your-organization.md#create-or-edit-hosted-sip-federated-providers-in-skype-for-business-server).
