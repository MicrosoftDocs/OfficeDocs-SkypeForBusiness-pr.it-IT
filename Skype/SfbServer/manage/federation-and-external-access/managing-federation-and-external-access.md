...
description: È possibile abilitare e configurare l'accesso degli utenti esterni per controllare se gli utenti esterni supportati possono collaborare con gli utenti interni di Skype for Business Server.
...
Configurare le impostazioni come descritto negli argomenti Configurare i criteri per controllare gli [acces](external-access-policies/configure-policies-to-control-remote-user-access.md)degli utenti remoti e abilitare o disabilitare la federazione e [la connettività per messaggistica istantanea pubblica.](access-edge/enable-or-disable-federation-and-public-im-connectivity.md)
...
Configurare le impostazioni come descritto nell'argomento Assegnare criteri di conferenza per [supportare](access-edge/assign-conferencing-policies-to-support-anonymous-users.md) utenti anonimi [e Creare criteri conferenza.](../conferencing/create-policies.md)

**Si desidera consentire agli utenti di comunicare con i contatti dei domini federati SIP?**

Configurare le impostazioni come descritto negli argomenti Configurare i [](access-edge/enable-or-disable-federation-and-public-im-connectivity.md)criteri per controllare l'accesso degli utenti [federati,](external-access-policies/configure-policies-to-control-federated-user-access.md)abilitare o disabilitare la federazione e la connettività per la messaggistica istantanea pubblica e gestire i domini federati SIP per [l'organizzazione.](sip-domains/manage-sip-federated-domains-for-your-organization.md)
...
Configurare le impostazioni come descritto nell'argomento Abilitare o disabilitare l'invio di una dichiarazione di non responsabilità per l'archiviazione ai [partner federati in](access-edge/enable-or-disable-sending-an-archiving-disclaimer-to-federated-partners.md).
...
Configurare le impostazioni come descritto negli argomenti Configurare i [](access-edge/enable-or-disable-federation-and-public-im-connectivity.md)criteri per controllare l'accesso degli utenti [pubblici,](external-access-policies/configure-policies-to-control-public-user-access.md)abilitare o disabilitare la federazione e la connettività per la messaggistica istantanea pubblica e creare o modificare provider [federati SIP pubblici](sip-providers/manage-sip-federated-providers-for-your-organization.md#create-or-edit-public-sip-federated-providers-in-skype-for-business-server)


**Si desidera consentire agli utenti di comunicare con i provider federati SIP ospitati che eseguono Microsoft 365 o Office 365 e Skype for Business online?**

Configurare le impostazioni come descritto negli argomenti Abilitare o disabilitare la federazione e la connettività [per](access-edge/enable-or-disable-federation-and-public-im-connectivity.md) la messaggistica istantanea pubblica e creare o modificare [provider federati SIP ospitati.](sip-providers/manage-sip-federated-providers-for-your-organization.md#create-or-edit-hosted-sip-federated-providers-in-skype-for-business-server)
...
Configurare le impostazioni come descritto negli argomenti Configurare i [](access-edge/enable-or-disable-federation-and-public-im-connectivity.md)criteri per controllare l'accesso degli utenti [federati,](external-access-policies/configure-policies-to-control-federated-user-access.md)abilitare o disabilitare la federazione e la connettività per la messaggistica istantanea pubblica e creare o modificare provider [federati SIP ospitati.](sip-providers/manage-sip-federated-providers-for-your-organization.md#create-or-edit-hosted-sip-federated-providers-in-skype-for-business-server)
