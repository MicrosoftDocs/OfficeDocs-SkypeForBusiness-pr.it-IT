---
title: Gestire il server Chat persistente Skype for Business Server 2015
ms.reviewer: null
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
# <a name="manage-persistent-chat-server-in-skype-for-business-server-2015"></a>Gestire il server Chat persistente Skype for Business Server 2015
...
Nella tabella seguente sono riepilogati i Windows PowerShell disponibili per facilitare la gestione del server Chat persistente. Per informazioni dettagliate sulla sintassi, inclusi tutti i parametri disponibili, [vedere Skype for Business Server 2015 Management Shell](../management-shell.md).
