...
### <a name="view-network-region-link-information-by-using-windows-powershell-cmdlets"></a>Visualizzare le informazioni sui collegamenti di area di rete Windows PowerShell cmdlet
