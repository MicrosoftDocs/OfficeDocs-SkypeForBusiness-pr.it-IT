...
È possibile visualizzare i collegamenti tra due aree di rete nell'ambito del servizio Controllo di ammissione di chiamata. Le aree di una rete sono collegate mediante una connettività WAN fisica. È possibile utilizzare il Pannello Skype for Business Server per visualizzare un collegamento esistente tra due aree di rete. 


### <a name="to-view-a-network-region-link-in-skype-for-business-server-control-panel"></a>Per visualizzare un collegamento a un'area di rete nel Skype for Business Server di controllo
