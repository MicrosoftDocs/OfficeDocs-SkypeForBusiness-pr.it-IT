...
Utilizzare le procedure descritte in questo articolo per abilitare o disabilitare il bypass multimediale utilizzando il Pannello di controllo di Skype for Business Server.
...
Le impostazioni di bypass multimediale si applicano a livello globale in una distribuzione di Skype for Business Server. Il bypass multimediale consente alle chiamate di ignorare il Mediation Server. Per informazioni dettagliate su quando usare il bypass multimediale, vedi [Pianificare il bypass multimediale.](../../../plan-your-deployment/enterprise-voice-solution/media-bypass.md) È possibile disabilitare il bypass multimediale dal Pannello di controllo di Skype for Business Server. 
