...
3.  Nell'Editor del Registro di sistema espandere **Computer**, **HKEYLOCALMACHINE\_\_**, **SOFTWARE**, **Criteri,** **Microsoft**, Windows e quindi fare clic su **QoS**. In **QoS** dovrebbero essere presenti le chiavi del Registro di sistema per ognuno dei Criteri QoS creati. Ad esempio, se sono stati creati due nuovi criteri (uno denominato QoS audio Skype for Business Server e l'altro QoS video Skype for Business Server), dovrebbero essere presenti voci del Registro di sistema per Skype for Business Server Audio QoS e Skype for Business Server QoS video.
