...
**Riepilogo:** Informazioni sui contatori delle prestazioni che è possibile utilizzare per monitorare i server che eseguono UCWA (Unified Communications Web API) e il servizio Mcx Mobility di Skype for Business Server.
  
Nelle tabelle seguenti sono elencati i nomi e le descrizioni dei contatori delle prestazioni che è possibile utilizzare per monitorare i server che eseguono UCWA (Unified Communications Web API) e il servizio Mcx Mobility di Skype for Business Server. 
...
|Conteggio modalità di condivisione applicazioni attiva  <br/> |Numero corrente di modalità di condivisione applicazioni  <br/> |
...
|Active Panoramic Video Modality Count  <br/> |Numero corrente di modalità Video panoramico  <br/> |
|Conteggio get in sospeso attivo  <br/> |Numero di operazioni in sospeso attualmente attive. connessioni di lunga durata al server  <br/> |
...
|Active Video Modality Count  <br/> |Numero corrente di modalità video  <br/> |
|Richieste di creazione applicazioni ricevute/secondo  <br/> |Frequenza al secondo delle richieste di creazione di applicazioni ricevute  <br/> |
|AS MCU Join Failures  <br/> |Numero di errori di aggiunta as MCU  <br/> |
...
|Durata media sessione (ms)  <br/> |Durata media di una sessione in millisecondi  <br/> |
|Errori di join MCU dei dati  <br/> |Numero di errori di join MCU dei dati  <br/> |
|Latenza ricerca contatti di Exchange (ms)  <br/> |Questo contatore indica il tempo medio (in millisecondi) per la ricerca del contatto in Exchange  <br/> |
|Latenza get foto HD di Exchange (ms)  <br/> |Questo contatore indica il tempo medio (in millisecondi) per recuperare una foto da Exchange  <br/> |
|Risposte HTTP 4xx/secondo  <br/> |Frequenza al secondo di risposte con codice HTTP 4xx  <br/> |
|Risposte HTTP 5xx/secondo  <br/> |La frequenza al secondo delle risposte con codice HTTP 5xx  <br/> |
|Errori di aggiunta MCU im  <br/> |Numero di errori di aggiunta MCU im  <br/> |
|Numero di errori di Visualizzazione foto di Active Directory  <br/> |Numero totale di errori durante il recupero delle foto da Active Directory  <br/> |
|Numero di errori di ricerca contatti  <br/> |Numero totale di errori durante la ricerca dei contatti in Exchange  <br/> |
|Numero di errori di deserializzazione  <br/> |Numero totale di errori di deserializzazione  <br/> |
|Numero di errori di get foto HD  <br/> |Il numero totale di errori nel recupero delle foto HD da Exchange  <br/> |
...
|Errori sottoscrizione presenza  <br/> |Numero di errori di sottoscrizione della presenza  <br/> |
|Registrazione degli errori degli endpoint  <br/> |Numero di errori di registrazione degli endpoint  <br/> |
|Richieste ricevute/secondo  <br/> |Frequenza al secondo delle richieste ricevute  <br/> |
|Richieste riuscite/secondo  <br/> |Frequenza al secondo di richieste riuscite (codici di risposta HTTP 2xx/3xx)  <br/> |
|Creazione richieste applicazioni completata/secondo  <br/> |Frequenza al secondo delle richieste di creazione delle applicazioni riuscite  <br/> |
|Timeout conteggio get in sospeso  <br/> |Il numero di richieste in sospeso per il timeout  <br/> |
...
|Totale richieste ricevute nel canale dei comandi  <br/> |Numero totale di richieste ricevute nel canale dei comandi  <br/> |
...
|Sottoscrizioni di notifica Push correnti  <br/> |Numero corrente di sottoscrizioni di notifica Push. Questo numero, insieme al numero di sessioni attualmente attive, rappresenta il sottoinsieme di sessioni attualmente attive registrate per i dispositivi Windows Mobile o iPhone.  <br/> |
|Conteggio polling timeout di rete attualmente attivo  <br/> |Il numero di polling di rete che hanno timeout  <br/> |
...
|Richieste di notifica Push non riuscite/secondo  <br/> |Frequenza al secondo di notifiche push non riuscite  <br/> |
|Richieste di notifica Push riuscite/secondo  <br/> |Frequenza al secondo di notifiche push riuscite  <br/> |
|Richieste di notifica Push limitate al secondo  <br/> |Frequenza al secondo delle notifiche push limitate  <br/> |
|Richieste di notifica Push al secondo  <br/> |Frequenza al secondo delle notifiche push inviate  <br/> |
|Richieste non riuscite/secondo  <br/> |Frequenza al secondo di richieste non riuscite  <br/> |
|Richieste ricevute/secondo  <br/> |Frequenza al secondo delle richieste ricevute  <br/> |
|Richieste rifiutate/secondo  <br/> |Frequenza al secondo di richieste rifiutate  <br/> |
|Richieste riuscite/secondo  <br/> |Frequenza al secondo di richieste riuscite  <br/> |
|Richieste di sessione avviate con esito positivo al secondo  <br/> |Frequenza al secondo di richieste Get Location riuscite. Le richieste di avvio di una sessione utilizzano la maggior parte della CPU nel server. Il carico massimo supportato è di 12/secondo. La supportabilità dipende da altri carichi sul server. Avviare una sessione in genere significa un accesso per un utente che è stato disconnesso per un lungo periodo di tempo.  <br/> |
