...
- [Rapporto dettagli chiamata in Skype for Business Server](call-detail-report.md) (facendo clic sulla metrica A/V Edge Server. Se il chiamante o il chiamato è un server, è anche possibile raggiungere il Rapporto tendenze multimediale qualità server facendo clic sul nome dell'endpoint.
