---
title: Report sull'utilizzo di Response Group in Skype for Business Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
L'accesso al Rapporto di utilizzo di Response Group può essere effettuato dalla home page di Relazioni monitoraggio. È possibile eseguire il drill-down [nel rapporto elenco chiamate Response Group in Skype for Business Server](call-list-report.md) facendo clic su una delle metriche seguenti:
