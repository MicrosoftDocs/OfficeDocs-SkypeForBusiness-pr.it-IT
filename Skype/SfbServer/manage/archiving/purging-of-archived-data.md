...
Ad esempio, il comando seguente consente l'eliminazione di tutti i dati archiviati. Dopo l'esecuzione di questo comando, Skype for Business Server elimina tutti i record di archiviazione precedenti al valore specificato per il parametro KeepArchivingDataForDays. 
...
Dopo l'esecuzione di questo comando, Skype for Business Server elimina solo i record di archiviazione che soddisfano due criteri: 1) sono precedenti al valore specificato per il parametro KeepArchivingDataForDays; e 2) sono stati esportati utilizzando il cmdlet **Export-CsArchivingData.**
