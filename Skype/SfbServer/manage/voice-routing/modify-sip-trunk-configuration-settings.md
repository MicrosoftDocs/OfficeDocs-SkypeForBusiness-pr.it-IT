...
> [!Note]
> I cmdlet CsTrunkConfiguration di Skype for Business Server supportano proprietà aggiuntive non visualizzate nel Pannello di controllo di Skype for Business Server. Per ulteriori informazioni, vedere l'argomento della Guida relativo al cmdlet [Set-CsTrunkConfiguration.](/powershell/module/skype/Set-CsTrunkConfiguration) 

**Per modificare le impostazioni di configurazione dei trunk SIP tramite il Pannello di controllo di Skype for Business Server**
