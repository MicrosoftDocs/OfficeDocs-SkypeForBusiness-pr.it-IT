...
Quando si modificano le impostazioni di configurazione dei trunk SIP Skype for Business Server Pannello di controllo del server, sono disponibili le opzioni seguenti:
