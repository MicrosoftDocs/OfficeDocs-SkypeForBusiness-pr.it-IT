...
Per configurare un trunk con il bypass multimediale disabilitato, attenersi alla procedura che segue. Se si desidera configurare un trunk con il bypass multimediale abilitato, vedere Configurare un [trunk con bypass multimediale in Skype for Business Server.](configure-a-trunk-with-media-bypass.md)
...
13. Abilitare i dati **forward P-Asserted-Identity** per consentire l'inoltro delle informazioni sull'autore delle chiamate PAI tra il lato Mediation Server e il lato gateway (e viceversa), se presente.
