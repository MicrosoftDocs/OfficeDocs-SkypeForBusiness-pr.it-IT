...
12. **È necessario selezionare Abilita latch RTP** per abilitare i supporti di bypass per i client dietro un NAT (Network Address Translation) o un firewall e un SBC che supporta il latching.
