...
5. In **Modifica Skype for Business Server utente** in Criteri di Persistent **Chat** selezionare il criterio utente di Persistent Chat che si desidera applicare.
