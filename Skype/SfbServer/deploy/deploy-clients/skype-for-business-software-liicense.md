...
Per ulteriori informazioni, vedere [Come individuare Office e Windows Servizio di gestione delle chiavi host tramite DNS e rimuovere istanze non autorizzate.](https://blogs.technet.com/b/odsupport/archive/2011/11/14/how-to-discover-kms-hosts-via-a-dns-query-and-remove-them-if-need-be.aspx) 
