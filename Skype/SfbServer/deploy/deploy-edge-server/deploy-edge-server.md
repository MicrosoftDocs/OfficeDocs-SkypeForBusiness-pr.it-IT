...
- [Requisiti ambientali di Edge Server in Skype for Business Server](../../plan-your-deployment/edge-server-deployments/edge-environmental-requirements.md)
    
- [Creare la topologia di Edge per Skype for Business Server](create-your-edge-topology.md)
    
- [Distribuire Edge Server in Skype for Business Server](deploy-edge-servers.md)
