...
1. Accedi a CUCM e passa a Cisco Unified CM Administration-Call\> Routing-Class\> of Control-Partition\>.
    
2. Nella schermata Configurazione partizione immetti il nome e la descrizione della partizione e fai clic **su Aggiungi nuovo**.
