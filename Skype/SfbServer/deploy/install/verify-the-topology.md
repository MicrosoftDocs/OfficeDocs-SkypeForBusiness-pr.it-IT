...
1. Utilizzare Computer e utenti di Active Directory per aggiungere l'oggetto utente di Active Directory del ruolo di amministratore per la distribuzione di Skype for Business Server (in cui è installato il Pannello di controllo di Skype for Business Server) al gruppo **CSAdministrator.**
...
4. Avviare il Pannello di controllo di Skype for Business Server e quindi fornire le credenziali, se richiesto. Il Pannello di controllo di Skype for Business Server visualizza informazioni sulla distribuzione.
    
5. Nella barra di spostamento sinistra fare clic su Topologia e quindi verificare che lo stato del servizio sia un computer con una freccia verde e che accanto a ogni ruolo di Skype for Business Server distribuito e portato online sia presente un segno di spunta verde per lo stato della replica. 
...
9. Nel riquadro dei risultati della ricerca selezionare gli utenti che si desidera aggiungere e quindi fare clic su **OK.**
    
10. Nella pagina **Nuovo utente di Skype for Business Server** gli utenti selezionati vengono visualizzati nella **visualizzazione** Utenti. **Nell'elenco Assegna utenti a un pool** selezionare il server in cui devono risiedere gli utenti.
    ...
    Per testare la funzionalità di base, selezionare l'opzione desiderata per **l'impostazione Genera URI SIP dell'utente** (le altre opzioni della configurazione usano le impostazioni predefinite), quindi fare clic su **Abilita**, come illustrato nella figura.
    
     ![Abilitare gli utenti nel Pannello di controllo.](../../media/7ee8717d-9a1f-4864-8f45-71071c88878f.png)
  
11. Viene visualizzata una pagina di riepilogo che mostra un segno di spunta nella colonna **Abilitato** per indicare che gli utenti sono stati selezionati. La colonna **Indirizzo SIP** visualizza l'indirizzo necessario per la configurazione dell'accesso degli utenti.
    
     ![Utenti aggiunti al Pannello di controllo di Skype for Business Server.](../../media/8960548a-8d6d-44c5-bc01-6f9fb11b7588.png)
  
12. Accedere a un computer aggiunto al dominio e un altro utente a un altro computer del dominio.
    
13. Installare il client Skype for Business in ognuno dei due computer client, quindi verificare che entrambi gli utenti possano accedere a Skype for Business Server e inviare messaggi istantanei l'uno all'altro.
