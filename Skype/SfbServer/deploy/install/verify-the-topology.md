...
3. Utilizzare l'account amministrativo per accedere al computer in Skype for Business Server pannello di controllo.
    
4. Avviare Skype for Business Server Pannello di controllo e quindi fornire le credenziali, se richiesto. Skype for Business Server pannello di controllo visualizza informazioni sulla distribuzione.
    
5. Sulla barra di spostamento sinistra fare clic su Topologia e quindi verificare che lo stato del servizio mostra un computer con una freccia verde e che accanto a ogni ruolo di Skype for Business Server distribuito e portato online sia presente un segno di spunta verde per lo stato della replica. 
