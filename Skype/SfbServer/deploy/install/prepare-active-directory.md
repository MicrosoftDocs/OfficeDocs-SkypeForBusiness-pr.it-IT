...
6. **Passaggio 3: Preparare la foresta corrente**
    ...
    g. Fare **clic Skype for Business Server Management Shell** dalla pagina **App** per avviare PowerShell.
...
12. Verificare che accanto a Prepara **Active Directory** per confermare l'esito positivo sia visualizzato un segno di spunta verde, come illustrato nella figura.
