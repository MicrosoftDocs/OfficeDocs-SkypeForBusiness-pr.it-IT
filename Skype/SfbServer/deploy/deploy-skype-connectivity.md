...
Skype connettività offre Skype for Business utenti con la possibilità di cercare e aggiungere Skype utenti. Skype Connettività è una funzionalità di Skype for Business che consente di abilitare la federazione e la ricerca nella directory con Skype utenti. Dopo aver abilitato Skype connettività, Skype for Business gli utenti potranno cercare e aggiungere Skype utenti.
  
## <a name="skype-directory-search"></a>Skype Directory Search

Skype funzionalità Ricerca directory consente Skype for Business utenti di cercare Skype contatti. La funzionalità di ricerca consente agli utenti di eseguire ricerche utilizzando quanto segue:
...
Skype Connectivity è anche una funzionalità di Skype for Business Online, che fa parte di Microsoft 365 e Office 365. È possibile abilitare la funzionalità Skype connettività dall'Skype for Business di amministrazione all'interno del interfaccia di amministrazione di Microsoft 365.
  
Per Microsoft 365 Midsize Business, Office 365 Enterprise, Microsoft 365 Education e Office 365 per enti pubblici: accedi al interfaccia di amministrazione di Microsoft 365 e passare all'Skype for Business di amministrazione. Passare a Comunicazioni esterne. In Provider di servizi di messaggistica istantanea pubblica fare clic su Abilita. Se si desidera controllare l'accesso dei singoli utenti Skype connettività, è possibile farlo modificando le impostazioni delle comunicazioni esterne dei singoli utenti.
...
|:-----|:-----|:-----|
|Skype Windows Desktop   |7.6 o versione successiva, Windows XP e versioni successive   |**NOVITÀ**: supporto aggiunto per Windows Skype client in esecuzione su Windows XP e Windows Vista (richiede la versione **client più recente 7.26 o successiva)**  |
...
|Skype app Windows universale (Windows 10) desktop e mobile   |Windows 10 (aggiornamento Redstone 1 o versione successiva)   |Windows'app universale riceverà l'aggiornamento nell'autunno 2016 aggiungendo il supporto per l'interoperabilità   |
