...
6. Immettere quanto segue in **Digita espressione regolare**:
   ...
   - In **Regola di conversione** specificare un modello per il formato dei numeri convertiti.
     ...
     Ad esempio, se immetti ^\+(\d{9}\d+) **$ in Corrispondenza** questo modello e 011$ **1 in Regola** di conversione, la regola trasla +441235551010 in 011441235551010.
