...
### <a name="to-create-network-region-links-by-using-skype-for-business-server-control-panel"></a>Per creare collegamenti di area di rete tramite il Skype for Business Server Di controllo
