...
È possibile modificare le regole di confronto utilizzando Microsoft SQL Server Management Studio. Per informazioni dettagliate sull'utilizzo di questo strumento, vedere ["Utilizzo SQL Server Management Studio"](/sql/ssms/sql-server-management-studio-ssms). Per modificare le regole di confronto, eseguire la procedura seguente:
