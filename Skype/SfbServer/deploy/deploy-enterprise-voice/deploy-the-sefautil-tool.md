...
Per distribuire e gestire la risposta alle chiamate di gruppo, devi usare la versione Skype for Business Server dello strumento SEFAUtil. 
...
6. Se non l'hai già fatto, scarica la versione Skype [](https://www.microsoft.com/download/details.aspx?id=52631)for Business Server dello strumento SEFAUtil da questo percorso e installala nel pool di applicazioni attendibili creato nel passaggio 3.
