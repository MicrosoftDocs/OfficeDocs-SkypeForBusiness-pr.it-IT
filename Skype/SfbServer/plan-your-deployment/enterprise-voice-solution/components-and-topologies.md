...
![Call Admission Control (CAC) con diagramma MPLS.](../../media/CAC_MPLS_2.jpg)
...
- Tra l'Skype for Business client e Mediation Server
...
Questa configurazione è simile al caso 1. In entrambi i casi, il Mediation Server sa quale dispositivo termina i supporti all'estremità opposta del collegamento WAN e l'indirizzo IP del gateway PSTN o PBX con Media Termination Point (MTP) è configurato nel Mediation Server come hop successivo.
