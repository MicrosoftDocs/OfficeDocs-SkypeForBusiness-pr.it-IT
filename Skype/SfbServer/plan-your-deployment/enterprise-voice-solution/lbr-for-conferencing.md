...
L'Location-Based Routing Conferencing offre alle Skype for Business un meccanismo per la prevenzione del bypass a pedaggio PSTN. L'applicazione monitora le conferenze attive e applica Location-Based di routing in base alla posizione degli utenti Skype for Business partecipanti.

LLocation-Based di routing delle conferenze determina se Location-Based il routing deve essere applicato a una riunione Skype for Business se vengono soddisfatti i criteri seguenti:
...
L'Location-Based routing per conferenze impedisce la partecipazione di utenti Skype for Business e endpoint PSTN da siti di rete diversi alla stessa conferenza. Se l'organizzatore di una riunione è abilitato Location-Based routing, l'applicazione di conferenza applica le restrizioni seguenti:
...
Ad esempio, se l'applicazione "UdcAgent" ha un valore di priorità "2", l'applicazione "DefaultRouting" ha un valore di priorità "8", l'applicazione "ExumRouting" ha un valore di priorità "9" e l'applicazione "OutboundRouting" ha un valore di priorità "10", è necessario assegnare all'applicazione Location-Based Routing per conferenze un valore di priorità pari a "3". In questo modo, la priorità delle applicazioni viene posizionata nell'ordine seguente: altre applicazioni (priorità: da 0 a 1), "UdcAgent" (priorità: 2), applicazione di routing delle conferenze (priorità: 3), altre applicazioni (priorità: da 4 a 8), "DefaultRouting" (Priorità: 9 Location-Based), "ExumRouting" (Priorità: 10) e "OutboundRouting" (Priorità: 11).
...
Dopo aver utilizzato questo cmdlet, riavviare tutti i Front End Server nel pool o nei edizione Standard Server in cui è stata abilitata l'applicazione routing Location-Based per conferenze.
