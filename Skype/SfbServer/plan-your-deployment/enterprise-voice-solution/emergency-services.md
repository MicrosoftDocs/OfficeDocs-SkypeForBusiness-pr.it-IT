...
2. Skype for Business Server corrisponde al numero di emergenza e instrada la chiamata (in base al valore utilizzo **PSTN** definito nel criterio percorso applicabile) a un Mediation Server e da qui, tramite un trunk SIP al provider di servizi E9-1-1.
