...
Il diagramma seguente mostra come una chiamata di emergenza viene instradata da Skype for Business Server al punto psap (Public Safety Answering Point) quando si utilizza un trunk SIP e un provider di servizi E9-1-1 qualificato.
