...
Skype for Business Server, Mediation Server è collocato per impostazione predefinita con un server Standard Edition, un pool Front End o un Survivable Branch Appliance. Tutti i Mediation Server in un pool Front End devono essere configurati in modo identico.
