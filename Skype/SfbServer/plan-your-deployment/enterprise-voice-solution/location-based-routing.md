...
- Egress calls - Location-Based Routing può imporre l'uscita delle chiamate in uscita verso un gateway PSTN che si trova nella stessa area in cui il chiamante deve impedire il bypass a pagamento PSTN, impedendo così l'uscita delle chiamate a un gateway PSTN situato in un'area diversa del chiamante.
...
Le impostazioni di inoltro di chiamata di un utente abilitato per Location-Based Routing continueranno a essere applicate, tuttavia, le chiamate inoltrate saranno soggette alle restrizioni di routing Location-Based dell'utente.
...
|:-----|:-----|:-----|:-----|
|Endpoint PSTN  <br/> |Anello simultaneo consentito tramite il criterio di routing vocale del sito del chiamante  <br/> |Anello simultaneo consentito tramite il criterio di routing vocale del sito del chiamante  <br/> |Anello simultaneo consentito attraverso i criteri vocali del chiamante ai trunk non abilitati per Location-Based routing  <br/> |
...
|:-----|:-----|:-----|
|Skype for Business Server o Aggiornamento cumulativo di Lync Server 2013 di febbraio 2013  <br/> |Skype for Business Server o Aggiornamento cumulativo di Lync Server 2013 di febbraio 2013  <br/> |sì  <br/> |
|Skype for Business Server o Aggiornamento cumulativo di Lync Server 2013 di febbraio 2013  <br/> |Lync Server 2013  <br/> |no  <br/> |
|Skype for Business Server o Aggiornamento cumulativo di Lync Server 2013 di febbraio 2013  <br/> |Lync Server 2010  <br/> |no  <br/> |
|Skype for Business Server o Aggiornamento cumulativo di Lync Server 2013 di febbraio 2013  <br/> |Office Communications Server 2007 R2  <br/> |no  <br/> |
