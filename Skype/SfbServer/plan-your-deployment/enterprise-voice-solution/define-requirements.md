...
Riepiloga i passaggi necessari per abilitare il servizio E9-1-1 in Skype for Business Server VoIP aziendale, a seconda che si abbia un provider di servizi E9-1-1 trunk SIP o un gateway ELIN.
  
Prima di iniziare una distribuzione di Skype for Business Server E9-1-1, dovresti essere in grado di rispondere alle domande descritte nelle sezioni seguenti. Gli elementi da pianificare dipendono dal tipo di soluzione E9-1-1 che si sceglie di distribuire, ovvero un provider di servizi E9-1-1 trunk SIP o un gateway ELIN (Emergency Location Identification Number). Nella tabella seguente vengono identificate le sezioni di questa cartella di lavoro per la pianificazione che sarà necessario esaminare per ognuna di queste soluzioni.
  
**Passaggi per la pianificazione in base al tipo di soluzione E9-1-1**

|**Provider di servizi trunk SIP**|**Gateway ELIN**|
|:-----|:-----|
|[Definire l'ambito della distribuzione E9-1-1 in Skype for Business Server](scope.md) <br/> |[Definire l'ambito della distribuzione E9-1-1 in Skype for Business Server](scope.md) <br/> |
...
|[Abilitare gli utenti per il servizio E9-1-1 in Skype for Business Server](enable-users.md) <br/> |[Abilitare gli utenti per il servizio E9-1-1 in Skype for Business Server](enable-users.md) <br/> |
...
|[Progettare il trunk SIP per il servizio E9-1-1 in Skype for Business Server](design-the-sip-trunk.md) <br/> |[Includere il desk di sicurezza in Skype for Business Server](security-desk.md) <br/> |
