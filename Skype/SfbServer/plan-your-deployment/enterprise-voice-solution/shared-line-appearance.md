...
SLA è una nuova funzionalità in Skype for Business Server, novembre 2015 aggiornamento cumulativo. 
  
Per informazioni sulla distribuzione di SLA, vedere [deploy Shared Line Appearance in Skype for Business Server 2015](../../deploy/deploy-enterprise-voice/deploy-shared-line-appearance.md).
