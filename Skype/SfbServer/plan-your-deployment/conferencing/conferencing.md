...
- **PowerPoint condivisione.** Consente agli utenti di condividere PowerPoint presentazioni nella riunione tramite un server Office Web Apps, che consente di:
  ...
  - Gli utenti con le autorizzazioni appropriate possono scorrere una presentazione PowerPoint indipendente dalla presentazione stessa. Ad esempio, mentre Davide presenta la presentazione, Heidi può esaminare qualsiasi diapositiva che desidera senza influire sulla presentazione di Ken.
...
- **Aggiunta di un utente tramite chiamata in uscita.** I relatori e i partecipanti a cui è stata concessa l'autorizzazione possono aggiungere numeri PSTN alle conferenze e disporre della chiamata in uscita per la conferenza a tali numeri.
  ...
  Skype for Business Server sono disponibili diverse funzionalità che gli utenti possono utilizzare per configurare l'esperienza di videoconferenza per l'utente, tra cui:
...
- **Pagina servizi di conferenza telefonica Impostazioni accesso esterno.** Nella pagina Impostazioni conferenza telefonica con accesso esterno vengono visualizzati i numeri di accesso esterno per conferenze con le rispettive lingue disponibili, le informazioni sulla conferenza assegnate (ovvero per le riunioni che non devono essere pianificate) e i controlli DTMF in conferenza e supporta la gestione del PIN (Personal Identification Number) e delle informazioni di conferenza assegnate. La pagina Conferenze telefoniche con accesso Impostazioni viene installata automaticamente come parte dei servizi Web.
...
- **Office Web Apps Server.** Per utilizzare le funzionalità di conferenza Web, gli amministratori devono installare Office Web Apps Server e devono configurare Skype for Business Server per comunicare con Office Web Apps Server.
...
- In un pool condiviso, Skype for Business Server può ospitare riunioni con un massimo di 250 utenti. Un pool condiviso è un pool che ospita tutti i Skype for Business Server, tra cui messaggistica istantanea e presenza, conferenze e VoIP aziendale. 
...
- **Si desiderano abilitare le conferenze Web, che includono funzionalità di collaborazione sui documenti e condivisione di applicazioni?**
    ...
    Per consentire agli utenti di condividere PowerPoint presentazioni, è necessario configurare Office Web Apps Server. Per informazioni dettagliate sulla configurazione Office web apps server, vedere [Configure integration with Office Web Apps Server in Skype for Business Server](../../deploy/deploy-conferencing/office-web-app-server.md).
...
- **Si desidera consentire agli utenti esterni con Skype for Business di partecipare alle conferenze?**
  ...
  - **Utenti remoti.** Gli utenti dell'organizzazione, quando lavorano all'esterno dei firewall e usano i portatili o altri dispositivi Skype for Business Server.
