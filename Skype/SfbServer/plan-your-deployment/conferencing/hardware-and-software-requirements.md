...
applicazione Operatore conferenza e applicazione Annuncio conferenza è necessario che Windows Runtime formato multimediale sia installato nei Front End Server. Windows Media Format Runtime è necessario per riprodurre Windows File audio multimediali (WMA) utilizzati per la musica di attesa, i nomi registrati e i prompt. Se si esegue l'installazione in Windows Server 2012 o Windows Server 2012 R2 (scelta consigliata), è necessario installare Microsoft Media Foundation per ottenere Windows Media Format Runtime. Se si esegue l'installazione in qualsiasi versione di Windows Server prima di Windows 2012, è necessario verificare che l'esperienza desktop di Windows sia installata per ottenere Windows Media Format Runtime.
...
|Front End Server  <br/> |Skype for Business Server Web Conferencing  <br/> |8057  <br/> |TCP (TLS)  <br/> |Utilizzata per attendere le connessioni PSOM (Persistent Shared Object Model) dal client.  <br/> |
|Front End Server  <br/> |Skype for Business Server servizio Compatibilità web conferencing  <br/> |8058  <br/> |TCP (TLS)  <br/> |Utilizzato per ascoltare le connessioni PSOM (Persistent Shared Object Model) dal client Live Meeting e dalle versioni precedenti di Skype for Business Server.  <br/> |
...
|Tutti i server interni  <br/> |Vari  <br/> |49152-57500  <br/> |TCP/UDP  <br/> |Intervallo di porte multimediali utilizzato per le conferenze audio su tutti i server interni. Utilizzato da tutti i server che terminano l'audio: Front End Server (per Skype for Business Server Operatore conferenza, Skype for Business Server Annuncio conferenza e Skype for Business Server servizio Audio/Video Conferencing) e Mediation Server.  <br/> |
|Office web apps server  <br/> ||443  <br/> ||Usato da Skype for Business Server per connettersi a Office Web Apps Server.  <br/> |
