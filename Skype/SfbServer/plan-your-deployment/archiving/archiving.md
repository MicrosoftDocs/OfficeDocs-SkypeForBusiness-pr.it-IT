...
- **Archivio dati di archiviazione**. L'archiviazione dei Skype for Business Server può essere implementata come Skype for Business Server SQL Server database o, se si dispone di una distribuzione Exchange, integrata con Exchange archiviazione. 
