...
Per informazioni dettagliate su come configurare le configurazioni di archiviazione iniziali quando si distribuisce l'archiviazione, vedere [Deploy archiving for Skype for Business Server](../../deploy/deploy-archiving/deploy-archiving.md). Per informazioni dettagliate sulla gestione dell'archiviazione dopo la [distribuzione,](../../manage/archiving/archiving.md)vedere Manage archiving in Skype for Business Server . 
