...
I programmi di installazione client sono disponibili sia per i programmi di installazione MSI che per i programmi di installazione dei tipi a scelta. La Skype for Business di sostegno del client può influire sulle scelte effettuate, pertanto è consigliabile comprendere i punti seguenti:
...
- L'esperienza più recente Skype for Business client sarà disponibile nel programma di Skype for Business 2019 click-to-run.
...
Entrambe le versioni client di base e completa (con la scelta di versioni a 32 e 64 bit) sono disponibili con un programma di installazione a clic per eseguire, gli utenti possono scaricarli in [Download Skype for Business in](https://products.office.com/skype-for-business/download-app?tab=tabs-3)tutti i dispositivi.
...
- [Skype for Business risoluzioni video client](video-resolutions.md)
