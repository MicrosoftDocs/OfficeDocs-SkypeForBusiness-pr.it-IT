...
- L'esperienza client Skype for Business più recente e più grande si trova nel programma di installazione a click-to-run di Skype for Business 2019.
...
Click-to-run è una tecnologia di streaming e virtualizzazione Microsoft che puoi usare per installare e aggiornare i prodotti Office, tra cui Skype for Business. Queste funzionalità di streaming e virtualizzazione si basano sulle tecnologie di Microsoft Application Virtualization (App-V). La fase di esecuzione a clic presenta i vantaggi seguenti:
...
Entrambe le versioni client di base e completa (con una scelta di versioni a 32 e 64 bit) sono disponibili con un programma di installazione a click-to-run, gli utenti possono scaricare skype [for business](https://products.office.com/skype-for-business/download-app?tab=tabs-3)su tutti i dispositivi.
...
Vedere gli articoli seguenti per comprendere le funzionalità, le piattaforme, i sistemi operativi, i browser e l'integrazione supportati necessari per i client Skype for Business.
...
- [Requisiti del client Skype for Business per Mac](mac-requirements.md)

- [Pianificare Microsoft Teams Rooms](/MicrosoftTeams/rooms/rooms-plan)
