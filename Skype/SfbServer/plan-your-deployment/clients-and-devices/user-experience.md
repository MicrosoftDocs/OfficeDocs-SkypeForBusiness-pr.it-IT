...
|:-----|:-----|:-----|
|Skype for Business Online  <br/> |Non sono disponibili altri passaggi oltre alla distribuzione della build client 4711.1002 (aprile 2015) o successiva.  <br/> |[Usare l'esperienza client Lync con Skype for Business Online](user-experience.md#LyncwithSfBO) <br/> |
|Skype for Business Server 2015  <br/> |Non sono disponibili altri passaggi oltre alla distribuzione della build client 4711.1002 (aprile 2015) o successiva.  <br/> |[Usare l'esperienza del client Lync Skype for Business Server locale](user-experience.md#LyncwithSfBServer) <br/> |
...
- **Lync Server 2010** - È necessario eseguire l'aggiornamento cumulativo di febbraio 2015 (4.0.7577.710) per Lync Server 2010 o un aggiornamento successivo. Per informazioni, vedere [Updates for Lync Server 2010](https://go.microsoft.com/fwlink/p/?LinkId=532771).
  ...
  **Passaggio 2:** Usa quindi un criterio client per impostare l'esperienza Skype client con il client Skype for Business client. Esistono **3 opzioni per** l'utilizzo di un criterio client per impostare l'esperienza client.
 ...
 **Passaggio 2:** Successivamente, utilizzare un criterio client per impostare l'esperienza client Lync con il client Skype for Business client. Esistono **3 opzioni per** l'utilizzo di un criterio client per impostare l'esperienza client.
...
Per facilitare la preparazione dell'utente e dell'organizzazione per la transizione, sono disponibili molte risorse aggiuntive che consentono di pianificare, istruire e coinvolgere gli utenti finali.
...
- [Perché vengono visualizzati Skype for Business quando si utilizza Lync?](https://go.microsoft.com/fwlink/p/?LinkID=544712)
