...
In seguito, tali utenti possono creare riunioni e invitare utenti esterni all'organizzazione e gli invitati alle riunioni potrebbero non avere alcuna versione del client Skype for Business. Quando questi utenti fanno clic sull'URL per l'invito alla riunione, viene rilevata la mancanza di un client e all'invitato senza un client Skype for Business verrà richiesto di scaricare e installare un client leggero solo per le riunioni in modo che possa partecipare alla riunione.
  
> [!NOTE]
> L Skype for Business Web App e Skype riunioni sono disponibili solo quando si tenta di accedere a una riunione senza Skype for Business. La Guida dell'utente per queste app è disponibile all'indirizzo [https://aka.ms/smahelp](https://aka.ms/smahelp). 
...
Ad Skype for Business Server, Skype Meeting App (Windows) e Skype for Business per Mac (su Mac) sono disponibili come sostituzioni per Skype for Business Web App  a partire da CU5, ma fornire le app sostitutive richiede la configurazione aggiuntiva descritta in [Enable Skype Meetings App to replace Skype for Business Web App (Optional)](../../deploy/deploy-clients/deploy-web-downloadable-clients.md#SMA_Enable). Se Skype'app Riunioni e Skype for Business per Mac sono abilitati, gli utenti scarideranno la versione più recente delle app dal Microsoft 365 o Office 365 rete per la distribuzione di contenuti (rete CDN ) anziché dal server Skype for Business server. Per Skype for Business Server 2019, l'Skype'app Riunioni Skype for Business per Mac è l'unica opzione.
  
Skype'app Riunioni offre un'esperienza browser semplificata per scaricare e installare l'app e partecipare alle riunioni, inclusa la partecipazione con un solo clic per gli utenti di Internet Explorer. Skype'app Riunioni include anche molti miglioramenti rispetto all'Skype for Business Web App per l'affidabilità e l'esperienza di riunione. 
  
> [!NOTE]
> A Skype for Business Server 2015 CU5 o versioni successive, le riunioni tenute con Skype for Business Online non invieranno più a un utente senza client il Skype for Business Web App, verranno invece inviate Skype Meeting App (Windows) o Skype for Business per Mac (su Mac). A Skype for Business Server 2015 CU5 o versioni successive, se abiliti l'app Riunioni di Skype per sostituire [Skype for Business Web App (](../../deploy/deploy-clients/deploy-web-downloadable-clients.md#SMA_Enable)facoltativo),gli utenti senza client verranno inviati Skype Meeting App o Skype for Business per Mac invece di Skype for Business Web App. 
...
&#x2778;'accesso all'app Web da Chrome su Windows verrà avviato un piccolo programma che carica l'app Web in un frame incorporato di Internet Explorer. Per il corretto caricamento dell'app Web, è necessario che sia installata una delle versioni supportate di Internet Explorer.
...
Skype Meetings App viene eseguita come app nei computer che usano Windows 10, Windows 8.1, Windows 8, Windows 7, con Installato Internet Explorer 11 a 32 e 64 bit o versione successiva. 
...
Se un utente dell'app riunioni Skype for Business Web App o Skype verifica problemi di connessione, è probabile che l'infrastruttura di rete dell'organizzazione non sia configurata per supportare Office 365, come descritto in URL e intervalli di indirizzi [IP di Office 365](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2?ui=en-US&amp;rs=en-US&amp;ad=US). Questo è il caso se la riunione è stata creata da un utente di Skype for Business Online o Skype for Business Server. 
...
|Produrre Riunione Skype Broadcast  <br/> |&#x2714;|||||
 ...
 &#x2776; i partecipanti non possono controllare i desktop condivisi dagli utenti di Skype for Business per Mac, Lync per Mac 2011 o Communicator per Mac 2011. Questo non funziona anche per le Skype for Business Web App su Max OSX.
 ...
 &#x2778; Il client Lync per Mac 2011 non può visualizzare presentazioni Microsoft Office 2013 PowerPoint quando sono state condivise in una conferenza dal Skype for Business Web App.
...
- Se l'utente si trova in una rete non configurata per soddisfare i requisiti di [rete, molte](meetings-clients.md#Network) funzionalità dell'app potrebbero non funzionare e potrebbero non essere affatto in grado di connettersi alla riunione.
...
A partire da Skype for Business Server 2015 CU5, AES non è supportato per ASP.NET 4.6 e ciò potrebbe causare l'avvio dell'app riunioni Skype. [I requisiti di crittografia dovuti ASP.NET 4.5](../security/user-and-client-authentication.md#cryptographic-requirements-due-to-asp-net-45) hanno altri dettagli.
