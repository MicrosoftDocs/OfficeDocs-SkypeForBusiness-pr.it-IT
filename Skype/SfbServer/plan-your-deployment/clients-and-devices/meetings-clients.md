...
**Riepilogo:** I professionisti IT devono esaminare i requisiti di supporto per Skype for Business Web App e Skype Meetings App durante la pianificazione di Skype for Business Server. Questo articolo non è destinato agli utenti di queste app.
...
In seguito, questi utenti possono creare riunioni e invitare utenti esterni all'organizzazione e tali invitati potrebbero non avere alcuna versione del client Skype for Business. Quando questi utenti fanno clic sull'URL dell'invito alla riunione, viene rilevata la mancanza di un client e all'invitato senza un client Skype for Business verrà richiesto di scaricare e installare un client leggero solo per le riunioni in modo che possa partecipare alla riunione.
  
> [!NOTE]
> Skype for Business Web App e Skype Meetings App sono disponibili solo quando si tenta di accedere a una riunione senza skype for Business. La Guida dell'utente per queste app è disponibile in [https://aka.ms/smahelp](https://aka.ms/smahelp) . 
  
> [!NOTE]
> Non è possibile preinstallare Skype for Business Web App o Skype Meetings App, ma gli utenti di [smartphone](https://products.office.com/skype-for-business/download-app?tab=tabs-1) e [tablet](https://products.office.com/skype-for-business/download-app?tab=tabs-2) potrebbero essere in grado di installare client mobili economici che possono usare per partecipare alle riunioni.
  
Per impostazione predefinita, il server che ospita la riunione invierà l'utente a scaricare e installare Skype for Business Web App per partecipare alla riunione. Skype for Business Web App è archiviato nel Front End Server e viene inviato al partecipante alla riunione. 
  
For Skype for Business Server, Skype Meetings App (on Windows) and Skype for Business for Mac (on Mac) are available as replacements for Skype for Business Web App beginning with CU5, but providing the replacement apps requires the additional configuration described in [Enable Skype Meetings App to replace Skype for Business Web App (Optional)](../../deploy/deploy-clients/deploy-web-downloadable-clients.md#SMA_Enable). Se l'app Riunioni Skype e Skype for Business per Mac sono abilitati, gli utenti scariccheranno la versione più recente delle app dalla rete per la distribuzione di contenuti (CDN) di Microsoft 365 o Office 365 anziché dal server Skype for Business. Per Skype for Business Server 2019, l'unica opzione è usare l'app Riunioni Skype e Skype for Business per Mac.
  
L'app Riunioni Skype offre un'esperienza browser semplificata per scaricare e installare l'app e partecipare alle riunioni, inclusa la partecipazione con un solo clic per gli utenti di Internet Explorer. Skype Meetings App include anche molti miglioramenti rispetto a Skype for Business Web App per l'affidabilità e l'esperienza di riunione. 
  
> [!NOTE]
> A causa di Skype for Business Server 2015 CU5 o versioni successive, le riunioni tenute con Skype for Business online non invieranno più a un utente senza client Skype for Business Web App, ma riceveranno l'app Riunioni Skype (in Windows) o Skype for Business per Mac (su Mac). A seguito di Skype for Business Server 2015 CU5 o versione successiva, se si abilita l'app Riunioni Skype per sostituire [Skype for Business Web App (facoltativo),](../../deploy/deploy-clients/deploy-web-downloadable-clients.md#SMA_Enable)agli utenti senza client verrà inviata l'app Riunioni Skype o Skype for Business per Mac anziché Skype for Business Web App. 
  
## <a name="software-requirements"></a>Requisiti software
<a name="OS-Browser"> </a>

Per usare Skype for Business Web App, un utente deve avere una delle seguenti combinazioni di sistema operativo e browser supportate. 
  
**Sistema operativo e supporto minimo del browser per Skype for Business Web App**

| Sistema operativo | Edge | Internet Explorer 11 o versione successiva a 32 e 64 bit | Internet Explorer 10 o versione successiva a 32 e 64 bit | Internet Explorer 9 o versioni successive a 32 e 64 bit | Versione a 32 e 64 bit di Safari 6.2.8 - 11.X | Versione a 32 e 64 bit di Chrome 18.X o versione successiva |
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
&#x2776; Il plug-in del browser Skype for Business Web App richiede un plug-in di condivisione specifico per usare funzionalità vocali, video, condivisione e visualizzazione dello schermo basate su computer. Un partecipante alla riunione ha la possibilità di installare il plug-in di condivisione quando partecipa alla riunione o quando avvia una di queste funzionalità. In Windows 8 e Windows 8.1, il plug-in di condivisione può essere installato solo se si esegue Internet Explorer 10 o Internet Explorer 11 per il desktop. Queste funzionalità non sono disponibili con le versioni non desktop di Internet Explorer 10 e 11. Si noti che Firefox e Safari versione 12.0 e successive non sono più supportati.
  
&#x2777; Nei sistemi operativi Windows 7, Windows Server 2008 R2 e Macintosh supportati sono disponibili tutte le funzionalità, tra cui voce basata su computer, video, visualizzazione applicazioni, condivisione applicazioni, visualizzazione desktop e condivisione desktop. Per usare queste funzionalità, devi installare un plug-in quando richiesto. Mac OS X versione 10.7 non è più supportato.  Nota anche che l'app Web non verrà installata in OS X 10.15 o versione successiva.  È consigliabile usare la versione più recente di Skype for Business per Mac che supporta scenari di aggiunta anonima in futuro.
  
&#x2778;'accesso all'app Web da Chrome in Windows avvierà un piccolo programma che carica l'app Web in un frame di Internet Explorer incorporato. Questo programma richiede l'installazione di una delle versioni supportate di Internet Explorer per il corretto caricamento di Web App.
  
> [!NOTE]
> Gli utenti di Microsoft 365 e Office 365 possono usare Internet Explorer 10 o versione successiva con Skype for Business. 
  
### <a name="skype-meetings-app"></a>App Riunioni Skype

L'app Riunioni Skype viene eseguita come app nei computer che usano Windows 10, Windows 8.1, Windows 8, Windows 7, con Internet Explorer 11 a 32 e 64 bit o versione successiva installato. 
  
Per altre dipendenze, fare riferimento alle [piattaforme supportate per l'app Riunioni Skype](https://support.office.com/client/results?Shownav=true&amp;lcid=1033&amp;ns=SKFBWA&amp;version=15&amp;omkt=en-US&amp;ver=15&amp;HelpID=SfBWebApp4001)
  
### <a name="skype-for-business-for-mac"></a>Skype for Business per Mac

Skype for Business per Mac viene eseguito su computer con macOS versione 10.8 o successiva. 
...
Questa tabella confronta le funzionalità riunioni disponibili per gli utenti del client Skype for Business, Skype for Business Web App, Skype Meetings App e Lync Web App. Lync Web App è elencato a scopo di confronto delle funzionalità: un utente sta scaricando e utilizzando Lync Web App solo se la riunione è stata ospitata in un server Lync 2013.

| Funzionalità/funzionalità | Client Skype for Business 2016 o 2019 | Client Skype for Business su Mac | App Riunioni Skype | Skype for Business Web App | Lync Web App |
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|Condividere un programma (se consentito)  <br/> |&#x2714;||&#x2714;(solo in Windows; richiede plug-in)  <br/> |&#x2714;(solo in Windows; richiede plug-in)  <br/> |&#x2714;(solo in Windows; richiede plug-in)  <br/> |
|Assumere il controllo del desktop o del programma condiviso di un altro utente  <br/> |&#x2714;||&#x2714; (&#x2776; solo in Windows; richiede plug-in)  <br/> |&#x2714; (&#x2776; solo in Windows; richiede plug-in)  <br/> |&#x2714; (&#x2776; solo in Windows; richiede plug-in)  <br/> |
...
|Invitare partecipanti in base al nome  <br/> |&#x2714;|&#x2714;||||
...
|Esplorare i file di Microsoft PowerPoint  <br/> |&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;|
|Aggiungere e modificare le note delle riunioni di OneNote  <br/> |&#x2714;||Solo modifica (non aggiunta)  <br/> |Solo modifica (non aggiunta)  <br/> |Solo modifica (non aggiunta)  <br/> |
...
|Disattivare il gruppo di destinatari  <br/> |&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;|
|Impostare tutti come partecipanti  <br/> |&#x2714;|||||
|Produrre Skype Meeting Broadcast  <br/> |&#x2714;|||||
   
 &#x2776; i partecipanti non possono controllare i desktop condivisi dagli utenti di Skype for Business per Mac, Lync per Mac 2011 o Communicator per Mac 2011. Questo non funzionerà anche per Skype for Business Web App su Max OSX.
...
Per gli utenti finali, la [Guida online](https://aka.ms/smahelp) per queste app è immediatamente disponibile. I professionisti IT devono essere a conoscenza dei problemi seguenti:
...
- Gli utenti potrebbero visualizzare un avviso del firewall la prima volta che eseguono l'app riunioni. Potrebbe essere richiesto di aprire le porte per ottimizzare l'esperienza e ciò potrebbe richiedere privilegi di amministratore sul computer che potrebbero non avere. L'app dovrebbe comunque funzionare e l'utente può tranquillamente rifiutare di aprire le porte richieste. 
...
- Per il corretto funzionamento di alcune funzionalità di Skype for [](https://support.office.com/article/Allow-cookies-for-Skype-Meetings-App-Skype-for-Business-Web-App-2108276b-b5c3-484b-bf2b-dac6eeba4c93) Business Web App, è necessario consentire al browser di salvare i cookie nel computer o nel dispositivo.
    
- Potrebbe essere necessario [attivare il supporto di JavaScript](https://support.office.com/article/Turn-on-JavaScript-for-Skype-Meetings-App-Skype-for-Business-Web-App-3d997bf9-637c-4fe6-8ee3-9e62bfda52cd) nel browser per il funzionamento di alcune funzionalità di Skype for Business Web App come previsto.
    
### <a name="aes-support"></a>Supporto AES 

A partire da Skype for Business Server 2015 CU5, AES non è supportato per ASP.NET 4.6 e ciò potrebbe causare l'avvio dell'app Riunioni Skype. [I requisiti di crittografia dovuti ad ASP .NET 4.5](../security/user-and-client-authentication.md#cryptographic-requirements-due-to-asp-net-45) sono più dettagliati.
