...
|Windows Server 2012 sistema operativo R2 Datacenter con tutti gli aggiornamenti necessari installati.   |Windows Server 2012 sistema operativo R2 Standard con tutti gli aggiornamenti necessari installati.   |
...
- Se si esegue l'aggiornamento in una casella di Windows Server 2008 R2 (vedere la nota precedente), è necessario installare prima l'articolo della Knowledge Base 2533623. [Si tratta di questo collegamento](https://support.microsoft.com/kb/2533623/).
...
È possibile usare il mirroring SQL o SQL clustering con Skype for Business Server 2015, è supportato. SQL il mirroring viene configurato tramite Skype for Business Server Generatore di topologie. Se si ha intenzione di configurare SQL clustering, questa operazione viene eseguita in SQL Server.
