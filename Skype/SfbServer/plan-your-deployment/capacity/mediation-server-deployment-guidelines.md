...
È possibile utilizzare lo Skype for Business Planning Tool per valutare se collocare il Mediation Server con il pool Front End è in grado di gestire il carico. Se l'ambiente non soddisfa questi requisiti, sarà necessario distribuire un pool Mediation Server autonomo.
