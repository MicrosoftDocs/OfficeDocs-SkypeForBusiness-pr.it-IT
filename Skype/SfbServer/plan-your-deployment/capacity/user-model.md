---
title: Pianificazione della capacità dell'utilizzo del modello utente per Skype for Business Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
description: Questo articolo fornisce indicazioni sul numero di server necessari in un sito per il numero di utenti in tale sito, in base all'utilizzo descritto in Modelli utente in Skype for Business Server.
...
---
# <a name="capacity-planning-user-model-usage-for-skype-for-business-server"></a>Pianificazione della capacità dell'utilizzo del modello utente per Skype for Business Server
...
> [!NOTE]
> Tutti i suggerimenti forniti in questo articolo presuppongono che sia stato installato l'aggiornamento cumulativo di Skype for Business, novembre 2015 o versione successiva sui server.

## <a name="tested-hardware-platform"></a>Piattaforma hardware testata

Abbiamo eseguito i test delle prestazioni sull'hardware descritto nella tabella seguente. Tutti i suggerimenti e i risultati sono basati su questo hardware. Se decidi di provare a usare hardware meno potente di quello elencato qui, tieni presente che potrebbero verificarsi problemi di funzionalità o prestazioni scarse. Questi consigli relativi all'hardware sono gli stessi di Lync Server 2013, se utile (e in scenari di aggiornamento).

**Hardware utilizzato nei test delle prestazioni**

|**Componente hardware**|**Consigliata**|
|:-----|:-----|
|CPU  <br/> |Processore doppio a 64 bit, core esadecimale, 2,26 gigahertz (GHz) o superiore.  <br/> I processori Intel Itanium non sono supportati per i ruoli server di Skype for Business Server.  <br/> |
|Memoria  <br/> |32 gigabyte (GB).  <br/> |
|Disco  <br/> |8 o più unità disco rigido da 10.000 RPM con almeno 72 GB di spazio libero su disco. Due dei dischi dovrebbero utilizzare RAID 1 e sei dovrebbero utilizzare RAID 10.  <br/> -OPPURE- <br/>Unità SSD (Solid State Drive) che offrono prestazioni simili a 8 unità disco meccaniche da 10.000 RPM. <br/> |
...
|:-----|:-----|
|Pool Front End con dodici Front End Server e un server back-end o una coppia di server back-end con mirroring.  <br/> |80.000 utenti univoci connessi contemporaneamente, più il 50% di più punti di presenza (MPOP) che rappresentano istanze non mobili, più il 40% degli utenti abilitati per i dispositivi mobili per un totale di 152.000 endpoint.  <br/> |
...
La tabella seguente mostra la larghezza di banda media per la messaggistica istantanea e la presenza, in base al modello utente, come definito nei modelli utente [in Skype for Business Server.](user-models.md)
...
Se l'organizzazione dispone di un numero di conferenze in modalità mista molto superiore a quello previsto nel modello utente, potrebbe essere necessario distribuire più Front End Server di quanto consigliato in questo documento (fino a un limite di 12 Front End Server). Per informazioni dettagliate sui presupposti nel modello utente, vedere [Modelli utente in Skype for Business Server.](user-models.md)
...
|:-----|:-----|:-----|:-----|
|Processore doppio, core esadecimale, CPU hyperthread da 2,26 GHz con **hyperthreading** disabilitato, con 32 GB di memoria e una scheda di rete a due porte.  <br/> |1100  <br/> |46  <br/> |35  <br/> |
|Processore doppio, core esadecimale, CPU hyper-thread da 2,26 GHz, con 32 GB di memoria e una scheda di rete a due porte.  <br/> |1500  <br/> |63  <br/> |47  <br/> |
...
|:-----|:-----|
|Processore doppio, core esadecimale, CPU hyper-thread da 2,26 GHz, con 32 GB di memoria e 2 schede di rete da 1 GB.  <br/> |150  <br/> |
...
|Disco  <br/> |25 unità disco rigido da 10.000 RPM con 300 GB su ogni disco, con la configurazione nella tabella seguente  <br/> |
