...
description: I modelli utente descritti di seguito forniscono la base per le misure di pianificazione della capacità e i suggerimenti descritti nell'utilizzo del modello utente per la pianificazione della capacità per Skype for Business Server.
...
I modelli utente descritti di seguito forniscono la base per le misure di pianificazione della capacità e i suggerimenti descritti nell' [utilizzo del modello utente per la pianificazione della capacità per Skype for Business Server](user-model.md).
  
## <a name="skype-for-business-server-user-models"></a>Modelli utente di Skype for Business Server
...
|Percentuale di utenti di Active Directory  <br/> |Si presuppone che il 70% di tutti gli utenti di Active Directory nell'organizzazione siano abilitati per Skype for Business Server. il 80% degli utenti abilitati ha eseguito l'accesso a Skype for Business Server ogni giorno (80% di concorrenza). Gli utenti simultanei rappresentano la base per i valori indicati nel resto di questa sezione.  <br/> |
|Cambiamenti in Active Directory  <br/> |Si presuppone che il 0,5% del totale degli utenti siano stati creati e abilitati per Skype for business in Active Directory ogni settimana e che il 0,5% del totale degli utenti sia disabilitato da Active Directory e da Skype for business ogni settimana. Per il 5% degli utenti viene modificato almeno un attributo di Active Directory ogni settimana.  <br/> |
|Gruppi di distribuzione di Active Directory  <br/> |Si parte dal presupposto che il numero di gruppi di distribuzione di Active Directory nell'organizzazione sia pari a tre volte il numero di tutti gli utenti in Active Directory. Le dimensioni dei gruppi di distribuzione sono le seguenti:  <br/> • 64% hanno 2-30 utenti  <br/> • 13% con 31-50 utenti  <br/> • 10% con 51-100 utenti  <br/> • 13% con 101-500 utenti  <br/> |
|Utenti di VoIP (Voice over IP)  <br/> |60% degli utenti di Skype for Business Server sono abilitati per le comunicazioni unificate (ovvero i loro numeri di telefono sono di proprietà di Skype for Business Server).  <br/> |
|Distribuzione dei client registrati  <br/> |il 65% dei client esegue il software Skype for business, tra cui Skype for business e Lync Phone Edition.  <br/> 30% dei client che eseguono il software client da una versione precedente di Lync.  <br/> 5% di client che utilizzano Skype for Business Web App.  <br/> Se la mobilità è abilitata, si presuppone che il 40% degli utenti utilizzi la mobilità contemporaneamente alle altre opzioni client registrate precedentemente citate. In questo caso, il rapporto più punti di presenza del client (MPOP) è 1:1.9. Se l'utilizzo dei dispositivi mobili è disabilitato, il rapporto MPOP invece è pari a 1:1,5.  <br/> |
|Distribuzione degli utenti remoti  <br/> |Il 70% degli utenti si connette internamente.  <br/> il 30% degli utenti che si connettono tramite un server perimetrale (è possibile anche avere un Director qui, ma non è obbligatorio).  <br/> |
|Distribuzione dei contatti  <br/> |Il numero massimo di contatti di cui può disporre un utente è 1.000. Meno dell'1% degli utenti dispone di 1.000 contatti. Meno del 25% degli utenti dispone di 100 o più contatti.  <br/> Media di 80 contatti per gli utenti con connettività a cloud pubblici. Di questi utenti:  <br/> • 50% dei contatti sono all'interno dell'organizzazione. Il 10% di questi utenti è rappresentato da utenti remoti che si connettono dall'esterno del firewall.  <br/> • 40% dei contatti sono utenti Skype.  <br/> • il 10% dei contatti proviene da partner federati.  <br/> Media di 50 contatti per gli utenti senza connettività a cloud pubblici. Di questi utenti:  <br/> • 80% dei contatti sono all'interno dell'organizzazione. Il 10% di questi utenti è rappresentato da utenti remoti che si connettono dall'esterno del firewall.  <br/> • il 20% dei contatti proviene da partner federati.  <br/> Ogni utente dispone di un gruppo di distribuzione nell'elenco contatti. Per i test delle prestazioni, si presuppone che i gruppi di distribuzione siano sempre espansi.  <br/> |
...
|**Categoria**|**Descrizione**|
|:-----|:-----|
|Sessioni di messaggistica istantanea peer-to-peer  <br/> |Ogni utente esegue in media sei sessioni di messaggistica istantanea peer-to-peer al giorno.  <br/> 10 messaggi istantanei per sessione.  <br/> Ogni messaggio è associato a due messaggi di informazioni SIP e 2 messaggi SIP 200 OK (per gli indicatori di stato, ad esempio " \<Name\> sta digitando")  <br/> |
|Sessioni di messaggistica istantanea di gruppo  <br/> |Il numero medio di messaggi inviati in una sessione di messaggistica istantanea di gruppo è pari a 5 per utente.  <br/> Il numero medio di messaggi inviati nella parte di messaggistica istantanea di una conferenza AV è 2 per utente.  <br/> |
|Polling della presenza  <br/> |In generale, si presuppongono 60 polling di presenza per utente all'ora. Per ogni utente si presuppone una media di:  <br/> • Un sondaggio giornaliero per la presenza di utenti nella scheda organizzazione dell'utente (ma non nell'elenco contatti). Il numero medio di non contatti nella scheda organizzazione dell'utente è di 15 utenti. Due operazioni di visualizzazione di schede contatto al giorno.  <br/> • Un sondaggio di presenza ogni volta che l'utente fa clic su un altro utente per avviare una conversazione, stimata in una volta all'ora.  <br/> • Sei ricerche utente all'ora. Ogni volta che viene eseguita una ricerca, viene inviato un sondaggio batch per tutti gli utenti nell'elenco dei risultati di ricerca. Si presuppone che la dimensione media dei risultati di ricerca sia 20. Se i risultati della ricerca restano sullo schermo, il sondaggio batch viene aggiornato ogni 5 minuti. si presuppone che siano presenti due aggiornamenti all'ora.  <br/> • Quando l'utente apre o Visualizza un messaggio di posta elettronica in Outlook, viene visualizzato un sondaggio relativo alla presenza di utenti nei campi a: e CC: del messaggio di posta elettronica, stimato in cinque messaggi all'ora e quattro utenti per ogni messaggio di posta elettronica.  <br/> |
|Sottoscrizioni della presenza  <br/> |Quando un utente ne aggiunge un altro come contatto, il primo utente sottoscrive cinque categorie di informazioni sul secondo utente. Gli aggiornamenti di queste categorie di informazioni vengono inviati automaticamente al primo utente. <br/> Per ogni client, viene inviata una singola richiesta di sottoscrizione batch per ottenere lo stato di presenza di una media di 40 contatti, con ulteriori 40 finestre di dialogo per ottenere la presenza dei contatti federati.  <br/> Le informazioni sulla presenza per i membri di un gruppo di distribuzione espanso vengono trovate mediante sottoscrizioni della presenza persistenti e non mediante il polling. Il modello prevede un'espansione per utente ogni due ore.  <br/> Gli abbonamenti brevi si verificano quando un utente esegue l'accesso, vi è una sottoscrizione batch per tutti i contatti dell'utente e quindi l'utente si disconnette rapidamente. Si presuppongono sei sottoscrizioni brevi per utente all'ora, ognuna della durata di 10 minuti. <br/> |
...
|**Categoria**|**Descrizione**|
|:-----|:-----|
|Riunioni pianificate e riunioni immediate  <br/> |60% pianificate, 40% non pianificate.  <br/> Delle riunioni pianificate, si presuppone che 80% siano assegnate a conferenze, ovvero occorrenze di conferenze ricorrenti; 10% sono riunioni aperte una tantum; 8% sono riunioni anonime una tantum e 2% sono riunioni chiuse una tantum.  <br/> |
|Distribuzione dei client per i servizi di conferenza  <br/> |Per le riunioni pianificate:  <br/> • 65% di utenti di conferenze utilizzano Skype for business 2016.  <br/> • il 5% degli utenti delle conferenze utilizza Skype for Business Web App.  <br/> • 30% di utenti di conferenze utilizzano client precedenti, tra cui Lync 2013 e Microsoft Lync 2010.  <br/> Per le riunioni non pianificate:  <br/> • 70% di utenti di servizi di conferenza utilizzano Skype for business.  <br/> • 30% di utenti di conferenze utilizzano client precedenti, tra cui Lync 2013 e Microsoft Lync 2010.  <br/> |
...
|Combinazioni multimediali per le conferenze  <br/> |Il 75% delle conferenze è rappresentato da conferenze Web, che includono funzionalità audio e altre modalità di collaborazione.  <br/> Per queste conferenze, gli altri metodi di collaborazione sono i seguenti:  <br/> **Nota:** Questi numeri aggiungono fino a più di 100% perché una conferenza può disporre di più metodi di collaborazione. <br/> • 50% aggiungere la condivisione di applicazioni. Si presuppone che un utente invii dati fino a un massimo di 1,1 MB al secondo.  <br/> • 50% aggiunge la messaggistica istantanea (con una media di 2 messaggi per utente).  <br/> • 20% Aggiungi collaborazione dati, tra cui PowerPoint o lavagna, una media di 2 file di PowerPoint presentati per conferenza, con una media di file di PowerPoint di 10 MB (senza video incorporato) o 30 MB (con video incorporato). Media di 20 annotazioni per lavagna.  <br/> • 20% Aggiungi video. Di questi utenti, il 70% partecipa a conferenze abilitate per il video multiview, in cui ogni utente riceve 2-3 flussi video.  <br/> • 15% aggiungere note condivise.  <br/> |
...
|Criteri vocali  <br/> |Si presuppone che esista un criterio globale e 2 criteri di tag per sito. il 100% dei siti dispone di un criterio sito e il 30% degli utenti ha un criterio per utente assegnato. Si presuppone un dial plan per sito e due route per sito.  <br/> |
...
- 60% di utenti sono abilitati per VoIP aziendale e il 60% di questi utenti è abilitato per le chiamate PSTN.
