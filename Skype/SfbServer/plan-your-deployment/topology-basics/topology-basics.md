...
- Monitoraggio. Usato per supportare la raccolta dei dati per audio/video (A/V) Qualità dell'esperienza (QoE) e registrazione dettagli chiamata (CDR) per le conferenze VoIP aziendale e audio/video nella distribuzione. Ne parleremo in dettaglio nell'argomento Planning for Monitoring.
