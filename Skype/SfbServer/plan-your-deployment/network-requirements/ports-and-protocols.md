...
> [!NOTE]
> Quando Skype for Business Server viene avviato, apre le porte necessarie nel firewall Windows firewall. Windows Il firewall dovrebbe essere già in esecuzione nella maggior parte delle applicazioni normali, ma se non viene utilizzato Skype for Business Server funzionerà senza di esso. 
