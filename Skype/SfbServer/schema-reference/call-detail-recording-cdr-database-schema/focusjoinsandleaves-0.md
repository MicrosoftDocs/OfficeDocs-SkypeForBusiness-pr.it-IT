...
|**UserTenant** <br/> |nvarchar (256)  <br/> |Tenant dell'utente le cui informazioni di partecipazione o uscita da una conferenza sono state acquisite. Per ulteriori informazioni, vedere la [tabella tenant](tenants.md) . <br/> |
...
|**UserClientType** <br/> |int  <br/> |Client usato dall'utente le cui informazioni di partecipazione o uscita da una conferenza sono state acquisite. Per ulteriori informazioni, vedere [UserAgentDef Table](useragentdef.md) . <br/> |
...
|**IsuserInternal** <br/> |po'  <br/> |Bit che determina se l'utente è interno o meno.  <br/> |
