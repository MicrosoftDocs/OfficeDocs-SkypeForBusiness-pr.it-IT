...
Gli amministratori devono considerare la tabella PurgeSettings di sola lettura: le modifiche alle impostazioni di eliminazione dei dettagli delle chiamate devono essere apportate solo utilizzando i cmdlet [New-CsCdrConfiguration](https://docs.microsoft.com/powershell/module/skype/new-cscdrconfiguration?view=skype-ps) o [Set-CsCdrConfiguration.](https://docs.microsoft.com/powershell/module/skype/set-cscdrconfiguration?view=skype-ps)
...
|**KeepCallDetailForDays** <br/> |int  <br/> ||Specifica la validità dei record cdR (in giorni) che verranno eliminati dal database: se l'eliminazione è abilitata, i record cdR precedenti a questo valore verranno rimossi dal database. Il valore predefinito è 60 giorni.  <br/> |
|**KeepErrorReportForDays** <br/> |int  <br/> ||Specifica il periodo di validità dei record della segnalazione errori (in giorni) che verranno eliminati dal database: se l'eliminazione è abilitata, i record di segnalazione errori precedenti a questo valore verranno rimossi dal database. Il valore predefinito è 60 giorni.  <br/> |
