...
|**UserTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente che ha effettuato la registrazione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
