...
|**UserUriType** <br/> |nvarchar(256)  <br/> |Tipo di URI dell'utente che ha effettuato la registrazione. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
