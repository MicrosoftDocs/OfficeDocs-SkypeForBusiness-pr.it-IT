...
|**FromTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente che ha dato origine all'errore. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
...
|**ToTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente di destinazione della segnalazione errori. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
