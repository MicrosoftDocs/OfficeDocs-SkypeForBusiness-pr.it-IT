...
|:-----|:-----|:-----|
|**SessionIdTime** <br/> |datetime  <br/> |Ora della richiesta di sessione. Valore usato in combinazione con SessionIdSeq per identificare in modo univoco una sessione. Per ulteriori informazioni, vedere la tabella [Dialogs in Skype for Business Server 2015](dialogs.md) Table. <br/> |
...
|**FromUriType** <br/> |nvarchar(256)  <br/> |Tipo di URI dell'utente che ha avviato la sessione. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
|**ToUriType** <br/> |nvarchar(256)  <br/> |Tipo di URI dell'utente che si è unito alla sessione. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
...
|**TargetUriType** <br/> |nvarchar(450)  <br/> |Tipo di URI dell'utente di destinazione della sessione. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
|**OnBehalfOfUri** <br/> |nvarchar(450)  <br/> |URI dell'utente per conto del quale è stata avviata la sessione.  <br/> |
|**OnnnBehalfOfUriType** <br/> |nvarchar(256)  <br/> |Tipo di URI dell'utente per conto del quale è stata avviata la sessione. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
