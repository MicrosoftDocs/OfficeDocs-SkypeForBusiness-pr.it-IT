...
|**FromTenant** <br/> |nvarchar(450)  <br/> |Tenant dell'utente che ha avviato la sessione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
|**ToTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente che si è unito alla sessione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
...
|**OnBehalfOfTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente per conto del quale è stata avviata la sessione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
...
|**ReferredByTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente che ha fatto riferimento alla sessione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
