...
Ogni record rappresenta una sessione peer-to-peer, ovvero una chiamata telefonica VoIP-VoIP, una sessione di messaggistica istantanea con due partecipanti o un altro tipo di sessione. È possibile eseguire una tabella di join con la [tabella media](media.md) per trovare i dettagli di ogni supporto coinvolto in questa sessione.
  
Si noti che i campi IsUser1IntegratedWithDeskPhone e IsUser2IntegratedWithDeskPhone sono stati eliminati dalla tabella SessionDetails utilizzata in Skype for Business Server 2015.
...
|**SessionIdSeq** <br/> |int  <br/> |Primaria, esterna  <br/> |Numero ID per identificare la sessione. Utilizzato insieme a **SessionIdTime** per identificare in modo univoco una sessione. * per altre informazioni, vedere la [tabella Dialogs in Skype for Business Server 2015](dialogs.md) . <br/> |
...
|**User1Id** <br/> |int  <br/> |Stranieri  <br/> |ID di un utente nella sessione. Per ulteriori informazioni, vedere la [tabella users](users.md) . <br/> |
|**User2Id** <br/> |int  <br/> |Stranieri  <br/> |ID dell'altro utente nella sessione. Per ulteriori informazioni, vedere la [tabella users](users.md) . <br/> |
...
|**TargetUserId** <br/> |int  <br/> |Stranieri  <br/> |URI utente di destinazione originale nella richiesta SIP. Per ulteriori informazioni, vedere la [tabella users](users.md) . <br/> |
|**SessionStartedById** <br/> |int  <br/> |Stranieri  <br/> |ID dell'utente che ha avviato la sessione. Per ulteriori informazioni, vedere la [tabella users](users.md) . <br/> |
...
|**User1ClientVerId** <br/> |int  <br/> |Stranieri  <br/> |Versione del client utilizzata da User1. Per ulteriori informazioni, vedere la [Tabella ClientVersions in Skype for Business Server 2015](clientversions.md) . <br/> |
|**User2ClientVerId** <br/> |int  <br/> |Stranieri  <br/> |Versione del client utilizzata da User2. Per ulteriori informazioni, vedere la [Tabella ClientVersions in Skype for Business Server 2015](clientversions.md) . <br/> |
|**User1EdgeServerid** <br/> |int  <br/> |Stranieri  <br/> |Server perimetrale utilizzato da User1. Per ulteriori informazioni, vedere la [tabella EdgeServers in Skype for Business Server 2015](edgeservers.md) . <br/> |
|**User2EdgeServerid** <br/> |int  <br/> |Stranieri  <br/> |Server perimetrale utilizzato da User2. Per ulteriori informazioni, vedere la [tabella EdgeServers in Skype for Business Server 2015](edgeservers.md) . <br/> |
|**IsUser1Internal** <br/> |po'  <br/> ||Indica se User1 è connesso o meno dall'interno.  <br/> |
|**IsUser2Internal** <br/> |po'  <br/> ||Indica se User2 è connesso o meno dall'interno.  <br/> |
...
|**CallPriority** <br/> |int  <br/> |Stranieri  <br/> |Priorità della chiamata. Per ulteriori informazioni, vedere la [Tabella CallPriorities in Skype for Business Server 2015](callpriorities.md) . <br/> |
...
|**Elaborati** <br/> |po'  <br/> ||Per uso interno del servizio di monitoraggio.  <br/> Questo campo è stato introdotto in Microsoft Lync Server 2013.  <br/> |
