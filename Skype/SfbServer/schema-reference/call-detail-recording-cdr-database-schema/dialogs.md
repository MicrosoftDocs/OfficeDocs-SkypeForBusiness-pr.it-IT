...
---
# <a name="dialogs-table-in-skype-for-business-server-2015"></a>Tabella Dialogs in Skype for Business Server
 
La tabella Dialogs è una tabella di supporto in cui vengono archiviate le informazioni sui DialogID per le sessioni peer-to-peer.
...
|**ExternalId** <br/> |varbinary(775)  <br/> | <br/> |ID finestra di dialogo SIP, archiviato come binario. Il formato del file binario è il seguente:  <br/> dialog;from-tag;to-tag  <br/> Questi dati possono essere convertiti in formato testo utilizzando la sintassi seguente:  <br/>  `cast(cast(ExternalId as varbinary(max)) as varchar(max))` <br/> |
