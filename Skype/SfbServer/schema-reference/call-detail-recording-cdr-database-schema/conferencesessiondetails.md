...
|**UserTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente che partecipa alla sessione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
...
|**ReferredByUriTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente che ha fatto riferimento alla sessione. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
