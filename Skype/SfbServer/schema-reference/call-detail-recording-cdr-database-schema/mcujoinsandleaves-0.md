...
|**McuUriType** <br/> |nvarchar(256)  <br/> |URI del server per le conferenze al quale l'utente è connesso. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
...
|**UserUriType** <br/> |nvarchar(256)  <br/> |Tipo di URI dell'utente le cui informazioni di accesso e abbandono relative al server per le conferenze sono state raccolte. Per altre [informazioni, vedi la tabella UriTypes.](uritypes.md) <br/> |
