...
|**UserTenant** <br/> |nvarchar(256)  <br/> |Tenant dell'utente le cui informazioni di accesso e abbandono relative al server per le conferenze sono state raccolte. Per ulteriori [informazioni, vedere la tabella Tenants](tenants.md) . <br/> |
