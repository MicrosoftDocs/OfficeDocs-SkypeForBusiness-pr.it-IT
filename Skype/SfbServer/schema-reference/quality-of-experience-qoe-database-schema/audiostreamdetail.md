...
|DialogCategory  <br/> |bit  <br/> |Categoria finestra di dialogo: 0 è il numero da Skype for Business Server a Mediation Server; 1 è il numero del gateway da Mediation Server a PSTN.  <br/> |
...
|CallerMicGlitchRate  <br/> |int  <br/> |Media di glitch per cinque minuti per l'acquisizione del microfono del chiamante. Per una buona qualità, il valore deve essere inferiore a 1 ogni 5 minuti. Questa metrica non è riportata da A/V Conferencing Server, Mediation Server o telefoni IP.  <br/> |
...
|CallerVsEntryCauses  <br/> |smallint  <br/> |La commutazione vocale è una modalità half-duplex con possibilità di interruzione ridotta. Per altre [informazioni, vedi la tabella MediaLine.](medialine-0.md) <br/> |
|CallerEchoEventCauses  <br/> |tinyint  <br/> |Cause di un evento di eco per il chiamante. Per altre [informazioni, vedi la tabella MediaLine.](medialine-0.md) <br/> |
...
|CallerEchoPercentSend  <br/> |decimal(5,2)  <br/> |Percentuale di tempo in cui viene rilevata l'eco nel flusso inviato del chiamante. Un'elevata percentuale di eco nei flussi di invio è un'indicazione della perdita di eco.  <br/> |
|CallerRxAGCSignalLevel  <br/> |int  <br/> |Livello di segnale ricevuto nel Mediation Server dal gateway per l'audio del chiamante; ciò si applica solo al Mediation Server. L'unità di misura per questa metrica è dBoV. Per una buona qualità, l'intervallo accettabile deve essere compreso tra -30 e -18 dBoV.  <br/> |
...
|CallerRxAGCGain  <br/> |int  <br/> |Controllo guadagno automatico sul lato Mediation Server applicato all'audio del chiamante.  <br/> |
...
|CalleeSpeakerGlitchRate  <br/> |int  <br/> |Glitch medi per cinque minuti per il rendering dell'altoparlante del chiamato. Per una buona qualità, il valore deve essere inferiore a 1 ogni 5 minuti. Questa metrica non è riportata da A/V Conferencing Server, Mediation Server o telefoni IP.  <br/> |
|CalleeMicGlitchRate  <br/> |int  <br/> |Glitch medi per cinque minuti per l'acquisizione del microfono del chiamato. Per una buona qualità, il valore deve essere inferiore a 1 ogni 5 minuti. Questa metrica non è riportata da A/V Conferencing Server, Mediation Server o telefoni IP.  <br/> |
|CalleeTimestampDriftRateMic  <br/> |decimal(9,2)  <br/> |Frequenza di deriva del clock del dispositivo del microfono del chiamato, rispetto al clock della CPU.  <br/> |
...
|CalleeVsEntryCauses  <br/> |smallint  <br/> |La commutazione vocale è una modalità half-duplex con possibilità di interruzione ridotta. Per altre [informazioni, vedi la tabella MediaLine.](medialine-0.md) <br/> |
|CalleeEchoEventCauses  <br/> |tinyint  <br/> |Cause di un evento di eco per il destinatario della chiamata. Per altre [informazioni, vedi la tabella MediaLine.](medialine-0.md) <br/> |
...
|CalleeEchoPercentSend  <br/> |decimal(5,2)  <br/> |Percentuale di tempo in cui viene rilevata l'eco nel flusso inviato del chiamato. Un'elevata percentuale di eco nei flussi di invio è un'indicazione della perdita di eco.  <br/> |
|CalleeRxAGCSignalLevel  <br/> |int  <br/> |Livello di segnale ricevuto nel Mediation Server dal gateway per l'audio del chiamato; ciò si applica solo al Mediation Server. L'unità di misura per questa metrica è dBoV. Per una buona qualità, l'intervallo accettabile deve essere compreso tra [-30 e -18] dBoV.  <br/> |
...
|CalleeRxAGCGain  <br/> |int  <br/> |Controllo guadagno automatico sul lato Mediation Server applicato all'audio del chiamato.  <br/> |
