...
|DialogCategory  <br/> |bit  <br/> |Categoria finestra di dialogo: 0 è il Skype for Business Server del Mediation Server, 1 è il passaggio da Mediation Server a gateway PSTN.  <br/> |
...
|CallerUserAgentType  <br/> |smallint  <br/> |Tipo dell'agente utente del chiamante. Per informazioni [dettagliate, vedere la tabella UserAgent](useragent.md) . <br/> |
