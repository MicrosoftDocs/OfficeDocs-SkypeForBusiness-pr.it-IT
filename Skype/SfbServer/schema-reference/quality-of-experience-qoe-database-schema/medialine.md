...
|CallerInside  <br/> |po'  <br/> |Indica se il chiamante si trova nella rete dell'organizzazione. 1 significa che il chiamante è all'interno della rete dell'organizzazione. 0 significa che il chiamante è all'esterno della rete dell'organizzazione.  <br/> |
...
|CallerReflexiveIPAddr  <br/> |var (50)  <br/> |Indirizzo IP del chiamante, come indicato dal servizio A/V Edge. Questo indirizzo può essere diverso rispetto al CallerIPAddr se il client si trova dietro un sistema NAT, ad esempio.  <br/> |
...
|CalleeNetworkConnectionDetail  <br/> |varchar (256)  <br/> |Informazioni dettagliate sulla connessione di rete del chiamante. Per ulteriori informazioni, vedere la [tabella NetworkConnectionDetail](networkconnectiondetail.md) . <br/> |
|CallerBssid  <br/> |varchar (256)  <br/> |BSSI (Basic Service Set Identifier) utilizzato dalla connessione WiFi del chiamante.  <br/> |
|CallerVPN  <br/> |po'  <br/> |Indica se il chiamante ha eseguito la connessione su una rete privata virtuale. 1 indica una VPN, 0 indica una rete non VPN.  <br/> |
...
|CalleeInside  <br/> |po'  <br/> |Indica se il destinatario della chiamata si trova all'interno della rete aziendale. 1 indica che il destinatario della chiamata è all'interno della rete aziendale, mentre 0 indica che è all'esterno della rete.  <br/> |
...
|CalleeCaptureDev  <br/> |var (50)  <br/> |Nome del dispositivo di acquisizione del destinatario della chiamata.  <br/> |
...
|CalleeWifiDriverDeviceDesc  <br/> |varchar (256)  <br/> |Descrizione del driver WiFi del destinatario della chiamata.  <br/> |
|CalleeWifiDriverVersion  <br/> |varchar (256  <br/> |Versione del driver WiFi del destinatario della chiamata.  <br/> |
|CalleeNetworkConnectionDetail  <br/> |varchar (256)  <br/> |Informazioni dettagliate sulla connessione di rete del destinatario della chiamata. Per ulteriori informazioni, vedere la [tabella NetworkConnectionDetail](networkconnectiondetail.md) . <br/> |
|CalleeBssid  <br/> |varchar (256)  <br/> |Identificatore del set di servizi di base utilizzato dalla connessione WiFi del destinatario della chiamata.  <br/> |
|CalleeVPN  <br/> |po'  <br/> |Indica se il destinatario della chiamata ha eseguito la connessione su una rete privata virtuale. 1 indica una VPN, 0 indica una rete non VPN.  <br/> |
...
|AppliedBandwidthSource  <br/> |varchar (256)  <br/> |Origine del limite della larghezza di banda imposto. In questo articolo viene descritto il percorso del limite di larghezza di banda, ad esempio "server criteri", "Attiva server" o "modalità".  <br/> |
|Chiamante  <br/> |po'  <br/> |Indica se è stata ricevuta la metrica del chiamante. 1 indica sì e 0 indica no.  <br/> |
|Destinatario chiamata  <br/> |po'  <br/> |Indica se è stata ricevuta la metrica del destinatario della chiamata. 1 indica sì e 0 indica no.  <br/> |
|MidCallReport  <br/> |po'  <br/> |Indica se il report riguarda una parte della chiamata o l'intera chiamata.  <br/> |
|ClassifiedPoorCall  <br/> |po'  <br/> |Indica se una chiamata è stata classificata come di livello insufficiente (1) o buono (0).  <br/> |
