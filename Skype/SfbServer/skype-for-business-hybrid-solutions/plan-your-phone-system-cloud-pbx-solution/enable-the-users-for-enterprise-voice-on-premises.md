...
- Se un utente è già abilitato per Skype for Business locale, ma non è stato abilitato per VoIP aziendale o ha assegnato un LineURI prima di essere spostato in Skype for Business Online, eseguire il cmdlet seguente per ogni utente:
