...
Una chiamata in ingresso dalla rete PSTN utilizza lo stesso percorso di segnalazione nella direzione inversa. Per gli utenti interni, i supporti verranno comunque in ultima analisi fluire tra il client Skype for Business e cloud Connector Mediation Server e quindi il servizio SBC o il gateway.
...
4. Il gateway centrale di Amsterdam prende le decisioni di routing appropriate e quindi invia il traffico a un SBC o a un gateway a Zurigo, mentre i supporti fluino direttamente tra il client Skype for Business e SBC o il gateway di Amsterdam.
