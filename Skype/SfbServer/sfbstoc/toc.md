...
### [Pianificare Sistema telefonico connettività PSTN in locale](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/plan-phone-system-with-on-premises-pstn-connectivity.md)
...
#### [Abilitare gli utenti per VoIP aziendale online e Sistema telefonico nella segreteria telefonica di Office 365](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/enable-users-for-enterprise-voice-online-and-phone-system-voicemail.md)
...
#### [Configurare l'integrazione Cloud Connector con il tenant di Office 365](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/configure-cloud-connector-integration-with-your-office-365-tenant.md)
...
#### [Clienti riunioni](../plan-your-deployment/clients-and-devices/meetings-clients.md)
...
####### [Gestire le posizioni](../plan-your-deployment/enterprise-voice-solution/manage-locations.md)
####### [Gateway ELIN](../plan-your-deployment/enterprise-voice-solution/elin-gateways.md)
####### [Acquisizione manuale di una posizione](../plan-your-deployment/enterprise-voice-solution/manually-acquiring-a-location.md)
...
####### [Criteri di posizione](../plan-your-deployment/enterprise-voice-solution/location-policies.md)
####### [Ambito criteri di posizione](../plan-your-deployment/enterprise-voice-solution/location-policy-scope.md)
###### [Numeri di emergenza multipli](../plan-your-deployment/enterprise-voice-solution/multiple-emergency-numbers.md)
...
##### [Routing basato sulla posizione](../plan-your-deployment/enterprise-voice-solution/location-based-routing.md)
...
#### [Preparazione di Active Directory](../deploy/install/prepare-active-directory.md)
...
###### [Creare route tra aree di rete](../deploy/deploy-enterprise-voice/create-network-interregional-routes.md)
...
###### [Creare criteri di posizione](../deploy/deploy-enterprise-voice/create-location-policies.md)
###### [Aggiungere un criterio di posizione a un sito di rete](../deploy/deploy-enterprise-voice/add-a-location-policy-to-a-network-site.md)
###### [Configurare il database delle posizioni](../deploy/deploy-enterprise-voice/configure-the-location-database.md)
###### [Configurare un'applicazione SNMP](../deploy/deploy-enterprise-voice/configure-an-snmp-application.md)
###### [Servizio di informazione sulla posizione secondario](../deploy/deploy-enterprise-voice/secondary-location-information-service.md)
...
##### [Processo di distribuzione per il parcheggio di chiamata](../deploy/deploy-enterprise-voice/deployment-process-for-call-park.md)
###### [Creare o modificare un intervallo di codice orbit del parcheggio di chiamata](../deploy/deploy-enterprise-voice/create-or-modify-a-call-park-orbit-range.md)
###### [Configurare le impostazioni del parcheggio di chiamata](../deploy/deploy-enterprise-voice/configure-call-park-settings.md)
###### [Personalizzare la musica di attesa del parcheggio di chiamata](../deploy/deploy-enterprise-voice/customize-call-park-music-on-hold.md)
###### [Abilitare il parcheggio di chiamata per gli utenti](../deploy/deploy-enterprise-voice/enable-call-park-for-users.md)
###### [Verificare le regole di normalizzazione per il parcheggio di chiamata](../deploy/deploy-enterprise-voice/verify-normalization-rules-for-call-park.md)
###### [Verificare la distribuzione del parcheggio di chiamata (facoltativo)](../deploy/deploy-enterprise-voice/optional-verify-call-park-deployment.md)
...
#### [Monitoraggio e report](../manage/health-and-monitoring/monitoring-reports.md)
...
####### [Rapporto di messaggistica istantanea](../manage/health-and-monitoring/im-report.md)
...
####### [Rapporto dettagli](../manage/health-and-monitoring/detail-report.md)
...
###### [Rapporto inventario telefoni IP](../manage/health-and-monitoring/ip-phone-inventory-report.md)
...
##### [Report di diagnostica chiamate (per utente)](../manage/health-and-monitoring/call-diagnostic-reports-per-user.md)
##### [Report di diagnostica chiamate](../manage/health-and-monitoring/call-diagnostic-reports.md)
###### [Report di riepilogo](../manage/health-and-monitoring/summary-report.md)
####### [Sottoreport di riepilogo sulle conferenze](../manage/health-and-monitoring/conference-summary-subreport.md)
####### [Sottoreport di riepilogo P2P](../manage/health-and-monitoring/p2p-summary-subreport.md)
###### [Report di diagnostica sulle attività peer-to-peer](../manage/health-and-monitoring/peer-to-peer-activity-diagnostic-report.md)
###### [Report di diagnostica conferenze](../manage/health-and-monitoring/conference-diagnostic-report.md)
###### [Report errori principali](../manage/health-and-monitoring/top-failures-report.md)
###### [Report di distribuzione errori](../manage/health-and-monitoring/failure-distribution-report.md)
###### [Report di elenco errori](../manage/health-and-monitoring/failure-list-report.md)
###### [Report di diagnostica](../manage/health-and-monitoring/diagnostic-report.md)
##### [Report di diagnostica della qualità dei contenuti multimediali](../manage/health-and-monitoring/media-quality-diagnostic-reports.md)
...
###### [Report posizioni](../manage/health-and-monitoring/location-report.md)
###### [Report dispositivi](../manage/health-and-monitoring/device-report.md)
###### [Report elenco chiamate](../manage/health-and-monitoring/call-list-report-0.md)
###### [Report dettagliato sulle chiamate](../manage/health-and-monitoring/call-detail-report.md)
...
##### [Abilitare oppure disabilitare](../manage/conferencing/enable-or-disable.md)
...
##### [Directory](../manage/conferencing/directories.md)
