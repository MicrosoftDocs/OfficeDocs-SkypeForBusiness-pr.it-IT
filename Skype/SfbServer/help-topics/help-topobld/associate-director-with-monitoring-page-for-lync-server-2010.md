...
Per configurare un Monitoring Server e associarlo al server Director o al pool di server Director:
 ...
 **Fine**: esegue il commit delle modifiche e completa la procedura guidata.
  
 **Annulla**: rimuove le modifiche e annulla la configurazione.
  
 **?**: visualizza le informazioni della Guida, come questo argomento.
