...
Fare **clic su** Nuovo per definire una nuova SQL Server di controllo facoltativamente un'istanza per il backup di Persistent Chat SQL Server di mirroring.
