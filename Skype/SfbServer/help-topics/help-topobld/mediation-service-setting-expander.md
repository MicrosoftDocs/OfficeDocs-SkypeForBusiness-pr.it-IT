...
ms.locfileid: "41819578"
---
# <a name="mediation-service-setting-expander"></a>Espansione delle impostazioni del servizio Mediation
 
Usare questa pagina per impostare le porte in ascolto per il Mediation Server e impostare le relative associazioni con i gateway PSTN (Public Switched Telephone Network). 
