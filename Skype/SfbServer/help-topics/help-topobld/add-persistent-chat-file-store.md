...
> [!IMPORTANT]
> La condivisione file per Skype for Business Server non può essere posizionata nel Front End Server Enterprise Edition, ma può trovarsi in un server Standard Edition. 
