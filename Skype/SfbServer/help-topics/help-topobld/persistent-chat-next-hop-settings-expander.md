...
description: Per configurare il pool dell'hop successivo di Persistent Chat, selezionare un Front End Server o un pool Front End nell'elenco.
...
Per configurare il **pool dell'hop** successivo di Persistent Chat, selezionare un Front End Server o un pool Front End nell'elenco.
