...
Fare **clic** su Avanti dopo aver immesso le opzioni per la configurazione dell SQL Server store del pool e per procedere con la definizione del pool del server Chat persistente.
