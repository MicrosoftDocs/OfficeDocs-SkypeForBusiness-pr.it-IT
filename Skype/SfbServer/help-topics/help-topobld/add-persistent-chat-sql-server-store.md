...
Selezionare nell'elenco **Mirroring SQL Server archiviare** un'SQL Server e un'istanza facoltativa per agire come mirror SQL Server per il SQL Server persistente.
...
Fare **clic su** Nuovo per definire una nuova SQL Server di controllo facoltativamente un'istanza per il controllo del mirroring SQL Server chat persistente.
