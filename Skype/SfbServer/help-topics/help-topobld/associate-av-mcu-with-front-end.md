...
---
# <a name="associate-av-mcu-with-front-end"></a><span data-ttu-id="e93d5-104">Associare AV MCU con Front End</span><span class="sxs-lookup"><span data-stu-id="e93d5-104">Associate AV MCU With Front End</span></span>
 
<span data-ttu-id="e93d5-105">Tutti i pool di front end Enterprise Edition con i servizi di conferenza abilitati devono disporre di un servizio di conferenza A/V collocato oppure utilizzare un pool di conferenze A/V autonomo.</span><span class="sxs-lookup"><span data-stu-id="e93d5-105">All Enterprise Edition Front End pools with Conferencing enabled must have an A/V Conferencing service collocated, or must use a stand-alone A/V Conferencing pool.</span></span> <span data-ttu-id="e93d5-106">Tutti i pool di front end Enterprise Edition esistenti che dispongono attualmente di un servizio di conferenza A/V possono essere selezionati per l'uso di questo nuovo pool di servizi di conferenza A/V autonomo.</span><span class="sxs-lookup"><span data-stu-id="e93d5-106">Any existing Enterprise Edition Front End pools that currently have an A/V Conferencing service collocated may be selected to use this new stand-alone A/V Conferencing pool instead.</span></span>
