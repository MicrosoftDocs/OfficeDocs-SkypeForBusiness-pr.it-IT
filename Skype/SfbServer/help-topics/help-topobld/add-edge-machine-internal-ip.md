...
---
# <a name="add-edge-machine-internal-ip"></a>Aggiungere IP interni al computer Edge

Usare questa pagina per specificare l'indirizzo IP interno e il nome di dominio completo interno (FQDN) per il server perimetrale.
