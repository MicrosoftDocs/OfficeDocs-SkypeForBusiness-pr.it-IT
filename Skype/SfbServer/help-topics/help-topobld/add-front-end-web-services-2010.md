...
Non è possibile sostituire il nome di dominio completo (FQDN) del pool di servizi Web interno per un edizione Standard Server. Se si configura il bilanciamento del carico DNS (Domain Name System) per un pool Front End di edizione Enterprise, è possibile specificare un URL di base interno diverso da quello del pool e può essere, ad esempio, internal- \<your base URL\> .
