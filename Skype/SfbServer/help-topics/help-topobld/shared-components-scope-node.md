...
Selezionare **Nuovo** per creare un nuovo archivio file, un nuovo gateway IP/PSTN, un nuovo server Office Web Apps, un nuovo archivio SQL Server o un nuovo trunk.
