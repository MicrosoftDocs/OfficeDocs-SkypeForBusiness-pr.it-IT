...
È inoltre possibile scegliere di associare questo server perimetrale o pool di server perimetrali a Mediation Server o pool Mediation Server per configurare e abilitare la VoIP aziendale per gli utenti esterni.
