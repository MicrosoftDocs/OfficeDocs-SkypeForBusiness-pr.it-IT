...
La funzionalità per dispositivi mobili di Skype for Business Server 2015 supporta le funzionalità di Skype for business su un dispositivo mobile.
  
La funzionalità di mobilità è identica a quella di Lync Server 2013. Per ulteriori informazioni sulla preparazione dell'ambiente per la mobilità, vedere [Planning for Mobility in Lync Server 2013](https://technet.microsoft.com/library/hh689981%28v=ocs.15%29.aspx).
