...
2. Nella pagina **Prepara foresta** fare clic su **Avanti**.
    ...
    > [!NOTE]
    > La preparazione della foresta consente di scegliere dove collocare i gruppi universali per Skype for Business Server. Scegliere una posizione conforme ai requisiti dell'organizzazione.
