...
ms.locfileid: "41796957"
---
# <a name="deployment-wizard-admin-tools"></a><span data-ttu-id="175c3-103">Distribuzione guidata: Strumenti di amministrazione</span><span class="sxs-lookup"><span data-stu-id="175c3-103">Deployment Wizard: Admin Tools</span></span>
 
<span data-ttu-id="175c3-104">Per informazioni dettagliate sull'uso della distribuzione guidata per installare Skype for Business Server, vedere [installare Skype for Business Server](../../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="175c3-104">For details about using Deployment Wizard to install Skype for Business Server, see [Install Skype for Business Server](../../../deploy/install/install.md).</span></span>
