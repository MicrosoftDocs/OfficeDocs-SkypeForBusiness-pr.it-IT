...
> [!NOTE]
> L'installazione del SQL Server locale può richiedere del tempo. Gli aggiornamenti non verranno visualizzati nella schermata di riepilogo dell'installazione SQL Server durante l'installazione. Se si desidera monitorare l'avanzamento dell'installazione, utilizzare Task Manager per controllare l'SQL Server installazione.