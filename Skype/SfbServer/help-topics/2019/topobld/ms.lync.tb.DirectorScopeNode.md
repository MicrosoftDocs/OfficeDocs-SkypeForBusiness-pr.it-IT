...
- **Nuovo server**. Consente di caricare la pagina **Definisci nuovo server**, che può essere usata per aggiungere un altro server Director al pool.
    
- **Modifica proprietà**. Consente di aprire la pagina **Modifica proprietà** per il server, in cui è possibile modificare l'FQDN, le porte e l'archivio file associato per il pool di server Director.
