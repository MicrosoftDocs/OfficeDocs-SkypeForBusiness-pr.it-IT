...
---
# <a name="add-front-end-file-store"></a><span data-ttu-id="072cd-104">Aggiungere l'archivio file per Front End Server</span><span class="sxs-lookup"><span data-stu-id="072cd-104">Add Front End File Store</span></span>
...
> [!IMPORTANT]
> <span data-ttu-id="072cd-107">La condivisione file non può essere posizionata nel server Enterprise Edition Front End Server, ma può essere posizionata in un server Standard Edition.</span><span class="sxs-lookup"><span data-stu-id="072cd-107">The file share cannot be located on the Enterprise Edition Front End Server, but can be located on a Standard Edition server.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="072cd-108">È possibile definire la condivisione file in Generatore di topologie prima di crearla, ma è necessario crearla nel percorso definito prima di pubblicare la topologia.</span><span class="sxs-lookup"><span data-stu-id="072cd-108">You can define the file share in Topology Builder before you create the file share, but you must create the file share in the defined location you define before you publish the topology.</span></span>
