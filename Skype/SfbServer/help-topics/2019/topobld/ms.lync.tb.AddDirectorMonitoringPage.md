...
- Se è stato selezionato Abilita **mirroring** SQL Server archivio , facoltativamente selezionare Usa controllo **del mirroring** SQL Server per abilitare il failover automatico per selezionare un archivio di controllo del mirroring SQL Server dall'elenco.
