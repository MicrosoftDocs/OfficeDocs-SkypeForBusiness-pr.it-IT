...
- **Monitoraggio di SQL Server Store**: selezionare un nome di dominio completo di SQL Server (e facoltativamente un'istanza) nell'elenco.
...
[Associare un archivio di monitoraggio a un pool di front-end in Skype for Business Server](../../../deploy/deploy-monitoring/associate-a-monitoring-store.md)
