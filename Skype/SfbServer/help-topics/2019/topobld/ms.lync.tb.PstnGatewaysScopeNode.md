...
- **Nuovo gateway IP/PSTN**. Consente di avviare la procedura guidata **Definisci nuovo gateway IP/PSTN**, che può essere usata per aggiungere alla topologia un nuovo gateway PSTN.
