...
ms.locfileid: "49811486"
---
# <a name="associate-av-mcu-with-front-end"></a><span data-ttu-id="51b0a-104">Associare MCU AV a front-end</span><span class="sxs-lookup"><span data-stu-id="51b0a-104">Associate AV MCU With Front End</span></span>
 
<span data-ttu-id="51b0a-p102">Tutti i pool Enterprise Edition Front End con la funzionalità di conferenza abilitata devono disporre di un servizio A/V Conferencing collocato o devono usare un pool A/V Conferencing autonomo. Tutti i pool Enterprise Edition Front End esistenti che attualmente dispongono di un servizio A/V Conferencing collocato possono invece essere selezionati per usare questo nuovo pool A/V Conferencing autonomo.</span><span class="sxs-lookup"><span data-stu-id="51b0a-p102">All Enterprise Edition Front End pools with Conferencing enabled must have an A/V Conferencing service collocated, or must use a stand-alone A/V Conferencing pool. Any existing Enterprise Edition Front End pools that currently have an A/V Conferencing service collocated may be selected to use this new stand-alone A/V Conferencing pool instead.</span></span>
