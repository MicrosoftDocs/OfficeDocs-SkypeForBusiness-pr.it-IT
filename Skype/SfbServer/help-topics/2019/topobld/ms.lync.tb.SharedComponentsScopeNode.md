...
Selezionare **Nuovo** per creare un nuovo archivio file, un nuovo gateway IP/PSTN, un nuovo Office Web Apps Server, un nuovo archivio SQL Server o un nuovo trunk.
