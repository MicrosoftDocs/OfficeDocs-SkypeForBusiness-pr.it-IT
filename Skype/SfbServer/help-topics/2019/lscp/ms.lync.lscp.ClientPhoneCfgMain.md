...
- **Nuovo** Puoi aggiungere una nuova configurazione del dispositivo con l'ambito seguente:
    
  - Globale
    
  - Sito
    
- **Modifica** Puoi modificare le opzioni di una configurazione del dispositivo nell'elenco. Usando questa voce, è possibile scegliere tra le opzioni seguenti:
