...
- **Nuovo** È possibile aggiungere una nuova configurazione del log del dispositivo con l'ambito seguente:

  - Globale

  - Sito

- **Modifica** Puoi modificare le opzioni di una configurazione del log del dispositivo nell'elenco. Usando questa voce, è possibile scegliere tra le opzioni seguenti:
  ...
  - **Seleziona tutto** Questa opzione consente di selezionare tutte le configurazioni dei log dei dispositivi nell'elenco.

  - **Elimina** Questa opzione consente di eliminare tutte le configurazioni dei log del dispositivo selezionate.

- **Aggiorna** Puoi aggiornare l'elenco di configurazioni dei log dei dispositivi per verificare lo stato delle opzioni di tutte le configurazioni dei log del dispositivo.
