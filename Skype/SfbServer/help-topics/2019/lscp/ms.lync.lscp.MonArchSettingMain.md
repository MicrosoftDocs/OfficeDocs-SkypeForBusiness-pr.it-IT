...
- Integrazione con l'archivio di Exchange, per gli utenti ospitati in Exchange
...
> [!NOTE]
> Le configurazioni di archiviazione si applicano agli utenti ospitati su Skype for Business Server e, se si utilizza Exchange per archiviare i dati di archiviazione in Microsoft Exchange, per gli utenti ospitati in Exchange, ma vengono implementati in modo leggermente diverso per gli utenti ospitati in Exchange. Le differenze sono descritte nella sezione successiva. 
