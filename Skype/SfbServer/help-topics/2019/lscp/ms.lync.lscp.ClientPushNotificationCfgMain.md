...
> [!IMPORTANT]
> Le impostazioni criteri applicate a un determinato livello di criteri possono sostituire le impostazioni applicate a un altro livello di criteri. La precedenza dei criteri è: i criteri utente (la maggior parte dell'influenza) sostituiscono i criteri del sito e quindi i criteri del sito sostituiscono i criteri globali (minore influenza). Ciò significa che maggiore è la prossimità dell'impostazione criteri all'oggetto su cui influiscono i criteri, maggiore è l'influenza su tale oggetto. 
...
2. **Modifica**: selezionare un criterio e fare clic su Modifica per selezionare un'azione dal menu a discesa. È possibile modificare solo i siti già creati o modificare il criterio Globale.
   ...
   - **Mostra dettagli...**: visualizza informazioni sui criteri attualmente selezionati. È possibile modificare solo il criterio esistente.
...
- **Commettere** L'azione di commit crea o aggiorna i criteri e salva le modifiche
