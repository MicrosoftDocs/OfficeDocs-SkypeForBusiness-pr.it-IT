...
ms.locfileid: "45189198"
---
# <a name="voice-usage-policy"></a><span data-ttu-id="76e76-103">Criteri vocali di utilizzo</span><span class="sxs-lookup"><span data-stu-id="76e76-103">Voice Usage Policy</span></span>
 
<span data-ttu-id="76e76-104">Per informazioni dettagliate sulle diverse procedure che è possibile eseguire utilizzando il pannello di controllo di Skype for Business Server, vedere gli articoli di gestione in [Skype for Business server 2019](../../../../SfBServer2019/skype-for-business-server-2019.yml).</span><span class="sxs-lookup"><span data-stu-id="76e76-104">For details about the different procedures that you can perform by using the Skype for Business Server Control Panel, see the Manage articles in [Skype for Business Server 2019](../../../../SfBServer2019/skype-for-business-server-2019.yml).</span></span>
