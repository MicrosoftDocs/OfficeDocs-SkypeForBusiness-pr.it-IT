...
- Abilitare e disabilitare le configurazioni delle versioni client esistenti.

> [!NOTE]
> Poiché gli utenti anonimi non sono associati a un sito, vengono loro applicati solo i criteri di livello globale.
