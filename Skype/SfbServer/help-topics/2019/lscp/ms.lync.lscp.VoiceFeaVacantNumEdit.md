...
- **Servizio annunci** Selezionare **Annuncio** per fare in modo che l'applicazione Annuncio gestirà la chiamata Exchange messaggistica unificata Exchange un Operatore automatico gestire la chiamata in arrivo.
