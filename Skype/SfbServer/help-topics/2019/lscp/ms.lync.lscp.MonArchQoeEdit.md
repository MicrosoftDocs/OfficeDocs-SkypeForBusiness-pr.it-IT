---
title: Dati di qualità dell'esperienza (QoE) crea nuovi o modifica esistenti
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
manager: serdars
...
ms.locfileid: "41795045"
---
# <a name="quality-of-experience-qoe-data-create-new-or-edit-existing"></a>Dati Qualità percepita dagli utenti (QoE): crearne di nuovi o modificare quelli esistenti
...
- [Creare impostazioni di configurazione della qualità delle esperienze in Skype for Business Server](../../../manage/health-and-monitoring/create-qoe-configuration-settings.md)
    
- [Eliminare le impostazioni di configurazione della qualità delle esperienze in Skype for Business Server](../../../manage/health-and-monitoring/delete-qoe-configuration-settings.md)
