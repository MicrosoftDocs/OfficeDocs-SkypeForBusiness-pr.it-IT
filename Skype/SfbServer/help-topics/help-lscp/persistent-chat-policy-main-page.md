...
Se un utente è stato abilitato per Skype for business, è possibile applicare criteri adeguati a utenti specifici per abilitarli o disabilitarli per il server Chat persistente.
