...
- **Ambito** Identifica l'ambito della configurazione riunione che si sta creando o modificando: globale, sito o pool.

- **Name** Le configurazioni riunione sono denominate per impostazione predefinita e il nome non può essere modificato.
...
- **Designazione come relatore** Selezionare la categoria di utenti (oltre all'organizzatore della riunione) che vengono designati automaticamente come relatori quando aderiscono a una conferenza. Indipendentemente da questa impostazione, i relatori possono essere designati in modo esplicito come tali quando viene pianificata la conferenza oppure possono essere promossi in modo esplicito a relatori durante la conferenza. Le opzioni sono:

  - **Nessuno** Selezionare questa opzione se nessuno diverso dall'organizzatore viene designato automaticamente come relatore.

  - **Società** Selezionare questa opzione per designare automaticamente come relatori solo i membri dell'organizzazione.
...
- **URL logo** Digitare l'URL contenente l'immagine da utilizzare per gli inviti a conferenze personalizzati.

- **URL guida** Digitare l'URL di un sito Web in cui gli utenti possono ottenere assistenza per partecipare alla conferenza.

- **URL testo legale** Digitare l'URL di un sito Web contenente le informazioni legali e le dichiarazioni di non responsabilità per la conferenza.
