...
- **Servizio annunci** Selezionare **Annuncio** per fare in modo  che l'applicazione Annuncio gestirà la chiamata Exchange messaggistica unificata Exchange un Operatore automatico di messaggistica unificata per gestire la chiamata in arrivo.
