...
- **Abilitare gli utenti** Fare clic per aprire la finestra di dialogo [Users: New Lync Server](users-new-lync-server-user.md) , in cui è possibile aggiungere un nuovo utente a Skype for Business Server.
...
- **Azione** Fare clic su **azione**, quindi selezionare l'azione che si desidera eseguire per gli utenti selezionati nei risultati della ricerca. Sono disponibili le azioni seguenti:
  ...
  - **Assegnare i criteri** Apre la finestra di dialogo [utenti: Assegna criteri](users-assign-policies.md) , in cui è possibile configurare i criteri assegnati all'utente.

  - **Visualizzazione dello stato del pin** Apre la finestra di dialogo [utenti: Visualizza stato PIN](users-view-pin-status.md) , in cui vengono visualizzati i dati del PIN per l'utente selezionato.
  ...
  - **Spostare gli utenti selezionati nel pool** Apre la finestra di dialogo [Sposta utente](move-user.md) , in cui è possibile selezionare il pool in cui spostare l'utente selezionato.

  - **Spostare tutti gli utenti nel pool** Apre la finestra di dialogo [Sposta utente](move-user.md) , in cui è possibile selezionare il pool in cui spostare tutti gli utenti selezionati.
