...
Se la richiesta in sospeso è stata approvata e il recupero del certificato viene eseguito correttamente, lo stato indicherà che un certificato è stato assegnato all'archivio certificati locale e che nel riquadro stato verrà visualizzata anche l'identificazione personale del certificato.
  
Se l'amministratore dell'autorità di certificazione nega la richiesta di certificato, il riquadro stato segnalerà che la richiesta del certificato in sospeso con un ID specifico (gestito dall'autorità di certificazione) viene negata.
