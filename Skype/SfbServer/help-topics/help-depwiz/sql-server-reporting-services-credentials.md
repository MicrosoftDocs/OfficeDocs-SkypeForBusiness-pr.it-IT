...
Per informazioni dettagliate sulla distribuzione dei report di Reporting Services per il server che esegue il monitoraggio, vedere [Install Monitoring Reports in Skype for Business server 2015](../../deploy/deploy-monitoring/install-monitoring-reports.md).
