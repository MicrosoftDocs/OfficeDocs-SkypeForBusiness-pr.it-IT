...
La priorità superiore sono soddisfazione dei clienti e il servizio eccellente. Tuttavia, nel caso in cui si dispone di un reclamo, verranno illustrate rapidamente che consentono di risolvere il problema. La pagina [Chiamata piani di Office 365 - codice per la gestione reclamo per Regno Unito (Regno Unito)](code-of-practice-for-the-united-kingdom-u-k.md) vengono illustrati le procedure per le piccole aziende presentare una comunicazione con noi e la combinazione di risoluzione controversia indipendenti.
...
Pianificare la chiamata a Office 365 utilizza la connessione a banda larga. Se si è verificato la connessione a banda larga potenza Taglia o errore, non sarà in grado di effettuare chiamate telefoniche. Le possibili cause di questi errori potrebbero essere di fuori del controllo.
  
## <a name="6-emergency-calls"></a>6. Chiamate d'emergenza

Skype per le aziende consente di accedere ai servizi di chiamata di emergenza pubblica 999/112 ai clienti in England, Wales, Scozia e Irlanda. Tuttavia, le chiamate di emergenza a 999 o 112 operano in modo diverso con servizi di pianificare la chiamata di Office 365 di servizi telefonici tradizionali. Per segnalare ogni utente dei servizi di pianificare la chiamata di Office 365 di queste differenze sono necessari i clienti.
...
Tutti i provider di servizi è necessario registrare con PhonepayPlus, che è un'organizzazione indipendente approvata dagli Ofcom. PhonepayPlus regola servizi frequenza Premium ed esamina reclami presentati da parte dei consumatori. Tutti i provider di servizi devono essere conformi al codice PhonepayPlus dell'esercitazione, che sono disponibili nel [http://www.phonepayplus.org.uk/for-business/code-of-practice](http://www.phonepayplus.org.uk/for-business/code-of-practice). Se un Provider di servizi viola il codice dell'esercitazione, PhonepayPlus può:
...
Per trovare informazioni sui contatti per un Provider di servizi, è possibile utilizzare strumento #NumberChecker degli PhonepayPlus a [http://www.phonepayplus.org.uk/for-consumers/making-an-enquiry/submit-an-online-enquiry](http://www.phonepayplus.org.uk/for-consumers/making-an-enquiry/submit-an-online-enquiry). Se si ritiene che sono stati erroneamente addebiti per un servizio di frequenza Premium, contattare direttamente il Provider di servizi.
