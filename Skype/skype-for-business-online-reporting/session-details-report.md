---
title: Rapporto Dettagli sessione
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.date: 12/15/2017
...
f1keywords: None
ms.custom: Reporting
description: "Il nuovo dashboard di Office 365 report mostra Panoramica attività tra i prodotti di Office 365 all'interno dell'organizzazione. Consente di eseguire il drill-ai rapporti di livello dei singoli prodotti per fornire più granulare delle conoscenze relative alle attività all'interno di ogni prodotto."
...
---
# <a name="session-details-report"></a>Rapporto Dettagli sessione

Il nuovo dashboard di Office 365 **report** Mostra panoramica attività tra i prodotti di Office 365 all'interno dell'organizzazione. Consente di eseguire il drill-ai rapporti di livello dei singoli prodotti per fornire più granulare delle conoscenze relative alle attività all'interno di ogni prodotto. Ad esempio, è possibile utilizzare report **Skype per Business dettagli** per visualizzare informazioni dettagliate sull'esperienza di chiamata dell'utente singolo.
...
***
![Numero 4](../images/sfbcallout4.png)<br/>La tabella mostra suddivisione di tutti i dettagli di sessioni per utente. Mostra tutti gli utenti che hanno Skype per le aziende assegnata e alle informazioni sulla sessione. È possibile aggiungere o rimuovere colonne nella tabella. <br/><br/>La tabella include le colonne seguenti per ogni sessione:
