...
- Le impostazioni della segreteria telefonica Outlook sul Web non si applicano Cloud Voicemail.
...
- La segreteria telefonica cloud non supporta l'organizzazione Operatore automatico in GA. Se si desidera che le cassette postali spostate in Cloud Voicemail continuino a essere disponibili tramite l'operatore automatico, è necessario mantenere disponibile almeno un server Exchange 2013 o Exchange 2016 che esegue il servizio o il ruolo di messaggistica unificata.
- È necessario configurare almeno un **server** Skype for Business 2019 e spostare gli utenti in tale server prima di spostare le cassette postali in Exchange 2019. In caso negativo, tali cassette postali non saranno in grado di ricevere messaggi di segreteria telefonica.
- Le chiamate inviate alla segreteria telefonica verranno trasferite Cloud Voicemail dove verranno registrate. Al termine della chiamata, il messaggio della segreteria telefonica verrà inviato alla cassetta postale del destinatario sul server locale Exchange 2019. È necessario prendere in considerazione questo traffico vocale per determinare se la connettività Internet è sufficiente per supportare Cloud Voicemail.
...
5. Impostare il criterio segreteria telefonica ospitata per ogni utente spostato su Skype for Business Server 2019 per l'Cloud Voicemail.
...
8. Rimuovere le autorizzazioni dei server Exchange 2013 o Exchange 2016 dopo che l'ultima cassetta postale è stata spostata.
    ...
    > [!IMPORTANT]
    > Se si fa affidamento su un operatore automatico, mantenere almeno Exchange 2013 o Exchange 2016 in esecuzione e disponibile.
...
4. Impostare il criterio segreteria telefonica ospitata per ogni utente spostato su Skype for Business Server 2019 per l'Cloud Voicemail.
