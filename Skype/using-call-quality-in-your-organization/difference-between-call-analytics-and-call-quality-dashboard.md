...
Per ulteriori informazioni sull'impostazione delle chiamate Analitica, vedere [impostare Skype per Business chiamare Analitica](set-up-call-analytics.md). Per ulteriori informazioni sul funzionamento di agenti help desk con chiamata Analitica, vedere [Utilizzo delle chiamate Analitica per risolvere i problemi di qualità delle chiamate](use-call-analytics-to-troubleshoot-poor-call-quality.md).
