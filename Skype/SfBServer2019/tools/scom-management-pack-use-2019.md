...
## <a name="configuration-overview"></a>Panoramica della configurazione
 ...
 Per configurare l'Skype for Business Server 2019 per l'utilizzo con System Center Operations Manager, è necessario eseguire tre operazioni:
...
Le funzionalità seguenti sono una novità Skype for Business Server Management Pack 2019.
...
- **Individuazione automatica per l'accesso client** Le applicazioni client che a Skype for Business Server 2019 spesso individuano automaticamente il server a cui accedere. Le transazioni sintetiche ora supportano la verifica che l'individuazione automatica sia configurata correttamente.
...
Quando si crea un Management Pack per l'archiviazione di impostazioni personalizzate per un Management Pack sealed, è consigliabile denominare il nuovo Management Pack in modo appropriato, ad esempio "Personalizzazioni Skype for Business Server 2019".
