...
Identificare e [configurare il server di gestione principale](../../SfbServer/management-tools/use-scom-management-pack/configure-the-primary.md). A questo scopo, è necessario installare System Center Operations Manager 2012 SP1 o R2. 
...
I Management Pack possono essere usati con System Center Operations Manager 2007 R2 (64 bit) (supportato solo per scopi di migrazione) o System Center Operations Manager 2012 SP1 &amp; r2 (64 bit). La tabella seguente mostra le configurazioni supportate per i Management Pack per Skype for Business Server 2019: 
  
|**Configurazione**|**Supportati?**|
|:-----|:-----|
|Sistema operativo Windows Server 2008 R2  <br/> Sistema operativo Windows Server 2012 R2  <br/> |Sì. Sia nei nodi Skype for Business Server 2019 che nel monitoraggio delle transazioni sintetiche.  <br/> |
|Server raggruppati  <br/> |Non supportato.  <br/> |
|Monitoraggio senza agenti  <br/> |Non supportato.  <br/> |
|Ambiente virtuale  <br/> |Sì.  <br/> |
|Ruoli del server appartenenti a un dominio  <br/> |Tutti i ruoli server interni di Skype for Business Server 2019 devono essere Uniti a un dominio.  <br/> |
|Ruoli server autonomi  <br/> |I server Edge di Skype for Business Server 2019 non devono essere Uniti al dominio.  <br/> |
...
Il pacchetto di monitoraggio per Skype for Business Server 2019 include i file seguenti:
...
Il Management Pack di Skype for Business Server 2019 sfrutta una vasta gamma di funzionalità che consentono di rilevare e diagnosticare i problemi. Queste caratteristiche consentono di ottenere una visibilità in tempo reale per l'integrità di un ambiente Skype for Business Server 2019.
...
|8  <br/> |MCX messaggistica istantanea peer-to-peer (mobile)  <br/> |Disponibile nella versione di 2011 di settembre di Lync Server 2010 per Skype for business 2019  <br/> |
...
|15  <br/> |Conferenza di condivisione applicazioni  <br/> |Disponibile in Skype for Business Server 2015 e oltre <br/> |
|16  <br/> |Conferenza UCWA (Web Meeting join)  <br/> |Disponibile in Skype for Business Server 2015 e oltre <br/> |
...
Quando si crea un Management Pack per l'archiviazione di impostazioni personalizzate per un Management Pack sealed, è consigliabile assegnare un nome al nuovo Management Pack in modo appropriato, ad esempio "personalizzazioni di Skype for Business Server 2019".
