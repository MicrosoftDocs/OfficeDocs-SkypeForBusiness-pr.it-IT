...
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="a181d-103">Script di autenticazione del Pannello di controllo di Skype for Business Server 2019</span><span class="sxs-lookup"><span data-stu-id="a181d-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="a181d-104">Di seguito sono riportati gli script helper correlati all'autenticazione per macp (Modern Admin Control Panel).</span><span class="sxs-lookup"><span data-stu-id="a181d-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="a181d-105">Configurare l'autenticazione MACP con Microsoft 365 o Office 365</span><span class="sxs-lookup"><span data-stu-id="a181d-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="a181d-106">Questo script deve essere eseguito dopo l'installazione dell'aggiornamento cumulativo 1 o successivo di Skype for Business Server 2019 nell'ambito della configurazione del nuovo Pannello di controllo.</span><span class="sxs-lookup"><span data-stu-id="a181d-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="a181d-107">Configurare l'applicazione MACP nella farm ADFS</span><span class="sxs-lookup"><span data-stu-id="a181d-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="a181d-108">Questo script deve essere eseguito dopo l'installazione dell'aggiornamento cumulativo più recente di Skype for Business Server 2019, come parte della configurazione del nuovo Pannello di controllo.</span><span class="sxs-lookup"><span data-stu-id="a181d-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="a181d-109">Configurare OAuth per MACP</span><span class="sxs-lookup"><span data-stu-id="a181d-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="a181d-110">Questo script deve essere eseguito dopo l'installazione dell'aggiornamento cumulativo più recente di Skype for Business Server 2019, come parte della configurazione del nuovo Pannello di controllo.</span><span class="sxs-lookup"><span data-stu-id="a181d-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
