...
4. Nel Visualizzatore eventi, fare **clic su Registri applicazioni** e servizi per espanderlo, quindi selezionare Skype for Business Server. 
...
8. Nell'elenco degli eventi filtrati, nella scheda **Generale,** cercare una voce che indica che la replica utente è stata completata correttamente. 
