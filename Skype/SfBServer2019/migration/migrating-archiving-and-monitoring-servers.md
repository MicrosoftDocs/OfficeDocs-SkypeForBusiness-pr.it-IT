...
- I dati di archiviazione e i dati di monitoraggio non vengono spostati nella distribuzione di Skype for Business Server 2019. I dati di cui è stato fatto backup prima della rimozione delle autorizzazioni per l'ambiente legacy saranno la cronologia delle attività nell'ambiente legacy.
    
- La versione legacy del server di archiviazione e del Monitoring Server può essere associata solo a un pool Front End legacy. In Skype for Business Server 2019, Archiviazione e monitoraggio non sono più ruoli del server, ma servizi integrati nel pool Front End di Skype for Business Server 2019.
    
- Durante il periodo di coesistenza delle distribuzioni legacy e di Skype for Business Server 2019, la versione legacy del server di archiviazione e del Monitoring Server raccoglie dati per gli utenti ospitati in pool legacy. Archiviazione e monitoraggio in Skype for Business Server 2019 raccolgono i dati per gli utenti ospitati nei pool di Skype for Business Server 2019.
