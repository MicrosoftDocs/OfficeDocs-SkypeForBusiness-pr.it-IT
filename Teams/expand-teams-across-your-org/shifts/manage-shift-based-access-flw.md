...
Questi stati di presenza basati sul turnoSegne&mdash;![ di controllo verde, indica Al turno.](../../media/flw-presence-on-shift.png) **Al turno**, ![cerchio grigio con x, indica Turno disattivato.](../../media/flw-presence-off-shift.png) **Fuori turno**, ![cerchio rosso a tinta unita, indica](../../media/flw-presence-busy.png)&mdash; che **Occupato è separato** dal [set predefinito](../../presence-admins.md) di stati presenza in Teams. Con questi due set di stati di presenza, è possibile configurare esperienze diverse per le persone dell'organizzazione in base al loro ruolo.
