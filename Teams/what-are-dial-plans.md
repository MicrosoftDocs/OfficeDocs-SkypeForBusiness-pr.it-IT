...
- Calling Plans
description: 'Scopri il tipo di piani per chiamate telefoniche (piani di chiamata PSTN) disponibili con Teams e come sceglierne uno per la tua organizzazione.  '
ms.openlocfilehash: 77ee7801d43bd6a7cf9ae9a9e3fc74c302f8caa0
ms.sourcegitcommit: f0e2a5928e9b959daf45202b9f256f65c2087195
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 10/20/2022
ms.locfileid: "68614249"
---
...
Vedere [Creare e gestire piani di](create-and-manage-dial-plans.md) chiamata per creare e gestire piani di chiamata tenant.
...
Vedere [Creare e gestire piani di](create-and-manage-dial-plans.md) chiamata per creare piani di chiamata tenant.
...
Per informazioni dettagliate sull'uso delle espressioni regolari di .NET Framework, vedere [Espressioni regolari di .NET Framework](/dotnet/standard/base-types/regular-expressions).

Vedere [Creare e gestire piani di](create-and-manage-dial-plans.md) chiamata per creare e gestire regole di normalizzazione per i piani di chiamata tenant.
