...
2. A sinistra, in **Voce**, seleziona **Criteri di chiamata**.
...
4. Selezionare **Gestisci criteri**, selezionare un criterio e quindi selezionare **Modifica**.
...
2. Selezionare **Teams** **dispositiviSIP** > .

3. Nell'angolo in alto a destra selezionare **ActionsProvision**  >  devices ed eseguire una di queste operazioni:
  ...
  - **Per eseguire il provisioning di un dispositivo:**
   ...
   - **Per eseguire il provisioning di molti dispositivi:**
     ...
     e. A destra del riquadro Upload **indirizzi MAC** selezionare Seleziona un **file** e selezionare **il fileTemplate_Provisioning.csv** che contiene i dati.

     f. Nel riquadro **Provisioning dei dispositivi****, in In** attesa dell'attivazione, selezionare un dispositivo e  quindi selezionare Genera codice di verifica per generare un codice di verifica una sola volta per ogni dispositivo di cui è stato eseguito il provisioning. Prendere nota del codice di verifica per ogni dispositivo SIP.
...
7. Passare a [https://microsoft.com/devicelogin](https://microsoft.com/devicelogin)e in **Immetti codice** immettere il codice di associazione del dispositivo SIP e quindi selezionare **Avanti**.
...
2. Selezionare **Teams** **dispositiviSIP** > . Tutti i dispositivi SIP connessi sono elencati a destra.
