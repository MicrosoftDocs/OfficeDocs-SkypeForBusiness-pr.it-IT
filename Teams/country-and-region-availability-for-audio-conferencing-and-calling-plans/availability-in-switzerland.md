...
> [!NOTE]
> È possibile ottenere i numeri di servizio in Svizzera per l'uso con i **Servizi** di conferenza, l'operatore automatico e le code di chiamata, ma non è possibile ottenere i numeri **degli utenti** in Svizzera perché i piani di chiamata non sono disponibili.
...
|Vengono assegnati automaticamente i numeri di telefono per l'Audioconferenza?  <br/> |Sì, per: <br/><ul><li> Zurigo</ul>Se vuoi numeri di telefono dedicati, consulta [Ottenere numeri di telefono di servizio per Skype for Business e Microsoft Teams](/microsoftteams/getting-service-phone-numbers).  <br/> |
