...
Ecco i servizi Microsoft 365 e Office 365 per Skype for business e Microsoft teams disponibili per l'Italia.
...
|Vengono assegnati automaticamente i numeri di telefono per l'Audioconferenza?  <br/> |Sì, per:<br/><ul><li> Milano</ul>Se si desiderano numeri di telefono dedicati, vedere [recupero di numeri di telefono del servizio](/microsoftteams/getting-service-phone-numbers).  <br/> |
...
|Minuti disponibili per i piani di chiamata. |Per ogni mese di calendario sono disponibili quattro opzioni per il piano: <ul><li>Piano per chiamate nazionali di 120 minuti </li><li>Piano per chiamate nazionali di 240 minuti</li></li><li>Piano per chiamate nazionali di 1200 minuti </li></li><li>Piano per chiamate nazionali e internazionali: 1200 minuti nazionali-o-600 minuti di chiamate internazionali (a seconda di quale viene raggiunto per primo nel mese del calendario)</li></li></ul>[Trasparenza tariffaria (IT)](https://www.microsoft.com/download/details.aspx?id=102426)<br>[Trasparenza tariffaria (EN)](https://www.microsoft.com/download/details.aspx?id=102426) |
...
|:-----|:-----|
|Per quali capitali o città principali puoi ottenere numeri a tariffa?  <br/> |Milano  <br/> |
|Sono disponibili numeri verdi a tariffa?  <br/> |Sì  <br/> |
|Sono disponibili numeri verdi gratuiti?  <br/> |Sì  <br/> |

 Per ottenere numeri di telefono a pedaggio e a numero verde per i servizi di audioconferenza, gli operatori automatici e le code di chiamata, vedere [ottenere i numeri di telefono del servizio](/microsoftteams/getting-service-phone-numbers).
