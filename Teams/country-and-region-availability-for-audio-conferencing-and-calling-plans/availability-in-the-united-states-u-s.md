...
Ecco i servizi di Office 365 per Skype for business e Microsoft teams disponibili per gli Stati Uniti.
...
| Minuti disponibili per i piani di chiamata.              | Per ogni mese di calendario sono disponibili quattro opzioni per il piano: <ul><li>Piano per chiamate nazionali di 120 minuti (disponibilità limitata)</li><li>Piano per chiamate nazionali di 240 minuti (disponibilità limitata)</li></li><li>Piano per chiamate nazionali di 3000 minuti </li></li><li>Piano per chiamate nazionali e internazionali: 3000 minuti nazionali-o-600 minuti di chiamate internazionali (a seconda di quale viene raggiunto per primo nel mese del calendario)</li></li> |
...
> [!Note]
> Le chiamate in Canada vengono trattate come chiamate nazionali.
