...
Ecco i servizi Microsoft 365 e Office 365 per Skype for Business e Microsoft Teams disponibili per il Sudafrica.
...
|Vengono assegnati automaticamente i numeri di telefono per l'Audioconferenza?  <br/> |Sì, per: <br/><ul><li> Città del Capo</ul>Se vuoi numeri di telefono dedicati, consulta [Ottenere numeri di telefono di servizio per Skype for Business e Microsoft Teams](../getting-service-phone-numbers.md).  <br/> |
...
|Chiamate in uscita possibili verso...?  <br/> | A 196 paesi o aree geografiche, incluse [queste](users-can-make-outbound-calls-to-these-countries-and-regions.md).<br/> |
