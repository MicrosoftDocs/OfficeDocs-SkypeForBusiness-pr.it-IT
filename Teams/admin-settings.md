...
Stiamo continuamente migliorando l'esperienza dell'app in Teams e l'aggiunta di funzionalità e funzionalità. Nel corso del tempo, verranno migliorate le funzionalità di gestione delle app, quindi controllare di nuovo le informazioni più aggiornate sui criteri delle app.

## <a name="manage-apps"></a>Gestire le app

Usare la **pagina Gestisci app** per visualizzare e gestire tutte Teams app nel catalogo app dell'organizzazione. È possibile visualizzare lo stato e le proprietà a livello di organizzazione delle app, bloccare o consentire le app a livello di organizzazione, caricare nuove app personalizzate nel catalogo tenant e gestire le impostazioni delle app a livello di organizzazione.
...
- Aumentare la consapevolezza e l'adozione delle app di base. Ad esempio, aggiungere un'app di selezione e gestione dei talenti personalizzata per gli utenti del team delle risorse umane.
...
Teams consente agli sviluppatori dell'organizzazione di creare, testare e distribuire app personalizzate ad altri utenti. È possibile aggiungere app personalizzate a Teams caricando un pacchetto di app in un file di .zip direttamente in un team o nel contesto personale. È possibile usare i criteri di configurazione delle app per controllare chi nell'organizzazione può caricare app personalizzate. È anche possibile impostare impostazioni a livello di organizzazione per controllare se gli utenti possono interagire con app personalizzate specifiche.
