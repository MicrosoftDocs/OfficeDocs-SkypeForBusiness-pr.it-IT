...
---
<a name="add-a-guest-to-a-team"></a>Aggiungere un guest a un team
=====================
> [!IMPORTANT]
> [!INCLUDE [new-teams-sfb-admin-center-notice](includes/new-teams-sfb-admin-center-notice.md)]

Chiunque abbia un account di posta elettronica aziendale o personale, come Outlook, Gmail o altri, può partecipare come guest in Teams.
...
Gli utenti guest che sono stati già aggiunti tramite B2B di Azure AD, Gruppi di Office 365 o SharePoint Online sono pronti. L'amministratore di Office 365 o un proprietario dei team può aggiungere questi guest ai rispettivi team. Se un team è già presente in un gruppo di Office 365 e viene aggiunto un guest al gruppo, il guest otterrà l'accesso al team. L'aggiunta di un guest tramite il gruppo di Office 365 non genera un messaggio di posta elettronica di invito per il guest, pertanto una persona del team deve informarlo.

> [!NOTE]
> I guest sono soggetti ai limiti del servizio di [Office 365](https://go.microsoft.com/fwlink/p/?linkid=282347) e [Azure Active Directory](https://go.microsoft.com/fwlink/p/?linkid=853019).
