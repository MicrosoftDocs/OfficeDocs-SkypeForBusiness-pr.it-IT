...
| [Microsoft elementi essenziali di Teams per l'IT](https://www.youtube.com/watch?v=MfDB7VenWuA&list=PLXtHYVsvn_b_JeDjgD5XdkyHTDXdYgPGn) | Video di YouTube che illustra le opzioni di configurazione e le considerazioni per la pianificazione e la distribuzione di Teams. |
...
| [Microsoft Teams per l'istruzione](Teams-quick-start-edu.yml) | Guida introduttiva per Teams per l'istruzione per gli amministratori IT. |
| [Gestione delle app nell Microsoft interfaccia di amministrazione di Teams](manage-apps.md) | Guida sui casi di utilizzo delle app e su come gestire le app tramite l'interfaccia di amministrazione di Teams. |
...
| [Risoluzione dei problemi di Teams](/microsoftteams/troubleshoot/teams-welcome) | Una raccolta di articoli che forniscono indicazioni per la risoluzione dei problemi comuni di Teams. |

## <a name="resources-for-faculty-and-staff"></a>Risorse per docenti e personale didattico

Usare le risorse seguenti per docenti e personale didattico per iniziare a usare Assistente alla carriera e Microsoft Teams.
...
| [Panoramica di Microsoft Teams](https://support.microsoft.com/teams) | Guida introduttiva di Teams Microsoft per docenti e studenti. |
| [Microsoft teams introduttivo con un pager](https://download.microsoft.com/download/8/f/1/8f187ed2-a4b8-4269-b756-744c2e81a423/teams-for-education-getting-started-1-pager.pdf) | Un documento di una pagina, facile da condividere, che riepiloga la guida introduttiva di Microsoft Teams. |
| [Risorse di Microsoft Teams per l'istruzione per amministratori](resources-teams-edu.md) | Una raccolta di risorse di marketing e comunicazione Teams per l'istruzione. |
| [Scaricare la Guida introduttiva di Teams per l'istruzione](https://support.microsoft.com/topic/downloadable-guides-6bd3eb82-0a0f-43cc-a4d2-c9f4e7ebdf39) | Guide PDF scaricabili per iniziare rapidamente con Teams. |
...
| [Introduzione al team di classe](https://support.microsoft.com/topic/get-started-in-your-class-team-6b5fd708-35b9-4caf-b66e-d8f2468e4fd5#ID0EDD=Students) | Articolo utile per acquisire familiarità con gli studenti e accedere alla classe in Teams. |
| [Apprendimento remoto con Office 365 per studenti](https://support.microsoft.com/topic/remote-learning-with-office-365-for-students-eea3ee92-ba42-4217-90d4-155f9a5477e4) | Informazioni di base su Microsoft Teams e suggerimenti per un'esperienza di apprendimento remoto di successo. |

## <a name="additional-resources"></a>Risorse aggiuntive

Le risorse seguenti non sono necessarie per configurare Assistente alla carriera, ma sono incluse in questo articolo in quanto possono essere utili per docenti, personale e studenti.

|Risorsa |Descrizione |
|---------|------------|
| [Assegnare attività in Teams per l'istruzione](https://support.microsoft.com/topic/microsoft-teams-5aa4431a-8a3c-4aa5-87a6-b6401abea114?ui=en-us&rs=en-us&ad=us#ID0EAABAAA=Assignments&ID0EBBD=Assignments) | Istruzioni dettagliate sull'aggiunta della funzionalità Attività che consente all'istituto di istruzione di assegnare attività o test agli studenti, gestire le tempistiche delle attività, valutare con categorie, tenere traccia dei progressi dei singoli studenti e dei corsi e altro ancora. |
| [Approfondimenti in Teams per l'istruzione](https://support.microsoft.com/topic/educator-s-guide-to-insights-in-microsoft-teams-27b56255-90c0-47aa-bac3-1c9f50157181) | Guida di Insights in Microsoft Teams per tenere traccia delle attività di Teams degli studenti, come consegna e coinvolgimento delle attività nelle conversazioni di classe. |
| [Insights per l'istruzione](class-insights.md) | Guida per gli amministratori IT per abilitare l'analisi in tempo reale dei progressi e delle attività degli studenti all'interno delle classi. |
