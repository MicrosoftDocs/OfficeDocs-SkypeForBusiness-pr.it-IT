...
L'integrazione moodle in Microsoft Teams è basata sul set di [plug-in Moodle open source.](https://github.com/Microsoft/o365-moodle) Per installare il plug-in nel server Moodle:
...
1. Selezionare **l'opzione Carica un file** nel riquadro di spostamento sinistro, cercare il file scaricato in precedenza e fare clic **su Carica file.**
1. Selezionare di **nuovo l'opzione** Amministrazione sito nel riquadro di spostamento sinistro per tornare al dashboard di amministrazione. Scorrere verso il basso fino **a Plug-in locali** e fare clic **sul collegamento Microsoft Office 365 Integration.** Mantenere aperta questa pagina di configurazione in una scheda del browser separata perché verrà utilizzata durante il resto del processo.
...
**Nota importante:** Mantenere aperta la pagina di configurazione del plug-in Moodle di Microsoft 365 o Office 365 in una scheda del browser separata mentre si torna a questo set di pagine durante questo processo.
...
1. Nella pagina del plug-in Microsoft 365 o Office 365 Integration selezionare la **scheda** Configurazione.
...
1. Eseguire lo script di PowerShell per:
    ...
    * Accedere all'account di amministratore di Microsoft 365 o Office 365 nella finestra popup.
...
1. A questo punto sarà necessario aggiungere l'ID e la chiave al plug-in Moodle. Tornare alla pagina di amministrazione dei plug-in (Amministrazione > plug-in > Integrazione Microsoft 365).
...
1. Dopo l'aggiornamento della pagina, verrà visualizzata un'altra nuova sezione con il consenso **dell'& altre informazioni.**
    * Fare clic sul collegamento Fornire il consenso **dell'amministratore,** immettere le credenziali di  amministratore globale di Microsoft 365 o Office 365, quindi accettare per concedere le autorizzazioni.
...
1. Tornare alla pagina di amministrazione del plug-in (amministrazione del sito > plug-in > Microsoft 365 Integration) e selezionare la pagina **Impostazioni di Teams.** È necessario configurare alcune impostazioni di sicurezza per abilitare l'integrazione dell'app Teams.
...
Il bot gratuito Moodle Assistant per Microsoft Teams aiuta insegnanti e studenti a rispondere a domande sui loro corsi, attività, voti e altre informazioni in Moodle. Il bot invia anche notifiche moodle a studenti e insegnanti direttamente in Teams. Questo bot è un progetto open source gestito da Microsoft ed è [disponibile su GitHub.](https://github.com/microsoft/Moodle-Teams-Bot)
...
1. Tornare alla pagina di amministrazione del plug-in (Amministrazione sito > plug-in > Microsoft 365 Integration) e selezionare la **scheda Impostazioni di Teams.**
...
9. Dopo aver salvato le modifiche, tornare alla scheda **Impostazioni** team, fare clic sul pulsante Scarica **file** manifesto e salvare il pacchetto manifesto nel computer (verrà utilizzato nella sezione successiva).
...
3. Fare clic **sul collegamento Carica un'app** personalizzata nell'elenco di opzioni. *Nota:* Se si è connessi come amministratore globale, sarà possibile caricare l'app nell'app store dell'organizzazione, altrimenti sarà possibile caricare l'app solo per Teams di cui si fa parte ("sideloading").
4. Selezionare il `manifest.zip` pacchetto scaricato in precedenza e fare clic su **Salva.** Se il pacchetto manifesto non è ancora stato scaricato, è possibile farlo dalla scheda **Impostazioni** team della pagina di configurazione del plug-in Moodle.
