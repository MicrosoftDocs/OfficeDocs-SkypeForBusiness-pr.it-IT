...
|:-----|:-----|
|Ottenere nuovi numeri di telefono per utenti o servizi non elencati nell'interfaccia di amministrazione di Microsoft teams.  <br/> | In Germania non è possibile ottenere i numeri di telefono per l'organizzazione usando l'interfaccia di amministrazione di Microsoft teams. Devi inviare una richiesta di nuovo numero di telefono. Scaricare il modulo. <br/>[Nuova richiesta di numero di telefono per la Germania (v. 5.0) (de-de)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-germany-(v.5.0)-(de-de).pdf?raw=true) <br/><br/>Compilalo e [inviacelo](mailto:ptneu@microsoft.com).  <br/> |
|Ottenere i numeri di telefono trasferiti a noi.  <br/> | Scaricare uno di questi moduli. <br/><br/> Per i numeri di telefono degli utenti:<br/>[Lettera di autorizzazione (LOA) per la Germania (numeri geografici) (v. 5.0) (de-de)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-germany-(geographic-numbers)-(v.5.0)-(de-de).pdf?raw=true)<br/><br/>  Per i numeri di telefono gratuiti:<br/>[Lettera di autorizzazione (LOA) per la Germania (numeri verdi) (v. 5.0) (de-de)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-germany-(toll-free-numbers)-(v.5.0)-(de-de).pdf?raw=true) <br/><br/> Compilalo e [inviacelo](mailto:ptneu@microsoft.com).  <br/> |
