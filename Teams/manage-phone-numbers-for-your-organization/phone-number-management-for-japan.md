...
|:-----|:-----|
|Ottenere nuovi numeri di telefono utente per i Piani per chiamate in Giappone.|Contatta [SoftBank Calling per](https://aka.ms/SoftBankVoicePlan) nuovi numeri di telefono per i tuoi utenti. Questi numeri saranno aggiunti all'organizzazione in modo che potrai assegnarli ai tuoi utenti. <br/>
|Ottenere nuovi numeri di telefono di servizio per audioconferenza, operatori automatici e code di chiamata in Giappone.|[Ti invitiamo a contattarci](mailto:ptnapac@microsoft.com).|
