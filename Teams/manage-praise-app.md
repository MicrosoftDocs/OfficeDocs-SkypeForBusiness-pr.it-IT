...
Complimenti è abilitato per impostazione predefinita per tutti gli Teams utenti dell'organizzazione. È possibile disattivare o attivare l'app a livello di organizzazione nella pagina [Gestisci app](manage-apps.md) nell'interfaccia di amministrazione di Microsoft Teams.
