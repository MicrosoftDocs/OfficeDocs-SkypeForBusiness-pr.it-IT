...
Usare la scadenza della riunione per limitare OneDrive o SharePoint per il consumo di spazio di archiviazione nel cloud basato sui record Teams riunioni. Una tipica registrazione della riunione consuma circa 400 MB all'ora di registrazione.
