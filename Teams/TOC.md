...
## [Gestire i team di grandi dimensioni](best-practices-large-groups.md)
## [Creare un team a livello di organizzazione in Teams](create-an-org-wide-team.md)
## [Creare team di responsabili](create-manager-directs-teams.md)
...
## [Visualizzare le analisi in Teams](teams-analytics-and-reports/view-analytics.md)
...
#### [Esperienza guest](guest-experience.md)
#### [Autorizzare l'accesso guest](teams-dependencies.md)
#### [Attivare o disattivare l'accesso guest](set-up-guests.md)
...
#### [Resoconto sull’utilizzo dell’app Teams](teams-analytics-and-reports/app-usage-report.md)
...
#### [Partecipare a riunioni di terze parti](rooms/third-party-join.md)
...
### [Configurare l’audioconferenza](set-up-audio-conferencing-in-teams.md)
### [Guida introduttiva per configurare un'audioconferenza per le piccole e medie imprese](audio-conferencing-smb.md)
...
### [Disponibilità di Audioconferenza per Paese e area geografica](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
...
### [Configurazione del tastierino](dial-pad-configuration.md)
...
### Ottimizzazione degli elementi multimediali locali per Instradamento diretto
...
#### Protocolli
##### [Definizioni e standard RFC](direct-routing-protocols.md)
##### [Protocollo SIP](direct-routing-protocols-SIP.md)
##### [Protocolli multimediali](direct-routing-protocols-media.md)
...
## Case study sulla migrazione della funzionalità vocale di Contoso
### [Panoramica](voice-case-study-overview.md)
### [Piano di aggiornamento di Teams](voice-case-study-migration-plan.md)
### [Sistema telefonico](voice-case-study-phone-system.md)
### [Instradamento basato sulla posizione](voice-case-study-location-based-routing.md)
...
#### [Gestione dei numeri di telefono per l'Austria](manage-phone-numbers-for-your-organization/phone-number-management-for-austria.md)
...
#### [Gestione dei numeri di telefono per la Danimarca](manage-phone-numbers-for-your-organization/phone-number-management-for-denmark.md)
#### [Gestione dei numeri di telefono per la Francia](manage-phone-numbers-for-your-organization/phone-number-management-for-france.md)
...
#### [Gestione dei numeri di telefono per l'Italia](manage-phone-numbers-for-your-organization/phone-number-management-for-italy.md)
#### [Gestione dei numeri di telefono per il Giappone](manage-phone-numbers-for-your-organization/phone-number-management-for-japan.md)
#### [Gestione dei numeri di telefono per il Portogallo](manage-phone-numbers-for-your-organization/phone-number-management-for-portugal.md)
...
#### [Gestione dei numeri di telefono per la Svezia](manage-phone-numbers-for-your-organization/phone-number-management-for-sweden.md)
#### [Gestione dei numeri di telefono per la Svizzera](manage-phone-numbers-for-your-organization/phone-number-management-for-switzerland.md)
#### [Gestione dei numeri di telefono per il Regno Unito di Gran Bretagna e Irlanda del Nord](manage-phone-numbers-for-your-organization/phone-number-management-for-the-u-k.md)
...
#### [RAS di Hong Kong](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-hong-kong.md)
...
#### [Svizzera](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-switzerland.md)
...
### Gestire Credito per la comunicazione
...
### Pianificare progetto e requisiti 
#### [Panoramica](upgrade-plan-journey.md)
...
## [Disponibilità per paesi e aree geografiche](business-voice/country-region-availability.md)
## Cose da sapere prima dell’acquisto
### [Cosa acquistare per avere Business Voice](business-voice/what-to-buy.md)
### [Ottenere assistenza da parte di un rivenditore o un partner](business-voice/reseller-partner-support.md)
...
### Visite virtuali
#### [Visite virtuali con Teams - integrazione in EHR](expand-teams-across-your-org/healthcare/ehr-admin.md)
#### [Visite virtuali con Bookings e Teams](bookings-app-admin.md)
### [Creare pacchetti di criteri per Teams](policy-packages-healthcare.md)
...
### [Riferimento a Education SKU](sku-reference-edu.md)
...
### [Pacchetti di criteri di Teams per il governo](policy-packages-gov.md)
...
### [Registrazione di chiamate e riunioni basata sui criteri](teams-recording-policy.md)
...
### [Esperienze connesse facoltative](teams-privacy-oce-overview.md)
...
## [Problemi relativi alla ricezione di messaggi e chiamate nei sistemi legacy](legacy-login-issues.md)
...
### [Pianificare i Gruppi di Microsoft 365 durante la creazione dei team in Teams](plan-office-365-groups.md)
...
### [Ottenere Teams per Android in Cina](get-teams-android-in-china.md)
...
### [Come viene usata la memoria in Microsoft Teams](teams-memory-usage-perf.md)
### [URL e intervalli di indirizzi IP per Office 365 e Microsoft 365](office-365-urls-ip-address-ranges.md).
...
### [Opzioni di licenza per i componenti aggiuntivi di Teams](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
### [Assegnare le licenze per i componenti aggiuntivi di Teams](teams-add-on-licensing/assign-teams-add-on-licenses.md)
...
## Interoperabilità con Microsoft 365 e Office 365

### [Gruppi di Microsoft 365 e Teams](office-365-groups.md)
### [Creare un account risorsa di Microsoft 365 con l'interfaccia di amministrazione di Microsoft 365](devices/resource-account-ui.md)
### [Migliorare i gruppi di Microsoft 365 con Teams](enhance-office-365-groups.md)
...
#### [Usare le regole del flusso di posta con Exchange](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365)
### [Modalità di interazione di SharePoint Online e OneDrive for Business con Teams](sharepoint-onedrive-interact.md)
### [Esperienza di Teams in un tenant con Microsoft 365 o Office 365 Multi-Geo](teams-experience-o365odb-spo-multi-geo.md)
...
### [Schermi Teams](devices/teams-displays.md)
### [Aggiornare i telefoni Teams agli schermi Teams](devices/upgrade-phones-to-displays.md)
### [Implementare telefoni e schermi Teams usando Intune](devices/phones-displays-deploy.md)
...
### [Telefoni IP certificati per Microsoft Teams](devices/teams-ip-phones.md)
...
### [Installare PowerShell per Teams](teams-powershell-install.md)
### [Gestire Teams con PowerShell per Teams](teams-powershell-managing-teams.md)
### [Note sulla versione di PowerShell per Teams](teams-powershell-release-notes.md)
### [Passare dal connettore Skype for Business Online al modulo Teams PowerShell](teams-powershell-move-from-sfbo.md)
### [Informazioni di riferimento sui cmdlet per Teams](https://docs.microsoft.com/powershell/module/teams/?view=teams-ps)
## [Documentazione per sviluppatori di Teams](https://docs.microsoft.com/microsoftteams/platform)
## [Ottenere assistenza in Teams](get-help-in-microsoft-teams.md)
## [Aggiornamenti dei contenuti di Teams](teams-updates.md)

## [Come cercare il PIN di supporto](support-pin.md)
...
### [Antigua e Barbuda](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-antigua-and-barbuda.md)
...
### [Camerun](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-cameroon.md)
### [Canada](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-canada.md)
### [Isole Cayman](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-the-cayman-islands.md)
...
### [RAS di Hong Kong](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-hong-kong.md)
...
### [Giamaica](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-jamaica.md)
...
### [Macedonia del Nord](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-macedonia.md)
...
### [Isole Marianne Settentrionali](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-northern-mariana-islands.md)
...
### [Saint Kitts e Nevis](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-saint-kitts-and-nevis.md)
...
### [Isole Turks e Caicos](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-turks-and-caicos-islands.md)
...
## [Anteprima pubblica in Microsoft Teams](public-preview-doc-updates.md)