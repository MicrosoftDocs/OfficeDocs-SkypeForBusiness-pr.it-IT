...
Microsoft Teams supporta i flussi di lavoro per l'interazione con i clienti, fungendo da hub per la connessione interna ed esterna tra le sue modalità di comunicazione, tra cui chat, video riunioni e chiamate. Per alcune organizzazioni, le Microsoft Teams [vocali cloud,](./cloud-voice-landing-page.md)tra cui l'operatore automatico e le code di [chiamata,](./create-a-phone-system-call-queue.md)soddisfano le proprie esigenze. [](./what-are-phone-system-auto-attendants.md)
...
Se si è un'organizzazione alla ricerca di una soluzione integrata per i contact center, vedere Soluzioni [Microsoft Teams](https://cloudpartners.transform.microsoft.com/contact-center-solutions) certificate per i centri contatti per un elenco di provider di soluzioni certificate e vedere Soluzioni di Contact [Center](#connected-contact-center-solutions) connesse per un elenco di provider nel processo di certificazione.
...
## <a name="connected-contact-center-solutions"></a>Soluzioni contact center connesse

I provider seguenti offrono soluzioni di contact center integrate in Teams usando uno dei modelli di integrazione Connessione, Extend o Power.
