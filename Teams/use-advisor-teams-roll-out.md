...
La prima volta che si usa Advisor per Teams, viene creato un team di distribuzione in Teams. Aggiunge canali per ogni carico di lavoro che si vuole implementare. 
...
Quando Advisor crea il team di distribuzione, il bot Advisor rilascia il messaggio seguente.
...
Dopo che Advisor per Teams ha creato il team di distribuzione, è possibile gestire il team come qualsiasi altro team, inclusa la possibilità di eliminarlo. Tenere presente che, se non si elimina il team tramite l'interfaccia di amministrazione di Teams, il team verrà riportato come esistente.
