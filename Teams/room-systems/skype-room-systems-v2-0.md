...
In genere, i bundle e le unità integrate includono il software preinstallato, mentre se si acquistano componenti supportati singolarmente per i sistemi Surface Pro, è necessario installare il software. Per istruzioni, vedere [questo articolo sull'installazione di software nei dispositivi](room-systems-scale.md). 

È possibile distribuire le sale di Microsoft teams con Microsoft teams, Skype for business online o le distribuzioni ibride o locali di Skype for business.  Vedere l' [aggiornamento delle licenze della sala riunioni](skype-room-systems-v2.md) per le squadre per informazioni sulle licenze necessarie.
...
| Disponibilità del sito             | Servizi/team di progetto AV/IT |             | [Disponibilità del sito](room-systems-v2.md#site-readiness)                      |
| Disponibilità del servizio          | Team di progetto IT                        |             | [Disponibilità del servizio](room-systems-v2.md#service-readiness)                      |
| Configurazione              | Team di progetto IT                        |             | [Configurazione e distribuzione](room-systems-v2.md#configuration-and-deployment)                      |
...
| Manutenzione e operazioni | Team di progetto AV/IT              |             | [Panoramica della gestione](skype-room-systems-v2.md)                      |
