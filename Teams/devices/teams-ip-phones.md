...
>[!NOTE]
>Le date di fine della certificazione verranno aggiornate regolarmente in base ai piani dei partner OEM per l'aggiornamento a una versione più recente del sistema operativo Android.
...
| Visualizzazione ThinkSmart di Lenovo                 | `CD-18781Y.200410.067`                                     | 5 dicembre 2022             | 8.1 |
...
| Yealink EXP50 supportato in MP56, MP58, VP59| Per ogni modello di dispositivo supportato, vedere aggiornamento #7 versione firmware | 5 agosto 2023      | 9 |
...
I dispositivi seguenti sono certificati nel Microsoft Teams di certificazione dei pannelli di controllo:
...
|Utilità di pianificazione TAP di Logitech | `1.3.111` |3 settembre 2024 | 10 |
...
| Poly Trio C60   | `7.1.4.0201`  | Aggiornamento 2021 #3B                        |
| Poly CCX400/CCX500/CCX600   | `7.1.4.0200`  | Aggiornamento 2021 #3B                 |
|Audiocode C448HD  | `1.14.449` | Aggiornamento 2021 #3  |
|Audiocodice C450HD  | `1.14.449` | Aggiornamento 2021 #3  |
|Audiocode C470HD  | `1.14.449` | Aggiornamento 2021 #3  |
|Audiocode C448HD  | `C448HD_TEAMS_1.14.449` | Aggiornamento 2021 #3  |
|Audiocodice C450HD  | `C450HD_TEAMS_1.14.449` | Aggiornamento 2021 #3  |
|Audiocode C470HD  | `C470HD_TEAMS_1.14.449` | Aggiornamento 2021 #3  |
|Poly Trio C60      | `7.1.3.0985`            | Aggiornamento 2021 #3  |
|Poly CCX400/CCX500/CCX600 | `7.1.3.0991`     | Aggiornamento 2021 #3  |
|Crestron UC-2      | `1.0.4.57`              | Aggiornamento 2021 #3  |
|Yealink T55A/T56A/T58A   | `58.15.0.143`     | Aggiornamento 2021 #3  |
|Yealink MP54/MP56/MP58   | `122.15.0.60`     | Aggiornamento 2021 #3  |
|Yealink VP59             | `91.15.0.77`      | Aggiornamento 2021 #3  |
|Yealink CP960            | `73.15.0.139`     | Aggiornamento 2021 #3  |
| Poly Trio C60           | `7.0.3.0517`      | Aggiornamento 2021 #2      |
| Poly CCX400/CCX500/CCX600   | `7.0.3.0515` | Aggiornamento 2021 #2                     |
| Codici audio C448HD/C450HD/C470HD   | `1.10.143`  | Aggiornamento 2021 #2           |
| Yealink T55/T56/T58   | `58.15.0.131`  | Aggiornamento 2021 #2                       |
| Yealink VP59   | `91.15.0.63`  | Aggiornamento 2021 #2                               |
| Yealink CP960  | `73.15.0.126`  | Aggiornamento 2021 #2                               |
| Yealink MP56/MP54/MP58  | `122.15.0.44` | Aggiornamento 2021 #2                       |
| Crestron UC-2  | `1.0.3.66` | Aggiornamento 2021 #2 |
| Poly Trio C60   | `7.0.2.1071`  | Aggiornamento 2021 #1                        |
| Poly CCX400/CCX500/CCX600   | `7.0.2.1072`  | Aggiornamento 2021 #1                 |
...
Per [informazioni sulle funzionalità supportate da questi dispositivi, vedere Microsoft Teams set](phones-for-teams.md) di funzionalità dei telefoni.
...
| Rilascio del prodotto| Data di rilascio | Microsoft Teams'app | Portale aziendale versione | Versione dell'agente di amministrazione |
|:----------------|:-------------|:----------------------------|:-----------------------|:--------------------|
| Aggiornamento 2022 #1  | 24 febbraio 2022 |`1449/1.0.96.2022011305`| `5.0.5304.0` | `1.0.0.202112100118.product version code : 322` |
...
| Yealink MeetingBar A30 | `133.15.0.80 `   | Aggiornamento 2022 #1   |
| Yealink CTP18 | ` 137.15.0.49 `    | Aggiornamento 2022 #1   |
...
| Modello di dispositivo  | Versione firmware | Rilascio del prodotto incluso|
|:--------------|:-----------------|:-------------------------|
|Visualizzazione ThinkSmart di Lenovo| `CD-18781Y.211116.114` |Aggiornamento 2021 #3  |
...
|Rilascio del prodotto| Data di rilascio | Microsoft Teams'app | Portale aziendale versione | Versione dell'agente di amministrazione |
|:----------------|:-------------|:----------------------------|:-----------------------|:--------------------|
|Aggiornamento #1A 2022 | Febuary 25, 2022 | `1449/1.0.97.2022730007` | `5.0.5304.0`  | `322` |
...
Per altre informazioni su come ottenere Teams, vedere [Come si ottiene l'accesso](https://support.office.com/article/fc7f1634-abd3-4f26-a597-9df16e4ca65b) a Microsoft Teams?
...
[Esplorare Microsoft Teams telefoni e dispositivi certificati.](https://products.office.com/microsoft-teams/across-devices/devices)

[Teams e Skype interoperabilità](../teams-skype-interop.md)
