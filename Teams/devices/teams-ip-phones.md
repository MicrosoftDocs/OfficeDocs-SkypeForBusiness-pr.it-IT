...
- Distribuito e gestito tramite l'interfaccia di amministrazione di Teams con l'integrazione di Intune

## <a name="currently-certified-teams-phones"></a>Telefoni Teams attualmente certificati

I dispositivi seguenti sono certificati nel programma di certificazione telefoni Microsoft Teams:
...
| Poly Trio 8500/8800 (solo modalità condivisa) | 5.9.0.10869                                                                                                                                                                                                                                | Giugno 2019                    |
| Yealink EXP50 supportato in T56, T58, MP56, MP58, VP59| Per ogni modello di dispositivo supportato, vedere aggiornare #7 firmware | Gennaio 2021 |
| Yealink MP58 | 122.15.0.27| Dicembre 2020 |
| Yealink MP54 | 122.15.0.27| Novembre 2020 |
| Yealink MP56 | 122.15.0.6 | Marzo 2020    |
| Yealink VP59 | 91.15.0.16 | Giugno 2019     |
| Yealink T55  | 58.15.0.36 | Maggio 2019      |
| Yealink CP 960| 73.15.0.20 | Dicembre 2018|
| Yealink T58 & serie T56 | 58.15.0.20 | Dicembre 2018 |

## <a name="currently-certified-teams-rooms-on-android"></a>Teams Rooms attualmente certificato su Android

I dispositivi seguenti sono certificati nel programma di certificazione Microsoft Teams Rooms per Android:

| Modello di dispositivo | Versione firmware | Data di rilascio  | Dimensioni della sala                                        |
|:------------------------|:-----------------|:--------------|:----------------------------------------------------------|
| Yealink MeetingBar A30       | 133.15.0.52    | Marzo 2021 | Sala di medie dimensioni (4,5 m x 6m) |
| Console touch Yealink CTP18  | 137.15.0.28    | Marzo 2021 | Compatibile con MeetingBar A20 e MeetingBar A30 |
| Yealink MeetingBar A20  | 133.15.0.19      | Novembre 2020 | Focus room(3m x 3m) </br> Sala riunioni di piccole dimensioni(4,5 m x 4,5 m) |
| Poly Studio X30         | 3.1.1.216109     | Giugno 2020     | Focus room(3m x 3m) </br> Sala riunioni di piccole dimensioni(4,5 m x 4,5 m) |
| Poly Studio X50         | 3.1.1.216109     | Giugno 2020     | Focus room(3m x 3m) </br> Sala riunioni di piccole dimensioni(4,5 m x 4,5 m) |
...
I dispositivi seguenti sono certificati nel programma di certificazione dello schermo di Microsoft Teams:
...
I dispositivi seguenti sono certificati nel programma di certificazione dei pannelli di Microsoft Teams:
...
### <a name="product-release-information-for-teams-phones"></a>Informazioni sulla versione del prodotto per i telefoni Teams

Di seguito sono riportate le versioni più recenti dell'app per telefono e del firmware di Teams.
...
|:----------------|:--------------|:----------------------------|:-----------------------|:--------------------|
| Aggiorna #7  | 8 dicembre 2020  |1449/1.0.94.2020111101 | 5.0.4927.0            | 1.0.0.202010121132.product (.223) |
| Aggiorna #6  | 12 ottobre 2020  |1449/1.0.94.2020091801     | 5.0.4912.0             | 1.0.0.202006290446.product(216) |
| Aggiorna #5  | 31 agosto 2020 | 1449/1.0.94.2020071702    | 5.0.4867.0             | 1.0.0.202006290446.product(216) |
| Aggiorna #4  | 30 giugno 2020 | 1449/1.0.94.2020051601      | 5.0.4771.0             | 1.0.0.202005060552  |
| Aggiorna #3  | 13 maggio 2020  | 1449/1.0.94.2020040801      | 5.0.4715.0             | 1.210               |

#### <a name="firmware-versions"></a>Versioni firmware

Quando si installa una nuova versione del firmware nel dispositivo, è possibile determinare le versioni installate corrispondenti dell'app Microsoft Teams, del portale aziendale e dell'agente di amministrazione. Trovare la versione del prodotto nella **colonna Rilascio** prodotto incluso e quindi cercare il rilascio del prodotto nella tabella delle versioni **delle app** precedente.

| Modello di dispositivo        | Versione firmware     | Rilascio del prodotto anno/incluso  |
|:--------------------|:---------------------|:-------------------------|
...
Per informazioni sulle funzionalità supportate da questi dispositivi, vedere Set di funzionalità per i telefoni di [Microsoft Teams.](phones-for-teams.md)

Vedere [Visualizzazione di Microsoft Teams](teams-displays.md).
...
Di seguito sono riportate le versioni più recenti di Teams Rooms per l'app Android e il firmware.

#### <a name="app-versions"></a>Versioni delle app

| Rilascio del prodotto| Data di rilascio | Versione dell'app Microsoft Teams | Versione del portale aziendale | Versione dell'agente di amministrazione |
|:----------------|:-------------|:----------------------------|:-----------------------|:--------------------|
| Aggiorna #3  |24 novembre 2020  |1449/1.0.94.2020102101  |5.0.4927.0     |1.0.0.202006290446.product version code: 216 |
| Aggiorna #2  | 24 agosto 2020| 1449/1.0.94.2020062501    | 5.0.4771.0    | 1.0.0.202005060552.product version code: 212|
| Aggiorna #1  | 13 maggio 2020 | .040901                     | .4715                  | .210                |
...
| Modello di dispositivo  | Versione firmware | Rilascio del prodotto anno/incluso |
|:--------------|:-----------------|:-------------------------|
| Yealink VC210 + CP900 | 118.15.0.42     | 2020, aggiornamento #3    |
| Poly Studio X30 | 3.2.3.280012          | 2020, aggiornamento #3    |
| Poly Studio X50 | 3.2.3.280012          | 2020, aggiornamento #3    |

### <a name="product-release-information-for-teams-displays"></a>Informazioni sulla versione del prodotto per Teams visualizzate

Di seguito sono riportate le versioni più recenti per l'app di visualizzazione e il firmware di Microsoft Teams.

#### <a name="app-versions"></a>Versioni delle app

|Rilascio del prodotto| Data di rilascio | Versione dell'app Microsoft Teams | Versione del portale aziendale | Versione dell'agente di amministrazione |
|:----------------|:-------------|:----------------------------|:-----------------------|:--------------------|
|Aggiorna #1  |22 ottobre 2020 |1449/1.0.95.2020092307    |5.0.4927.0              |1.0.0.202006290446.product|
...
| Modello di dispositivo  | Versione firmware | Rilascio del prodotto anno/incluso|
|:--------------|:-----------------|:-------------------------|
|Visualizzazione ThinkSmart di Lenovo| CD-18781Y.201006.099 |2020, aggiornamento #1 |
...
Le licenze di Microsoft Teams possono essere acquistate nell'ambito degli abbonamenti [a Microsoft 365 o Office 365.](/office365/servicedescriptions/teams-service-description) Per altre informazioni sulle licenze necessarie per l'uso di Microsoft Teams nei telefoni, vedere Licenze [di sistema telefonico disponibili.](https://products.office.com/microsoft-teams/voice-calling)
...
Se si è un fornitore che cerca di partecipare al programma di certificazione, vedere [Come](/skypeforbusiness/certification/how-to-join) partecipare per i requisiti e i programmi disponibili.

[Esplorare i telefoni di Microsoft Teams e i dispositivi certificati.](https://products.office.com/microsoft-teams/across-devices/devices)
