...
Ecco alcune operazioni che è possibile eseguire per gestire i dispositivi Teams Rooms mobili. Teams Rooms dispositivi sono disponibili [nell'interfaccia Microsoft Teams di amministrazione in](https://admin.teams.microsoft.com) **Dispositivi**  >  **Teams Rooms**.
...
I telefoni, le barre di collaborazione, Teams e i Teams vengono registrati automaticamente in Microsoft Intune se ci si è iscritti. Dopo la registrazione di un dispositivo, la conformità del dispositivo viene confermata e i criteri di accesso condizionale vengono applicati al dispositivo.
...
| Aggiungere o rimuovere tag per i dispositivi               | Selezionare uno o più dispositivi > **Gestisci tag**. Per altre informazioni sui tag dei dispositivi, vedere [Gestire Teams dispositivi.](manage-device-tags.md)                                                                                                                                                                 |
...
1. Nel riquadro di spostamento sinistro passare **a Dispositivi** > selezionare Teams tipo di dispositivo > profili **di configurazione**. Ad esempio, selezionare **Dispositivi** Teams i profili di configurazione per creare un nuovo profilo di configurazione per Teams  >    >   pannelli.
