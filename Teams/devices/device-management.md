...
Per gestire i dispositivi, ad esempio modificare la configurazione dei dispositivi, riavviare i dispositivi, gestire gli aggiornamenti o visualizzare l'integrità dei dispositivi e delle periferiche, è necessario avere uno dei ruoli di amministratore di Microsoft 365 seguenti:

- Microsoft 365 Amministratore globale
- Teams Amministratore del servizio
- Teams Amministratore del dispositivo

Per altre informazioni sui ruoli di amministratore in Teams, vedere Usare Teams [ruoli di](../using-admin-roles.md)amministratore per gestire Teams .

## <a name="what-devices-can-you-manage"></a>Quali dispositivi è possibile gestire?

Puoi gestire qualsiasi dispositivo certificato e registrato in Teams. Un dispositivo viene registrato automaticamente la prima volta che un utente accede a Teams sul dispositivo. Per un elenco dei dispositivi certificati che è possibile gestire, vedere:
...
Per gestire i dispositivi, nel riquadro di spostamento sinistro dell Microsoft Teams [di amministrazione](https://admin.teams.microsoft.com)passare a Dispositivi **e** quindi selezionare il tipo di dispositivo. Ogni tipo di dispositivo ha una propria sezione, che consente di gestirli separatamente.
...
Ecco alcune operazioni che è possibile eseguire per gestire i dispositivi Teams Rooms mobili. Teams Rooms dispositivi sono disponibili [nell'interfaccia Microsoft Teams di amministrazione](https://admin.teams.microsoft.com) in **Dispositivi**  >  **Teams Rooms**.
...
| Visualizzare la cronologia e la diagnostica dei dispositivi     | Nella colonna **Cronologia** fare clic sul **collegamento Visualizza** per un dispositivo per visualizzarne la cronologia degli aggiornamenti e i dettagli diagostici.                                                                                                                                                                                         |
...
1. Nel riquadro di spostamento sinistro passare **a** Dispositivi > selezionare Teams tipo di dispositivo > **profili di configurazione**. Ad esempio, selezionare **Dispositivi** Teams profili di configurazione per creare un nuovo profilo di configurazione per i Teams  >    >   mobili.
...
1. Nel riquadro di spostamento sinistro passare a **Dispositivi** > selezionare il tipo Teams dispositivo. Ad esempio, per assegnare un profilo di configurazione a un dispositivo Teams, selezionare Dispositivi  >  **Teams pannelli**.
