...
- **Vedere caratteristiche di anteprima**: attivare questa opzione per ottenere l'accesso anticipato alle nuove funzionalità.
...
- **URL del supporto tecnico per i** partecipanti: immettere l'URL di supporto dell'organizzazione che i partecipanti alla riunione possono usare se hanno bisogno di assistenza durante una riunione.
...
> [!IMPORTANT]
> Microsoft usa altre società per fornire notifiche in tempo Skype for Business per dispositivi mobili per Windows Phone, iPhone e iPad utenti. Vedere la presente [Informativa sulla privacy](https://go.microsoft.com/fwlink/p/?linkid=247732).
...
- **Conformità**: attiva questa opzione se sei legalmente obbligato a conservare le informazioni archiviate elettronicamente.