---
title: Aggiornamento Microsoft Teams all'abbonamento
author: SerdarSoysal
ms.author: serdars
manager: serdars
ms.topic: article
...
Teams gratuito è progettato per le piccole e medie imprese e ha le caratteristiche seguenti:
...
- Dopo l'aggiornamento non è possibile tornare Teams gratis.
- Non è possibile unire più tenant Teams in un singolo tenant a pagamento.
...
- Tutti gli utenti devono essere aggiornati: non è supportata una combinazione di Teams di abbonamenti gratuiti e a pagamento nello stesso tenant.
