...
Dopo aver seguito tutte le schede precedenti per configurare l'operatore automatico, fare clic sul pulsante seguente per passare all'articolo successivo.

> [!div class="nextstepaction"]
> [Passaggio successivo: Completare la configurazione di Business Voice](set-up-finish.md)
