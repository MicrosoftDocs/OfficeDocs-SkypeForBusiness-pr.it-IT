---
title: Configurare la Microsoft Teams Sistema telefonico con i numeri di telefono del piano per chiamate
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
description: Scopri come configurare le chiamate Microsoft Teams Sistema telefonico numeri di telefono del piano per chiamate per gli utenti e i servizi dell'organizzazione.
appliesto:
- Microsoft Teams
...
ms.locfileid: "63053255"
---
# <a name="step-2-set-up-teams-phone-system-phone-numbers"></a>Passaggio 2: Configurare i numeri Teams Sistema telefonico di telefono
...
2. Nel riquadro di spostamento sinistro passare a <a href="https://admin.teams.microsoft.com/phone-numbers" target="_blank">**Voce** >  **Telefono numeri**</a> e quindi fare clic su **Aggiungi**.
...
4. Nella pagina Ubicazione e quantità eseguire le operazioni seguenti:
    ...
    2. In **Tipo numero** selezionare una delle opzioni seguenti:
        ...
        - **Operatore automatico (numero verde)** Numero verde (Stati Uniti e Canada) o numero verde (Regno Unito). Le tariffe per le lunghe distanze vengono addebitate all'azienda. Prima di selezionare questa opzione, è necessario acquistare Crediti comunicazioni. Per altre informazioni, vedere Cosa è necessario acquistare per ottenere funzionalità vocali per le piccole [o medie imprese?](whats-business-voice.md).

    3. In **Quantità** selezionare **1**.
        > [!NOTE]
        > Se viene visualizzato il messaggio Non si hanno licenze sufficienti per richiedere più numeri di questo **tipo, assicurarsi** di aver acquistato Teams Telefono con licenze bundle piano chiamate. Per altre informazioni, vedere Cosa è necessario acquistare per ottenere funzionalità vocali per le piccole [o medie imprese?](whats-business-voice.md).
    4. Scegliere Località **o** **Codice** area, a seconda che si vogliano cercare numeri di telefono usando la città di una località o se si vogliono cercare numeri in un codice area specifico.
    5. Se si seleziona **Posizione**:

        1. Digitare la città in cui si trova l'indirizzo per gli [](set-up-emergency-locations.md) interventi di emergenza nel passaggio Configurare le posizioni per gli interventi di emergenza oppure, se è necessario creare una nuova posizione per un altro ufficio o un ufficio domestico, fare clic su Aggiungi una **posizione**.
