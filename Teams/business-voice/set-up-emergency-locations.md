---
title: Configurare le Microsoft 365 Teams Telefono con le località di emergenza del piano di chiamata
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
description: Scopri come configurare le località di emergenza per Microsoft 365 Teams Telefono con piano chiamate.
appliesto:
- Microsoft Teams
...
ms.locfileid: "61766889"
---
# <a name="step-1-set-up-a-teams-phone-emergency-location"></a>Passaggio 1: Configurare una posizione Teams Telefono di emergenza
...
2. Nel riquadro di spostamento sinistro passare a Posizioni <a href="https://admin.teams.microsoft.com/locations" target="_blank">   >  **indirizzi di emergenza.**</a>
