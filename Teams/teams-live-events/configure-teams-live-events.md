...
> [!NOTE]
> Se prevedi di creare eventi live usando un'app o un dispositivo esterno, dovrai anche [configurare il provider eCDN](../teams-stream-ecdn.md).
