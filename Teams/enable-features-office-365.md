---
title: Gestire le impostazioni di Microsoft Teams per l'organizzazione
author: LolaJacobsen
ms.author: lolaj
manager: serdars
ms.topic: article
...
Gli utenti possono caricare e condividere file dai servizi di archiviazione cloud in canali e chat di Teams. Le opzioni di archiviazione cloud di Teams attualmente includono ShareFile, Dropbox, Box e Google Drive. Attivare l'opzione per i provider di archiviazione cloud che l'organizzazione vuole usare.
