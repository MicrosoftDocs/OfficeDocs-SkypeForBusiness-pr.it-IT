...
|Sistema operativo  |    Windows 11, Windows 10 (escluso Windows 10 LTSC per l’app desktop di Teams), Windows 10 su ARM, Windows 8.1, Windows Server 2019, Windows Server 2016, Windows Server 2012 R2. Nota: è consigliabile usare la versione di Windows più recente e le patch di sicurezza disponibili.|
...
|Videochiamate e riunioni | <ul><li>Richiede un processore a due core. Per una risoluzione e una frequenza fotogrammi di condivisione video/schermo più elevate, si consiglia un processore a quattro core o superiore. </li><li>Per partecipare a una riunione usando il rilevamento della prossimità in una Microsoft Teams Room è necessario Bluetooth LE. Bluetooth LE richiede l'abilitazione del Bluetooth nel dispositivo client.</li></ul>
|
