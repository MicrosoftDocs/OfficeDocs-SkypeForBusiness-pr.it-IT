...
Potresti volere la soluzione più semplice Teams Telefono &mdash; piano per chiamate. Si tratta della soluzione all-in-the-cloud di Microsoft che fornisce funzionalità PBX (Private Branch Exchange) e chiamate alla rete PSTN (Public Switched Telephone Network), come illustrato nel diagramma seguente. Con questa soluzione, Microsoft è il gestore PSTN.
...
- Una soluzione combinata che usa Teams Telefono piano per chiamate, Teams Telefono con Connessione con operatore e/o Teams Telefono con Routing diretto


## <a name="what-do-you-need-to-read"></a>Cosa è necessario leggere?

**Obbligatorio per tutti.** Alcune delle sezioni di questo articolo riguardano tutte le organizzazioni. Ad esempio, tutti dovrebbero leggere le informazioni Teams Telefono e comprendere le opzioni per la connessione alla rete PSTN (Public Switched Telephone Network). 
...
Le chiamate tra utenti dell'organizzazione vengono gestite internamente all'interno di Teams Telefono e non passano mai alla rete PSTN (Public Switched Telephone Network). Questo vale per le chiamate tra utenti dell'organizzazione che si trovano in aree geografiche diverse, rimuovendo i costi a lunga distanza per queste chiamate interne.

In questo articolo vengono presentate le Teams Telefono caratteristiche e funzionalità principali e le decisioni di distribuzione da prendere in considerazione:
...
- [Case study sulla migrazione vocale di Contoso](voice-case-study-overview.md)<br>
  ...
  - [Teams Telefono di connettività PSTN e pstn](voice-case-study-phone-system.md)
