...
Per altre informazioni sui ruoli Teams di amministratore, vedere Usare Teams [ruoli di amministratore](using-admin-roles.md)per gestire Teams . Per informazioni su come assegnare ruoli di amministratore in Azure Active Directory, vedere Visualizzare e [assegnare ruoli in Azure Active Directory](/Azure/active-directory/users-groups-roles/directory-manage-roles-portal).
...
- Per scaricare un file di dati esistente, passare a Microsoft Teams interfaccia **di** amministrazione  >  **Call Quality Dashboard** Upload  >  **adesso**. **Nell'elenco Caricamenti** fare clic su **Scarica** accanto al file desiderato. 
