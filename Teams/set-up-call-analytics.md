...
ms.custom:
- Reporting
description: Configurare l'analisi delle chiamate per utente per identificare e risolvere Microsoft Teams problemi di qualità delle chiamate.
ms.openlocfilehash: be93a24f7d18e5b347c6375622ca47c3bdaeae26
ms.sourcegitcommit: cbdc80c302e97d18a923ef57bb5d4b6cf7676d00
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 03/30/2022
ms.locfileid: "64556477"
---
# <a name="set-up-call-analytics-for-microsoft-teams"></a>Configurare l'analisi delle chiamate per Microsoft Teams

L'amministratore Microsoft Teams, è possibile usare l'analisi delle chiamate per utente per risolvere i problemi Teams la qualità delle chiamate e i problemi di connessione per **i singoli utenti**. Per sfruttare al meglio l'analisi delle chiamate, configurare quanto segue:
  
- Assegnare ruoli di supporto specializzati a persone, ad esempio agenti helpdesk, per consentire loro di visualizzare l'analisi delle chiamate per gli utenti. Questi ruoli di supporto non possono accedere al resto dell'Teams di amministrazione. 
...
Per altre informazioni sui ruoli Teams di amministratore, vedere Usare Teams [ruoli di](using-admin-roles.md) amministratore per gestire Teams. Per informazioni su come assegnare ruoli di amministratore in Azure Active Directory, vedere [Visualizzare e assegnare ruoli in Azure Active Directory](/Azure/active-directory/users-groups-roles/directory-manage-roles-portal).
...
- Per scaricare un file di dati esistente, passare  > **Microsoft Teams'interfaccia di amministrazioneAnalytics & reportCall** >  **Quality Dashboard** >  **Upload adesso**. **Nell'elenco Caricamenti** fare clic su **Scarica** accanto al file desiderato. 
