...
ms.locfileid: "64737604"
---
# <a name="microsoft-teams-device-health-monitoring"></a>monitoraggio dell'integrità del dispositivo Microsoft Teams
...
1. Nel riquadro di spostamento sinistro dell'interfaccia di amministrazione di Microsoft Teams selezionare **Notifiche &** **avvisiSezioni** > .
...
3. Selezionare il dispositivo per configurare la regola di stato per l'abilitazione degli avvisi.
    ...
    ![Teams pagina della regola dello stato dei dispositivi.](../media/device-state-rule.png )
...
|Campo |Descrizione  |
|--------|-------------|
|**Tipo di regola**   |La regola dello stato del dispositivo consente di gestire in modo efficace. Teams dispositivi e viene classificato come tipo di gestione dei dispositivi. In futuro saranno disponibili altre regole di tipo gestione dispositivi per monitorare altre funzionalità correlate (ad esempio: dispositivo non integro e stato di accesso del dispositivo).|
|**Condizione**   |Puoi monitorare l'integrità dei dispositivi se passano offline. [Altre informazioni](../devices/device-management.md) sulla gestione dei dispositivi nell Teams interfaccia di amministrazione. |
...
|**Azioni** >  **Avviso canale**   |Nella sezione Azioni è possibile specificare i canali dei team per cui ricevere avvisi. Attualmente, verrà creato un team predefinito denominato **Avvisi di amministrazione e Notifiche** e un canale denominato **MonitoringAlerts** a cui verranno recapitate le notifiche. <BR/> <BR/> Gli amministratori globali e gli amministratori Teams nel tenant verranno aggiunti automaticamente a questo team predefinito.|
...
1. È possibile selezionare Teams dispositivi da monitorare selezionando gli utenti che hanno eseguito l'accesso a tali dispositivi. Seleziona **Aggiungi** nella sezione **Utenti dispositivo** .
...
Le notifiche vengono recapitate nel canale **MonitoringAlerts** creato automaticamente del team **di avvisi e notifiche dell'amministratore** . Riceverai un avviso entro 15 minuti dalla modalità offline del dispositivo. 
