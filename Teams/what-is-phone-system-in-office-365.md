...
ms.locfileid: "36184822"
---
# <a name="what-is-phone-system-in-office-365"></a>Che cos’è il Sistema telefonico in Office 365?

## <a name="phone-system-in-office-365-and-skype-for-business-server"></a>Sistema telefonico in Office 365 e Skype for Business Server

**Phone System** è la tecnologia Microsoft per l'abilitazione delle funzionalità di controllo delle chiamate e PBX nel cloud di Office 365 con Skype for business online e Microsoft teams. Sistema telefonico consente di sostituire il sistema PBX esistente con un set di funzionalità fornite da Office 365 e strettamente integrate nell'esperienza cloud dell'organizzazione. Per altre informazioni sulle funzionalità, vedere [Ecco cosa si ottiene con il sistema telefonico in Office 365](here-s-what-you-get-with-phone-system.md).
  
Con il sistema telefonico, gli utenti possono usare Skype for business online e Microsoft teams per gestire le attività di controllo delle chiamate di base, ad esempio l'immissione e la ricezione di chiamate, il trasferimento di chiamate e la soppressione e l'esclusione delle chiamate. Gli utenti del sistema telefonico possono fare clic su un nome nella propria rubrica, mentre Skype for business o Microsoft teams effettua una chiamata a quella persona. Per effettuare e ricevere chiamate, gli utenti del sistema telefonico possono usare i loro dispositivi mobili, un auricolare con un portatile o un PC o uno dei numerosi telefoni IP che funzionano con Skype for business e Microsoft teams. Per gli amministratori, il sistema telefonico offre la possibilità di gestire le chiamate all'interno della stessa console di amministrazione usata per la messaggistica, la collaborazione e così via.
...
- Con l'acquisto di un piano per le chiamate (nazionale o nazionale e internazionale) per Office 365. Vedere [sistema telefonico e piani per chiamate](calling-plan-landing-page.md)
    

- Usando la connettività PSTN locale, dove il software in locale si connette con l'infrastruttura di telefonia esistente. Vedere [soluzioni](https://docs.microsoft.com/SkypeForBusiness/hybrid/msft-telephony-solutions)per la telefonia Microsoft.


## <a name="more-about-calling-plans"></a>Ulteriori informazioni sui piani di chiamata

L'uso di un componente aggiuntivo piano per la chiamata al sistema telefonico in Office 365 consente la connettività PSTN per la chiamata a telefoni fissi e cellulari in tutto il mondo (a seconda del livello di servizio concesso in licenza). Gli utenti sono ospitati nel cloud e sono abilitati per il sistema telefonico con il componente aggiuntivo piano chiamante fornito da Microsoft. L'uso di piani di chiamata non richiede una distribuzione locale del server. I piani per le chiamate funzionano solo con il sistema telefonico in Office 365 e non è possibile usare i piani di chiamata con un altro sistema PBX.

![Diagramma di topologia che mostra cloud PBX con chiamate PSTN](media/3e847ec3-f441-4833-8616-c5ebab094e3e.png)

Poiché i piani di chiamata operano in Office 365, si tratta di un'offerta completamente in cloud che non richiede una distribuzione locale del server. Puoi scegliere di usare un piano per chiamate nazionali o nazionali e internazionali, che verranno assegnati a ogni utente che vuoi effettuare chiamate. [Altre informazioni](calling-plan-landing-page.md)
  
Gli utenti residenti in Skype for business online o Microsoft teams in Office 365 avranno accesso a Office 365 Voice Services. Microsoft è il provider di servizi PSTN e delle chiamate di base e può anche consentire o trasferire i numeri di telefono degli utenti. 
...
## <a name="phone-system-with-services"></a>Sistema telefonico con servizi
 Il sistema telefonico può essere usato in Aso per servizi e segreteria telefonica:
...
- **Segreteria telefonica** Quando si riceve una licenza di sistema telefonico per un utente, l'utente potrà ottenere la segreteria telefonica che è stata lasciata dai chiamanti. La segreteria telefonica cloud viene automaticamente configurata e provisionata per gli utenti dopo l'assegnazione di una licenza di sistema telefonico e di un numero di telefono. Vedere [configurare la segreteria telefonica cloud](set-up-phone-system-voicemail.md).
