...
> [!NOTE]
> È necessario configurare Crediti comunicazioni e quindi assegnare una licenza Crediti comunicazioni per ogni utente nell'interfaccia di amministrazione Microsoft 365  >  **utenti**  >  **attivi**. Le licenze di Crediti comunicazioni vengono visualizzate come illimitate in quantità, in quanto vengono usate per concedere l'accesso al saldo Crediti comunicazioni per qualsiasi utente a cui si assegna la licenza Crediti comunicazioni.
...
> [!NOTE]
> Per visualizzare i piani e i [prezzi,](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) accedere all'interfaccia di amministrazione Microsoft 365 fatturazione e andare a **Abbonamenti**  >  **fatturazione**  >  **Aggiungere abbonamenti**. 
  
**Nell'Microsoft 365 di amministrazione** di  >  **Billing**  >  **Purchase Services**  >  **Adds** è possibile selezionare Crediti comunicazioni per aggiungere i crediti e aggiungere il credito manualmente in qualsiasi momento. È possibile anche abilitare l'opzione **Autoricarica**, che consente di ricaricare automaticamente l'account quando il saldo scende al di sotto della soglia impostata. Se si sceglie di pagare i Crediti comunicazioni versando l'importo in un'unica soluzione e il saldo scende a zero, i servizi di chiamata aggiuntivi illustrati in precedenza non saranno più disponibili. Per questo, è consigliabile utilizzare la funzione " **Autoricarica** " per evitare qualsiasi interruzione del servizio, nel caso in cui i Crediti comunicazioni arrivino a 0 (zero). Per visualizzare il saldo corrente dei Crediti comunicazioni, accedere a **Fatturazione** Dei tuoi prodotti Crediti  >    >  **comunicazioni**.
...
È anche possibile visualizzare informazioni sui prezzi accedendo all'interfaccia di amministrazione [Microsoft 365](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) e accedendo a **Servizi** di  >  **acquisto fatturazione.**
