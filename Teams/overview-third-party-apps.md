...
Microsoft garantisce che gli amministratori abbiano il controllo sulle app di terze parti e che solo le app di alta qualità siano disponibili nel Teams Store. Tutte le app devono eseguire una fase di convalida obbligatoria che verifica la funzionalità dell'app, l'identità dello sviluppatore, le autorizzazioni richieste dall'app e i controlli relativi a conformità, privacy, gestione dei dati e sicurezza dei dati. Consigliamo alle app di far parte di un programma facoltativo per dimostrare una maggiore attenzione alla conformità agli standard di settore, alla gestione dei dati e alla sicurezza. Per informazioni su questi programmi, vedere gli articoli seguenti:
