...
f1keywords: ''
description: Scopri come acquistare app di terze parti per Teams nell'Microsoft Teams di amministrazione.
appliesto:
- Microsoft Teams
...
- La fatturazione tramite fattura è disponibile solo per gli amministratori globali o un amministratore con autorizzazioni di amministratore Teams servizio e amministratore fatturazione.
