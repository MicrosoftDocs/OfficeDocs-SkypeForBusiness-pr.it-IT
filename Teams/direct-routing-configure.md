...
Per un elenco completo dei controller SBC supportati, vedere Elenco dei controller di [bordo di sessione certificati per il routing diretto.](direct-routing-border-controllers.md)

Per configurare Telefono Microsoft sistema e consentire agli utenti di usare Routing diretto, seguire questa procedura: 
...
Se si sta configurando un SBC per più tenant, è anche necessario leggere Configurare un [SBC per più tenant.](direct-routing-sbc-multiple-tenants.md)
