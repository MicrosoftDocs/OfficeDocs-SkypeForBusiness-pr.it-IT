...
- **Numeri di servizio** I numeri di servizio sono disponibili in diversi tipi di numero e la disponibilità varia in base al paese/area geografica.
    
  - **Numeri di servizio a pedaggio**
    
    I numeri di servizio a pedaggio possono sostenere un costo a pedaggio per il chiamante e sono disponibili due tipi:
