...
ms.collection:
- M365-collaboration
description: Informazioni sulla scadenza e il rinnovo del team e su come usare Microsoft 365 criteri di scadenza del gruppo per pulire automaticamente i team inutilizzati Microsoft Teams.
f1.keywords:
- NOCSH
appliesto:
- Microsoft Teams
