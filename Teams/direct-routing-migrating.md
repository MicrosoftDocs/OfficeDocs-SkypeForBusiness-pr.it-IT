...
- Sistema telefonico connettività PSTN locale usando Cloud Connector Edition (per Skype for Business Online)
...
```
## <a name="migrating-from-office-365-phone-system-with-on-premises-pstn-connectivity-in-skype-for-business-server"></a>Migrazione da Sistema telefonico di Office 365 con connettività PSTN locale in Skype for Business Server
...
## <a name="migrating-from-office-365-phone-system-with-on-premises-pstn-connectivity-via-cloud-connector-edition"></a>Migrazione da Sistema telefonico di Office 365 con connettività PSTN locale tramite Cloud Connector Edition 
