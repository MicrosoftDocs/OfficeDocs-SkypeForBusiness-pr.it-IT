...
- Esperienza utente semplificata in Teams, centrata su riunioni Teams, team e canali (che, facoltativamente, può essere nascosta usando il criterio [Autorizzazioni app](teams-app-permission-policies.md)); Teams le [chat private,](teams-client-experience-and-conformance-to-coexistence-modes.md) le chiamate e l'auto-presenza non vengono esposte in Meetings First, consentendo agli sforzi di distribuzione e adozione di concentrarsi completamente sulle riunioni.
...
Gli unici requisiti rigidi per Meetings First sono gli stessi di Teams con Active Directory locale e una distribuzione locale Skype for Business locale:

- [Prerequisiti generali per l'Teams](upgrade-plan-journey-prerequisites.md), inclusi
...
Una [Skype for Business ibrida non](/skypeforbusiness/hybrid/configure-federation-with-skype-for-business-online) è necessaria, ma è consigliabile. Alcune funzionalità, ad esempio servizio di migrazione riunioni e interoperabilità, si basano su tale topologia.

Meetings First è supportato con qualsiasi versione del Skype for Business Server (e noto per funzionare con Lync Server non più supportato). È supportato con qualsiasi client Skype for Business supportato, tuttavia le funzionalità Better Together richiedono un client recente.
...
Per la migliore esperienza di Meetings First, gli utenti devono essere abilitati per [Exchange Online,](exchange-teams-interact.md) [SharePoint Online](sharepoint-onedrive-interact.md)e OneDrive for Business e Microsoft 365 creazione di gruppi. Meetings First è supportato per gli utenti la cui cassetta postale si trova Exchange locale o che non hanno SharePoint Online o OneDrive For Business o la creazione Microsoft 365 gruppo. Tuttavia, la loro esperienza sarà meno completa. In particolare, per le organizzazioni che usano Exchange Server locale, potrebbero esserci (a seconda della versione di Exchange Server) alcune limitazioni alla creazione e alla visualizzazione di riunioni dal client di Teams, oltre che per quanto riguarda le funzionalità di conformità.
