...
- Esperienza utente semplificata in Teams, centrata su riunioni Teams e team e canali (che, facoltativamente, può essere nascosta usando il criterio [Autorizzazioni app](teams-app-permission-policies.md)); Teams le [chat private,](teams-client-experience-and-conformance-to-coexistence-modes.md) le chiamate e l'auto-presenza non vengono esposte in Meetings First, consentendo agli sforzi di distribuzione e adozione di concentrarsi completamente sulle riunioni.
...
- "Meglio insieme" tra Teams e Skype for Business: 
  ...
  - Riconciliazione del controllo HID del dispositivo USB (disponibile anche per Mac): i controlli HID sono rispettati da Teams durante le riunioni Teams e da Skype for Business in tutte le altre circostanze.
