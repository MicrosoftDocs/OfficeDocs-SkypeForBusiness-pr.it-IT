...
"Meetings First" è rivolto e ottimizzato per le organizzazioni Skype for Business Server con VoIP aziendale locali che vogliono iniziare Teams usare le riunioni Teams il più rapidamente possibile. Per queste organizzazioni, Meetings First è  un'alternativa all'uso della modalità Isole che assegna priorità all'esperienza Teams riunioni.
...
- [Servizio di migrazione riunioni:](/skypeforbusiness/audio-conferencing-in-office-365/setting-up-the-meeting-migration-service-mms)le riunioni organizzate dall'utente verranno migrate nel cloud e convertite in riunioni Teams quando l'utente viene alzato di livello in Riunioni prima (richiede Exchange Online).
- Esperienza utente semplificata in Teams, centrata su riunioni Teams e team e canali (che facoltativamente possono essere nascosti usando il criterio [Autorizzazioni app](teams-app-permission-policies.md)); Teams le [chat private, le chiamate](teams-client-experience-and-conformance-to-coexistence-modes.md) e l'auto-presenza non vengono esposte in Meetings First, consentendo alle attività di distribuzione e adozione di concentrarsi completamente sulle riunioni.
...
Per la migliore esperienza di Meetings First, gli utenti devono essere abilitati per [Exchange Online,](exchange-teams-interact.md) [SharePoint Online](sharepoint-onedrive-interact.md)e OneDrive for Business e Microsoft 365 creazione di gruppi. Riunioni prima è supportato per gli utenti la cui cassetta postale si trova Exchange locale o che non hanno SharePoint Online o OneDrive For Business o che Microsoft 365 creazione di gruppi. Tuttavia, la loro esperienza sarà meno completa. In particolare, per le organizzazioni che usano Exchange Server locale, potrebbero esserci (a seconda della versione di Exchange Server) alcune limitazioni alla creazione e alla visualizzazione di riunioni dal client Teams, oltre che per quanto riguarda le funzionalità di conformità.
...
Per consentire agli utenti di avere la migliore esperienza possibile Teams riunioni, è consigliabile:
...
- Aggiornare le sale riunioni con [](/skypeforbusiness/certification/devices-meeting-rooms?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fMicrosoftTeams%2ftoc.json)Teams dispositivi e soluzioni per le sale riunioni o usare [Cloud Video Interop](cloud-video-interop.md) per Microsoft Teams per consentire alle sale e ai dispositivi di terze parti esistenti di partecipare a Teams riunioni.
...
Facoltativamente, è consigliabile nascondere l'applicazione Teams e canali dal riquadro di spostamento sinistro del client di Teams degli utenti per concentrare ulteriormente la propria esperienza sulle riunioni, che possono essere ottenute usando il criterio Configurazione [app.](teams-app-setup-policies.md)
