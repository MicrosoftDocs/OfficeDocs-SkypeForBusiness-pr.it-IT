...
Meetings First potrebbe non essere utile per le organizzazioni che non hanno VoIP aziendale utenti. Queste organizzazioni dovrebbero essere in grado di eseguire l'aggiornamento **a Teams** solo non appena saranno in grado di adottare Teams riunioni. È consigliabile ignorare prima le riunioni.
...
- Esperienza utente semplificata in Teams, centrata su riunioni Teams, team e canali (che facoltativamente possono essere nascosti usando il criterio [Autorizzazioni app](teams-app-permission-policies.md)); [Teams le chat private, le chiamate e l'auto-presenza](teams-client-experience-and-conformance-to-coexistence-modes.md) non vengono esposte in Meetings First, consentendo agli sforzi di distribuzione e adozione di concentrarsi completamente sulle riunioni.
- Esperienza [Teams riunione .](tutorial-meetings-in-teams.yml)
- "Meglio insieme" tra Teams e Skype for Business: 
  - Blocco automatico: quando si è in una riunione in Teams, quando si riceve una chiamata in Skype for Business la riunione Teams viene sospeso e viceversa. In questo modo gli utenti non potranno vedere le chiamate private dei partecipanti alle riunioni.
