...
audience: admin
ms.reviewer: lsomi
description: 'Informazioni su Meetings First, in cui gli utenti possono creare la riunione in Teams, continuando a usare le Skype for Business per chat, chiamate e presenza.'
...
- [Eseguire il provisioning Skype for Business Server utente (locale)](./tutorial-audio-conferencing.yml?tutorial-step=3) con audioconferenza Teams [audioconferenze](tutorial-audio-conferencing.yml).
- [Servizio di migrazione riunioni](/skypeforbusiness/audio-conferencing-in-office-365/setting-up-the-meeting-migration-service-mms): le riunioni organizzate dall'utente verranno migrate nel cloud e convertite in riunioni Teams quando l'utente viene alzato di livello in Riunioni per prime (richiede Exchange Online).
- Esperienza utente semplificata in Teams, centrata su riunioni Teams, team e canali (che facoltativamente possono essere nascosti usando il criterio [Autorizzazioni app](teams-app-permission-policies.md)); [Teams le chat private, le chiamate e l'auto-presenza](teams-client-experience-and-conformance-to-coexistence-modes.md) non vengono esposte in Meetings First, consentendo alle attività di distribuzione e adozione di concentrarsi completamente sulle riunioni.
...
- [Prerequisiti generali per le](upgrade-plan-journey-prerequisites.md) Teams, tra cui
...
Una [Skype for Business ibrida](/skypeforbusiness/hybrid/configure-federation-with-skype-for-business-online) non è necessaria, ma è consigliabile. Alcune funzionalità, ad esempio servizio di migrazione riunioni e interoperabilità, si basano su tale topologia.
...
- Aggiornare le sale riunioni con Teams dispositivi e soluzioni per [](/skypeforbusiness/certification/devices-meeting-rooms?bc=%2fmicrosoftteams%2fbreadcrumb%2ftoc.json&toc=%2fMicrosoftTeams%2ftoc.json)le sale riunioni o usare [Cloud Video Interop per Microsoft Teams per](cloud-video-interop.md) consentire alle sale e ai dispositivi di terze parti esistenti di partecipare Teams riunioni.
...
Dopo aver esaminato questo articolo, è consigliabile consultare Scegliere il percorso di [aggiornamento, indicazioni](upgrade-and-coexistence-of-skypeforbusiness-and-teams.md) sulla migrazione e l'interoperabilità [e Coesistenza](coexistence-chat-calls-presence.md) con Skype for Business per altri dettagli. [](migration-interop-guidance-for-teams-with-skype.md)
