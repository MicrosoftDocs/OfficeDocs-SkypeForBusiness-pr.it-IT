...
layout: HubPage
hide_bc: true
title: Documentazione tecnica di Microsoft Teams
ms.reviewer: ''
ms.author: kenwith
audience: admin
manager: serdars
author: kenwith
description: Documentazione tecnica di Microsoft Teams
ms.topic: hub-page
...
ms.locfileid: "42028277"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Documentazione tecnica di Microsoft Teams</h1>
        <P> </p>
        <ul class="pivots">
            <li>
                <a href="#home"></a>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Benvenuto in Teams</h3>
                                                <P>Panoramica di Teams e informazioni tecniche per amministratori di Teams o professionisti IT</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Aggiornamento da Skype for Business a Teams</h3>
                                                <P>Indicazioni e strumenti per esplorare il percorso ottimale verso Teams</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Hub di adozione</h3>
                                                <P>Strumenti per supportare l'implementazione di Teams</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Formazione e video</h3>
                                                <P>Formazione su Teams per tecnici e utenti</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Poster: soluzioni di telefonia e architettura di Teams</h3>
                                                <P>Illustrazioni stampabili di soluzioni di telefonia e architettura IT di Teams</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Espandere Teams nell'organizzazione</h3>
                                                <P>Soluzioni personalizzate per ogni settore, inclusi sanità, operatori sul campo, commercio al dettaglio, enti pubblici e istruzione</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Tech Community di Teams</h3>
                                            <p>Nella community tecnica di Teams si possono porre domande, ottenere risposte e leggere il blog di Teams</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Guida di Teams per utenti finali</h3>
                                            <p>Guida, corsi di formazione e novità per gli utenti finali</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <a href="https://docs.microsoft.com/microsoftteams/platform/overview"> <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Piattaforma di sviluppo di Teams</h3>
                                            <p>Informazioni sulla piattaforma di sviluppo di Microsoft Teams e su come usarla per creare app utili e potenti</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
