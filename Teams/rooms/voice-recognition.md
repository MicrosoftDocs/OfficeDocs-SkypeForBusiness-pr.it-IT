...
description: Informazioni sul controllo di Amministrazione tenant per il riconoscimento vocale (profilo vocale) nelle Teams sale riunioni.
...
> [!NOTE]
> L'altoparlante intelligente è disponibile in tutti i paesi e in tutte le aree geografiche tranne l'India, che non è ancora supportata. Per un elenco delle impostazioni locali attualmente supportate per la registrazione biometrica e la trascrizione in riunione, vedere [Impostazioni locali supportate](#supported-locales) .
...
2. Imposta le impostazioni del dispositivo Teams in modo che corrispondano al microfono e all'altoparlante dell'altoparlante dell'altoparlante intelligente.
...
I dati del profilo vocale possono essere usati in qualsiasi riunione con un altoparlante intelligente. Per informazioni sulle impostazioni della riunione, vedere [criteri di Teams riunioni](../meetings-policies-recording-and-transcription.md#allow-transcription) e [i cmdlet delle riunioni di PowerShell](/powershell/module/skype/set-csteamsmeetingpolicy).
...
|AllowTranscription|Obbligatorio per gli account utente e Teams chat room.|**Vero** e **Falso**|
||||

Nell'interfaccia di amministrazione di Teams impostare i criteri **di trascrizione**. Impostazioni sono **disattivate** per impostazione predefinita.
...
**I dati del profilo vocale vengono utilizzati in servizi Microsoft?**

No, i dati del profilo vocale vengono utilizzati solo per lo scopo per cui l'utente ha fornito il consenso. Microsoft non utilizzerà i dati del profilo vocale se non all'interno di Teams scenari di riconoscimento vocale.
