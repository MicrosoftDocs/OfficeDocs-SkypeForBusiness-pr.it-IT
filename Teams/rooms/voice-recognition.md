...
Un altoparlante intelligente usa le informazioni del profilo vocale per riconoscere chi ha detto cosa nella trascrizione in tempo reale. Quando una Microsoft Teams Rooms per Windows sala riunioni è dotata di un altoparlante intelligente, durante la riunione è possibile usare la trascrizione in tempo reale. Questo articolo spiega come l'amministratore del tenant controlla la profilatura vocale usata per il riconoscimento vocale per generare la trascrizione in tempo reale. È possibile controllare in che misura l'organizzazione usa il riconoscimento vocale e le caratteristiche seguenti:
...
No, i dati del profilo vocale vengono usati solo per lo scopo per cui l'utente ha fornito il consenso. Microsoft non userà i dati del profilo vocale se non negli Teams di riconoscimento vocale.
