...
## <a name="closing-customer-reported-incident-tickets"></a>Chiusura dei ticket di eventi imprevisti segnalati dal cliente
...
1. Seleziona **Chiudi ticket**.
   ...
   ![screenshot dei dettagli della panoramica degli eventi imprevisti](../media/customer-reported-incidents-003.png)
...
1. Scegli un motivo per la chiusura selezionando una categoria dall'elenco.
   ...
   ![screenshot del ticket chiuso](../media/customer-reported-incidents-004.png)
...
Nella sezione Panoramica dettagli del ticket viene indicato che il ticket è stato chiuso dal servizio Managed Rooms (Microsoft) o dal nome del cliente/partner.  
 ...
 ![screenshot che mostra chi ha chiuso il ticket ](../media/customer-reported-incidents-005.png)
