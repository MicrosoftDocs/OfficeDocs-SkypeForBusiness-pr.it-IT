...
|  Dispositivi Cisco room non in grado di partecipare alla riunione Teams   |    La partecipazione a una riunione di teams tramite Direct Guest join da un dispositivo room Cisco non riesce e la chiamata termina dopo che un utente seleziona **partecipa**. |  Una modifica nel client Web teams che consente ai dispositivi Cisco room di partecipare alle riunioni di Teams ha causato questa regressione. Stiamo rilasciando una correzione per questo problema che verrà distribuito in tutti i tenant da 1/15/2020. Cisco e Microsoft collaborano per evitare problemi simili in futuro.   |  Nessuno |
...
_*_ Microsoft teams Rooms è un'applicazione con più finestre e richiede la connessione di una facciata dello schermo della sala alla porta HDMI del dispositivo, perché l'app funzioni correttamente. Verificare che sia collegato uno schermo HDMI oppure usare un connettore HDMI fittizio se si sta testando e non è ancora stato acquistato uno schermo.
_** <a name="See"> </a>  
