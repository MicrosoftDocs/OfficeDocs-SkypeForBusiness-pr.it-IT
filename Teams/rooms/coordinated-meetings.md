...
- [Creare Surface Hub account del dispositivo 2S](/surface-hub/surface-hub-2s-account)
...
| **Impostazione predefinita video**      | Determina il dispositivo in cui la fotocamera sarà attiva all'avvio di una riunione. Per un'esperienza ottimale, è consigliabile impostare su solo il Teams Rooms mentre tutti gli altri `true` dispositivi sono impostati su `false` .          |
...
5. Se **audio predefinito** nel foglio di lavoro è , impostare Attiva microfono del dispositivo su Attiva, altrimenti `true` lasciarlo _disattivato._ 
