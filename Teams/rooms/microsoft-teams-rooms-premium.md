...
|**Registrazione sala**   |Facile onboarding con l'autoregistrazione dei dispositivi della chat room nel Microsoft Teams Rooms servizio gestito.          |
...
|  |  |
|---------|---------|
|**Ambito**   |Gli eventi correlati all'app sala riunioni, ai dispositivi della sala e alle periferiche sono inclusi nel Microsoft Teams Rooms del servizio gestito.|
...
|**Reindirizzamento al supporto OEM (Original Equipment Manufacturer)**    |Il Microsoft Teams Rooms soC del servizio gestito funziona per comprendere il problema e, se applicabile, aiuta a coordinare il supporto con l'OEM. In alcuni casi, l'utente potrebbe essere responsabile dell'impegno diretto con l'OEM.         |
...
|I clienti ricevono indicazioni per portare le proprie sale agli standard consigliati Microsoft Teams Rooms servizio gestito dall'onboarding    |Le indagini relative a immagini software personalizzate all'interno o non conformi alle indicazioni consigliate per la versione del software Microsoft Teams Rooms il servizio gestito non sono nell'ambito.          |         |
...
- [Microsoft Teams Rooms servizio gestito](https://rooms.microsoft.com)
