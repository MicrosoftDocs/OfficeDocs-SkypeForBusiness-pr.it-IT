...
*I dispositivi audio giusti per ogni spazio*:
...
# <a name="signature-teams-room"></a>[Signature Teams Room](#tab/emtr)

## <a name="signature-teams-room"></a>Signature Teams Room

![Rendering di una sala riunioni Di Teams Signature.](../media/emr1.png)

Questa sezione illustra come Microsoft stia trasformando le sale riunioni standard in Signature Microsoft Teams Rooms che offre il meglio della nuova esperienza in prima fila di Teams. Usare questo articolo per la progettazione di sale e le indicazioni tecnologiche, i prodotti consigliati e le specifiche di riferimento per le strutture aziendali Microsoft.

## <a name="microsofts-vision-for-the-future-of-meeting-rooms"></a>Visione di Microsoft per il futuro delle sale riunioni

Il futuro del lavoro sarà fluido, dinamico e basato sul cloud. Microsoft abilita esperienze di riunione che consentono alle persone di essere lì, ovunque e in qualsiasi momento. Queste riunioni sono ibride, il che significa che è possibile parteciparvi senza problemi. Le riunioni che usano dispositivi ottimizzati per Signature Teams Rooms sono incluse; ogni voce viene ascoltata e tutti sono chiaramente rappresentati.
...
## <a name="what-is-a-signature-teams-room"></a>Che cos'è una Sala riunioni Di Teams Signature?

Nell'ambiente di lavoro ibrido di Microsoft, gli standard di sala di nuova generazione sono informati dalle esigenze dei partecipanti remoti e in sala. Una sala riunioni Signature Teams è progettata per offrire un'esperienza di riunione ibrida *elevata* , promuovendo connessioni più naturali e coinvolgenti, consentendo a tutti i partecipanti alla riunione di sentirsi inclusi, rappresentati e produttivi. La stanza segue una serie di principi resi reali attraverso una combinazione di Teams Rooms funzionalità software e hardware e linee guida per la configurazione della sala.

Il concetto per Signature Teams Room è progettato intorno a due obiettivi chiave supportati da un set di principi di esperienza.
...
Un'esperienza Signature Teams Room è costituito da tutti questi componenti e idee messi insieme senza una singola funzionalità che definisce l'esperienza. Le singole funzionalità e i concetti contenuti in Signature Teams Rooms possono essere distribuiti autonomamente.
...
![Rendering di una sala riunioni Di Teams Signature da una vista dall'alto.](../media/emr5.png)
...
Il contenuto della riunione è circondato da componenti fluidi contestuali come agenda, attività e note, che possono essere aggiornati in tempo reale, consentendo ai partecipanti di rimanere coinvolti e produttivi. Inoltre, la chat della riunione viene visualizzata chiaramente in modo che, quando si partecipa a una riunione di Teams da una sala riunioni di Teams, sia possibile visualizzare e partecipare facilmente alla conversazione in tempo reale. In una sala riunioni Di Teams Signature, questo contenuto viene visualizzato su uno schermo con proporzioni ampie per aumentare le dimensioni del contenuto della riunione e il numero di partecipanti che possono essere visualizzati contemporaneamente.

Questo layout è supportato nelle configurazioni a schermo singolo e a doppio schermo. Anche se il layout in prima fila ha un impatto particolare in una Signature Teams Room, la prima fila può essere usata in qualsiasi sala riunioni di Teams in esecuzione su Windows, indipendentemente dalla configurazione dell'hardware e dei mobili.
...
## <a name="signature-teams-room-design-guidance"></a>Indicazioni per la progettazione della sala riunioni di Signature Teams
...
![Progetto della progettazione di una sala riunioni Signature Teams.](../media/emr10.png)

25 ft x 14 ft

#### <a name="room-capacity"></a>Capacità della sala

Questa sala riunioni Signature Teams è ottimizzata per un'azienda compresa tra 6 e 8 persone.
...
Per le distribuzioni iniziali di Signature Teams Rooms all'interno delle nostre strutture Microsoft, abbiamo scelto di montare la console di calcolo e tocco Microsoft Teams Rooms al tavolo, con una fotocamera integrata e un dispositivo della barra audio (con audio discreto a sinistra e a destra per audio spaziale) montato su mobili specializzati, situati sotto l'immagine visualizzata e tra la proiezione anteriore della stanza  e la tabella. È importante tenere la console a portata di mano dei partecipanti senza ostacolare l'uso della tabella per i dispositivi e/o i documenti personali. Per lo schermo, viene utilizzato un proiettore ad alta risoluzione a bassa risoluzione.
...
Come minimo, i collegamenti elettrici devono essere forniti sia sul tavolo (per gli utenti finali) che nella posizione di montaggio delle apparecchiature. Se i dispositivi cocreati vengono utilizzati nello spazio, potrebbero essere necessari anche collegamenti elettrici nelle rispettive posizioni.
...
La firma Teams Rooms richiede l'uso di Microsoft Teams Rooms in Microsoft Windows.
...
Una sala riunioni di Signature Teams richiede che lo schermo sia posizionato davanti a tutti i partecipanti alla riunione in sala, direttamente di fronte alla tabella.
...
Una sala riunioni Di Teams Signature richiede che lo schermo sia un singolo display con proporzioni ampie o una combinazione combinata di schermi che possono ottenere l'effetto di essere un singolo schermo se visto dai partecipanti alla riunione in sala.
