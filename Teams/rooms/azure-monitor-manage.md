...
È possibile configurare Monitoraggio di Azure in modo da fornire telemetria di base che consente di monitorare Microsoft Teams delle sale riunioni. Per [informazioni dettagliate, vedere Pianificare](azure-monitor-plan.md) Microsoft Teams Rooms gestione delle Microsoft Teams Rooms [con Azure Monitor](azure-monitor-deploy.md). Con la maturazione della soluzione di monitoraggio, è possibile usare altre funzionalità di monitoraggio e dati per creare una visualizzazione più dettagliata delle prestazioni dei dispositivi.
