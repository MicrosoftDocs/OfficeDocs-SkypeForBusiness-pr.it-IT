---
title: Pianificare Microsoft Teams Rooms gestione dei messaggi con Monitor di Azure
ms.author: dstrome
author: dstrome
ms.reviewer: Turgayo
manager: serdars
...
ms.collection:
- M365-collaboration
description: Questo articolo illustra considerazioni sulla pianificazione per l'uso di Monitor di Azure per amministrare Microsoft Teams Rooms dispositivi nell'Skype for Business o Teams distribuzione.
...
ms.locfileid: "58505414"
---
# <a name="plan-microsoft-teams-rooms-management-with-azure-monitor"></a>Pianificare Microsoft Teams Rooms gestione dei messaggi con Monitor di Azure
...
[Azure Monitor](/azure/azure-monitor/overview) è una raccolta di servizi di gestione progettati nel cloud fin dall'inizio. Invece di distribuire e gestire le risorse locali, i componenti di Monitoraggio di Azure sono ospitati interamente in Azure. La configurazione è minima e puoi essere operativo letteralmente in pochi minuti. Con alcune operazioni di personalizzazione, può essere di aiuto nella gestione dei sistemi di conferenza di Microsoft Teams Rooms, fornendo notifiche in tempo reale dell'integrità del sistema o degli errori per i singoli sistemi di sala e può potenzialmente essere scalato fino alla gestione di migliaia di Microsoft Teams Rooms sale riunioni.
...
L Microsoft Teams Rooms app nel dispositivo console scrive gli eventi nel relativo Windows eventi. Un agente di monitoraggio Microsoft, una volta installato, passa le informazioni al servizio Monitoraggio di Azure. 
...
## <a name="individual-microsoft-teams-rooms-console-requirements"></a>Requisiti di Microsoft Teams Rooms Console
