...
ms.locfileid: "62015226"
---
# <a name="plan-microsoft-teams-rooms"></a>Pianificare Microsoft Teams Rooms

Questo articolo introduce un approccio end-to-end per la pianificazione, la distribuzione e l'Microsoft Teams Rooms nell'ambito della strategia generale per riunioni e sale riunioni.
...
![Un utente tocca una Teams Rooms console, con uno schermo sullo sfondo.](../media/room-systems-image1.jpg "Un utente tocca una Teams Rooms console, con uno schermo sullo sfondo") 
 [Microsoft Teams Rooms guida](https://support.office.com/article/Skype-Room-Systems-version-2-help-e667f40e-5aab-40c1-bd68-611fe0002ba2) è un'ottima risorsa per saperne di più su Microsoft Teams Rooms e su come può aggiungere valore come parte della distribuzione.
...
È possibile distribuire Microsoft Teams Rooms con Microsoft Teams o Skype for Business locali.  Per informazioni [sulle licenze necessarie,](rooms-licensing.md) vedere l'Teams Sala riunioni gestione licenze.

| &nbsp;   |  &nbsp;   |
|-----------|------------|
|![decidere la distribuzione.](../media/audio_conferencing_image7.png) <br/>Punti decisionali|<ul><li>Si distribuiranno Microsoft Teams Rooms nell'organizzazione? </li><li>Come si acquistano i Microsoft Teams Rooms?</li></ul> |
...
| Selezione del dispositivo           | It Project Team / AV Team              |             | [Selezione del dispositivo](#device-selection)                      |
| Approvvigionamento                | It Project Team / AV Team              |             | [Approvvigionamento](#procurement)                      |
...
Valutare la Microsoft Teams Rooms più adatta per ogni chat room in base alle funzionalità future desiderate per la chat room. Decidere quali dispositivi av sono più adatti, a seconda delle dimensioni della stanza e del layout. 
...
In base al fornitore preferito, usare le informazioni fornite nell'articolo sui requisiti per definire il Microsoft Teams Rooms e la configurazione dei dispositivi periferici supportati per ogni tipo di sala e usarli come modello per la distribuzione. 
...
_Modello di Microsoft Teams Rooms di esempio per l'organizzazione_
