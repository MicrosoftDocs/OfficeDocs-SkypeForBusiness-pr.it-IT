...
## <a name="hardware-decoder-driver-recommendations---intel"></a>Suggerimenti per i driver per decoder hardware-Intel
...
## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Raccomandazioni del driver per decoder hardware-NVIDIA
...
## <a name="hardware-decoder-driver-recommendations---amd"></a>Raccomandazioni per driver per decoder hardware-AMD
...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Suggerimenti per i driver del codificatore hardware-Intel
...
## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Raccomandazioni del driver del codificatore hardware-NVIDIA
...
## <a name="hardware-encoder-driver-recommendations---amd"></a>Raccomandazioni del driver del codificatore hardware-AMD
