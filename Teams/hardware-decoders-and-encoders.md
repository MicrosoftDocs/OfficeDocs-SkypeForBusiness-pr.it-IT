...
Le combinazioni seguenti di sistema operativo, modello e driver non sono abilitate per l'accelerazione hardware a causa di diversi problemi dei driver.
...
Per i sistemi operativi legacy, solo le opzioni seguenti Device_ids sono abilitate per l'accelerazione hardware.
...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Suggerimenti per il driver dell'codifica hardware - Intel
...
## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Suggerimenti per il driver dell'codifica hardware - Nvidia
...
## <a name="hardware-encoder-driver-recommendations---amd"></a>Suggerimenti per il driver dell'codifica hardware - AMD
