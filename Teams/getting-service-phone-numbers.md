...
---
# <a name="getting-service-phone-numbers"></a>Ottenere numeri telefonici di servizio.
...
- **Utilizzare un modulo di richiesta per nuovi numeri.** A volte (a seconda del paese o dell'area geografica) non sarà possibile ottenere i nuovi numeri di telefono usando l'interfaccia di amministrazione di Microsoft Teams oppure saranno necessari numeri di telefono o codici di area specifici. In tal caso, è necessario scaricare un modulo e inviarlo di nuovo a Microsoft. Per ulteriori informazioni, consulta [Gestire i numeri di telefono per la propria organizzazione](/microsoftteams/manage-phone-numbers-for-your-organization).
...
1. Nel riquadro di spostamento sinistro passare a **Numeri di**  >  **telefono vocali** e quindi fare clic su **Aggiungi.**
...
3. Nella pagina Ubicazione e quantità eseguire le operazioni seguenti:
    ...
    1. In **Codice area** selezionare un codice area. 
...
Nel riquadro di spostamento sinistro passare a **Numeri** di telefono vocale per visualizzare i numeri dell'organizzazione, inclusi la posizione, il tipo di numero  >   e le informazioni sullo stato.
