...
Per scoprire quali paesi e aree geografiche sono considerati zona A, vedere [aree paese e area geografica per i servizi di audioconferenza](audio-conferencing-zones.md).
...
1. Nella barra di spostamento sinistra fare clic su **utenti** e quindi fare clic sul nome visualizzato dell'utente nell'elenco degli utenti disponibili.

3. Accanto a servizi di **audioconferenza** fare clic su **modifica**.

4. In **chiamata in uscita dalle riunioni** selezionare l'opzione di restrizione chiamata in uscita desiderata.
...
|    Identity =' Tag: DialoutCPCZoneAPSTNInternational '    |    L'utente nella conferenza può effettuare la chiamata solo per [la zona di paesi e aree geografiche](audio-conferencing-zones.md)e questo utente può eseguire chiamate in uscita a numeri nazionali e internazionali.    |
|    Identity =' Tag: DialoutCPCZoneAPSTNDomestic '    |    L'utente nella conferenza può effettuare la chiamata solo per [la zona di paesi e aree geografiche](audio-conferencing-zones.md)e questo utente può eseguire solo chiamate in uscita al numero PSTN nazionale.    |
|    Identity =' Tag: DialoutCPCZoneAPSTNDisabled '    |    L'utente nella conferenza può effettuare la chiamata solo per [la zona di paesi e aree geografiche](audio-conferencing-zones.md)e questo utente non può eseguire chiamate in uscita al numero PSTN oltre ai numeri di emergenza.    |
