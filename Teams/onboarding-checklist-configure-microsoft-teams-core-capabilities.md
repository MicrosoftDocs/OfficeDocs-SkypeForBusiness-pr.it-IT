...
| 8  | Configurare e gestire l'accesso degli utenti Teams | Anche se è consigliabile abilitare tutti gli utenti per Teams, è possibile consentire o disabilitare l'accesso a Teams per ogni utente assegnando o rimuovendo la licenza Teams prodotto. | | [Gestire l'accesso degli utenti Microsoft Teams](user-access.md) |
...
| 10 | Facoltativo: usare PowerShell per amministrare Teams | È possibile usare i cmdlet di PowerShell anziché l Microsoft 365 di amministrazione per amministrare e gestire Teams impostazioni. | | [Microsoft Teams PowerShell](/powershell/module/teams/?view=teams-ps) |