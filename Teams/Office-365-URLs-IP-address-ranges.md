...
Se i criteri di rete e di sicurezza richiedono che il traffico di Microsoft 365 o Office 365 fluirà attraverso un server proxy, assicurarsi che i requisiti precedenti siano già soddisfatti prima di distribuire Teams nell'ambiente di produzione. Per altre informazioni, vedere [Server proxy per Teams o Skype for Business Online](proxy-servers-for-skype-for-business-online.md).