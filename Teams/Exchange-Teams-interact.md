...
| La cassetta postale dell'utente è ospitata in:                                       | eDiscovery         | Blocco&nbsp;a fini giudiziari    | Conservazione        | Gestione di team e canali | Creare e visualizzare riunioni in Teams | Modificare l’immagine del profilo | Cronologia delle chiamate | Gestire i contatti | Accedere ai contatti di Outlook | Messaggi vocali        | Aggiungere e configurare connettori | Aggiungere e configurare schede | Aggiungere e configurare bot | Modificare le impostazioni Fuori sede |
|--------------------------------------------------------------------|--------------------|--------------------|------------------|-----------------------|-----------------------------------|-----------------------------|--------------|-----------------|-------------------------|------------------|------------------------------|------------------------|------------------------|------------------------|
| **Exchange Online**                                                | Sì <sup>1</sup>   | Sì <sup>1</sup>   | Sì              | Sì                   | Sì                               | Sì<sup>7</sup>             | Sì          | Sì             | Sì <sup>6</sup>        | Sì              | Sì                          | Sì                    | Sì                    | Sì                    
| **Exchange Online Dedicated vNext**                                | Sì <sup>1</sup>   | Sì <sup>1</sup>   | Sì              | Sì                   | Sì                               | Sì<sup>7</sup>             | Sì          | Sì             | Sì <sup>6</sup>        | Sì              | Sì                          | Sì                    | Sì                    | Sì                    
| **Exchange Online Dedicated – legacy** (sincronizzazione con Azure AD obbligatoria) | Sì <sup>1</sup>   | Sì <sup>1,2</sup> | Sì <sup>3</sup> | Sì                   | No                                | No                          | Sì          | Sì             | No                      | Sì <sup>4</sup> | Sì <sup>5</sup>             | Sì                    | Sì                    | Sì                    
| **Exchange locale** (sincronizzazione con Azure AD)                        | Sì <sup>1,9</sup> | Sì <sup>1</sup>   | Sì <sup>3</sup> | Sì                   | Sì <sup>8</sup>                  | Sì<sup>10</sup>            | Sì          | Sì             | No                      | Sì <sup>4</sup> | Sì <sup>5</sup>             | Sì                    | Sì                    | No                      
...
<sup>5</sup> Se uno dei proprietari di un team può aggiungere connettori, tutti gli altri membri del team potranno farlo, indipendentemente dal fatto che la cassetta postale sia ospitata in locale o online.
...
<sup>9</sup> È inoltre richiesto un minimo di una licenza di Exchange Online Piano 1. Per altre informazioni, vedere [Cercare i dati della chat di Teams per gli utenti locali](/microsoft-365/compliance/search-cloud-based-mailboxes-for-on-premises-users).

<sup>10</sup> Gli utenti locali possono usare Teams per aggiornare l'immagine del profilo anche se il `SetPhotoEnabled` criterio cassetta postale di Outlook sul Web è impostato su `false`.
 > [!NOTE]
 > L'impostazione Fuori sede (OOF) tramite il client Teams non è attualmente supportata per gli utenti le cui cassette postali sono ospitate in locale; questi utenti devono eseguire questa azione tramite il client Outlook.
...
- Per creare team in Microsoft Teams, gli utenti devono essere abilitati per la creazione di gruppi di Microsoft 365.
  ...
  > [!IMPORTANT]
  > Se si disinstalla il client di Skype for Business dopo aver spostato un utente in modalità **Solo Teams**, l’icona di presenza potrebbe smettere di funzionare in Outlook e in altre app di Office. L’icona di presenza funziona bene in Teams. Per risolvere il problema, seleziona il pulsante dei puntini di sospensione a sinistra dell'immagine del profilo nell'angolo in alto a destra di Microsoft Teams, quindi seleziona **Impostazioni**. Nella scheda **Generali** in **Applicazione**, selezionare **Registra Teams come l'applicazione di chat per Office (richiede il riavvio delle applicazioni di Office)**. Dopo aver selezionato questa opzione, chiudere e riaprire tutte le app di Office, incluso Outlook. Dopo l’apertura di Outlook, le informazioni sulla presenza saranno disponibili.
...
- L'individuazione automatica e i servizi Web Exchange vengono pubblicati esternamente. Per informazioni sui servizi di Microsoft 365 che devono accedere agli endpoint di individuazione automatica e servizi Web Exchange locali, vedere [Altri endpoint non inclusi nel servizio Web indirizzo IP e URL di Office 365](/microsoft-365/enterprise/additional-office365-ip-addresses-and-urls).
...
- La casella di controllo relativa alla funzionalità di distribuzione ibrida di Exchange in Azure AD Connect è selezionata. Per altre informazioni, vedere [Writeback ibrido di Exchange](/azure/active-directory/hybrid/reference-connect-sync-attributes-synchronized#exchange-hybrid-writeback).
...
- Se l’organizzazione possiede dei requisiti di conformità per garantire che tutte le discussioni delle riunioni siano individuabili, è consigliabile disabilitare le riunioni private se l’organizzatore dispone di una cassetta postale di Exchange locale. Per altre informazioni, vedere [Pianificazione di riunioni private](./meeting-policies-in-teams-general.md#private-meeting-scheduling).
