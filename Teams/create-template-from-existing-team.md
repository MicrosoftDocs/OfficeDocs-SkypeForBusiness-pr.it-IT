...
Microsoft Teams consente di creare un modello da un team esistente che può essere salvato e modificato in base alle specifiche esigenze dell'organizzazione.
...
4. Selezionare **Usa un team esistente come modello** e selezionare **Avanti**.

 ![Immagine della schermata iniziale dei modelli di team con l'opzione Usa un team esistente come modello evidenziata.](media/team-existing-team-as-template.png)

5. Selezionare un team da usare come punto di partenza selezionando accanto al nome del team e **quindi avanti.**
...
7. Nella sezione **Canali, schede e app** aggiungi tutti i canali e le app di cui il team ha bisogno.
