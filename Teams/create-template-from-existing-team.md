...
4. Selezionare **Usa un team esistente come modello**e fare clic su **Avanti**.
...
5. Selezionare un team da usare come punto di partenza facendo clic su accanto al nome del team e quindi su **Avanti**.

![Immagine dell'elenco di team con un team evidenziato.](media/team-existing-team-selection.png)

6. Nella sezione **Impostazioni modello** completare i campi seguenti e quindi fare clic su **Avanti**:
    - Nome modello
    - Descrizioni brevi e lunghe del modello
    - Visibilità delle impostazioni locali  
  
7. Nella sezione **canali, schede e app** aggiungere tutti i canali e le app necessarie per il team.
...
8. Fare clic su **Invia** per salvare le modifiche.
