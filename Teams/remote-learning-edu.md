...
> - Un corso online di 1 ora nell’Educator Center Microsoft mostra come i docenti usano Teams nella loro vita professionale. [**Trasformare l'attività di apprendimento con Microsoft Teams**](https://education.microsoft.com/course/9c9f5c11/overview).
...
Teams dispone di [client](get-clients.md) per PC (Windows, Mac e Linux), Web e dispositivi mobili (Android e iOS) per garantire che tutto il personale scolastico e gli studenti possano restare connessi.

Per altre informazioni sugli scenari di utilizzo di Teams, consultare i [webinar su Teams per l'istruzione](https://aka.ms/TeamsEDUWebinars).
...
[Occorre assegnare le licenze agli utenti](teams-edu-licensing.md) prima che questi possano usare le funzionalità di Teams. Teams si basa su altre funzionalità di Microsoft 365, come [Gruppi di Microsoft 365](Office-365-groups.md), [Exchange](Exchange-Teams-interact.md), [SharePoint e OneDrive](SharePoint-OneDrive-interact.md) per offrire possibilità di collaborazione. Se questi servizi sono abilitati, gli utenti avranno la migliore l'esperienza possibile di Teams. [Teams è supportato per gli utenti che hanno un account di posta elettronica su Google](/microsoft-365/education/deploy/enabling-teams-for-education-for-google-users).

Microsoft Teams è incluso in Office 365 A1, che è gratuito per gli istituti di istruzione. Per informazioni su come distribuire Office 365 e preparare l'intero istituto di istruzione per Teams, vedere [questa pagina](/microsoft-365/education/deploy/create-your-office-365-tenant). Per ricevere assistenza è possibile creare un ticket [qui](https://signup.microsoft.com/Signup?OfferId=03ee83a5-5cb4-4545-aca9-33ead43f222a,d764709a-7763-45ef-a2a8-db5b8b6ae704&DL=ENTERPRISEPREMIUM_FACULTY&ali=1) e per ricevere formazione su Teams si può visitare il Microsoft Store locale per parlare con un esperto.

> [!NOTE]
> Per le informazioni più aggiornate sulle distribuzioni di EDU, leggere le [Indicazioni aggiornate per la distribuzione di M365 EDU durante l'epidemia di COVID-19](/microsoft-365/education/deploy/guidance-for-m365-edu-deployment-during-covid19).
...
Ci sono diversi modi per creare i team di classe, e Teams per l'istruzione offre una serie unica di strumenti di distribuzione per semplificare al massimo il processo.
 ...
 - [Creazione automatica dei team con SDS](#automatic-team-creation-using-sds)
 - [Creazione dei team con docente dai gruppi di classe di Office 365](#educator-led-team-creation-from-office-365-class-groups)
 - [Script di PowerShell con le API di Microsoft Graph](#powershell-script-using-graph-apis)
...
L'automazione della creazione del team consente ad amministratori IT e docenti di risparmiare tempo. Assicura ai docenti che tutti i team di classe siano stati creati e pronti per la configurazione al momento dell'accesso. [School Data Sync (SDS)](/SchoolDataSync) è uno strumento gratuito di Office 365 Education che leggi i dati dei sistemi di documentazione degli istituti, come un Sistema di gestione dei dati degli studenti (SIS) o un Sistema di gestione dell'apprendimento (LMS). SDS usa i dati per arricchire la configurazione di Office 365 in molti modi, tra cui la creazione di team di classe in blocco e la sincronizzazione con il sistema informativo per tenere aggiornati insegnanti e studenti quando l'iscrizione viene modificata. SDS può importare i dati da qualsiasi sistema di documentazione e ha connettori integrati per molti dei [fornitori SIS](/schooldatasync/frequently-asked-questions#what-sismis-vendors-does-school-data-sync-support) esistenti nel mondo. Raccomandiamo fortemente l'uso di SDS, in quanto offre i seguenti vantaggi.  
...
- [Accesso anticipato del docente](https://support.office.com/article/activate-early-access-class-teams-created-with-school-data-sync-0d154696-66ab-4fcf-b22f-c3d9a82aaf78): i docenti hanno il tempo di preparare i loro team prima di ricevere gli studenti.  
...
- Crea unità amministrative per la delega amministrativa con ambito e la [reimpostazione della password degli insegnanti](/schooldatasync/how-to-enable-teacher-password-reset). 
...
- [Sincronizzazione dei voti](/schooldatasync/grade-sync): i docenti possono annotare tutte le valutazioni in Teams e i voti vengono trascritti automaticamente sul registro SIS. 
- [Protezione dei dati degli studenti](/schooldatasync/protecting-student-personal-data): impedisce agli studenti di usare app non sviluppate da Microsoft e di tracciare e gestire il consenso dei genitori. 
...
Per iniziare, andare a [School Data Sync (SDS)](/SchoolDataSync) e contattare [https://aka.ms/sdssupport](https://aka.ms/sdssupport) l'assistenza distribuzione.  
...
- I docenti non autorizzati a creare i team possono comunque crearli dai gruppi esistenti, come mostrato [qui](https://support.office.com/article/create-a-class-team-in-microsoft-teams-preview-fae422eb-58b7-4431-9ff2-a4b9b6ae7c5b).
...
Per iniziare con il metodo SDS, andare a [School Data Sync (SDS)](/SchoolDataSync) e contattare [https://aka.ms/sdssupport](https://aka.ms/sdssupport) l'assistenza distribuzione. 
...
> [!NOTE]
> I team di classe richiedono l'iscrizione di gruppi nascosti, in modo che i docenti e gli studenti possano vedere i membri della classe. Per creare un gruppo di classe in Office 365, vedere [Creare un team di classe](/graph/api/educationroot-post-classes?tabs=http&view=graph-rest-beta&preserve-view=true) per soddisfare gli stessi requisiti di privacy.
...
- In caso di problemi (ad esempio, le classi mancano) in relazione alla creazione automatica del team SDS e i docenti ne hanno bisogno immediatamente, possono usare il [metodo di creazione del team guidato dal docente](#educator-led-team-creation-from-office-365-class-groups) per riprovare. La [Creazione manuale del team](#manual-team-creation) è un'altra soluzione, tuttavia, non mantiene aggiornata l'iscrizione al team.  
...
Early Access Class Teams consente ai docenti di accedere ai team di classe prima che gli studenti possano visualizzarli e avviare la partecipazione. Questo consente ai docenti di configurare, aggiungere file e organizzarsi prima di concedere l'accesso agli studenti. Una volta pronti ad accedere al team, gli studenti potranno [attivare la loro classe](https://support.office.com/article/activate-early-access-class-teams-created-with-school-data-sync-0d154696-66ab-4fcf-b22f-c3d9a82aaf78) con facilità. In quanto amministratore, disponi anche di un controllo aggiuntivo e di funzionalità relative alla creazione e alla configurazione di Early Access Class Teams.
...
Per impostazione predefinita, i team creati da gruppi (con SDS, con docenti o API Graph) creano automaticamente team con accesso anticipato. Per creare i propri team con accesso anticipato con l'API Graph, è necessario [creare una classe](/graph/api/educationroot-post-classes?tabs=http&view=graph-rest-beta&preserve-view=true) e [creare il team da un gruppo](/graph/api/team-post?tabs=http&view=graph-rest-beta#example-4-create-a-team-from-group&preserve-view=true).

##### <a name="how-do-i-check-if-a-class-is-activated"></a>Come si verifica l'attivazione di una classe?

Nel [tipo di risorsa del team](/graph/api/resources/team?view=graph-rest-beta&preserve-view=true) è stata aggiunta una nuova proprietà [isMembershipLimitedToOwners](/graph/api/resources/team?view=graph-rest-beta#properties&preserve-view=true) per determinare se una classe sia stata attivata o meno. Usare [Get Team API](/graph/api/team-get?tabs=http&view=graph-rest-beta&preserve-view=true) per eseguire una query relativa alla ```isMembershipLimitedToOwners``` proprietà di una classe specifica. Se il team è disattivato, verrà restituito il valore false. Se il team non è stato attivato dal proprietario del team, verrà restituito il valore true.
...
- [Playlist video di Teams per l'istruzione](https://www.youtube.com/playlist?list=PLiluTszfwwMKicAo6agloFALEB5WvYNYs)
...
## <a name="support-readiness"></a>Preparazione tecnica del supporto

I professionisti IT e il personale di supporto possono diventare subito operativi con l'architettura di Teams subito operativa e l'uso delle funzionalità di Microsoft 365 sottostanti tramite i [poster sull'architettura IT di Teams](teams-architecture-solutions-posters.md) e la [formazione tecnica per amministratori](itadmin-readiness.md).
...
- [Inoltrare un ticket di supporto (può essere usato da docenti e personale)](https://aka.ms/edusupport)
- [Supporto e centro assistenza per insegnanti che usano Teams](https://support.office.com/article/microsoft-teams-5aa4431a-8a3c-4aa5-87a6-b6401abea114)
- [Centro assistenza per gli studenti](https://support.office.com/article/student-help-center-395ab230-55bf-44c6-b265-e832d729b694)
- [Teams per Virtualized Desktop Infrastructure (VDI)](./teams-for-vdi.md)
- [Come ottimizzare rapidamente il traffico di Office 365 per il personale in remoto](https://techcommunity.microsoft.com/t5/office-365-blog/how-to-quickly-optimize-office-365-traffic-for-remote-staff-amp/ba-p/1214571)
...
- [Risorse di supporto per Teams](/microsoft-365/admin/contact-support-for-business-products)
- [Centro assistenza Teams](https://support.office.com/teams)
