...
- LIL_Placement
- seo-marvel-mar2020
description: Informazioni su Microsoft licenze per componenti aggiuntivi per Microsoft Teams e sulle funzionalità disponibili con ogni licenza.
ms.openlocfilehash: 74924c398d74f318311f41dfa8ac6797a57af385
ms.sourcegitcommit: aa398950cc2f10b268c72a2b25caa0cf893e8230
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 12/08/2022
ms.locfileid: "69307771"
---
...
Le opzioni di licenza per i componenti aggiuntivi disponibili dipendono dal piano di Microsoft 365 in uso. Per informazioni sulle opzioni per le chiamate vocali e i servizi di audioconferenza disponibili, vedi la sezione [Quali funzionalità di Microsoft sono disponibili con il mio piano?](#which-microsoft-capabilities-are-available-with-my-plan) di questo articolo.

Ecco un elenco delle licenze per i componenti aggiuntivi di Teams e delle relative funzionalità che è possibile aggiungere all'abbonamento a Teams.

|Licenza|Descrizione|
|-------|-----------|
| **Microsoft Teams Premium** | Microsoft Teams Premium è una licenza per i componenti aggiuntivi di Teams che consente alle organizzazioni con abbonamenti a Microsoft 365 di migliorare l'esperienza di Teams con vantaggi come riunioni più personalizzate e intelligenti, protezione avanzata delle riunioni e funzionalità avanzate di gestione e creazione di report. Per altre informazioni sulla licenza del componente aggiuntivo Teams Premium, vedere [licenze di Microsoft Teams Premium](licensing-enhance-teams.md). |
| **Microsoft 365 Business Voice** |Business Voice era il pacchetto di funzionalità vocali di Microsoft per le piccole e medie imprese, ma non è più disponibile per l'acquisto dal 1° marzo 2022. Gli attuali abbonati a Business Voice non possono più rinnovare le licenze Business Voice. <br/> <br/> Se sei una piccola o media impresa, ti consigliamo di acquistare la [licenza Teams Phone con piano per chiamate](../business-voice/whats-business-voice.md), se disponibile nella tua area geografica. <br/> <br/> In alternativa, è possibile acquistare una licenza di Teams Phone Standard che consenta di connettersi al provider PSTN di terze parti preferito. |
...
Tutti i piani Microsoft 365 consentono agli utenti di Teams di effettuare chiamate peer-to-peer all'interno dell'organizzazione usando la tecnologia VoIP. Tuttavia, è consigliabile aggiungere licenze diverse per funzionalità come effettuare chiamate a numeri PSTN o configurare un PBX.

### <a name="voice-and-pstn-connectivity"></a>Connettività pstn e voce

Che tu sia una piccola azienda, un'organizzazione aziendale, un istituto didattico, un ente pubblico o un'organizzazione no profit, hai tre modi per ottenere Teams Phone System e connettività PSTN:

- Acquista un piano Microsoft 365 Business, E1/E3, A1/A3 o G1/G3 e aggiungi Teams Phone con licenze per il bundle **del piano per** chiamate.
  - Questo modello offre funzionalità PBX Sistema telefonico Teams e un Microsoft piano per le chiamate nazionali.
  - Scegliere questa configurazione se si vuole che tutta la gestione dei numeri di telefono e la fatturazione vengano gestite da Microsoft.
  - Verifica se la licenza bundle [Teams Phone with Calling Plan è disponibile nella tua area geografica](../country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md).

- Acquistare un piano E1/E3, A1/A3 o G1/G3, aggiungere licenze **di Teams Phone Standard** e scegliere un Microsoft piano per chiamate autonomo o un gestore PSTN di terze parti.
  - Questo modello ti darà Teams Phone System, ma dovrai comunque connetterti alla rete PSTN.
  - Per visualizzare tutte le opzioni di connettività PSTN, vedere [Opzioni di connettività PSTN](../pstn-connectivity.md).
  - Per informazioni su tutte le soluzioni vocali, vedere [Pianificare la soluzione vocale di Teams](../cloud-voice-landing-page.md).

- Acquista un piano E5/A5/G5 e aggiungi **Microsoft Piani per chiamate** o connettiti a un provider di connettività PSTN di terze parti.
  - I piani Microsoft 365 E5, A5 e G5 includono Teams Phone System, ma le organizzazioni devono ancora scegliere [un'opzione di connettività PSTN](../pstn-connectivity.md).

Ecco un riepilogo dei quali Microsoft licenze per chiamate e voce per l'acquisto, in base al piano Microsoft 365:
...
<td>Teams Phone con licenze per il bundle del piano per chiamate <br/> <br/>oppure <br/> <br/>licenze Teams Phone Standard <br/> Plus <br/>Licenze per piani per chiamate nazionali o piani per chiamate internazionali <br/> </td>
<td>licenze Teams Phone Standard <br/> </td>
</tr>
<tr>
<td>piani Microsoft 365 E5/A5/G5</td>
<td>Licenze per piani per chiamate nazionali o piani per chiamate internazionali <br/> </td>
<td></td>
</tr>
</tbody>
</table>
...
## <a name="more-guidance-on-microsoft-plans"></a>Altre indicazioni sui piani di Microsoft

Altre informazioni su Microsoft piani e ottenere indicazioni in base al tipo di organizzazione:
