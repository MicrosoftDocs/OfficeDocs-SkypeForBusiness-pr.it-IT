...
- **Opzione 1**. Usa l' [app Free teams](https://products.office.com/microsoft-teams/free). Se si ha una piccola impresa (ad esempio 1-2 persone), l'uso dell'app teams è il modo migliore per farlo. L'app è infatti meno costosa da usare per le chiamate nazionali e internazionali. È comunque possibile effettuare chiamate audio e video di 1:1 e di gruppo e condividere il desktop per le presentazioni. [Confrontare le caratteristiche, le tariffe e le opzioni di pagamento](https://products.office.com/microsoft-teams/free).

     È consigliabile iniziare con teams Free per verificare se soddisfa le proprie esigenze. Tuttavia, se non hai ancora due opzioni.
