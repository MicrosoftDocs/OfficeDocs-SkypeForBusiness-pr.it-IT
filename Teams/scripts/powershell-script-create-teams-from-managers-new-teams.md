...
---
# <a name="powershell-script-sample---create-new-people-manager-teams"></a><span data-ttu-id="f2616-103">Esempio di script di PowerShell - Creare nuovi team di gestione delle persone</span><span class="sxs-lookup"><span data-stu-id="f2616-103">PowerShell script sample - Create new people manager teams</span></span>

<span data-ttu-id="f2616-104">Usare questo script di PowerShell per creare un team per ogni responsabile con i propri diretti come membri del team.</span><span class="sxs-lookup"><span data-stu-id="f2616-104">Use this PowerShell script to create a team for each manager with their directs as team members.</span></span> <span data-ttu-id="f2616-105">Prima di eseguire questo script, eseguire lo script Export [managers](powershell-script-create-teams-from-managers-export-managers.md) per esportare (da Active Directory) un elenco di responsabili e i relativi indirizzi per l'organizzazione.</span><span class="sxs-lookup"><span data-stu-id="f2616-105">Before you run this script, run the [Export managers](powershell-script-create-teams-from-managers-export-managers.md) script to  export (from your Active Directory) a list of managers and their directs for your organization.</span></span>

<span data-ttu-id="f2616-106">Per informazioni su questo script di PowerShell, vedere [Creare team di gestione persone.](../create-manager-directs-teams.md)</span><span class="sxs-lookup"><span data-stu-id="f2616-106">To learn about this PowerShell script, read [Create people manager teams](../create-manager-directs-teams.md).</span></span>

<span data-ttu-id="f2616-107">Se non si ha di nuovo PowerShell e serve aiuto per iniziare, vedere [Panoramica di Azure PowerShell.](/powershell/azure/overview?view=azurermps-5.1.1)</span><span class="sxs-lookup"><span data-stu-id="f2616-107">If you're new to PowerShell and need help getting started, see [Overview of Azure PowerShell](/powershell/azure/overview?view=azurermps-5.1.1).</span></span>


## <a name="create-new-people-manager-teams"></a><span data-ttu-id="f2616-108">Creare nuovi team di gestione delle persone</span><span class="sxs-lookup"><span data-stu-id="f2616-108">Create new people manager teams</span></span> 
