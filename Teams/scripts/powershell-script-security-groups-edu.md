...
ms.locfileid: "50756202"
---
# <a name="powershell-script-sample---create-security-groups-for-educators-and-students-in-your-school"></a><span data-ttu-id="c14b0-103">Esempio di script di PowerShell: creare gruppi di sicurezza per docenti e studenti dell'istituto di istruzione</span><span class="sxs-lookup"><span data-stu-id="c14b0-103">PowerShell script sample - Create security groups for educators and students in your school</span></span>

<span data-ttu-id="c14b0-104">Usare questo script di PowerShell per creare i gruppi di sicurezza necessari per gestire i criteri di Microsoft Teams nell'istituto di istruzione.</span><span class="sxs-lookup"><span data-stu-id="c14b0-104">Use this PowerShell script to create the security groups that you need to manage Microsoft Teams policies in your school.</span></span> <span data-ttu-id="c14b0-105">La [caratteristica assegnazione dei criteri ai](../assign-policies.md#assign-a-policy-to-a-group) gruppi in Teams consente di assegnare un criterio a un gruppo di utenti, ad esempio un gruppo di sicurezza.</span><span class="sxs-lookup"><span data-stu-id="c14b0-105">The [policy assignment to groups](../assign-policies.md#assign-a-policy-to-a-group) feature in Teams lets you assign a policy to a group of users, such as a security group.</span></span> <span data-ttu-id="c14b0-106">L'assegnazione dei criteri viene propagata ai membri del gruppo in base alle regole di precedenza.</span><span class="sxs-lookup"><span data-stu-id="c14b0-106">The policy assignment is propagated to members of the group according to precedence rules.</span></span> <span data-ttu-id="c14b0-107">Quando vengono aggiunti o rimossi membri da un gruppo, le assegnazioni dei criteri ereditate vengono aggiornate di conseguenza.</span><span class="sxs-lookup"><span data-stu-id="c14b0-107">As members are added to or removed from a group, their inherited policy assignments are updated accordingly.</span></span>

<span data-ttu-id="c14b0-108">Questo script di PowerShell crea due gruppi di sicurezza, uno per personale e docenti e un altro per gli studenti dell'istituto di istruzione, in base al tipo di licenza.</span><span class="sxs-lookup"><span data-stu-id="c14b0-108">This PowerShell script creates two security groups, one for staff and educators and another for students in your school, based on license type.</span></span> <span data-ttu-id="c14b0-109">È quindi possibile assegnare criteri ai gruppi di sicurezza creati.</span><span class="sxs-lookup"><span data-stu-id="c14b0-109">You can then assign policies to the security groups that you created.</span></span> <span data-ttu-id="c14b0-110">Per altre informazioni sull'uso di questo script, vedere Assegnare criteri a set di utenti di grandi dimensioni [nell'istituto di istruzione.](../batch-group-policy-assignment-edu.md)</span><span class="sxs-lookup"><span data-stu-id="c14b0-110">For more information about using this script, see [Assign policies to large sets of users in your school](../batch-group-policy-assignment-edu.md).</span></span>

<span data-ttu-id="c14b0-111">Questo script esegue le operazioni seguenti:</span><span class="sxs-lookup"><span data-stu-id="c14b0-111">This script does the following:</span></span>

- <span data-ttu-id="c14b0-112">Identifica il personale e i docenti a cui è assegnata una SKU per istituti di docente, crea un gruppo di sicurezza e quindi aggiunge personale e docenti al gruppo.</span><span class="sxs-lookup"><span data-stu-id="c14b0-112">Identifies staff and educators who are assigned a Faculty SKU, creates a security group, and then adds staff and educators  to the group.</span></span>
- <span data-ttu-id="c14b0-113">Identifica gli studenti a cui è assegnato uno SKU per gli studenti, crea un gruppo di sicurezza e quindi aggiunge gli studenti al gruppo.</span><span class="sxs-lookup"><span data-stu-id="c14b0-113">Identifies students who are assigned a Student SKU, creates a security group, and then adds the students to the group.</span></span>
- <span data-ttu-id="c14b0-114">Aggiorna l'appartenenza di ogni gruppo di sicurezza per aggiungere o rimuovere personale, docenti e studenti a seconda che abbia una licenza.</span><span class="sxs-lookup"><span data-stu-id="c14b0-114">Updates the membership of each security group to add or remove staff, educators, and students based on whether they have a license.</span></span>

<span data-ttu-id="c14b0-115">È necessario eseguire regolarmente questo script per mantenere aggiornati e aggiornati i gruppi di sicurezza.</span><span class="sxs-lookup"><span data-stu-id="c14b0-115">You'll need to run this script regularly to keep the security groups fresh and up to date.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="c14b0-116">È importante comprendere le regole di [precedenza](../assign-policies.md#precedence-rules) e la classificazione delle assegnazioni di [gruppo](../assign-policies.md#group-assignment-ranking) quando si assegnano criteri ai gruppi.</span><span class="sxs-lookup"><span data-stu-id="c14b0-116">It's important to understand [precedence rules](../assign-policies.md#precedence-rules) and [group assignment ranking](../assign-policies.md#group-assignment-ranking) when assigning policies to groups.</span></span> <span data-ttu-id="c14b0-117">Assicurarsi di leggere e comprendere i concetti descritti in Informazioni sull'assegnazione dei criteri [ai gruppi.](../assign-policies.md#what-you-need-to-know-about-policy-assignment-to-groups)</span><span class="sxs-lookup"><span data-stu-id="c14b0-117">Make sure that you read and understand the concepts in [What you need to know about policy assignment to groups](../assign-policies.md#what-you-need-to-know-about-policy-assignment-to-groups).</span></span>

## <a name="before-you-start"></a><span data-ttu-id="c14b0-118">Prima di iniziare</span><span class="sxs-lookup"><span data-stu-id="c14b0-118">Before you start</span></span>

<span data-ttu-id="c14b0-119">Scaricare e installare il [modulo di PowerShell di Skype for Business Online,](https://docs.microsoft.com/microsoft-365/enterprise/manage-skype-for-business-online-with-microsoft-365-powershell)quindi riavviare il computer, se richiesto.</span><span class="sxs-lookup"><span data-stu-id="c14b0-119">Download and install the [Skype for Business Online PowerShell module](https://docs.microsoft.com/microsoft-365/enterprise/manage-skype-for-business-online-with-microsoft-365-powershell), and then restart your computer if prompted.</span></span>

<span data-ttu-id="c14b0-120">Per snellire di più, vedere Gestire Skype for Business online con PowerShell di [Office 365](https://docs.microsoft.com/office365/enterprise/powershell/manage-skype-for-business-online-with-office-365-powershell) e [panoramica di Teams PowerShell.](../teams-powershell-overview.md)</span><span class="sxs-lookup"><span data-stu-id="c14b0-120">To lean more, see [Manage Skype for Business Online with Office 365 PowerShell](https://docs.microsoft.com/office365/enterprise/powershell/manage-skype-for-business-online-with-office-365-powershell) and [Teams PowerShell overview](../teams-powershell-overview.md).</span></span>


## <a name="sample-script"></a><span data-ttu-id="c14b0-121">Script di esempio</span><span class="sxs-lookup"><span data-stu-id="c14b0-121">Sample script</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c14b0-122">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="c14b0-122">Related topics</span></span>

[<span data-ttu-id="c14b0-123">Assegnare i criteri agli utenti in Teams</span><span class="sxs-lookup"><span data-stu-id="c14b0-123">Assign policies to your users in Teams</span></span>](../assign-policies.md)