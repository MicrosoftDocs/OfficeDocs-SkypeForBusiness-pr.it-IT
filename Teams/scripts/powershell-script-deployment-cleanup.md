...
ms.service: msteams
audience: admin
description: Usare questo script di PowerShell per disinstallare Teams e rimuovere la Teams per gli utenti.Use this PowerShell script to uninstall Teams and remove the Teams folder for users.
f1.keywords:
- NOCSH
