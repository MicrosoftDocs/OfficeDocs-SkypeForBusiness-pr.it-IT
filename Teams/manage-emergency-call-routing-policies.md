...
Per gestire i criteri di routing delle chiamate di emergenza, è possibile accedere ai criteri per gli interventi di emergenza vocali nell'interfaccia di amministrazione di Microsoft Teams o usando  >   Windows PowerShell. I criteri possono essere assegnati a utenti e [siti di rete.](cloud-voice-network-settings.md)
...
1. Nel riquadro di spostamento sinistro dell'interfaccia di amministrazione di Microsoft Teams passare **a** Criteri di emergenza vocale e quindi fare clic sulla  >  scheda Criteri **routing chiamate.**
