...
È possibile instradare le chiamate a numeri non assegnati a un utente, a un account della risorsa associato a un Operatore automatico o a una coda di chiamata o a un servizio di annuncio che riproduce un file audio personalizzato per il chiamante. Il file audio verrà riprodotto più volte finché il chiamante non si blocca.
...
È necessario specificare il numero o l'intervallo di numeri chiamato e il routing associato per le chiamate a questi numeri. Ad esempio, il comando seguente specifica che tutte le chiamate al numero +1 (555) 222-3333 verranno instradati all'account della risorsa aa@contoso.com:
...
- Per instradare le chiamate ai numeri di servizio del piano chiamate Microsoft non assegnato, il tenant deve avere almeno una licenza Sistema telefonico - Utente virtuale.
