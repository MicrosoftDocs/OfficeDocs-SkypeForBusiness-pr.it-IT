...
2. Configurare il numero di telefono e abilitare la segreteria telefonica e la segreteria telefonica aziendale. 
3. Assegnare Teams solo agli utenti.
...
Dopo aver creato l'utente e aver assegnato una licenza, è necessario configurare le impostazioni del telefono online dell'utente. 
...
## <a name="assign-teams-only-mode-to-users-to-ensure-calls-land-in-microsoft-teams"></a>Assegnare Teams solo agli utenti per garantire che le chiamate siano effettuate Microsoft Teams
