...
- [Nuovo canale del team (PowerShell)](/powershell/module/teams/new-teamchannel)
- [Nuovi criteri di messaggistica dei team (PowerShell)](/powershell/module/skype/new-csteamsmessagingpolicy)
- [Assegnare i criteri agli utenti in Microsoft Teams](policy-assignment-overview.md) 
