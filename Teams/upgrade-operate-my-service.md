...
Questo articolo fa parte della fase operational excellence del percorso di aggiornamento, che inizia non appena hai completato l'aggiornamento da Skype for Business a Teams.

Questo articolo fornisce una panoramica dei requisiti per il corretto funzionamento di Teams per l'organizzazione dopo l'aggiornamento. Grazie al corretto funzionamento dei servizi di Teams, si può essere certi di offrire un'esperienza affidabile e di alta qualità per l'organizzazione.
...
<tr><td><img src="media/audio_conferencing_image9.png" alt="An icon depicting the next steps"/><br/>Passaggi successivi</td><td><ul><li>Esaminare la Guida operativa per intero.</li><li>Implementare una strategia operativa in linea con gli obiettivi dell'organizzazione per garantire la qualità e l'affidabilità dei carichi di lavoro di Teams.</li><li>Consultare la guida alla revisione della qualità dell'esperienza.</li><li> Implementare una strategia operativa per eseguire regolarmente revisioni della qualità dell'esperienza per assicurarsi che la distribuzione di Teams funzioni al massimo delle funzionalità.</li></ul></td></tr>
...
| App di amministrazione di Microsoft 365 | Fornisce notifiche push al dispositivo mobile. | Da usare quando è necessario ricevere una notifica degli incidenti del servizio mentre si è in viaggio. |
...
| Microsoft 365 Service Communications API | Accesso a livello di programmazione all'integrità dei servizi di Microsoft 365 o Office 365. | Da usare quando è necessaria l'integrazione con uno strumento di monitoraggio di terze parti o si vuole creare una soluzione personalizzata. |
...
[App per dispositivi mobili di amministrazione di Microsoft 365](https://support.office.com/article/Office-365-Admin-Mobile-App-e16f6421-2a1a-4142-bf9d-9846600a060a)

[Scaricare l'app per dispositivi mobili di amministrazione di Microsoft 365](https://products.office.com/business/manage-office-365-admin-app)
...
È possibile monitorare l'integrità dei servizi e le modifiche imminenti sfruttando l'API Service Communications per accedere all'integrità dei servizi e alle modifiche a livello di programmazione. Usare questa API per creare uno strumento di monitoraggio personalizzato o connettere gli strumenti di monitoraggio esistenti alle comunicazioni dei servizi di Microsoft 365 o Office 365, semplificando potenzialmente la modalità di monitoraggio dell'ambiente. Per altre informazioni, vedere [Microsoft 365 o Office 365 per sviluppatori Enterprise.](/office/developer-program/microsoft-365-developer-program-faq)
...
I dati sull'utilizzo di Teams sono disponibili nel dashboard report. I dati sull'utilizzo di Teams sono disponibili in tre report diversi. Il primo report offre una visualizzazione cross-product di come gli utenti comunicano e collaborano usando i vari servizi in Microsoft 365 o Office 365. Questo report è disponibile qui: [Report di Microsoft 365 nell'interfaccia di amministrazione - Utenti attivi](https://support.office.com/article/Office-365-Reports-in-the-Admin-Center-Active-Users-FC1CF1D0-CD84-43FD-ADB7-A4C4DFA8112D)
...
Inoltre, il ruolo **di lettore** report è disponibile per gli utenti che richiedono l'accesso ai report, ma non eseguono attività che richiedono autorizzazioni a livello di amministratore. È possibile assegnare questo ruolo per fornire report sull'utilizzo a tutti gli stakeholder, per monitorare e guidare l'adozione. Per altre informazioni sui diversi ruoli disponibili, vedere Informazioni sui ruoli di amministratore [di Microsoft 365.](https://support.office.com/article/About-Office-365-admin-roles-da585eea-f576-4f55-a1e0-87090b6aaa9d)
...
| Misurare l'utilizzo | Misurare e valutare l'utilizzo di Teams nella fase Drive Value (al termine della distribuzione). Risolvere i problemi di utilizzo in base alle esigenze. | Bisettimanale | |
...
[Caricare informazioni sull'edificio](/SkypeForBusiness/using-call-quality-in-your-organization/turning-on-and-using-call-quality-dashboard#upload-building-information)
