...
2.  Impostare il tenant in modalità Isole (per i tenant di cui è stato eseguito il provisioning DOPO l'1/9/2019, contattare il supporto tecnico per apportare questa modifica)  
...
Microsoft Teams può essere un'opzione che consente all'organizzazione di riunire tutti i dipendenti, gli information worker e i frontline worker su un'unica piattaforma. È possibile [iniziare oggi](https://products.office.com/microsoft-teams/group-chat-software) stesso. È possibile rimanere in contatto con tutti gli annunci più recenti e gli aggiornamenti mensili dei prodotti [qui.](https://techcommunity.microsoft.com/t5/microsoft-teams-blog/bg-p/MicrosoftTeamsBlog)
