...
La nuova esperienza dell'interfaccia di amministrazione offre un'esperienza unificata per gestire sia le Teams che Skype for Business. Microsoft offre funzionalità aggiuntive, approfondimenti end-to-end e la possibilità di gestire Teams impostazioni a livello utente.
...
## <a name="settings-migrated-to-the-new-microsoft-teams-admin-center"></a>Impostazioni eseguita la migrazione alla nuova interfaccia Microsoft Teams di amministrazione
...
Al termine della migrazione di queste impostazioni, le disabiliteremo nell'interfaccia di amministrazione di Microsoft 365 e nell'interfaccia di amministrazione di Skype for Business e potranno quindi essere gestite nella nuova interfaccia di amministrazione di Microsoft Teams.