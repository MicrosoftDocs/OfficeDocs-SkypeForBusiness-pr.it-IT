...
- Includere nell'implementazione iniziale di Teams le app in primo piano, ad esempio Planner. Aggiungi altre [app di Teams](deploy-apps-microsoft-teams-landing-page.md) mentre guidi l'adozione di Teams.
