...
L'istituto di istruzione o l'università deve abilitare Microsoft Teams per l'apprendimento remoto? È possibile iniziare rapidamente a usare il one [pager introduttivo](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/teams-for-education-getting-started-1-pager.pdf?raw=true) e uno dei materiali di adozione seguenti.
...
|[Annunci sullo schermo digitali](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/digital-screen-adverts.zip?raw=true)<br>![Foto di un annuncio digitale sullo schermo.](media/edu-adoption-digital-screen-adverts.png)   |      |
