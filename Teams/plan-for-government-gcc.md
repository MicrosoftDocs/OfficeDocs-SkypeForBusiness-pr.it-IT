...
> [!NOTE]
> Se l'organizzazione ha già soddisfatto i requisiti di idoneità di Microsoft 365 GCC Government - GCC e ha applicato e accettato il programma, è possibile ignorare i passaggi 1 e 2 e andare direttamente al passaggio 3. 
...
-   I contenuti dei clienti dell'organizzazione sono logicamente separati dai contenuti dei clienti nei servizi Microsoft 365 commerciali da Microsoft.
...
La [Microsoft 365 del](/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/office-365-us-government) servizio del governo degli Stati Uniti descrive i vantaggi della piattaforma, che sono centrati sulla conformità dei requisiti negli Stati Uniti.
...
|    |     |
|-----------|------------|
| ![Icona che rappresenta i punti decisionali.](media/audio_conferencing_image7.png) <br/>Punti decisionali|<ul><li>Decidere se Microsoft 365 government - GCC è appropriato per l'organizzazione.</li><li>Verificare che l'organizzazione soddisfi i requisiti di idoneità.</li></ul> |

> [!Note]
> Microsoft 365 Government - GCC è disponibile solo negli Stati Uniti. I clienti non governativi degli Stati Uniti possono scegliere tra diversi Microsoft 365 [per enti pubblici.](https://products.office.com/en/government/compare-office-365-government-plans)
...
|    |     |
|-----------|------------|
| ![Icona che rappresenta un punto di decisione.](media/audio_conferencing_image7.png) <br/>Punto di decisione|<ul><li>Decidere se si modificherà una delle impostazioni di sicurezza Microsoft 365 Government - GCC, risolvendo per prima cosa l'impatto di eventuali modifiche apportate.</li></ul> |
...
|    |     |
|-----------|------------|
| ![Icona che rappresenta un punto di decisione.](media/audio_conferencing_image7.png) <br/>Punto di decisione|<ul><li>Decidere se il set Teams caratteristiche soddisfa le esigenze dell'organizzazione.</li></ul> |

## <a name="step-5-plan-for-governance"></a>Passaggio 5. Pianificare la governance

Determinare i requisiti per la governance e come soddisfarli. Per altre [informazioni, vedere Pianificare](plan-teams-governance.md) la governance in Teams informazioni.

|    |     |
|-----------|------------|
| ![Icona che rappresenta un punto di decisione.](media/audio_conferencing_image7.png) <br/>Punto di decisione|<ul><li>Determinare e documentare i requisiti di governance seguendo le linee guida in [Pianificare la governance in Teams](plan-teams-governance.md).</li></ul> |
...
Questo è anche un ottimo momento per usare Teams con il gruppo di stakeholder più ampio per iniziare a pianificare la distribuzione di riunioni e [funzionalità vocali cloud.](./cloud-voice-landing-page.md)