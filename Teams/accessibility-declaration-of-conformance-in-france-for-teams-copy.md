...
### <a name="section-1-champ-dapplication"></a>Section 1 Gear d'application
...
> 
> [4.2.3 Utilisation sans di couleurs](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=34&functional_statements_submitted=true)
> 
...
> 
> [4.2.6 Utilisation sans capacitàté vocale](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=40&functional_statements_submitted=true)
> 
...
> 
> [4.2.9 Minimiser les déclencheurs de photosensibles](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=46&functional_statements_submitted=true)
> 
...
<p>Dans le cas où la TIC fait appel à des caractéristiquesôiques, elle ne fait pas de l'utilisation d'une caractéristique runtimeique le seul moyen d'identification de l'utilisateur ou de contrôle de la TIC.</p></td>
<td>Non applicabile</td>
<td></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><h3 id="statut-visuel">5.6.2 Statut visenne</h3>
...
<p>b) la delimitatore de répétition peut être réduite jusqu'à un caractère par intervalle de 2 secondes.</p></td>
<td>Non applicabile</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où la TIC ou les TIC fournies à un utilisateur sont compatibles avec la communication voix bidirectionnelle et permettent à un utilisateur de communiquer avec un autre utilisateur en RTT, elles proposent un mécanisme disponibilint de sélectionner un mode de fonctionnement qui permet la voix et le texte simultanés.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="affichage-visuellement-distinguable">6.2.2.1 Affichage visuellement distinguibile</h3>
<p>Dans le cas où la TIC est dotée de capacitàtés d'envoi et de réception en RTT, l'affichage du texte envoyé est visuellement différencié de celui du texte reçu.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Dans le cas où la TIC est dotée de capacitàtés d'envoi et de réception en RTT, la direction (envoi/réception) du texte transmis est déterminable par un programme informatique, à moins que le RTT n'ait une fonctionnalitéstenée.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="interopérabilité">6.2.3 Interoperabilérabilité</h3>
...
<p>a) TIC inter-opérant sur le Réseau Téléléléique Public (RTC) avec une autre TIC qui se connecte directement au RTC comme décrit dans la Recommandation ITU-T V.18 [i.23] ou l'une de ses annexes pour les signaux de téléfontie en mode texte sur l'interface RTC ;</p>
...
<p>c) TIC inter-opérant avec une autre TIC utilisant une technologie RTT conforme à l'logo des protocoles IP Multimedia Sub-System (IMS) spécifiés dans les documents TS 126 114, TS 122 173 et TS 134 229 ;</p>
...
<p>Dans le cas où la TIC propose la communication voix en temps réel et propose également des fonctions de messagerie vocale, de réception automatique ou de serveur interactif, la TIC doit offrir aux utilisateurs un moyen d'accéder aux informations et d'exécuter les fonctions fournies par la TIC sans utiliser l'audition ou la parole.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><h3 id="taux-de-trame-vitesse-dimages">6.5.3 Taux de trame (sfondosse d'images)</h3>
...
<tr class="even">
<td><h3 id="contenu-non-textuel-lecture-décran-prise-en-charge">11.2.1.1 Contenu non textrant (lecture d'écran prise en charge)</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui prend en charge l'accès aux technologies d'assistance pour la lecture d'écran, elle remplit les Critères de Succès indiqués dans le Tableau 11.1 : Contenu non textères :</p>
<p>Tout le contenu non textparam qui est présenté à l'utilisateur est doté d'un équivalent text più normale qui a la même fonction, sauf dans les situations suivantes :</p>
<p>Commandes, saisie : Si le contenu non text est une commande ou s'il permet la saisie d'informations par l'utilisateur, alors il a un nom qui décrit saonction.</p>
<p>Media limité dans le temps : Si le contenu non text compatibile est un media limité dans le temps, alors les équivalents textntassis donnent au moins une identification descriptive de ce contenu non text più.</p>
<p>Test: Si le contenu non text più text più est un test ou un exercice qui serait invalide s'il était présenté sous forme de texte, alors des équivalents text piùs donnent au moins une identification descriptive du contenu non text più.</p>
<p>Contenu sensoriel : Si le contenu non text curriculum a pour principal objectif de créer une expérience sensorielle spécifique, alors des équivalents text piùe donnent au moins une identification descriptive de ce contenu non text più.</p>
<p>CAPTCHA : Si le contenu non textá sert à confirmer que c'est une personne et non un ordinateur qui accède au contenu, alors des équivalents textérs qui identifient et décrivent à quoi sert ce contenu non text più text più sont fournis, et des formes alternatives de CAPTCHA utilisant différents modes de sortie pour les différents types deconérents types de prima sensorielle sont fournies afin de répondre aux besoins des différents quos.</p>
<p>Estendizione, formattazione, invisibile: Si le contenu non textux est purement primosatif, s'il n'est utilisé que pour le formatage visère ou s'il n'est pas présenté aux utilisateurs, alors il est mis en êuvre de manière à être ignoré par la technologie d'assistance.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Pour les médias audio seulement préenregistrés et vidéo seulement préenregistrés, les principes ci-après se vérifient sauf lorsque l'audio ou la vidéo est un média de remplacement du texte et estment identifié comme tel :</p>
...
<p>Vidéo seulement préenregistrée : Une alternative au media limité dans le temps ou uneversare audio, qui présente des informations équivalentes pour le contenu vidéo seulement préenregistré, est fournie.</p></td>
<td>Non applicabile</td>
<td></td>
</tr>
<tr class="even">
...
<p>Des sous-titres sont fournis pour tout le contenu audio préenregistré en média synchronisé, sauf quand le média est une alternative au texte et estnciament identifié comme tel.</p></td>
<td>Non applicabile</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Une alternative au média limité dans le temps ou l'audio-description du contenu vidéo préenregistré est fournie pour le média synchronisé, sauf quand le média est une alternative au texte et estnciament identifié comme tel.</p></td>
<td>Non applicabile</td>
<td></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><h3 id="informations-et-relations">11.2.1.7 Informazioni e relazioni</h3>
...
<p>Les instructions fournies pour permettre la compréhension et l'utilisation du contenu ne reposent pas uniquement sur les caractéristiques sensorielles des composants telles que la forme, la taille, l'emplacement vis pour, l'orientation ou le son.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>La couleur n'est pas utilisée comme le seul moyen vislé de transmettre des informations, d'indiquer une action, de répondre rapidement ou de distinguer un élément vislément.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><h3 id="contraste-minimum">11.2.1.12 Contrasto (minimo)</h3>
...
<p>Prolungata : l'utilisateur est averti avant que la limite de temps n'expire et il lui est accordé au moins 20 secondes pour cette limite par une action simple (par exemple, « appuyer sur la barre d'espace ») et l'utilisateur est autorisé à più prolungato la limite de temps au moins dix fois ; ou</p>
...
<p>L'exception de la limite essentielle : la limite de temps est essentielle et la più prolungata invaliderait alors l'activité ; ou</p>
...
<p>Pour toute information enlogovement, clignotante, délogonte ou mise à jour automatiquement, tous les points suivants sont vrais :</p>
<p>Déplacement, clignotement, défilement : pour toute information encollement, clignotante ou détantente qui (1) démarre automatiquement, (2) dure plus de cinq secondes et (3) est présentée conjointement avec un autre contenu, l'utilisateur dispose d'un mécanisme pour la mettre en pause, l'arrêter ou la masquer, à moins que lelogovement, le clignotement ou le défilement s'avère un élément essentiel au bon déroulement de l'activité ; et</p>
...
<p>Le logiciel est exempt de tout élément qui flashe plus de trois fois dans n'importe quel intervalle d'une seconde ou ce flash doit se sitné sous le seuil de flash générique et le seuil de flash flash.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><h3 id="au-focus">11.2.1.29 Focus Au</h3>
...
<p>Conferma: un mécanisme est disponible pour examiner, confirmer et corriger les informations avant de finaliser leur soumission.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Le logiciel de la plate-forme fournit un plate de services de plate-forme documentés qui permettent à un logiciel qui est doté d'une interface utilisateur fonctionnant sur le logiciel de la plate-forme d'interagir avec la technologie d'assistance.</p>
...
<p>Le logiciel de la plate-forme fournit unnette de services d'accessibilité de la plate-forme documentés qui permettent à la technologie d'assistance d'interagir avec logiciel qui est doté d'une interface utilisateur fonctionnant sur le logiciel de la plate-forme.</p>
...
<tr class="odd">
<td><h3 id="relations-parent-enfant">11.3.2.9 Relazioni parente-enfant </h3>
...
<p>Dans le cas où le logiciel présente une interface utilisateur, il rendra, à l'aide des services décrits dans la clause 11.3.2.3, les contenus text unide des services décrits dans la clausee qui apparaît à l'écran, déterminables par un programme informatique par les technologies d'assistance.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><h3 id="notification-des-changements">11.3.2.15 Notifica relativa a modifiche </h3>
...
<tr class="odd">
<td><p><strong>11.6.4 Assistenza à la réparation</strong></p>
...
### <a name="section-12-documentation-et-services-dassistance"></a>Sezione 12 Documentazione e servizi di assistenza
...
<tr class="odd">
<td><h3 id="documentation-accessible">12.1.2 Documentazione accessibile </h3>
...
<p>b) un format non-web qui est conforme à la clausola 10.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Les services d'assistance de la TIC répondent aux besoins en communication des personnes porteuses de possibile directement ou depuis un point de référence.</p></td>
<td>Pris en charge</td>
<td><a href="https://support.microsoft.com/answerdesk/accessibility">Answer Desk per l'disabilità</a></td>
</tr>
<tr class="even">
<td><h3 id="documentation-accessible-1">12.2.4 Documentazione accessibile </h3>
...
Le présent document n'est pas la norme EN 301 549 v 1.1.2 (2015-04) et ne doit pas être utilisé en remplacement de celle-ci.Les extraits de la norme EN 301 549 v 1.1.2 qu'il contient ne sont référencés que pour décrire la conformité de Microsoft avec certaines de ses dis dispositions.Un exemplaire complet de la norme EN 301 549 v 1.1.2 (2015-04) est disponible dans ce PDF émanant de l'European Telecommunications Standards Institute, du Comité Européen de Normalisation et du Comité Européen de Normalisation Électrotechnique.
