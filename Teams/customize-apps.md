...
Vedere lo [schema Teams manifesto](https://docs.microsoft.com/microsoftteams/platform/resources/schema/manifest-schema) per informazioni dettagliate sui campi che è possibile personalizzare.
