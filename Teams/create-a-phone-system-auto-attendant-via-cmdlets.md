...
Verrà creato il seguente flusso delle chiamate dell'operatore automatico:

![Diagramma del flusso delle chiamate dell'operatore automatico creato con i cmdlet.](media/create-a-phone-system-auto-attendant-via-cmdlets.png)

Informazioni aggiuntive sulla configurazione:

- Operatore automatico: Contoso Main
  - Operatore: Adele Vance
  - Abilitare gli input vocali: Disattivato
...
- Operatore automatico: Contoso chiama per nome
  - Operatore: Adele Vance
  - Fuso orario: UTC
  - Lingua: inglese (Stati Uniti)
  - Abilitare gli input vocali: Attivato
  - Messaggio di saluto: Nessuno
  - Menu: sintesi vocale: "Pronuncia o immetti il nome della persona che desideri contattare. Per tornare al menu precedente, premere 9"
  - Ricerca directory: comporre per nome
  - Ambito di chiamata: membri del supporto tecnico & vendite
...
## <a name="get-operator-information"></a>Ottieni informazioni sull'operatore
...
## <a name="dial-by-name-auto-attendant---resource-account-creation"></a>Operatore automatico chiamata per nome - Creazione account risorsa

**Nota**: creare qui l'account della risorsa in modo che possa essere fatto riferimento all'operatore automatico principale. L'operatore automatico Componi per nome verrà creato in un secondo momento.
...
## <a name="contoso-main-menu-auto-attendant"></a>Operatore automatico menu principale Contoso

### <a name="create-holiday-schedules"></a>Creare pianificazioni festività
...
### <a name="create-after-hours-schedules"></a>Creare pianificazioni fuori orario
...
### <a name="create-after-hours-prompts-and-menu-options"></a>Creare richieste fuori orario e opzioni di menu
...
### <a name="create-open-hours-prompts-and-menu-options"></a>Creare richieste open hours e opzioni di menu
...
### <a name="create-open-hours-menu"></a>Crea menu Open Hours
...
### <a name="create-auto-attendant"></a>Crea operatore automatico
...
## <a name="dial-by-name-auto-attendant---completion"></a>Operatore automatico chiamata per nome - Completamento

### <a name="create-dial-scope"></a>Creare un ambito di chiamata
