...
| Amministratore del dispositivo Teams              | Gestire i dispositivi configurati per l'uso con il servizio teams.                    | Gestire la configurazione e gli aggiornamenti dei dispositivi, esaminare l'integrità del dispositivo e lo stato delle periferiche connesse, configurare e applicare i profili di configurazione e riavviare i dispositivi.<p>Il ruolo amministratore del dispositivo teams non consente l'accesso ai dati di qualità delle chiamate o alle analisi delle chiamate. Per visualizzare i dati di qualità delle chiamate o le analisi delle chiamate, è necessario assegnare il ruolo di amministratore delle comunicazioni teams. |
