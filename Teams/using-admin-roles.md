...
Usando Azure Active Directory (Azure AD), è possibile designare amministratori che hanno bisogno di diversi livelli di accesso per la gestione Microsoft Teams. Gli amministratori possono gestire l'intero Teams di lavoro oppure possono avere autorizzazioni delegate per la risoluzione dei problemi di qualità delle chiamate o per la gestione delle esigenze di telefonia dell'organizzazione.

## <a name="teams-roles-and-capabilities"></a>Teams ruoli e funzionalità

Sono disponibili diversi ruoli di amministratore di Teams: amministratore di Teams, amministratore delle comunicazioni Teams, specialista del supporto per le comunicazioni Teams, tecnico del supporto Teams comunicazioni e amministratore Teams dispositivi. Esaminare la tabella seguente per comprendere le operazioni che ogni ruolo può eseguire e gli strumenti che l'amministratore può usare nell'interfaccia di amministrazione di Microsoft Teams e in PowerShell.

> [!NOTE]
> Skype for Business gli amministratori online possono gestire i criteri delle app  Teams e **Skype for Business online** tramite PowerShell.
...
<sup>2 Microsoft Teams</sup> [di amministrazione3](./manage-teams-skypeforbusiness-admin-center.md)
 <sup>Teams'account</sup> di amministratore deve avere una licenza di Teams valida.
...
-->
Per altre informazioni sugli strumenti di amministrazione disponibili per la gestione dei Microsoft Teams, vedere [Gestione dei Microsoft Teams](./manage-teams-skypeforbusiness-admin-center.md).
