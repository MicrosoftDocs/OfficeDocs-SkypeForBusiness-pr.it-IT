...
L'app Tasks offre un'esperienza di gestione delle attività coesiva in Microsoft Teams, integrando singole attività basate su [Microsoft To Do](https://todo.microsoft.com/tasks/) e attività del team basate su Planner in un unico posto. Gli utenti possono accedere all’app Tasks sul lato sinistro di Teams e come scheda in un canale all'interno di singoli team. Con **Le mie attività** e **i piani condivisi**, gli utenti possono visualizzare e gestire tutte le attività individuali e del team e assegnare priorità al lavoro. Tasks è disponibile nei client desktop, Web e per dispositivo mobile di Teams.
...
Il team di marketing condivide i dettagli della promozione e il corrispondente elenco di attività con manager della comunicazione per la vendita al dettaglio. Retail Communications Manager, che funge da gatekeeper per i negozi, esamina le informazioni. Quindi creano un elenco attività per la promozione e un'attività per ogni unità di lavoro che devono essere eseguite dai negozi interessati. Al termine dell'elenco attività, è necessario selezionare gli archivi che devono completare il lavoro. In questo caso, la promozione si applica solo ai negozi negli Stati Uniti che hanno un ristorante al loro interno. In Attività filtrano l'elenco dei negozi in base all'attributo del ristorante in negozio, selezionano le posizioni corrispondenti degli Stati Uniti nella gerarchia e quindi pubblicano l'elenco attività in tali negozi.
