...
ms.collection:
- M365-collaboration
description: Informazioni su come usare il report sulle licenze Teams protezione delle informazioni nell'interfaccia di amministrazione di Microsoft Teams per vedere come le app dell'organizzazione usano le API di sottoscrizione degli eventi di notifica delle modifiche.
appliesto:
- Microsoft Teams
...
Il report sulle licenze di protezione delle [](/graph/api/resources/subscription?view=graph-rest-1.0) informazioni di [](/graph/api/resources/webhooks?view=graph-rest-1.0) Teams fornisce informazioni approfondite sulle app che hanno sottoscritto eventi di notifica delle modifiche per ascoltare i messaggi creati, aggiornati o eliminati a livello di tenant, ovvero /teams/getAllMessage o /chats/getAllMessages. Una notifica di modifica corrispondente al messaggio viene inviata correttamente solo quando l'utente ha la [licenza richiesta.](/graph/teams-licenses)  È possibile visualizzare il numero di notifiche di modifica attivate da un determinato utente.
...
3. In **App** selezionare un'app e quindi **selezionare Esegui report.**
    ...
    ![Screenshot del report Teams di licenza per la protezione delle informazioni nell'Teams di amministrazione con callout.](../media/teams-info-protection-license-report-with-callouts.png "Screenshot del report Teams sulla licenza di protezione delle informazioni nell'Teams di amministrazione con callout")
