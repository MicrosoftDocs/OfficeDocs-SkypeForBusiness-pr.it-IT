...
2. In **Intervallo di date** selezionare un intervallo e quindi selezionare Esegui **report.**
    ...
    ![Screenshot del report attività Teams utente nell'interfaccia Teams di amministrazione con callout](../media/teams-reports-user-activity-with-callouts.png "Screenshot del report attività Teams utente nell'interfaccia Teams di amministrazione con callout")
