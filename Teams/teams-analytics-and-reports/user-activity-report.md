...
1. Nel riquadro di spostamento sinistro dell'interfaccia Microsoft Teams di amministrazione selezionare Analisi & **reportUsage** > . Nella scheda **Visualizza report**, in **Report**, selezionare Teams **utente**.
...
Per rendere anonimi i Teams utente, è necessario essere un amministratore globale. In questo modo si nasconderanno le informazioni identificabili (usando hash MD5), ad esempio il nome visualizzato, la posta elettronica e l'ID AAD nel report e nella relativa esportazione.
