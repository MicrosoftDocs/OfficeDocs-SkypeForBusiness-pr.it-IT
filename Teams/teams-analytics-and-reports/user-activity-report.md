...
2. In **intervallo di date**selezionare un intervallo e quindi fare clic su **Esegui report**.
    ...
    ![Screenshot del report attività utente teams nell'interfaccia di amministrazione teams con callout](../media/teams-reports-user-activity-with-callouts.png "screenshot del report attività utente teams nell'interfaccia di amministrazione teams con callout")
