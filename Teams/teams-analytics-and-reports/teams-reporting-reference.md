...
Per accedere ai report, è necessario essere un amministratore globale di Microsoft 365 o Office 365, un lettore globale in Microsoft 365 o Office 365, un amministratore del servizio Teams o un Skype for Business amministratore. Per altre informazioni sui ruoli Teams di amministratore e sui report a cui ogni ruolo di amministratore può accedere, vedere Usare i ruoli di amministratore Teams per gestire [Teams.](../using-admin-roles.md)

Passare all'interfaccia Microsoft Teams di amministrazione, nel riquadro di spostamento sinistro, selezionare Report di **analisi &** e quindi in Visualizza report scegliere il report da eseguire.

> [!NOTE]
> I report nell'interfaccia Microsoft Teams sono separati dai report attività per Teams che fanno parte dei report Microsoft 365 nella interfaccia di amministrazione di Microsoft 365. Per altre informazioni sui report attività nel interfaccia di amministrazione di Microsoft 365, vedere Teams [report attività nel interfaccia di amministrazione di Microsoft 365](../teams-activity-reports.md)
...
Stiamo continuamente migliorando l'esperienza Teams report e aggiungendo caratteristiche e funzionalità. Nel corso del tempo, verranno integrate funzionalità aggiuntive nei report e verranno aggiunti nuovi report nell'interfaccia di amministrazione Microsoft Teams.
...
|[Teams utilizzo di Visite virtuali](virtual-visits-usage-report.md)  | Numero di visite virtuali<br>Numero di visite a Bookings<br>Numero di Teams visite integrate con Electronic Health Records (EHR)<br>Durata media di una visita<br>Tempo medio di attesa della sala d'attesa dei partecipanti<br>Ora di inizio<br>ID riunione<br>Tempo di attesa della sala d'attesa<br>Durata<br>Stato<br>Tipo di prodotto<br>Partecipanti<br>SMS inviati
[!INCLUDE [teams-reports-definitions](../includes/teams-reports-definitions.md)]

## <a name="make-the-user-specific-data-anonymous"></a>Rendere anonimi i dati specifici dell'utente

Per rendere anonimi i dati Teams'attività degli utenti e Teams di utilizzo dei dispositivi, è necessario essere un amministratore globale. In questo modo si nasconderanno informazioni identificabili, ad esempio nome visualizzato, posta elettronica e ID AAD nei report e nelle relative esportazioni.
...
> [!NOTE]
> Se si abilita questa impostazione, le informazioni verranno de-identificate nel [report attività Teams utente](user-activity-report.md) [Teams report sull'utilizzo dei](device-usage-report.md) dispositivi. Non influirà sugli altri report di utilizzo disponibili nell'Teams di amministrazione.
