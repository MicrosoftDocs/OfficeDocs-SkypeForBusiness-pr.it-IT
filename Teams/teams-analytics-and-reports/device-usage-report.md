...
2. In **Intervallo di date** selezionare un intervallo e quindi fare clic su Esegui **report.**
    ...
    ![Screenshot del report sull Teams di utilizzo dei dispositivi nell'interfaccia Teams di amministrazione con callout](../media/teams-reports-device-usage-with-callouts.png "Screenshot del report sull Teams di utilizzo dei dispositivi nell'Teams di amministrazione con callout")
