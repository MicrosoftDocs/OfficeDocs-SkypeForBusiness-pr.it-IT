...
> | 4 | Ora di invito | `datetimeoffset` | Quando l'invito iniziale viene inviato Teams uscita da una chiamata dell'utente o del bot al SBC o viene ricevuta in ingresso a Teams o una chiamata bot dal componente proxy SIP di Routing diretto da SBC |
