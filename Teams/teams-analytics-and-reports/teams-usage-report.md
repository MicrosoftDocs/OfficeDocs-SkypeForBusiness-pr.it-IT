...
ms.collection:
- M365-collaboration
description: Informazioni su come usare il report sull Teams di utilizzo nell'interfaccia di amministrazione di Microsoft Teams per ottenere una panoramica delle Teams attività nell'organizzazione.
appliesto:
- Microsoft Teams
...
2. In **Intervallo di date** selezionare un intervallo e quindi fare clic su **Esegui report**.
    ...
    ![Screenshot del report Teams utilizzo dei dati nell'interfaccia Teams di amministrazione con callout.](../media/teams-reports-teams-usage-with-callouts1.png "Screenshot del report sull Teams di utilizzo nell'Teams di amministrazione con callout")
...
|**4**   |È possibile filtrare gli elementi visualizzati nel grafico facendo clic su un elemento nella legenda. Ad esempio, fare clic **su** Totale utenti attivi, Teams & **canali** attivi, Canali **attivi** o Messaggi per  visualizzare solo le informazioni correlate a ognuno di essi. La modifica di questa selezione non modifica le informazioni nella tabella. |
