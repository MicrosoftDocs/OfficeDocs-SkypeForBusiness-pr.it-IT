---
title: 'Guida introduttiva: riunioni, webinar ed eventi live'
ms.reviewer: ''
description: Guida introduttiva per amministratori su come implementare e configurare riunioni, webinar ed eventi live in Microsoft Teams.
ms.topic: article
author: CarolynRowe
ms.author: crowe
manager: serdars
...
Questo articolo, destinato ad amministratori e professionisti IT, descrive brevemente le differenze tra riunioni, webinar ed eventi live. Fornisce quindi collegamenti alle informazioni necessarie per implementare rapidamente questa funzionalità per gli utenti.
...
[Riunioni](#meetings), [webinar](#webinars)ed [eventi live](#live-events) sono tutti tipi di riunioni, ma i webinar e gli eventi live offrono all'organizzatore un maggiore controllo sulla conversazione e sui partecipanti. I webinar offrono un'interazione bidirezionale, mentre gli eventi live offrono un'esperienza di domande e risposte gestita. 
...
| [Guida introduttiva visiva](https://teamworktools.azurewebsites.net/assets/TeamsWebinarsGetStartedGuide.pdf) | Guida visiva scaricabile che descrive come iniziare a pianificare webinar.  |
||
...
Microsoft consente di migliorare le esperienze di riunione integrando e usando le app per le riunioni. Ad esempio, l'integrazione di Whiteboard nelle riunioni di Teams è basata sull'app web Whiteboard, che consente ai partecipanti delle riunioni di Teams di disegnare, tracciare schizzi e scrivere contemporaneamente in un'area di disegno digitale condivisa.
...
Chiunque può partecipare gratuitamente a una riunione, a un webinar o a un evento live di Teams &mdash; non è necessaria una licenza. 
