...
Per altre informazioni sulle licenze, vedi [Gestione delle licenze di Office 365 per Teams](Office-365-licensing.md). 
...
- Per informazioni sulla gestione delle opzioni per una riunione, vedi [Modificare le impostazioni dei partecipanti per una riunione Teams](https://support.microsoft.com/office/change-participant-settings-for-a-teams-meeting-53261366-dbd5-45f9-aae9-a70e6354f88e).
