...
- Audio Conferencing
- seo-marvel-apr2020
description: Scopri come cercare i numeri di conferenza telefonica con accesso esterno disponibili per i servizi di audioconferenza da Microsoft Teams.
...
---
# <a name="see-a-list-of-audio-conferencing-numbers-in-microsoft-teams"></a>Visualizzare un elenco dei numeri dei servizi di audioconferenza in Microsoft Teams

Quando si configurano le audioconferenze per gli utenti di Microsoft Teams, è possibile visualizzare i numeri di telefono disponibili per i servizi di audioconferenza. Questo elenco conterrà tutti i numeri di telefono per Audioconferenza disponibili per l'organizzazione.
   
**Stai cercando i prezzi?** Consulta la sezione **Tariffe dei servizi di audioconferenza** in [Audioconferenza](https://www.microsoft.com/microsoft-teams/audio-conferencing).
...
2. Visualizza i numeri di telefono disponibili per i servizi di audioconferenza.

- Puoi anche visualizzare la posizione e la lingua principale che verranno utilizzate dall'operatore automatico dei servizi di audioconferenza.
