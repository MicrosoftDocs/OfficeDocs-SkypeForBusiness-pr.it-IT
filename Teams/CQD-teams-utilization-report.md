...
description: Usare i report Teams utilizzo Power BI per accedere ai dati del Microsoft Teams Call Quality Dashboard (CQD) per tenere traccia Microsoft Teams'utilizzo delle chiamate nell'organizzazione.
ms.openlocfilehash: 5e569385da9a7014d1f62c2b45aed63f6eeb6364
ms.sourcegitcommit: 15e90083c47eb5bcb03ca80c2e83feffe67646f2
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 08/30/2021
ms.locfileid: "58725475"
---
...
Questo nuovo Teams di utilizzo consente di vedere come (e quanto) gli utenti usano Microsoft Teams accedendo ai Teams Call Quality Dashboard (CQD). Questi report sono pensati per essere una posizione centralizzata a cui sia gli amministratori che i responsabili aziendali possono accedere rapidamente per questi dati.
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report1.png)
...
1. A destra degli elenchi a discesa del filtro dei dati, il numero di chiamate per tipo di supporto è suddiviso in una visualizzazione interna/esterna negli ultimi trenta giorni. È possibile vedere attraverso lo screenshot precedente che ci sono più chiamate provenienti da posizioni esterne all'organizzazione, il che ha senso considerando l'ambiente globale corrente.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report2.png)
...
1. A destra della casella Conteggio tipi di supporto, è stato selezionato Il numero di chiamate mensili per tipo di supporto per gli ultimi 90 giorni. È possibile passare il puntatore del mouse su ogni colonna e tipo di elemento multimediale per visualizzare il conteggio di un mese precedente o del mese corrente fino alla data corrente, fornendo informazioni sulla tendenza di utilizzo.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report3.png)
...
1. Il grafico centrale funziona come nel grafico di 90 giorni, tuttavia offre una visualizzazione di utilizzo giornaliero per gli ultimi 30 giorni e consente a un utente di fare clic con il pulsante destro del mouse ed eseguire il drill-down nei dettagli per un giorno specifico.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report4.png)
...
Nella sezione in basso a sinistra della pagina è presente una tabella che fornisce i valori totali per ogni tipo di supporto nell'ultimo anno. 
    ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report5.png)
    ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report6.png)   
...
A destra della tabella, un grafico a barre mostra i clienti con il maggior utilizzo (chiamate/flussi) degli ultimi 30 giorni.
   ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report7.png)
...
L'ultimo set di grafici per questa pagina mostra ogni tipo di elemento multimediale singolarmente, con una suddivisione che mostra l'uso di conferenze e P2P. I grafici seguenti mostrano che esiste un numero significativamente maggiore di utilizzo delle conferenze rispetto a P2P.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report8.png)
...
Accanto ai filtri dei dati viene visualizzato il riepilogo dell'utilizzo di 30 giorni, che consente di usare facilmente le caselle di testo. Il numero superiore mostra il totale di 30 giorni, con le suddivisioni interne ed esterne inferiori.

![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report9.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report10.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report11.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report12.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report13.png)
...
![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report14.png)
  ...
  1.  La tabella sotto il grafico visualizza le metriche per quell'ora. Può essere ordinato in base a qualsiasi intestazione di colonna. tuttavia, siamo interessati a trovare aree problematiche.  
    ![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report15.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report24.png)

![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report25.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report26.png)
...
1.  Nella pagina Riepilogo conteggio chiamate eseguire il drill-through come area specifica della tabella.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report16.png)

2.  Selezionare la riga per cui sono necessarie informazioni aggiuntive sull'area geografica.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report17.png)
...
3.  Le tendenze dei dati mostrano un numero significativo di minuti usati nella rete interna, con conferenze che superano di gran lunga l'uso P2P.
  ![Screenshot: Teams report di utilizzo.](media/CQD-teams-utilization-report18.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report19.png)
...
![Screenshot: Teams report sull'utilizzo dei dati.](media/CQD-teams-utilization-report20.png)
