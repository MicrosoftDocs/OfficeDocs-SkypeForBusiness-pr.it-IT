...
> [!NOTE]
> È anche necessario considerare gli scenari di migrazione vocale. Sistema telefonico è la tecnologia Microsoft per abilitare il controllo delle chiamate e le funzionalità PBX (Private Branch Exchange) nel cloud Microsoft 365 o Office 365. Per connettersi Sistema telefonico alla rete PSTN (Public Switched Telephone Network) in modo che gli utenti possano effettuare chiamate telefoniche in tutto il mondo, sono disponibili opzioni in base alle esigenze aziendali. Per altre informazioni sulle opzioni Sistema telefonico e la connettività PSTN, vedere Voice [- Sistema telefonico e connettività PSTN.](cloud-voice-landing-page.md)
...
- Le comunicazioni avviate dal client Teams da un *utente* della stessa organizzazione verranno sempre presenti nel client Teams'utente.
...
- Gli utenti in modalità TeamsOnly ricevono tutte le chat e le chiamate in arrivo nel client di Teams e la presenza viene fornita da Teams, indipendentemente da dove ha avuto origine la comunicazione: Teams, Skype for Business o qualsiasi tipo di utente federato.
