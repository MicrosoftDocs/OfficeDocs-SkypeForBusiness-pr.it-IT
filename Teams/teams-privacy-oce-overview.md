...
> [!NOTE]
> Gli amministratori possono vedere l'articolo [Gestire i controlli della privacy](https://docs.microsoft.com/deployoffice/privacy/manage-privacy-controls) per informazioni su come concedere o limitare la possibilità degli utenti di usare le esperienze connesse facoltative.
...
- [Panoramica dei controlli di privacy per Microsoft 365 Apps for enterprise](https://docs.microsoft.com/deployoffice/privacy/overview-privacy-controls)
- [Panoramica dei controlli dei criteri per Teams](policy-control-overview.md)
- [Privacy e Microsoft Teams](teams-privacy.md)
- [Dati di servizio obbligatori per Office](https://docs.microsoft.com/deployoffice/privacy/required-service-data)
