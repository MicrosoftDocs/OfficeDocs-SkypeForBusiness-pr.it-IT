...
> [!IMPORTANT]
> Gli utenti, il proprietario del gruppo di chiamate e i membri del gruppo di chiamata devono essere in Teams modalità di distribuzione. Per altre informazioni sulle modalità Teams distribuzione, vedere Informazioni sulla coesistenza e l'interoperabilità Microsoft Teams e [Skype for Business e sull'interoperabilità.](teams-and-skypeforbusiness-coexistence-and-interoperability.md)

## <a name="license-required"></a>Licenza richiesta

Agli utenti deve essere assegnata una licenza Microsoft Teams Sistema telefonico per configurare e usare la condivisione delle chiamate e il ritiro delle chiamate di gruppo. Per altri dettagli sul modello di licenza, vedere Ecco cosa si ottiene con [Sistema telefonico.](/MicrosoftTeams/here-s-what-you-get-with-phone-system)
...
Gli amministratori devono abilitare i gruppi di chiamate tramite **l'impostazione TeamsCallingPolicy AllowCallGroups per** un utente. Gli amministratori possono abilitarla anche tramite Teams di amministrazione.  Inoltre, l'utente configurato può anche configurare i gruppi di chiamate direttamente dal client. Gli utenti finali o gli amministratori non possono bloccare la configurazione tra loro, ma Teams portale di amministrazione e Teams client devono mostrare questa relazione in modo accurato in entrambe le posizioni. 
