...
- [Microsoft 365 di denominazione dei gruppi](https://support.office.com/article/office-365-groups-naming-policy-6ceca4d3-cad1-4532-9f0f-d469dfbbb552)
...
- [Opzioni di fine del ciclo di vita per gruppi, team e Yammer](/microsoft-365/solutions/end-life-cycle-groups-teams-sites-yammer)
...
> [!Note]
> La scadenza del gruppo è Azure AD Premium caratteristica. Perché questa funzionalità sia disponibile, il tenant deve avere un abbonamento a Azure AD Premium e licenze per l'amministratore che configura le impostazioni e i membri dei gruppi interessati.
...
- [Canali condivisi in Microsoft Teams](shared-channels.md)
...
Inoltre, è possibile configurare la moderazione per un canale e fornire funzionalità di moderatore a determinati utenti in modo che possano controllare chi può creare post del canale e rispondere. Per [altre informazioni,](manage-channel-moderation-in-teams.md) vedere Configurare e gestire la moderazione Microsoft Teams canale.
