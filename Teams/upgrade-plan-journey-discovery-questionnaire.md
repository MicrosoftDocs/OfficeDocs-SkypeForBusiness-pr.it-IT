---
title: 'Microsoft Teams aggiornamento | Valutazione dell''ambiente, domande di individuazione'
author: SerdarSoysal
ms.author: serdars
manager: serdars
ms.topic: article
...
> |---|---|---|
> | Prendere nota dell'organizzazione Microsoft 365 o Office 365 produzione <br>nome e ID nella colonna Risposta <br/>Se si hanno più tenant <br>associato all'organizzazione, <br>annotare tutti gli ID. | Nome tenant: <br/>ID tenant:| |
...
> | Quali Teams client sono in uso? | <input type="checkbox"> Web <br/> <input type="checkbox">Windows <br/> <input type="checkbox"> Mac <br/> <input type="checkbox"> iOS <br/> <input type="checkbox"> Android <br/> <input type="checkbox">Windows Mobile | |
...
> | La configurazione ibrida con Skype for Business Online? | <input type="checkbox"> Sì <br/> <input type="checkbox"> No | |
...
Usare la tabella seguente per acquisire i dettagli della rete dell'organizzazione e il modo in cui gli utenti sono (o saranno) connessi a Microsoft 365 o Office 365 servizi.
...
> | Se l'accesso Microsoft 365 o Office 365 tramite un server proxy, è disponibile <br>un modo per ignorare il proxy? | <input type="checkbox"> Sì <br/> <input type="checkbox"> No | |
