...
description: Informazioni su come gestire l'accesso Teams utenti assegnando o rimuovendo una licenza Teams agli utenti dell'organizzazione.
f1.keywords:
- CSH
...
|&nbsp;|&nbsp;|
|---------|---------|
|![Screenshot 1 di Teams licenza abilitata per un utente.](media/assign-teams-licenses-1.png)    | ![Screenshot 2 della licenza Teams abilitata per un utente](media/assign-teams-licenses-2.png)        |

### <a name="remove-a-teams-license"></a>Rimuovere una licenza Teams licenza

> [!IMPORTANT]
> La disabilitazione di una SKU Teams per l'applicazione di una SKU richiede circa 24 ore.
