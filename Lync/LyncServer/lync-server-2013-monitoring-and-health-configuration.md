...
# <a name="monitoring-and-health-configuration-in-lync-server-2013"></a>Configurazione di monitoraggio e integrità in Lync Server 2013
...
Gli argomenti di questa sezione includono procedure dettagliate per il monitoraggio e le attività di configurazione dell'integrità che è possibile eseguire nel pannello di controllo di Lync Server 2013 e Lync Server 2013 Management Shell.
