...
I partner di connettività di messaggistica istantanea pubblica attualmente supportati sono:
...
## <a name="xmpp-federation-support"></a>Supporto federativo XMPP

La Federazione XMPP supporta le comunicazioni degli utenti di Lync con gli utenti di domini XMPP configurati che usano un provider pubblico, ad esempio GTalk. Le comunicazioni con questi utenti possono includere le operazioni seguenti:

  - Messaggistica istantanea e presenza peer-to-peer
