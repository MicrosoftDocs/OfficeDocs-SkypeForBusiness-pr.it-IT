...
description: "Lync Server 2013: cmdlet per l'applicazione vocale."
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48576032"
---
# <a name="voice-application-cmdlets-in-lync-server-2013"></a>Cmdlet per l'applicazione vocale in Lync Server 2013
...
Le applicazioni vocali vengono eseguite nel servizio applicazioni nel Front End Server. Queste applicazioni consentono di gestire le chiamate in arrivo e in uscita consentendo di parcheggiare le chiamate, gestire i numeri non assegnati, coordinarsi con la messaggistica unificata di Exchange ed eseguire l'applicazione Response Group.

<div>

## <a name="voice-application-cmdlets"></a>Cmdlet per le applicazioni vocali

Di seguito è riportato un elenco dei cmdlet relativi alle applicazioni vocali:

**[Cmdlet per l'applicazione Parcheggio di chiamata in Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Cmdlet di messaggistica unificata di Exchange in Lync Server 2013](lync-server-2013-exchange-um-cmdlets.md)**
...
**[Cmdlet per l'applicazione Response Group in Lync Server 2013](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Cmdlet per i numeri non assegnati in Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**
