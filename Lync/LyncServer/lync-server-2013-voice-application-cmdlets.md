...
Le applicazioni vocali vengono eseguite nel servizio applicazioni nel server front-end. Queste applicazioni consentono di gestire le chiamate in arrivo e in uscita, consentendo di parcheggiare le chiamate, gestire i numeri non assegnati, coordinarsi con la messaggistica unificata di Exchange ed eseguire l'applicazione Response Group.

<div>

## <a name="voice-application-cmdlets"></a>Cmdlet per l'applicazione vocale

Di seguito è riportato un elenco dei cmdlet che gestiscono le applicazioni vocali:

**[Cmdlet dell'applicazione Call Park in Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Cmdlet di Response Group Application in Lync Server 2013](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Cmdlet di numeri non assegnati in Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**
