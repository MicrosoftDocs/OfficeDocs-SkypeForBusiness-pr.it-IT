...
4.  In **assegnazione percorso federativo di sito**selezionare **Abilita federazione SIP**e quindi selezionare Office Communications Server 2007 R2 Director o Office Communications Server 2007 R2 Edge Server se non è elencato alcun amministratore.
    ...
    Finestra ![di dialogo Modifica proprietà, pagina Route federativo pagina](images/JJ205136.bc13014b-3578-4d9e-9ff7-bdd09130b676(OCS.15).jpg "modifica proprietà, Route federativo")  
...
8.  Nell'elenco selezionare l'interfaccia Edge Server per BackCompatSite.
    ...
    ![Finestra di dialogo Modifica proprietà,](images/JJ205136.75045212-03ca-4b82-8337-5dacb487094f(OCS.15).jpg "finestra di dialogo Modifica proprietà") generale pagina generale  
