...
## <a name="assigning-a-per-user-location-policy-by-using-lync-server-management-shell-cmdlets"></a>Assegnazione di un criterio percorso Per-User tramite i cmdlet di Lync Server Management Shell
