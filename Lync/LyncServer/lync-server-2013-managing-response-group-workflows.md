---
title: 'Lync Server 2013: gestione dei flussi di lavoro di Response Group'
description: 'Lync Server 2013: gestione dei flussi di lavoro di Response Group.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48560412"
---
# <a name="managing-response-group-workflows-in-lync-server-2013"></a>Gestione dei flussi di lavoro di Response Group in Lync Server 2013
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Eliminare un flusso di lavoro in Lync Server 2013](lync-server-2013-delete-a-workflow.md)
