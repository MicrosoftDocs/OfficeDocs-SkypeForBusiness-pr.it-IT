...
La tabella EdgeServers è una tabella di supporto. Ogni record archivia le informazioni su un server perimetrale coinvolto in chiamate che includono record nel database.
