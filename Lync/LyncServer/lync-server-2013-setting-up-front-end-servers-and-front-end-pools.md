...
# <a name="setting-up-front-end-servers-and-front-end-pools-for-lync-server-2013"></a>Configurazione di front end server e pool Front end per Lync Server 2013
...
In questa sezione viene illustrata l'installazione di Lync Server 2013 e la configurazione dei ruoli del server per il server Standard Edition e il pool Front End, inclusi i Front End Server e i ruoli del server collocati con i Front End Server. Per installare e configurare i ruoli del server, è possibile eseguire la distribuzione guidata di Lync Server in ogni computer in cui si sta installando un ruolo del server. È possibile utilizzare la distribuzione guidata per completare tutti e quattro i passaggi di distribuzione, tra cui l'installazione dell'archivio di configurazione locale, l'installazione dei Front End Server, la configurazione di certificati e l'avvio dei servizi.
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Installare componenti server per Lync Server 2013](lync-server-2013-install-lync-server-server-components.md)
  ...
  - [Testare la distribuzione del pool in Lync Server 2013](lync-server-2013-test-the-pool-deployment.md)
