...
---
# <a name="new-exchange-server-integration-features-in-lync-server-2013"></a>Nuove funzionalità di integrazione di Exchange Server in Lync Server 2013
...
Lync Server 2013 supporta nuove funzionalità quando viene distribuita insieme a Microsoft Exchange Server 2013, come descritto nell'elenco seguente. Affinché ognuna di queste caratteristiche funzioni, è necessario distribuire sia Lync Server 2013 che Exchange 2013.
  ...
  - È possibile abilitare l' **integrazione dell'archiviazione Lync**, che integra l'archiviazione di lync Server 2013 nella funzionalità di blocco In-Place di Exchange 2013, per gli utenti ospitati in Exchange 2013, che consente agli amministratori di utilizzare la conformità e eDiscovery in un'esperienza comune.
