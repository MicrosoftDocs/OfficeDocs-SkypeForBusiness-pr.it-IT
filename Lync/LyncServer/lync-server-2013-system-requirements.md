...
description: 'Lync Server 2013: requisiti di sistema.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48562602"
---
# <a name="system-requirements-for-lync-server-2013"></a>Requisiti di sistema per Lync Server 2013
...
In questa sezione vengono illustrati i requisiti di sistema per la distribuzione di Lync Server 2013 e di tutti i componenti associati.
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Requisiti di sistema per i server che eseguono Lync Server 2013](lync-server-2013-system-requirements-for-servers-running-lync-server-2013.md)
