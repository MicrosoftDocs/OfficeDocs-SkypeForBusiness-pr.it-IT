...
description: 'Lync Server 2013: cmdlet per le conferenze Web.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48573622"
---
# <a name="web-conferencing-cmdlets-in-lync-server-2013"></a>Cmdlet per le conferenze Web in Lync Server 2013
...
Le conferenze e le riunioni online sono elementi importanti in Microsoft Lync Server 2013. I cmdlet CsConferencingConfiguration e CsConferencingPolicy sono gli strumenti di amministrazione principali per la gestione delle conferenze tramite Windows PowerShell.

<div>

## <a name="web-conferencing-cmdlets"></a>Web Conferencing Cmdlets

I cmdlet [New-CsClientPolicy](https://technet.microsoft.com/library/Gg425949(v=OCS.15)) e [Set-CsClientPolicy](https://technet.microsoft.com/library/Gg398300(v=OCS.15)) offrono ulteriori modalità di configurazione e gestione di Lync Server 2013.
