...
# <a name="web-conferencing-cmdlets-in-lync-server-2013"></a>Cmdlet di Web Conferencing in Lync Server 2013
...
I servizi di conferenza e le riunioni online sono elementi importanti in Microsoft Lync Server 2013. I cmdlet CsConferencingConfiguration e CsConferencingPolicy sono gli strumenti di amministrazione principali per la gestione delle conferenze tramite Windows PowerShell.

<div>

## <a name="web-conferencing-cmdlets"></a>Cmdlet per conferenze Web

I cmdlet [New-CsClientPolicy](https://technet.microsoft.com/en-us/library/Gg425949(v=OCS.15)) e [Set-CsClientPolicy](https://technet.microsoft.com/en-us/library/Gg398300(v=OCS.15)) consentono di configurare e gestire in modo aggiuntivo Lync Server 2013.
