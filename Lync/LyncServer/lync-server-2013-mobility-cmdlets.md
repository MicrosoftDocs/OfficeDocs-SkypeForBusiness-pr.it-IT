...
# <a name="mobility-cmdlets-in-lync-server-2013"></a>Cmdlet per dispositivi mobili in Lync Server 2013
...
I cmdlet per dispositivi mobili sono stati introdotti per gestire la funzionalità per dispositivi mobili aggiunta nell'aggiornamento cumulativo per Lync Server 2010: novembre 2011. Utilizzare questi cmdlet per gestire le impostazioni per le funzionalità per dispositivi mobili, ad esempio i criteri utente e la configurazione del servizio per dispositivi mobili.

<div>

## <a name="mobility-cmdlets"></a>Cmdlet relativi alla funzionalità per dispositivi mobili

I cmdlet che configurano le funzionalità per dispositivi mobili consentono di eseguire comandi da Lync Server Management Shell o di scrivere script per configurare e testare varie impostazioni di mobilità.
