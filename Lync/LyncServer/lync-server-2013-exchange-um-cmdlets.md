...
description: 'Lync Server 2013: cmdlet di messaggistica unificata di Exchange.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48564822"
---
# <a name="exchange-um-cmdlets-in-lync-server-2013"></a>Cmdlet di messaggistica unificata di Exchange in Lync Server 2013
...
Microsoft Lync Server 2013 funziona insieme alla messaggistica unificata di Exchange per implementare l'operatore automatico e l'accesso sottoscrittore per la segreteria telefonica ospitata. Queste funzionalità possono essere gestite tramite cmdlet in Lync Server Management Shell.

<div>

## <a name="exchange-um-cmdlets"></a>Cmdlet per Messaggistica unificata di Exchange

I cmdlet seguenti possono essere utilizzati per gestire la messaggistica unificata di Exchange
