...
## <a name="assigning-a-per-user-persistent-chat-policy-by-using-windows-powershell-cmdlets"></a>Assegnazione di un criterio di chat persistente Per-User tramite i cmdlet di Windows PowerShell
