...
description: 'Lync Server 2013: Panoramica del processo di distribuzione per VoIP aziendale.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48561082"
---
# <a name="deployment-process-overview-for-enterprise-voice-in-lync-server-2013"></a>Panoramica del processo di distribuzione per VoIP aziendale in Lync Server 2013
