...
description: 'Lync Server 2013: cmdlet di VoIP aziendale.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48558432"
---
# <a name="enterprise-voice-cmdlets-in-lync-server-2013"></a>Cmdlet di VoIP aziendale in Lync Server 2013
...
VoIP aziendale è l'implementazione Microsoft di Voice over IP (VoIP). I cmdlet disponibili per la gestione di VoIP aziendale in Microsoft Lync Server 2013 consentono di creare e modificare dial plan (in precedenza noti come profili località), criteri vocali, route e regole di normalizzazione.

<div>

## <a name="enterprise-voice-cmdlets"></a>Cmdlet per VoIP aziendale

La maggior parte delle attività di gestione che si applicano a VoIP aziendale può essere eseguita dal pannello di controllo di Lync Server. Le stesse attività possono essere eseguite utilizzando i cmdlet di Lync Server Management Shell o da uno script, consentendo di automatizzare determinate attività. Di seguito è riportato un elenco dei cmdlet correlati direttamente alla gestione di VoIP aziendale:
...
**[Cmdlet per le regole di normalizzazione vocale in Lync Server 2013](lync-server-2013-voice-normalization-rules-cmdlets.md)**
...
**[Cmdlet per i criteri vocali in Lync Server 2013](lync-server-2013-voice-policy-cmdlets.md)**
...
**[Cmdlet per il routing vocale in Lync Server 2013](lync-server-2013-voice-routing-cmdlets.md)**
...
[Cmdlet avanzati di VoIP aziendale in Lync Server 2013](lync-server-2013-advanced-enterprise-voice-cmdlets.md)  
