...
# <a name="get-persistent-chat-server-pool-availability-in-lync-server-2013"></a>Assicurare la disponibilità del pool di server Chat persistente in Lync Server 2013
