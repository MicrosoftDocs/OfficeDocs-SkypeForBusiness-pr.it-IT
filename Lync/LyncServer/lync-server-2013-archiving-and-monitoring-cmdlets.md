...
# <a name="archiving-and-monitoring-cmdlets-in-lync-server-2013"></a>Cmdlet per l'archiviazione e il monitoraggio in Lync Server 2013
...
I cmdlet per l'archiviazione e il monitoraggio consentono agli amministratori di gestire l'archiviazione dei messaggi istantanei e delle sessioni di conferenza; per registrare le informazioni dettagliate sulle chiamate; per monitorare Microsoft Lync Server 2013 utilizzando la qualità dell'esperienza (QoE).


> [!NOTE]
> Per ulteriori informazioni sui cmdlet, vedere il Blog di Windows&nbsp;PowerShell di Lync Server <A href="http://go.microsoft.com/fwlink/p/?linkid=263432">http://go.microsoft.com/fwlink/p/?linkId=263432</A>all'indirizzo. Il contenuto di ogni blog e il relativo URL sono soggetti a modifica senza preavviso.



<div>

## <a name="archiving-and-monitoring-cmdlets"></a>Cmdlet per l'archiviazione e il monitoraggio

Di seguito è riportato un elenco dei cmdlet correlati direttamente alla gestione dell'archiviazione e del monitoraggio:
