...
description: 'Lync Server 2013: gestione di VoIP aziendale per gli utenti.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48574942"
---
# <a name="managing-enterprise-voice-for-users-in-lync-server-2013"></a>Gestione di VoIP aziendale per gli utenti in Lync Server 2013
...
È possibile autorizzare Enterprise Voice per i singoli utenti. Utilizzare le procedure descritte in questa sezione per gestire VoIP aziendale utilizzando il pannello di controllo di Lync Server 2013 e Lync Server 2013 Management Shell.
