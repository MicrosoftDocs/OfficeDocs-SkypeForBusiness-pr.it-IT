...
I dati creati utilizzando il backup di SQL Server richiedono molto più spazio su disco, possibilmente 20 volte di più, rispetto a quello creato da `Export-CsPersistentChatData` , ma il backup di SQL Server è più probabile che sia una procedura che gli amministratori hanno familiarità con.
