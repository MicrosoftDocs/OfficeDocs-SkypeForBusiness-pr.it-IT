...
# <a name="view-details-about-a-service-in-lync-server-2013"></a>Visualizzare i dettagli di un servizio in Lync Server 2013
...
È possibile usare il pannello di controllo di Lync Server per visualizzare i dettagli su ogni servizio in uso in un computer specifico della topologia. È possibile visualizzare lo stato di ogni servizio e i dettagli, ad esempio i database associati, le porte e i servizi dipendenti.
