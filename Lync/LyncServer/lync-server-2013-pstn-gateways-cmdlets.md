...
# <a name="pstn-gateways-cmdlets-in-lync-server-2013"></a>Cmdlet per i gateway PSTN in Lync Server 2013
...
## <a name="pstn-gateways-cmdlets"></a>Cmdlet per i gateway PSTN

I cmdlet [Test-CsPstnOutboundCall](https://technet.microsoft.com/library/Gg398207(v=OCS.15)) e [Test-CsPstnPeerToPeerCall](https://technet.microsoft.com/library/Gg398662(v=OCS.15)) consentono di verificare che gli utenti siano in grado di effettuare chiamate sulla rete PSTN.
