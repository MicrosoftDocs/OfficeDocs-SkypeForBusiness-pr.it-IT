...
description: 'Lync Server 2013: distribuzione di funzionalità di VoIP aziendale avanzate.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48558582"
---
# <a name="deploying-advanced-enterprise-voice-features-in-lync-server-2013"></a>Distribuzione di funzionalità di VoIP aziendale avanzate in Lync Server 2013
...
Per informazioni dettagliate sulle funzionalità di VoIP aziendale avanzate, vedere le sezioni seguenti della documentazione relativa alla [pianificazione di Lync Server 2013](lync-server-2013-planning.md) :
