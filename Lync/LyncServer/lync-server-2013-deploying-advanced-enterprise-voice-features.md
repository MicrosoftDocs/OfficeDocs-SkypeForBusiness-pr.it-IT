---
title: 'Lync Server 2013: distribuzione di funzionalità vocali avanzate di Enterprise'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
# <a name="deploying-advanced-enterprise-voice-features-in-lync-server-2013"></a>Distribuzione di funzionalità vocali avanzate di Enterprise in Lync Server 2013
...
Per informazioni dettagliate sulle funzionalità vocali avanzate di VoIP aziendale, vedere le sezioni seguenti della documentazione relativa alla [pianificazione per Lync Server 2013](lync-server-2013-planning.md) :
