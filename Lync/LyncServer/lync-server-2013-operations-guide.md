...
Sono incluse le sezioni seguenti:
  ...
  - [Procedure consigliate per gli ambienti di Lync Server 2013](lync-server-2013-best-practices-for-lync-server-environments.md)
  ...
  - [Attività mensili in Lync Server 2013](lync-server-2013-monthly-tasks.md)

  - [Attività necessarie in Lync Server 2013](lync-server-2013-as-needed-tasks.md)

  - [Elenchi di controllo delle operazioni per Lync Server 2013](lync-server-2013-operations-checklists.md)
  ...
  - [Dipendenze operative in Lync Server 2013](lync-server-2013-operational-dependencies.md)
