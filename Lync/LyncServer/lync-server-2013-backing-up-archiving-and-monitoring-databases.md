...
# <a name="backing-up-archiving-and-monitoring-databases-in-lync-server-2013"></a>Backup dei database di archiviazione e monitoraggio in Lync Server 2013
...
> [!NOTE]  
> Quando si esegue il backup dell'archivio di gestione centrale, vengono sottoposte a backup le impostazioni per l'archiviazione e il monitoraggio. Per ulteriori informazioni, vedere <A href="lync-server-2013-backing-up-core-data-and-settings.md">backing up core data and Settings in Lync Server 2013</A>.
