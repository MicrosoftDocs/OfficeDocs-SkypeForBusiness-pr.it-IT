...
# <a name="single-director-in-lync-server-2013"></a>Singolo server Director in Lync Server 2013
...
Il Director può essere distribuito in una singola configurazione di Director o come pool di Director. Questa sezione definisce una topologia e una configurazione per un singolo Director. Se si prevede di distribuire un pool di amministratori per la gestione delle capacità più elevate e per l'elevata disponibilità, vedere l'argomento [pool di Director in scala in Lync Server 2013](lync-server-2013-scaled-director-pool.md) per la pianificazione delle considerazioni relative alla topologia in uso.
