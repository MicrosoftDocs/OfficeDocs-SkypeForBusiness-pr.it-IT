...
# <a name="response-group-application-cmdlets-in-lync-server-2013"></a>Cmdlet di Response Group Application in Lync Server 2013
...
Response Group Application è una caratteristica di gestione delle chiamate vocali aziendali che instrada le chiamate in arrivo a gruppi di agenti.

<div>

## <a name="response-group-application-cmdlets"></a>Cmdlet delle applicazioni di Response Group

I cmdlet seguenti possono essere usati per gestire l'applicazione Response Group.
