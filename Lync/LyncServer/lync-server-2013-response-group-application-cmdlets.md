...
description: "Lync Server 2013: cmdlet per l'applicazione Response Group."
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
---
# <a name="response-group-application-cmdlets-in-lync-server-2013"></a>Cmdlet per l'applicazione Response Group in Lync Server 2013
...
Response Group Application è una funzionalità di gestione delle chiamate vocali di VoIP aziendale che consente di instradare le chiamate in arrivo a gruppi di agenti.

<div>

## <a name="response-group-application-cmdlets"></a>Cmdlet per l'applicazione Response Group

I cmdlet seguenti possono essere utilizzati per gestire l'applicazione Response Group.
