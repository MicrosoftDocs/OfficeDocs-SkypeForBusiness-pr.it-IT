...
# <a name="centralized-logging-cmdlets-in-lync-server-2013"></a>Cmdlet di registrazione centralizzati in Lync Server 2013
...
I cmdlet di registrazione centralizzati consentono agli amministratori di gestire e configurare le funzionalità di registrazione centralizzate introdotte in Microsoft Lync Server 2013. La registrazione centralizzata consente agli amministratori di abilitare o disabilitare contemporaneamente la traccia degli eventi in più computer.

<div>

## <a name="centralized-logging-cmdlets"></a>Cmdlet di registrazione centralizzata

I cmdlet di registrazione centralizzati consentono di gestire il servizio di registrazione centralizzato introdotto in Lync Server 2013:
...
<!-- end list -->
  ...
  - [Mostra-CsClsLogging](https://technet.microsoft.com/en-us/library/JJ619173(v=OCS.15))
