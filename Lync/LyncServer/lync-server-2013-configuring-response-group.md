...
# <a name="configuring-response-group-in-lync-server-2013"></a>Configurazione di Response Group in Lync Server 2013
...
> [!TIP]  
> Per informazioni dettagliate sulla creazione di un Response Group mediante Lync Server Management Shell, incluso uno script di esempio, vedere la sezione relativa alla creazione del primo Response Group utilizzando Lync <A href="https://go.microsoft.com/fwlink/p/?linkid=204108">https://go.microsoft.com/fwlink/p/?linkId=204108</A>Server Management Shell all'indirizzo.
