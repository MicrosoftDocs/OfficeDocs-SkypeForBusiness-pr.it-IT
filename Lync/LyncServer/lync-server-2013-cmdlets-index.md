...
Per recuperare un elenco completo dei cmdlet disponibili per la gestione di Lync Server, digitare quanto segue al prompt dei comandi di Lync Server Management Shell:
