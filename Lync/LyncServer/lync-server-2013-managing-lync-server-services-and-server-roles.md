...
description: 'Lync Server 2013: gestione di servizi e ruoli del server di Lync Server.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48557452"
---
# <a name="managing-lync-server-2013-services-and-server-roles"></a>Gestione di servizi e ruoli del server di Lync Server 2013
...
È possibile utilizzare le procedure descritte in questa sezione per gestire i diversi servizi e i ruoli del server in Lync Server 2013.
