...
# <a name="call-admission-control-for-sites-in-lync-server-2013"></a>Controllo di ammissione di chiamata per i siti in Lync Server 2013
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Visualizzazione delle informazioni sui siti di rete in Lync Server 2013](lync-server-2013-viewing-network-site-information.md)
