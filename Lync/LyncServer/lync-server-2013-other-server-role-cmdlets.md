...
description: 'Lync Server 2013: altri cmdlet del ruolo del server.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48546862"
---
# <a name="other-server-role-cmdlets-in-lync-server-2013"></a>Altri cmdlet del ruolo del server in Lync Server 2013
