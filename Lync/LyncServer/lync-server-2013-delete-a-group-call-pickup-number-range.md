...
Usare la procedura seguente per eliminare un intervallo di numeri di prelievo delle chiamate di gruppo.

<div>

## <a name="to-delete-a-call-pickup-group-number-range"></a>Per eliminare un intervallo di numeri del gruppo di raccolta chiamate
