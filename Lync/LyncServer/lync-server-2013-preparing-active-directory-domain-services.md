...
Prima di distribuire e gestire Lync Server 2013, è necessario preparare i servizi di dominio Active Directory estendendo lo schema e quindi creando e configurando gli oggetti. Le estensioni dello schema aggiungono le classi e gli attributi di Active Directory richiesti da Lync Server.

Gli argomenti in questa sezione descrivono come preparare Servizi di dominio Active Directory per la distribuzione di Lync Server e come assegnare le autorizzazioni di configurazione e unità organizzativa (OU). Per informazioni dettagliate sulle modifiche allo schema necessarie per Lync Server, vedere [estensioni dello schema di Active Directory, classi e attributi usati da Lync server 2013](lync-server-2013-active-directory-schema-extensions-classes-and-attributes-used-by-lync-server.md).
