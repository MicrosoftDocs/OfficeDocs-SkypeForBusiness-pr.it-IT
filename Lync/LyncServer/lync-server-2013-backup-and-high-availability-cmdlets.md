...
# <a name="backup-and-high-availability-cmdlets-in-lync-server-2013"></a>Cmdlet per backup e disponibilità elevata in Lync Server 2013
...
I cmdlet per backup e disponibilità elevata consentono agli amministratori di gestire le funzionalità di backup, ripristino e disponibilità elevata del pool introdotte in Microsoft Lync Server 2013.

<div>

## <a name="backup-and-high-availability-cmdlets"></a>Cmdlet per backup e disponibilità elevata

Di seguito è riportato un elenco di cmdlet che si riferiscono direttamente al backup e alla configurazione della disponibilità della topologia di Lync Server:
