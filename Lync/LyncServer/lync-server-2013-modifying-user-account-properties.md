---
title: 'Lync Server 2013: modificare le proprietà degli account utente'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
# <a name="modifying-user-account-properties-in-lync-server-2013"></a>Modifica delle proprietà dell'account utente in Lync Server 2013
...
## <a name="in-this-section"></a>Contenuto della sezione
  ...
  - [Configurare la telefonia per un utente in Lync Server 2013](lync-server-2013-configure-telephony-for-a-user.md)

  - [Trasferire utenti in un altro pool in Lync Server 2013](lync-server-2013-move-users-to-another-pool.md)
