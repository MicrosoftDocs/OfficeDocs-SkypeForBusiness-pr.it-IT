...
# <a name="delete-dial-in-conferencing-pin-settings-for-a-site-or-group-of-users-in-lync-server-2013"></a>Eliminare le impostazioni del PIN per le conferenze telefoniche con accesso esterno per un sito o un gruppo di utenti in Lync Server 2013
...
## <a name="to-delete-a-user-or-site-pin-policy"></a>Per eliminare un criterio PIN utente o sito
