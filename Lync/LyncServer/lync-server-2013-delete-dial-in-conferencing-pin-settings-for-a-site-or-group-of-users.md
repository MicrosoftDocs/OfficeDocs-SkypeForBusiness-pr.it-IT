...
# <a name="delete-dial-in-conferencing-pin-settings-for-a-site-or-group-of-users-in-lync-server-2013"></a>Eliminare le impostazioni dei PIN per i servizi di conferenza telefonica con accesso esterno per un sito o un gruppo di utenti in Lync Server 2013
...
Seguire questa procedura per eliminare un criterio PIN a livello di utente o a livello di sito.
...
## <a name="to-delete-a-user-or-site-pin-policy"></a>Per eliminare un criterio PIN per un utente o un sito
...
4.  Nel campo di ricerca della pagina **criteri PIN** digitare tutto o parte del nome del criterio che si vuole eliminare.
