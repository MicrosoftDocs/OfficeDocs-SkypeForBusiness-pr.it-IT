...
Questa sezione illustra gli argomenti della pianificazione per la migrazione da Lync Server 2010 a Lync Server 2013.
...
## <a name="in-this-section"></a>Contenuto della sezione
  ...
  - [Migrazione dei server di chat di gruppo](migrating-group-chat-servers.md)
