...
# <a name="set-up-edge-certificates-for-lync-server-2013"></a>Configurare i certificati perimetrali per Lync Server 2013
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Configurare i certificati per l'interfaccia perimetrale interna in Lync Server 2013](lync-server-2013-set-up-certificates-for-the-internal-edge-interface.md)

  - [Configurare i certificati per l'interfaccia perimetrale esterna per Lync Server 2013](lync-server-2013-set-up-certificates-for-the-external-edge-interface.md)
