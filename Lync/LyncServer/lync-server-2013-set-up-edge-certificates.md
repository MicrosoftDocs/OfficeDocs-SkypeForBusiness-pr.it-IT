...
Quando si installa un server perimetrale, è necessario richiedere, installare e assegnare i certificati necessari per le interfacce interne ed esterne.
