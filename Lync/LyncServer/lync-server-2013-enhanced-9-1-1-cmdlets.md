...
# <a name="enhanced-9-1-1-cmdlets-in-lync-server-2013"></a>Cmdlet di 9-1-1 avanzati in Lync Server 2013
...
Microsoft Lync Server 2013 viene fornito con cmdlet che consentono di implementare e gestire l'implementazione avanzata di 9-1-1 (E9-1-1) di una soluzione VoIP aziendale. Usare questi cmdlet per mappare i punti di connessione agli indirizzi fisici e configurare le impostazioni necessarie per gli utenti di VoIP aziendale per completare correttamente le chiamate di emergenza e inviare automaticamente una posizione al provider di servizi di emergenza. Non è possibile configurare E9-1-1 dal pannello di controllo di Lync Server, è necessario usare i cmdlet.

<div>

## <a name="enhanced-9-1-1-cmdlets"></a>Cmdlet di 9-1-1 avanzati

Usare i cmdlet seguenti per configurare E9-1-1.
