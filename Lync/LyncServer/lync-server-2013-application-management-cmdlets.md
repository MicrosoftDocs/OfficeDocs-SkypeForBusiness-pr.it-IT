...
---
# <a name="application-management-cmdlets-in-lync-server-2013"></a>Cmdlet per la gestione delle applicazioni in Lync Server 2013
...
Microsoft Lync Server 2013 fornisce cmdlet che consentono di gestire le applicazioni di Lync Server e le applicazioni di terze parti attendibili.

<div>

## <a name="application-management-cmdlets"></a>Cmdlet per la gestione delle applicazioni

Utilizzare i cmdlet di queste categorie per gestire le applicazioni.

**[Cmdlet per gli endpoint dell'applicazione in Lync Server 2013](lync-server-2013-application-endpoints-cmdlets.md)**
...
**[Cmdlet per server applicazioni e servizi in Lync Server 2013](lync-server-2013-application-server-and-services-cmdlets.md)**
...
**[Cmdlet per le applicazioni attendibili in Lync Server 2013](lync-server-2013-trusted-applications-cmdlets.md)**
