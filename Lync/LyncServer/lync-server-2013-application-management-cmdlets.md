...
Microsoft Lync Server 2013 offre cmdlet che consentono di gestire le applicazioni Lync Server e le applicazioni di terze parti attendibili.

<div>

## <a name="application-management-cmdlets"></a>Cmdlet per la gestione delle applicazioni

Usare i cmdlet in queste categorie per gestire le applicazioni.

**[Cmdlet endpoint applicazione in Lync Server 2013](lync-server-2013-application-endpoints-cmdlets.md)**
...
**[Cmdlet di server e servizi delle applicazioni in Lync Server 2013](lync-server-2013-application-server-and-services-cmdlets.md)**
