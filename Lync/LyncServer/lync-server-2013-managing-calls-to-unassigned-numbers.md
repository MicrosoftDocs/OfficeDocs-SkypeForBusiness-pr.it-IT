...
# <a name="managing-calls-to-unassigned-numbers-in-lync-server-2013"></a>Gestione delle chiamate a numeri non assegnati in Lync Server 2013
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Configurare i numeri di telefono non assegnati in Lync Server 2013](lync-server-2013-configure-unassigned-phone-numbers.md)
