...
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Cmdlet di VoIP aziendale avanzati in Lync Server 2013
...
Quando implementi Enterprise Voice nell'organizzazione, hai anche la possibilità di implementare funzionalità e applicazioni aggiuntive che possono migliorare l'esperienza utente e l'efficienza dell'organizzazione. Queste caratteristiche includono il controllo di ammissione alle chiamate, le chiamate di emergenza avanzate di 9-1-1 (E9-1-1) e le impostazioni di configurazione multimediale.

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>Cmdlet di VoIP aziendale avanzati

Gli elenchi seguenti contengono cmdlet che consentono di gestire le funzionalità avanzate di una distribuzione di VoIP aziendale:

**[Cmdlet di controllo dell'ammissione alle chiamate in Lync Server 2013](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[Cmdlet di 9-1-1 avanzati in Lync Server 2013](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[Cmdlet per l'aspetto delle linee condivise (SLA)](shared-line-appearance-sla-cmdlets.md)**
...
**[Cmdlet di bypass multimediale in Lync Server 2013](lync-server-2013-media-bypass-cmdlets.md)**
...
**[Cmdlet di configurazione multimediale in Lync Server 2013](lync-server-2013-media-configuration-cmdlets.md)**
