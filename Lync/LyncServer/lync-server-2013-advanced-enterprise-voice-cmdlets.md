...
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Cmdlet avanzati di VoIP aziendale in Lync Server 2013
...
_**Ultimo argomento modificato:** 2016-04-12_

Quando si implementa VoIP aziendale nell'organizzazione, si ha inoltre la possibilità di implementare funzionalità e applicazioni aggiuntive in grado di migliorare l'esperienza utente e l'efficienza dell'organizzazione. Tali funzionalità includono il servizio Controllo di ammissione di chiamata, il servizio per chiamate di emergenza Enhanced 9-1-1 (E9-1-1) e le impostazioni di configurazione multimediale.

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>Cmdlet per VoIP aziendale avanzato

Nell'elenco seguente sono riportati i cmdlet che consentono di gestire le funzionalità avanzate di una distribuzione di VoIP aziendale:

**[Cmdlet per il controllo di ammissione di chiamata in Lync Server 2013](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[Cmdlet Enhanced 9-1-1 in Lync Server 2013](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[Cmdlet per il bypass multimediale in Lync Server 2013](lync-server-2013-media-bypass-cmdlets.md)**
...
**[Cmdlet per la configurazione multimediale in Lync Server 2013](lync-server-2013-media-configuration-cmdlets.md)**
