...
# <a name="media-configuration-cmdlets-in-lync-server-2013"></a>Cmdlet per la configurazione multimediale in Lync Server 2013
...
## <a name="media-configuration-cmdlets"></a>Cmdlet per la configurazione multimediale
