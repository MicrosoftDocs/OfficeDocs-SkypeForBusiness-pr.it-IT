...
# <a name="configure-dial-in-conferencing-personal-identification-number-pin-rules-in-lync-server-2013"></a>Configurare le regole PIN (Personal Identification Number) per le conferenze telefoniche con accesso esterno in Lync Server 2013
...
## <a name="in-this-section"></a>Contenuto della sezione
  ...
  - [Eliminare le impostazioni dei PIN per i servizi di conferenza telefonica con accesso esterno per un sito o un gruppo di utenti in Lync Server 2013](lync-server-2013-delete-dial-in-conferencing-pin-settings-for-a-site-or-group-of-users.md)
