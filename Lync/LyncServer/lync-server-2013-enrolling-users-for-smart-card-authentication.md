...
Per ulteriori informazioni sull'iscrizione a nome degli utenti come agente di registrazione, vedere registrazione dei certificati per conto di altri utenti all'indirizzo [http://go.microsoft.com/fwlink/p/?LinkID=313367](http://go.microsoft.com/fwlink/p/?linkid=313367).
