...
description: 'Lync 2013: aggiornamenti per client e server.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="lync-server-updates"></a>Aggiornamenti di Lync Server

Per informazioni sugli aggiornamenti per Lync Server 2013, vedere [aggiornamenti per Lync server 2013](https://support.microsoft.com/help/2809243/updates-for-lync-server-2013) nel sito Web del supporto tecnico Microsoft.
