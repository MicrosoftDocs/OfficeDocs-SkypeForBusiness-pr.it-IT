...
# <a name="phase-8-move-from-pilot-deployment-into-production"></a>Fase 8: passaggio dalla distribuzione pilota alla produzione
...
Gli argomenti di questa sezione descrivono le attività che è necessario completare prima di spostare la distribuzione di Lync Server 2013 da una distribuzione pilota a una distribuzione a livello di produzione.
