...
description: "Lync Server 2013: cmdlet per l'applicazione Parcheggio di chiamata."
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48570092"
---
# <a name="call-park-application-cmdlets-in-lync-server-2013"></a>Cmdlet per l'applicazione Parcheggio di chiamata in Lync Server 2013
...
L'applicazione Parcheggio di chiamata consente a un utente di effettuare una chiamata in attesa, quindi di recuperare la chiamata da un telefono diverso. Utilizzare questi cmdlet per configurare le impostazioni per le orbite del parcheggio di chiamata e l'applicazione Parcheggio di chiamata.

<div>

## <a name="call-park-application-cmdlets"></a>Cmdlet per l'applicazione Parcheggio di chiamata
