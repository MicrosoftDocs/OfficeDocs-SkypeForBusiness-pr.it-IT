...
description: 'Lync Server 2013: Revisione del report DNS.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
---
# <a name="reviewing-the-dns-report-in-lync-server-2013"></a>Revisione del report DNS in Lync Server 2013
...
![Report di amministrazione DNS](images/Gg558641.9dd1e810-ddc7-4816-a806-4239baf9ec51(OCS.15).jpg "Report di amministrazione DNS")
