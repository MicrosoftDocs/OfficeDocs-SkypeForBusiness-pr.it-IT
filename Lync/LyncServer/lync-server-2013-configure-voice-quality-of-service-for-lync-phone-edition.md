...
description: 'Lync Server 2013: configurare la qualità vocale del servizio per Lync Phone Edition.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48566702"
---
# <a name="configure-voice-quality-of-service-for-lync-phone-edition-in-lync-server-2013"></a>Configurare la qualità del servizio vocale per Lync Phone Edition in Lync Server 2013
...
È possibile configurare i requisiti di qualità del servizio (QoS) vocale per i dispositivi Lync Phone Edition in un pool impostando il livello di QoS per i telefoni IP che si connettono a Lync Server 2013.

<div>

## <a name="to-configure-voice-quality-of-service-for-lync-phone-edition"></a>Per configurare la qualità del servizio vocale per Lync Phone Edition
