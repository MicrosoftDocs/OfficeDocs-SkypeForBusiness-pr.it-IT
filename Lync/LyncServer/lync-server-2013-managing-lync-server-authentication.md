...
# <a name="managing-lync-server-2013-authentication"></a>Gestione dell'autenticazione di Lync Server 2013
...
Utilizzare le procedure seguenti per gestire la sicurezza e l'autenticazione di Lync Server 2013.

<div>

## <a name="in-this-section"></a>Contenuto della sezione

  - [Gestione dei certificati per i processi operativi in Lync Server 2013](lync-server-2013-managing-certificates-for-operational-processes.md)
  ...
  - [Gestione delle impostazioni del PIN in Lync Server 2013](lync-server-2013-managing-pin-settings.md)
