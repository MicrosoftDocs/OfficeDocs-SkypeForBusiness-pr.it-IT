...
Usare le procedure seguenti per gestire la sicurezza e l'autenticazione di Lync Server 2013.
...
## <a name="in-this-section"></a>In questa sezione
  ...
  - [Gestione delle impostazioni PIN in Lync Server 2013](lync-server-2013-managing-pin-settings.md)
