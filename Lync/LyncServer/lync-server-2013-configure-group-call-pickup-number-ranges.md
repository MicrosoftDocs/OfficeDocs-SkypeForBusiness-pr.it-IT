...
# <a name="configure-group-call-pickup-number-ranges-in-lync-server-2013"></a>Configurare gli intervalli di numeri di prelievo delle chiamate di gruppo in Lync Server 2013
