...
Questa pagina elenca tutti i cmdlet di Windows PowerShell disponibili per gli amministratori dei tenant di Microsoft Lync Online.
...
I cmdlet seguenti possono essere usati solo con Lync Online:
...
Per informazioni su come configurare il computer per l'uso di Windows PowerShell per la gestione con Lync Online, vedere l'argomento della guida che [Usa Windows PowerShell per gestire Lync Online](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15)).
...
Questi cmdlet possono essere usati sia con Lync Online che con la versione locale di Lync Server 2013:
