...
ms.locfileid: "48523343"
---
# <a name="lync-online-cmdlets"></a>Cmdlet di Lync Online
...
In questa pagina sono elencati tutti i cmdlet di Windows PowerShell disponibili per gli amministratori dei tenant di Microsoft Lync Online.

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>Cmdlet disponibili solo per gli amministratori di Lync Online

I cmdlet seguenti possono essere utilizzati solo con Lync Online:
...
Per informazioni su come configurare il computer per l'utilizzo di Windows PowerShell per la gestione con Lync Online, vedere l'argomento della Guida relativo [all'utilizzo di Windows PowerShell per la gestione di Lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Altri cmdlet disponibili per gli amministratori di Lync Online

È possibile utilizzare questi cmdlet sia con Lync Online sia con la versione locale di Lync Server 2013:
