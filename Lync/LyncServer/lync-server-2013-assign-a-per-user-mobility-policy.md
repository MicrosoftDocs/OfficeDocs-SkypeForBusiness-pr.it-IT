...
## <a name="assigning-a-per-user-mobility-policy-by-using-windows-powershell-cmdlets"></a>Assegnazione di un criterio per dispositivi mobili di Per-User tramite i cmdlet di Windows PowerShell
