...
---
# <a name="configuring-voice-policies-and-pstn-usage-records-to-authorize-calling-features-and-privileges-in-lync-server-2013"></a>Configurazione di criteri vocali e record utilizzo PSTN per autorizzare le funzionalità e i privilegi di chiamata in Lync Server 2013
...
> [!NOTE]  
> Per informazioni dettagliate, vedere <A href="lync-server-2013-voice-policies.md">Voice Policies in Lync Server 2013</A> nella documentazione relativa alla pianificazione.
