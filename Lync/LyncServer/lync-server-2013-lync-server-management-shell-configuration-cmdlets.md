...
description: 'Lync Server 2013: cmdlet di configurazione di Lync Server Management Shell.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48555302"
---
# <a name="lync-server-management-shell-configuration-cmdlets-in-lync-server-2013"></a>Cmdlet di configurazione di Lync Server Management Shell in Lync Server 2013
...
Lync Server Management Shell è un'implementazione della finestra di comando di Windows PowerShell con cmdlet specifici per la gestione di Microsoft Lync Server 2010 precaricati nell'ambiente. Questi cmdlet consentono di personalizzare l'ambiente.

<div>

## <a name="lync-server-management-shell-configuration-cmdlets"></a>Cmdlet per la configurazione di Lync Server Management Shell
