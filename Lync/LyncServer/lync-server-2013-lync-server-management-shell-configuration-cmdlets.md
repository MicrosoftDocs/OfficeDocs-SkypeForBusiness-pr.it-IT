...
Lync Server Management Shell è un'implementazione della finestra di comando di Windows PowerShell con cmdlet specifici per la gestione di Microsoft Lync Server 2010 precaricato nell'ambiente. Questi cmdlet consentono di personalizzare l'ambiente.

<div>

## <a name="lync-server-management-shell-configuration-cmdlets"></a>Cmdlet di configurazione di Lync Server Management Shell

Usa questi cmdlet per impostare alcune proprietà personalizzate di Lync Server Management Shell.
