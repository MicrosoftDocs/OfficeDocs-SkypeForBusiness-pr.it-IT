...
# <a name="persistent-chat-compliance-in-lync-server-2013"></a>Conformità chat persistente in Lync Server 2013
...
Per creare una nuova configurazione di conformità della chat persistente
...
Per ottenere la configurazione della conformità della chat persistente

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

Per impostare la configurazione della conformità della chat persistente
...
Per rimuovere la configurazione della conformità della chat persistente
