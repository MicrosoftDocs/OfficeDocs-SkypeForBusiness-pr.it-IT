...
---
# <a name="persistent-chat-compliance-in-lync-server-2013"></a>Conformità della chat persistente in Lync Server 2013
...
Per creare una nuova configurazione di conformità di Persistent Chat
...
Per ottenere la configurazione di conformità di Persistent Chat

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

Per impostare la configurazione di conformità di Persistent Chat
...
Per rimuovere la configurazione di conformità di Persistent Chat
