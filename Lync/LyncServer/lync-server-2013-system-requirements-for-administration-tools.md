...
# <a name="system-requirements-for-administration-tools-in-lync-server-2013"></a>Requisiti di sistema per gli strumenti di amministrazione in Lync Server 2013
...
Gli argomenti seguenti descrivono i requisiti per l'installazione dello strumento di amministrazione e la pubblicazione di una topologia.
