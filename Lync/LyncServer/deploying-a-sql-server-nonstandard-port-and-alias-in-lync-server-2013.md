...
1.  Selezionare **Start**e scegliere **Gestione configurazione SQL Server**, come illustrato nella figura seguente.
    ...
    Icona di ![SQL Server Management Studio]con(images/Dn776290.6e811f27-cea9-4437-b44c-55bff013150f(OCS.15).png "l'icona di SQL Server Management Studio")
...
2.  Nel riquadro di spostamento scegliere per espandere l' **istanza di SQL Server**, scegliere Espandi **configurazione di rete SQL Server**e scegliere **protocolli per \<il nome\>dell'istanza**, come illustrato nella figura seguente.
    ...
    ![Passare alle proprietà TCP/IP](images/Dn776290.3d7a964c-f17e-47fd-8f0c-535453da7fad(OCS.15).jpg "per passare alle proprietà TCP/IP")
...
6.  Per l'indirizzo IP che verrà usato da Lync Server per la connessione al database, verificare che **Enabled** sia impostato su **Sì**, come illustrato nella figura seguente.
    ...
    ![Impostare Enabled come Sì per l'indirizzo IP corretto.] (images/Dn776290.7f818b91-0793-4594-8932-90447270fad9(OCS.15).jpg "Impostare Enabled come Sì per l'indirizzo IP corretto.")
...
9.  Riavviare l'istanza di SQL Server selezionando **servizi SQL Server** nel riquadro sinistro di gestione configurazione SQL Server. Fare quindi clic con il pulsante destro del mouse su **nome \<\> istanza di SQL Server** nel riquadro destro e scegliere **Riavvia**, come illustrato nella figura seguente.
    ...
    ![Reimpostare il servizio SQL Server ad esempio.] (images/Dn776290.a965c8cf-f769-4b52-bb38-c48a438cf491(OCS.15).jpg "Reimpostare il servizio SQL Server ad esempio.")
...
4.  Immettere il **nome dell'alias**, il **numero di porta**, il **protocollo**e il **Server**, come illustrato nella figura seguente.
    ...
    ![Creazione di un nuovo alias]per(images/Dn776290.03653588-aecf-4fdd-b58a-95f5b372d478(OCS.15).jpg "la creazione di un nuovo alias")
...
2.  Selezionare **Start**e scegliere **Server Manager**, come illustrato nella figura seguente.
    ...
    ![Apertura]di Server Manager che(images/Dn776290.3e4bd8ad-2a65-4a05-af40-c8dd3583bc8f(OCS.15).jpg "apre Server Manager")
...
5.  Fare clic con il pulsante destro del mouse sul dominio e scegliere **nuovo alias (CNAME)...**, come illustrato nella figura seguente.
    ...
    ![Selezione dell'opzione per creare un nuovo alias CNAME](images/Dn776290.abe66cca-b53c-427a-9094-1a59dc6840ca(OCS.15).jpg "selezionando l'opzione per creare un nuovo alias CNAME")

6.  Immettere il **nome dell'alias** e l' **FQDN per SQL Server**, come illustrato nella figura seguente.
    
    ![Riempimento della finestra di dialogo nuovo alias CNAME.] (images/Dn776290.dd0ebd2d-3407-4459-8bd9-2b389a7bc440(OCS.15).jpg "Riempimento della finestra di dialogo nuovo alias CNAME.")
...
2.  Digitare **netstat-a-f**e verificare che SQL Server sia in uso con la porta corretta, come illustrato nella figura seguente.
    ...
    ![Usare netstat per verificare la porta.] (images/Dn776290.4ff3a1b2-c5eb-4496-8be7-374c351fa027(OCS.15).jpg "Usare netstat per verificare la porta.")
