...
Per proteggere i server della distribuzione di Lync Server 2013 da un danno accidentale o intenzionale che potrebbe causare tempi di inattività, prendere le seguenti precauzioni:
  ...
  - Installare con regolarità gli aggiornamenti della sicurezza nei server. Sottoscrivendo il servizio Microsoft Security Notification Service, è possibile ricevere una notifica immediata ogni volta che vengono pubblicati bollettini sulla sicurezza per i prodotti Microsoft. Per effettuare la sottoscrizione, visitare il sito Web Microsoft Technical Security Notifications all'indirizzo [https://go.microsoft.com/fwlink/p/?LinkId=145202](https://go.microsoft.com/fwlink/p/?linkid=145202) .
