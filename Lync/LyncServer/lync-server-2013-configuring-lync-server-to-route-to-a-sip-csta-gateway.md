...
description: 'Lync Server 2013: configurazione di Lync Server per il routing a un gateway SIP/CSTA.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48570822"
---
# <a name="configuring-lync-server-2013-to-route-to-a-sipcsta-gateway"></a>Configurazione di Lync Server 2013 per il routing a un gateway SIP/CSTA
