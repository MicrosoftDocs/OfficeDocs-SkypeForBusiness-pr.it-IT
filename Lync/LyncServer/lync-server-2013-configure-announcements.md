...
# <a name="configure-announcements-in-lync-server-2013"></a>Configurare gli annunci in Lync Server 2013
...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Eliminare un annuncio in Lync Server 2013](lync-server-2013-delete-an-announcement.md)
