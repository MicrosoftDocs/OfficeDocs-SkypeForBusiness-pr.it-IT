...
---
# <a name="supported-server-collocation-for-edge-components-in-lync-server-2013"></a>Collocazione dei server supportata per i componenti perimetrali in Lync Server 2013
