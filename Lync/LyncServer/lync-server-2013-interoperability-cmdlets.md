...
# <a name="interoperability-cmdlets-in-lync-server-2013"></a>Cmdlet di interoperabilità in Lync Server 2013
...
I cmdlet di interoperabilità vengono utilizzati per configurare l'autenticazione da server a server e l'autorizzazione tra Microsoft Lync Server 2013 e altri prodotti server, ad esempio Microsoft Exchange Server 2013. Con l'autenticazione e l'autorizzazione server-server i server riescono a scambiarsi e a condividere i dati facilmente.

<div>

## <a name="interoperability-cmdlets"></a>Cmdlet di interoperabilità

Di seguito è riportato un elenco di cmdlet che si riferiscono direttamente alla configurazione e alla gestione dell'interoperabilità tra Microsoft Lync Server 2013 e altri prodotti server:
