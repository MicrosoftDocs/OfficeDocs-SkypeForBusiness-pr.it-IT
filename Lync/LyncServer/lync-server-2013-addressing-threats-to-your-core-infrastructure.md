...
## <a name="in-this-section"></a>Argomenti della sezione
  ...
  - [Protezione di IIS in Lync Server 2013](lync-server-2013-protecting-iis.md)

  - [Windows Update per Lync Server 2013](lync-server-2013-windows-update-for-lync-server.md)
