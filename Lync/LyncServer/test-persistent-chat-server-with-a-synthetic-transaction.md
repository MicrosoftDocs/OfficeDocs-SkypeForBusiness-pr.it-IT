...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="49276-102">Testare il server Chat persistente con una transazione sintetica</span><span class="sxs-lookup"><span data-stu-id="49276-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="49276-103">_**Argomento Ultima modifica:** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="49276-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="49276-104">Per testare il server di chat persistente per l'invio e la ricezione di messaggi in una chat room tra due utenti</span><span class="sxs-lookup"><span data-stu-id="49276-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="49276-105">o</span><span class="sxs-lookup"><span data-stu-id="49276-105">or</span></span>
...
<span data-ttu-id="49276-106">o</span><span class="sxs-lookup"><span data-stu-id="49276-106">or</span></span>
