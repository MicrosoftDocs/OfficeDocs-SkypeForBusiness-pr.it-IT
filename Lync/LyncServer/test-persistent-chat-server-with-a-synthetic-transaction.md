...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a>Testare il server Chat persistente con una transazione sintetica
...
Per testare il server di chat persistente per l'invio e la ricezione di messaggi in una chat room tra due utenti
