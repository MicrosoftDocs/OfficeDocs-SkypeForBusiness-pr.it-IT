...
Lo strumento di stress e prestazioni di Lync Server 2013 (LyncPerfTool.exe) dispone di numerosi contatori che è possibile utilizzare per comprendere le operazioni eseguite dal client e l'eventuale presenza di problemi.

<div>

## <a name="client-counters"></a>Contatori client

Ogni istanza di LyncPerfTool.exe in esecuzione ha un'istanza separata dei contatori. Ogni istanza è denominata dal relativo ID di processo.
