...
description: Strumento per lo stress e le prestazioni di Lync Server 2013.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
5.  [Creare utenti e contatti](create-users-and-contacts.md)

6.  [Configurare il profilo utente](configure-user-profile.md)

7.  [Eseguire LyncPerfTool](run-lyncperftool.md)
